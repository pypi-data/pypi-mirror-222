...
Firstly thank you for your interest in contributing to _aws-step-functions-pydantic_!
...
Next get the latest checkout of the _aws-step-functions-pydantic_ repository:

```sh
git clone git@github.com:lmmx/aws-step-functions-pydantic.git
```

Change into the newly created directory and **after activating your virtual environment**
install an editable version of aws-step-functions-pydantic along with its tests requirements:

```sh
cd aws-step-functions-pydantic
pip install -e .[tests]
```
...
Thank you for considering contribution to _aws-step-functions-pydantic_!
