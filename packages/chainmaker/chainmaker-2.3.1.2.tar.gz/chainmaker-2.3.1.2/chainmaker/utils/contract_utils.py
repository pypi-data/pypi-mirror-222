...
class Contract(object):
    ...
    def init(self, contract_name: str = None, runtime_type=None, params=None, version=None, gas_limit: int = None,
             with_sync_result=None, user=None, endorsers=None, payer=None) -> "Contract":
        """
        创建合约
        :param params:
        :param runtime_type:
    ...
    def upgrade(self, byte_code_path: str = None, runtime_type: RuntimeType = None,
                params=None, version: str = None, gas_limit: int = None, with_sync_result=None) -> Union["Contract"]:
        """
        升级合约
        :param gas_limit:
        ...
        res = self._cc.upgrade_contract(self.contract_name, upgrade_byte_code_path,
                                        runtime_type, params, version=new_version, gas_limit=gas_limit, with_sync_result=with_sync_result)
        check_response(res)
        return self
