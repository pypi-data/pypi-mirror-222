...
class MultiSignMixin(BaseClient):
    ...
    def create_multi_sign_req_payload(self, params: Union[list, dict], tx_id: str = None, gas_limit: int = None) -> Payload:
        """
        创建多签请求待签名Payload
        :param gas_limit:
        ...
        return self._payload_builder.create_invoke_payload(SystemContractName.MULTI_SIGN.name, MultiSignMethod.REQ.name,
                                                           params, tx_id=tx_id, gas_limit=gas_limit)

    # 04-00 发起多签请求
    def multi_sign_req(self, payload: Payload,
                       payer: User = None, timeout: int = None, with_sync_result: bool = None) -> TxResponse:
        """
        发起多签请求
        ...
        return self.send_request_with_sync_result(payload, payer=payer, timeout=timeout, with_sync_result=with_sync_result)

    # 04-01 对多签请求Payload进行投票
    def multi_sign_vote(self, multi_sign_req_payload, endorser: ClientUser = None, is_agree: bool = True,
                        gas_limit: int = None, payer: User = None,
        ...
        return self.send_request_with_sync_result(payload, payer=payer, timeout=timeout,
    ...
    def multi_sign_trig(self, multi_sign_req_payload: Payload = None, tx_id: str = None, gas_limit: int = None,
                        payer: User = None,
                        timeout: int = None, with_sync_result: bool = None) -> TxResponse:
        """
