...
.cell-tag-hide-ou::before {
    content: url(${___CSS_LOADER_URL_REPLACEMENT_1___})
}
.cell-tag-hide-input::before {
    content: url(${___CSS_LOADER_URL_REPLACEMENT_1___})
}
`, "",{"version":3,"sources":["webpack://./style/base.css"],"names":[],"mappings":"AAAA;;;;CAIC;;;AAGD;IACI,+BAA+B;IAC/B,6BAA6B;AACjC;;AAEA,kEAAkE;AAClE;IACI;0DACkM;AACtM;;AAEA;IACI;AACJ;AACA;IACI;AACJ;AACA;IACI;AACJ","sourcesContent":["/*\n    See the JupyterLab Developer Guide for useful CSS Patterns:\n\n    https://jupyterlab.readthedocs.io/en/stable/developer/css.html\n*/\n\n\n.cell-tag-raises-exception {\n    border-style: dotted !important;\n    border-color: #800 !important;\n}\n\n/* multiple selection - might be better suited in courselevels ? */\n.jp-Notebook.jp-mod-commandMode .jp-Cell.jp-mod-selected {\n    background-image:\n        url('data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"4\" height=\"4\" viewBox=\"0 0 4 4\"><path fill-opacity=\"0.4\" d=\"M1 3h1v1H1V3zm2-2h1v1H3V1z\"></path></svg>') !important;\n}\n\n.cell-tag-hide-input::before {\n    content: url(only-out.svg)\n}\n.cell-tag-hide-ou::before {\n    content: url(only-out.svg)\n}\n.cell-tag-hide-input::before {\n    content: url(only-out.svg)\n}\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=style_index_js.51b37c986638cb7ec534.js.map