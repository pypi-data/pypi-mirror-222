...
from .collection import CollectionKey, convert_to_collection_keys, validate_collection_keys
    ...
    with maybe_docker_is_not_running():
        with download_openapi_spec() as open_api_spec_file:
            ...
            with app_context(db_manager_cls=db_,
                            ...
                            wstl_builder_factory=wstl_builder_factory,
                            package_name=project_slug) as (app, _):
