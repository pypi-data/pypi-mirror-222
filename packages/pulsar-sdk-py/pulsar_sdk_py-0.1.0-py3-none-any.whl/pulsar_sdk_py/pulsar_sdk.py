    ...
    class _WebsocketClient:
        ...
        async def response_generator(self, msg):
            ...
            try:
                ...
                last_time_printed = -1
                minimum_time_elapsed = 0.5
                while True:
                    debug_receive = await websocket_conn.recv()
                    time_elapsed = time.time() - last_time_printed
                    if time_elapsed < minimum_time_elapsed:
                        await asyncio.sleep(minimum_time_elapsed - time_elapsed)
