...
class EventCode():
    ...
    None: ArducamEvkSDK.EventCode # value = <EventCode.None: 0>
    ...
    __members__: dict # value = {'None': <EventCode.None: 0>, 'FrameStart': <EventCode.FrameStart: 1>, 'FrameEnd': <EventCode.FrameEnd: 2>, 'Exit': <EventCode.Exit: 3>, 'TransferError': <EventCode.TransferError: 256>, 'TransferTimeout': <EventCode.TransferTimeout: 257>, 'DeviceConnect': <EventCode.DeviceConnect: 512>, 'DeviceDisconnect': <EventCode.DeviceDisconnect: 513>}
    pass
class Format():
    def __init__(self) -> None: ...
    @property
