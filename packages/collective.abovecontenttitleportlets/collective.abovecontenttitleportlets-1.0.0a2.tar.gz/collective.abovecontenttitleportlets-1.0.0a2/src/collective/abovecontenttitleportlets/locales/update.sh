...
# locales/[language]/LC_MESSAGES/collective.abovecontenttitleportlets.po
# (e.g. locales/de/LC_MESSAGES/collective.abovecontenttitleportlets.po)

domain=collective.abovecontenttitleportlets
