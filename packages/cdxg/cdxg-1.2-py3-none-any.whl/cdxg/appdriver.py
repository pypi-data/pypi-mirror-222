...
class AppDriver:
    ...
    def background_app(self, seconds: int):
        ...
        """
        Cdxg.driver.background_app(seconds=seconds)
        return self
    ...
    def is_app_installed(bundle_id: str) -> bool:
        ...
        """
        return Cdxg.driver.is_app_installed(bundle_id=bundle_id)
    ...
    def install_app(self, app_path: str, **options: Any):
        ...
        """
        Cdxg.driver.install_app(app_path=app_path, **options)
        return self
    ...
    def remove_app(self, app_id: str, **options: Any):
        ...
        Returns:
            Union['WebDriver', 'Applications']: Self instance
        """
        Cdxg.driver.remove_app(app_id=app_id, **options)
        return self
    ...
    def terminate_app(app_id: str, **options: Any) -> bool:
        ...
        return Cdxg.driver.terminate_app(app_id=app_id, **options)
    ...
    def activate_app(self, app_id: str):
        ...
        Returns:
            Union['WebDriver', 'Applications']: Self instance
        """
        Cdxg.driver.activate_app(app_id=app_id)
        return self
    ...
    def query_app_state(app_id: str) -> int:
        ...
        return Cdxg.driver.query_app_state(app_id=app_id)
    ...
    def app_strings(language: str = None, string_file: str = None) -> Dict[str, str]:
        ...
        return Cdxg.driver.app_strings(language=language, string_file=string_file)
