...
class Shell(Topology):
    @staticmethod
    def ByDisjointedFaces(externalBoundary, faces, maximumGap=0.5, transferDictionaries=False, tolerance=0.0001):
        ...
        if transferDictionaries == True:
            ...
            for f in faces:
                ...
                selectors.append(s)
            _ = Topology.TransferDictionariesBySelectors(topology=shell, selectors=selectors, tranFaces=True, tolerance=0.01)
        return shell
