...
# is not next to bin/.
sys.path.insert (0, os.path.join ('/home/jean/repos/lilypond/release/binaries/mingw/lilypond/install/share/lilypond/2.25.7', 'python'))
...
gettext.install('lilypond', '/home/jean/repos/lilypond/release/binaries/mingw/lilypond/install/share/locale')
...
lilypond_binary = os.path.join('/home/jean/repos/lilypond/release/binaries/mingw/lilypond/install/bin', 'lilypond')
...
if '/home/jean/repos/lilypond/release/binaries/mingw/lilypond/install/bin' == ('@' + 'bindir@') or not os.path.exists(lilypond_binary):
