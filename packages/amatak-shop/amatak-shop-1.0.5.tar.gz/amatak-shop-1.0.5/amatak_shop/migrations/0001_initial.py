    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('WF', 'Women Fashion'), ('MF', 'Men Fashion'), ('PH &TE', 'Phones & Telecommunications'), ('CO&S', 'Computer,Office & Security'), ('C&E', 'Consumer & Electronics'), ('JW', 'Jewelry & Watches'), ('HPA', 'Home,pet & Appliances'), ('B&S', 'Bags & Shoes'), ('TKB', 'Toys, Kids & Babies'), ('OF&S', 'Outdoor Fun & Sports'), ('BH&H', 'Beauty, Health & Hair'), ('Au&Mo', 'Automobiles & Motorcycles'), ('T&HI', 'Tools & Home Improvement')], max_length=50)),
                ('label', models.CharField(choices=[('L', 'larg'), ('M', 'Meduim'), ('S', 'Small'), ('XL', 'Extra larg'), ('XS', 'Extra Small'), ('XXL', 'Extra Extra larg'), ('XXS', 'Extra Extra Small')], max_length=5)),
                ('color', models.CharField(choices=[('RD', 'Red'), ('Bk', 'Black'), ('BL', 'Blue'), ('PP', 'purple'), ('YL', 'Yellow'), ('OR', 'Orange')], max_length=5)),
