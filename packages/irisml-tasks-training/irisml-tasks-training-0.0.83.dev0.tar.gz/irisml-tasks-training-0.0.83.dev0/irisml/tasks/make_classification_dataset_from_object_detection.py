...
class Task(irisml.core.TaskBase):
    ...
    class Outputs:
        dataset: torch.utils.data.Dataset
        index_mappings: typing.List[typing.Tuple[int, int]] = None  # map cropped image index in IC to a tuple (original image index in OD dataset, box index in that image)
