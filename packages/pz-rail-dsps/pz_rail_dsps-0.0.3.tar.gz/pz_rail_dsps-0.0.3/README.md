...
[![PyPI](https://img.shields.io/pypi/v/pz-rail-dsps?color=blue&logo=pypi&logoColor=white)](https://pypi.org/project/pz-rail-dsps/)
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/LSSTDESC/rail_dsps/smoke-test.yml)](https://github.com/LSSTDESC/rail_dsps/actions/workflows/smoke-test.yml)

# rail_dsps

RAIL interface to dsps codes

**DSPS** - Differentiable stellar population synthesis. This is a fast implementation
based on JAX. It forward-models mock photometric catalogs from physically-motivated galaxy
spectra.
