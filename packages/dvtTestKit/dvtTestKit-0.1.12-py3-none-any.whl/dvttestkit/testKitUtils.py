...
def post_to_dynamodb(topic: str, payload: str,
                     table_name='your_table_name', _client=None):
    """
    ...
    :param _client: Boto3 DynamoDB client. By default, it is created by this module
    """
    if _client is None:
    ...
    try:
        ...
        logging.warning(f"Failed to put item to DynamoDB: {e}")
