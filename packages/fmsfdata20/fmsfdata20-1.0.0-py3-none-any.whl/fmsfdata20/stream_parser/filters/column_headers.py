...
from fmsfdata20.stream_parser.checks import type_check
from fmsfdata20.stream_parser.collectors import block_check, collector
from fmsfdata20.stream_parser.filters.generic import filter_stream, streamfilter
from fmsfdata20.stream_parser.functions import pass_event
...
def promote_first_row(stream):
    ...
    @collector(
        check=block_check(start_type=events.StartRow),
        receive_stream=True,
        stop_after=True,
        iterations=1,
    )
