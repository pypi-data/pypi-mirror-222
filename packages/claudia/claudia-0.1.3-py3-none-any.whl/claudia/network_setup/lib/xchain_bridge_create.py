...
WITNESS_CONFIG_TEMPLATE_DIR = "configs/sidechain/witness/template"
WITNESS_CONFIGS_DIR = "configs/sidechain/witness"
...
def parse_arguments():
    ...
    parser.add_argument("--witnessConfigDir", default=WITNESS_CONFIGS_DIR,
