...
from tablate.type.type_input import GridColumnInput, TableColumnInput, HtmlOuterStylesInput, ColumnStylesInput, \
    TextStylesInput, HtmlFrameStylesInput, HtmlColumnStylesInput, HtmlTextStylesInput, HtmlTextFrameStylesInput, \
    HtmlGridFrameStylesInput, TableRowsDataInputDict, TableHeaderFrameStylesInput, TableBodyFrameStylesInput, \
    HtmlTableFrameStylesInput, HtmlTableHeaderFrameStylesInput, HtmlTableBodyFrameStylesInput
from tablate.type.primitives import OuterBorder, FrameDivider, TextAlign, ColumnDivider, OuterPadding, OuterWidth, \
    Background, TextStyle, TextColor, Multiline, MaxLines, ColumnPadding, HideHeader


class Tablate(TablateApi):

    # todo: allow frame names -- also constructor options `show_frame_names` & `frame_name_align`
