...
class AddStyleMixin:
    ...
    def add_style_attribute(self, attribute: str, value: Union[str, int], pseudo: str = None) -> None:
        self._create_style(self._selector_dict, StyleItem(style=f"{attribute}:{value}", pseudo=pseudo))
