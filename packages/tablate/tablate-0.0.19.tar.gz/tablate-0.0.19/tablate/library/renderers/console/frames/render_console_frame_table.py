...
def render_console_table_frame(table_frame_store: TableBodyFrameStore, globals: Globals) -> str:
    ...
    for row_index, row_item in enumerate(table_frame_store.row_list):
        if table_frame_store.frame_styles.multiline is False or table_frame_store.frame_styles.max_lines == 1:
            ...
            return_string += row_outer_border(row_string=row_line_string, globals=globals)
        else:
