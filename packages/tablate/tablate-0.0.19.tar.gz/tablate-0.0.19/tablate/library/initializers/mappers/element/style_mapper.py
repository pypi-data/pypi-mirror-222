...
def style_mapper(base_input: Optional[BaseStylesInput],
                 ...
                 globals: Globals) -> BaseFrameStore:
    ...
    frame_styles_default = base_frame_mapper(frame_input=globals.console.frame_styles,
                                             frame_defaults=FrameBase())
    column_styles_default = base_column_mapper(columns_input=globals.console.column_styles,
                                               column_defaults=ColumnBase())
    text_styles_default = base_text_mapper(text_input=globals.console.text_styles,
    ...
    html_frame_styles_default = html_frame_mapper(html_frame_input=globals.html.html_frame_styles,
                                                  html_frame_defaults=HtmlFrameBase(),
                                                  html_px_multiplier=html_px_multiplier)
    html_column_styles_default = html_column_mapper(html_columns_input=globals.html.html_column_styles,
                                                    html_column_defaults=HtmlColumnBase())
    html_text_styles_default = html_text_mapper(html_text_input=globals.html.html_text_styles,
