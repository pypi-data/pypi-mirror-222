...
from tablate.library.initializers import table_init, text_init
...
from tablate.type.type_input import GridColumnInput, TableHeaderFrameStylesInput, \
    ...
    HtmlFrameStylesInput, HtmlOuterStylesInput, HtmlTextFrameStylesInput, \
...
class Tablate(TablateApiSet):
    ...
    def add_text_frame(self,
        ...
        if name is not None and name not in self._name_list:
