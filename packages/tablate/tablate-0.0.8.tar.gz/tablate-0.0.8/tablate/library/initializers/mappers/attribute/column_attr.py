...
def column_attr(column_dict: Type[T],
    ...
    divider = set_attr_resolver(instance=column_styles, key="divider", default=column_divider_default)
    padding = set_attr_resolver(instance=column_styles, key="padding", default=column_padding_default)
    text_style = set_attr_resolver(instance=text_styles, key="text_style", default=text_style_default)
    text_align = set_attr_resolver(instance=text_styles, key="text_align", default=text_align_default)
    text_color = set_attr_resolver(instance=text_styles, key="text_color", default=text_color_default)
    background = set_attr_resolver(instance=frame_styles, key="background", default=background_default)
    html_styles = set_attr_resolver(instance=frame_styles, key="html_styles", default={})
    ...
    return_dict = BaseColumnStore(**column_dict, background_padding=background_padding)
