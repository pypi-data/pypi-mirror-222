...
def render_html_column(frame_dict: FrameStoreUnion, globals: Globals, frame_styler: ElementStyler, frame_type: HtmlFrameType = "body") -> str:
    ...
    html_px = globals.html.html_outer_styles.html_px_multiplier
