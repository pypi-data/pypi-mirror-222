...
def render_console_single_line_grid(grid_frame_dict: GridFrameStore, globals: Globals):
    ...
    return row_outer_border(row_string=grid_line_string, globals=globals)


def render_console_multi_line_grid(grid_frame_dict: GridFrameStore, globals: Globals):
