...
def render_console_head(frame_list: FrameStoreList, globals: Globals) -> str:

    return_string = ""

    frame_border = globals.console.outer_styles.outer_border
    ...
    return_string += f"{' ' * outer_padding}{top_left[frame_border]}{top_border_inner}{top_right[frame_border]}\n"
