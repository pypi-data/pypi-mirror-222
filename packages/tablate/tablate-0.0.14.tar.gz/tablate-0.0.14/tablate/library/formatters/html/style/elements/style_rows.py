...
def style_row(row_store: HtmlTableRowsBase, row_styler: ElementStyler):
    row_divider_style = set_attr_resolver(instance=row_store, key="html_row_line_divider_style", default=None)
    row_divider_weight = set_attr_resolver(instance=row_store, key="html_row_line_divider_weight", default=None)
    odds_background = set_attr_resolver(instance=row_store, key="html_odds_background", default=None)
    evens_background = set_attr_resolver(instance=row_store, key="html_evens_background", default=None)
