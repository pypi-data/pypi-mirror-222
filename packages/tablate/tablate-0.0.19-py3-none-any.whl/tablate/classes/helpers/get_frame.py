...
def get_frame(frame_list: dict, selector: Union[int, str], globals: dict = None):
    frame_dict = select_frame(frame_list, selector)
    if globals is not None:
        return TablateItem(frame_item=frame_dict, **globals)
    else:
