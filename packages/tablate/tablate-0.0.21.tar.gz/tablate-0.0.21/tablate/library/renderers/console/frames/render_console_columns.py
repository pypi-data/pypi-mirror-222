...
def column_console_multiline(formatted_columns_array: List[List[str]], frame_dict: FrameStoreUnion, globals: Globals):
    line_count = 0
    ...
    for grid_line_index in range(line_count):
        ...
        return_string += row_outer_border(row_string=grid_line_string, globals=globals)
