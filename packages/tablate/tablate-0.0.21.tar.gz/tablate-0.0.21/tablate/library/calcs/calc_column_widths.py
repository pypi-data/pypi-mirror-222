...
@overload
def calc_column_widths(columns: List[BaseColumnInput], globals: Globals) -> List[BaseColumnInput]:
    ...


@overload
def calc_column_widths(columns: List[GridColumnInput], globals: Globals) -> List[GridColumnInput]:
    ...


@overload
def calc_column_widths(columns: List[TableColumnInput], globals: Globals) -> List[TableColumnInput]:
    ...
...
def calc_column_widths(columns: List[Type[T]], globals: Globals) -> List[T]:
