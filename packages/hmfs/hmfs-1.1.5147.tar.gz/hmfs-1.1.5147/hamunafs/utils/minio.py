...
class MinioAgent:
    ...
    def _upload_file(self, path, bucket, bucket_filename, tries=0):
        try:
    ...
    def upload_file(self, path, bucket, bucket_filename):
        # future = self.upload_pool.submit(self._upload_file, path, bucket, bucket_filename)
        # return future.result(timeout=10)
        return self._upload_file(path, bucket, bucket_filename)
    ...
    def _download_file(self, path, bucket, bucket_filename, tries=0):
        try:
    ...
    def download_file(self, path, bucket, bucket_filename):
        # future = self.download_pool.submit(self._download_file, path, bucket, bucket_filename)
        # return future.result(timeout=10)
        return self._download_file(path, bucket, bucket_filename)
