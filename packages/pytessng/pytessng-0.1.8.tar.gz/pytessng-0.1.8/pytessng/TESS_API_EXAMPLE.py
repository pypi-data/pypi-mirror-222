    ...
    def createLink(self, info):
        ...
        try:
            if self.ui.textCreateLink.text():
                point_1_x, point_1_y, point_1_z, point_2_x, point_2_y, point_2_z, *move = [float(i) for i in self.ui.textCreateLink.text().split(",")]
                ...
                netiface.createLink3D(qt_center_points, 1)
            else:
