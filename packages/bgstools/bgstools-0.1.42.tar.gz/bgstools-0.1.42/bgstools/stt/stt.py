...
def display_image_carousel(image_paths_dict: dict, RANDOM_FRAMES:list = []):
    ...
    if os.path.exists(selected_image_path):
        if selected_image_title in RANDOM_FRAMES:
            st.write(f"Frame **{FRAME_NUMBER}** | KEY: **:blue[{selected_image_title}]** | :white_check_mark:")
        else:
        ...
        st.image(image, caption=f':white_check_mark: | Frame {FRAME_NUMBER} | KEY: {selected_image_title}', use_column_width=True)
