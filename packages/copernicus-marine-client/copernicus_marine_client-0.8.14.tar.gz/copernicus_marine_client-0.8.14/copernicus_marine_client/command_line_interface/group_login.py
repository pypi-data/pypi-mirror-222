...
@cli_group_login.command(
    ...
    the user.
    If the user specified a different 'configuration-file-directory' from default one
    ...
    Case 4: Specific directory for configuration files

    > copernicus-marine login --configuration-file-directory USER/SPECIFIED/PATH
        """,
)
@click.option(
    "--username",
