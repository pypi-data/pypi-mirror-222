...
class CfnAccountPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        :param policy_document: The body of the policy document you want to use for this topic. You can only add one policy per PolicyType. The policy must be in JSON string format. Length Constraints: Maximum length of 30720
        :param policy_name: The name of the account policy.
        :param policy_type: Type of the policy.
        :param scope: Scope for policy application.
        '''
        if __debug__:
