...
class CfnPhoneNumber(
    ...
    def __init__(
        ...
        *,
        ...
        :param target_arn: The Amazon Resource Name (ARN) of Amazon Connect instances or traffic distribution group that phone numbers are claimed to.
...
class CfnQueue(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param hours_of_operation_arn: The identifier for the hours of operation.
        :param instance_arn: The identifier of the Amazon Connect instance.
        ...
        :param quick_connect_arns: The quick connects available to agents who are working the queue.
    ...
    class OutboundCallerConfigProperty:
        def __init__(
            ...
            *,
            ...
            :param outbound_caller_id_number_arn: The caller ID number.
            :param outbound_flow_arn: The outbound whisper flow to be used during an outbound call.
...
class CfnRoutingProfile(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: Scope in which this resource is defined.
        :param id: Construct identifier for this resource (unique in its scope).
        :param default_outbound_queue_arn: The identifier of the default outbound queue for this routing profile.
        ...
        :param queue_configs: The queues to associate with this routing profile.
        :param tags: An array of key-value pairs to apply to this resource.
        '''
        if __debug__:
    ...
    class MediaConcurrencyProperty:
        def __init__(
            ...
            *,
            ...
            :param cross_channel_behavior: Defines the cross-channel routing behavior that allows an agent working on a contact in one channel to be offered a contact from a different channel.
    ...
    class RoutingProfileQueueConfigProperty:
        def __init__(
            ...
            *,
            ...
            :param delay: The delay, in seconds, a contact should wait in the queue before they are routed to an available agent.
    ...
    class RoutingProfileQueueReferenceProperty:
        def __init__(self, *, channel: builtins.str, queue_arn: builtins.str) -> None:
            ...
            :param channel: The channels that agents can handle in the Contact Control Panel (CCP).
            :param queue_arn: The Amazon Resource Name (ARN) for the queue.
