...
class MetricTest(unittest.TestCase):
    ...
    def test_numpy_power_flow(self):
        ...
        # ppc -> Data
        pf_data_list = []
        for ppc in tqdm(ppc_list, ascii=True, desc="Converting ppcs to PF data numpy"):
    ...
    def test_torch_power_flow(self):
        ...
        # ppc -> Data
        pf_data_list = []
        for ppc in tqdm(ppc_list, ascii=True, desc="Converting ppcs to PF data torch"):
    ...
    def test_numpy_optimal_power_flow(self):
        ...
        # ppc -> Data
        opf_data_list = []
        for ppc in tqdm(ppc_list, ascii=True, desc="Converting ppcs to OPF data numpy"):
    ...
    def test_torch_optimal_power_flow(self):
        ...
        # ppc -> Data
        opf_data_list = []
        for ppc in tqdm(ppc_list, ascii=True, desc="Converting ppcs to OPF data torch"):
