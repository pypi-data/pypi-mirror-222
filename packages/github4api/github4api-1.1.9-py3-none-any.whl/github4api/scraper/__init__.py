...
class Scrape:
    ...
    def repositoriesNames(self: Self, username: str, ftl: bool = False) -> Union[list[str], list[None]]:
        names: list = []
    ...
    def userAchievements(self: Self, username: str) -> Union[list[str], list[None]]:
    ...
    def repositoryLastCommitDateOnBranch(self: Self, username: str, repo_name: str, branch_name: str) -> Union[str, None]:
        try:
    ...
    def repositoryCommitsDatesOnBranch(self: Self, username: str, repo_name: str, branch_name: str) -> Union[list[str], list[None]]:
        commits: list[str] = []
    ...
    def repositoryBranchesCount(self: Self, username: str, repo_name: str) -> Union[int, None]:
        try:
    ...
    def currentRepositoryIsForkedFromAnotherRepository(self: Self, username: str, repo_name: str) -> bool:
        try:
    ...
    def repositoryHasLicense(self: Self, username: str, repo_name: str) -> bool:
        try:
    ...
    def repositoryLicenseType(self: Self, username: str, repo_name: str) -> Union[str, None]:
        try:
    ...
    ##############################
    def listRepositoryWatchers(self: Self, username: str, repo_name: str) -> Union[list[str], list[None]]:
        watchers: list[str] = []
    ...
    def listRepositoryBranches(self: Self, username: str, repo_name: str) -> Union[list[str], list[None]]:
        branches: list[str] = []
    ...
    def listFollowings(self: Self, username: str) -> Union[list[str], list[None]]:
        followings: list[str] = []
    ...
    def listFollowers(self: Self, username: str) -> Union[list[str], list[None]]:
        followers: list[str] = []
    ...
    #   Method in Beta Version   #
    ##############################
    def starsGivenRepositoriesNames(self: Self, username: str) -> Union[list[str], list[None]]:
        sgrns: list[str] = []
    ...
    #                                                                         #
    ###########################################################################
    # def userOrganizations(self: Self, username: str) -> Union[list[str], str]:
    #     orgs: list[str] = []
        
    #     try:
    #         for org in bs4.BeautifulSoup(markup=RequestHandler(url=UserHandler(username=username).serialize()).sendGetRequest(content=True), features='html5lib').find(name='div', attrs={'class': 'border-top color-border-muted pt-3 mt-3 clearfix hide-sm hide-md'}):
    #             orgs.append(org)
    #         return orgs
    #     except:
    #         self.__json_data['userOrganizations'] = bs4.BeautifulSoup(
    #             markup=RequestHandler(
    #                 url=UserHandler(username=username).serialize(),
    #             ).sendGetRequest(
    #                 content=True
    #             ),
    #             features='html5lib',
    ...
    #         return self.json_data['userOrganizations']
    ###########################################################################
    #                                                                         #
    #                           If you see this                               #
    #                       It's better to know that                          #
    #                     I Accept Pull Request of this                       #
    #                 & I will mention YOU as a Contributor                   #
    #                                                                         #
    ###########################################################################
