...
class UserHandler:
    ...
    def serialize(self: Self, get_branch: bool = False, get_repos: bool = False, get_achievements: bool = False, _: bool = False, repo_name: str = None, branch_name: str = None, following: bool = False, follower: bool = False, stars: bool = False, watchers: bool = False, branches_count: bool = False) -> str:
        if (get_repos):
