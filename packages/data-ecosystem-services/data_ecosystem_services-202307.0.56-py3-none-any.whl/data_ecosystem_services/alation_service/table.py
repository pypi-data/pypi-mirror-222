...
class Table:
    ...
    def get_tables_for_schema_for_excel(self, config, alation_datasource_id, alation_schema_id):
        ...
        with tracer.start_as_current_span("get_tables_for_schema_for_excel"):
            ...
            column_naame = 'field_type_alation'

            if column_naame in df_fields_excel_schema.columns:
                # html columns
                ...
                # Assuming you have a DataFrame named 'df_html_fields_excel_schema'
                # To list all columns of the DataFrame 'df_html_fields_excel_schema'
                column_list = df_fields_excel_schema.columns.tolist()
                logger.info(str(column_list))
                logger.warning("No field_type_alation column in schema file")
                html_columns = []
