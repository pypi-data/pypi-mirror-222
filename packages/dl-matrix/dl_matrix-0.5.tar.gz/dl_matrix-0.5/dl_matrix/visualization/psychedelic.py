...
def plot_3d_scatter_psychedelic(
    file_path,
    columns_to_agg=["depth_x", "sibling_y", "sibling_count_z"],
    aggregate_func=None,
    colorscale="Rainbow",
    dragmode="turntable",
):
    # Load DataFrame from csv file
    result3d = pd.read_csv(file_path)
    result3d["content"] = result3d["content"].astype(str)

    result3d["formatted_content"] = result3d["content"].apply(wrap_text)
