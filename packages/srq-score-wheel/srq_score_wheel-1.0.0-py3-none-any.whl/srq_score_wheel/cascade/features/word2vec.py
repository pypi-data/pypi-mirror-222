...
ALERTS = 'alerts'
W2V_50 = gensim.models.KeyedVectors.load_word2vec_format(mod.PROD_W2VEC_PATH, binary=False)
W2V_100 = gensim.models.KeyedVectors.load_word2vec_format(mod.PROD_W2VEC_PATH_100, binary=False)
