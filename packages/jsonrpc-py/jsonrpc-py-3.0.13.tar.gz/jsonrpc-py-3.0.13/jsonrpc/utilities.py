...
@overload
def ensure_async(user_function: Callable[P, Awaitable[T]], /, *args: P.args, **kwargs: P.kwargs) -> Future[T]:
    ...


@overload
def ensure_async(user_function: Callable[P, CoroutineLike[T]], /, *args: P.args, **kwargs: P.kwargs) -> Future[T]:
    ...


@overload
def ensure_async(user_function: Callable[P, T], /, *args: P.args, **kwargs: P.kwargs) -> Future[T]:
    ...


def ensure_async(user_function: Callable[P, Any], /, *args: P.args, **kwargs: P.kwargs) -> Any:
