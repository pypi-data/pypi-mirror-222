...
from muphyn.packages.interface.application import AbstractDialog, DialogsHolder
...
from muphyn.packages.interface import YesNoMessageBox, RotateLeftAction, RotateRightAction, \
    UndoAction, RedoAction, DeleteAction, StartAction, StopAction
...
class MainWindow (QMainWindow) :
    ...
    def __init__ (self) :
        ...
        SchedulersLibrariesManager().add_library(ROOT_DIR+"/libraries/scheduler_library")
        ...
        self.open(new_project_on_startup(self._user_data))
    ...
    @property
    def schedulers_libraries (self) -> SchedulersLibrariesManager :
        """Permet de récuperer l'objet contenant les bibliothèques de planificateurs."""
        return SchedulersLibrariesManager()
    ...
    def _window_libraries_method (self) -> None :
        ...
        self.dialogs_holder.show_dialog('library', True)
    ...
    def _help_documentation_method (self, libraryItemPath: str = None) -> None :
        ...
        self.dialogs_holder.show_dialog('documentation', False, libraryItemPath=libraryItemPath)
    ...
    def _file_new_simulation_method (self) -> None :
        ...
        self.dialogs_holder.show_dialog('new_simulation', True)
    ...
    def _simulation_parameters_method (self) -> None :
        ...
        if isinstance(self._tabs.current_editor.editable_model, SimulationModel) : 
            self.dialogs_holder.show_dialog('simulation_parameters_dialog', True, current_simulation = self._tabs.current_editor.editable_model)
