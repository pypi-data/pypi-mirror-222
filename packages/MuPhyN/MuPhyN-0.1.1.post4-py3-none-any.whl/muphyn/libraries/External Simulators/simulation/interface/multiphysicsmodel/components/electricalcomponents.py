...
class GroundModel(AbstractComponentModel):
    ...
    # Constants
    IconPath = os.path.join(ROOT_DIR, "packages/interface/assets/Components/Electrics/ground.svg")
...
class ResistorModel(AbstractComponentModel):
    ...
    # Constants
    IconPath = os.path.join(ROOT_DIR, "packages/interface/assets/Components/Electrics/resistor.svg")
...
class VariableResistorModel(AbstractComponentModel):
    ...
    # Constants
    IconPath = os.path.join(ROOT_DIR, "packages/interface/assets/Components/Electrics/variable_resistor.svg")
...
class SignalCurrentSourceModel(AbstractComponentModel):
    ...
    # Constants
    IconPath = os.path.join(ROOT_DIR, "packages/interface/assets/Components/Electrics/signal_current_source.svg")
