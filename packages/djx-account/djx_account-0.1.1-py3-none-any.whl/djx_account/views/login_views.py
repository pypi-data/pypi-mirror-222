...
class LoginViewSet(GenericViewSet):
    ...
    @action(detail=False, methods=('get',), url_path='twitter')
    ...
    @action(detail=False, methods=('get',), url_path='facebook')
    ...
    @action(detail=False, methods=('get',), url_path='microsoft')
    ...
    @action(detail=False, methods=('get',), url_path='linkedin')
    ...
    @action(detail=False, methods=('get',), url_path='discord')
