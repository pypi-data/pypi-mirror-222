...
class Duct(Displayer):
    ...
    def _add_ws(self, WS: Workspace, kwargs: dict, handle=None, spark_jdbc=None, cli_aliases=None, bamboo_ws_name=None):
        self._ws.update({handle: WS.__init__(kwargs=kwargs,
                                             handle=handle,
                                             spark_jdbc=spark_jdbc,
                                             cli_aliases=cli_aliases,
                                             bamboo_ws_name=bamboo_ws_name,
                                             display_fn=self.__display,
                                             displayHTML_fn=self.__displayHTML)})
