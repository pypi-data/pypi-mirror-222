...
class ConnectClient(BaseClient):
    ...
    def create_evaluation_form(
        ...
        *,
        InstanceId: str,
        Title: str,
        Items: Sequence[Union["EvaluationFormItemTypeDef", "EvaluationFormItemOutputTypeDef"]],
        Description: str = ...,
    ...
    def create_rule(
        ...
        *,
        ...
        Function: str,
        Actions: Sequence[Union[RuleActionTypeDef, RuleActionOutputTypeDef]],
    ...
    def create_task_template(
        ...
        *,
        InstanceId: str,
        Name: str,
        Fields: Sequence[Union[TaskTemplateFieldTypeDef, TaskTemplateFieldOutputTypeDef]],
        Description: str = ...,
        ContactFlowId: str = ...,
        Constraints: Union[
            TaskTemplateConstraintsTypeDef, TaskTemplateConstraintsOutputTypeDef
        ] = ...,
        Defaults: Union[TaskTemplateDefaultsTypeDef, TaskTemplateDefaultsOutputTypeDef] = ...,
    ...
    def get_metric_data_v2(
        ...
        *,
        ...
        Metrics: Sequence[Union[MetricV2TypeDef, MetricV2OutputTypeDef]],
    ...
    def update_traffic_distribution(
        ...
        *,
        Id: str,
        TelephonyConfig: Union[TelephonyConfigTypeDef, TelephonyConfigOutputTypeDef] = ...
    ) -> Dict[str, Any]:
        """
