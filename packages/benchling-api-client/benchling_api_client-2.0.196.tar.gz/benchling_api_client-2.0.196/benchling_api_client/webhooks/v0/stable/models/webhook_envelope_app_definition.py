...
T = TypeVar("T", bound="WebhookEnvelopeAppDefinition")


@attr.s(auto_attribs=True, repr=False)
class WebhookEnvelopeAppDefinition:
    """  """
    ...
    def __repr__(self):
        ...
        return "WebhookEnvelopeAppDefinition({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        webhook_envelope_app_definition = cls(
            id=id,
            version_number=version_number,
        )

        webhook_envelope_app_definition.additional_properties = d
        return webhook_envelope_app_definition
