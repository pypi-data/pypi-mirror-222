...
from ..models.webhook_envelope_app_definition import WebhookEnvelopeAppDefinition
...
class WebhookEnvelope:
    ...
    _app_definition: WebhookEnvelopeAppDefinition
    _base_url: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_app_definition() -> WebhookEnvelopeAppDefinition:
            app_definition = WebhookEnvelopeAppDefinition.from_dict(d.pop("appDefinition"), strict=False)
        ...
        try:
            ...
            if strict:
                raise
            app_definition = cast(WebhookEnvelopeAppDefinition, UNSET)
    ...
    @property
    def app_definition(self) -> WebhookEnvelopeAppDefinition:
    ...
    def app_definition(self, value: WebhookEnvelopeAppDefinition) -> None:
