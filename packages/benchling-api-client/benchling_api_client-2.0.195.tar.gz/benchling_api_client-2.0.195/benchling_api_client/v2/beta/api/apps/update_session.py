...
) -> Optional[Union[Session, BadRequestError, ForbiddenError, NotFoundError]]:
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[Session, BadRequestError, ForbiddenError, NotFoundError]]:
    return Response(
