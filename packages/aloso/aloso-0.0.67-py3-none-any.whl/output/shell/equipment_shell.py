    ...
    def connection_and_get_data(host, user, directory_path, name_group, frequency):
        ...
        try:
            with ftplib.FTP() as connection:
                ...
                content["updated_recently"] = EquipmentShell.was_updated_recently(
                    last_modification_date=content["modification_date"],
                    frequency=frequency)
...
if __name__ == '__main__':
    EquipmentShell.get_equipments_directories_files_date_and_size()
