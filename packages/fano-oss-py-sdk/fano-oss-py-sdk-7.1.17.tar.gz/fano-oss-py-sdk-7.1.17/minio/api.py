...
from .helpers import (MAX_MULTIPART_COUNT, MAX_MULTIPART_OBJECT_SIZE,
                      ...
                      md5sum_hash, read_part_data, sha256_hash, url_replace)
...
class Minio:  # pylint: disable=too-many-public-methods
    ...
    **NOTE on concurrent usage:** `Minio` object is thread safe when using
    ...
    def __init__(self, endpoint, access_key=None,
        ...
        self._contextual_path = contextual_path
    ...
    def get_presigned_url(self, method, bucket_name, object_name,
                          ...
                          extra_query_params=None, is_external=False):
        """
        ...
        :param version_id: Version ID of the object.
        :param extra_query_params: Extra query parameters for advanced usage.
        :param is_external: Flag to generate presigned URL for external
        :return: URL string.
        ...
        url = self._base_url.build(
            ...
            object_name=object_name,
            query_params=query_params,
            contextual_path=self._contextual_path
        )
        ...
        if self._contextual_path:
            url = url_replace(url, netloc=endpoint)
            url = url_replace(url, path="/oss/_/" + url.path.lstrip("/"))
            if is_external:
                tu = BaseURL(self._external_host, None)
                tus = "https" if tu.is_https else "http"
                url = url_replace(url, netloc=tu.host, scheme=tus)
    ...
    def presigned_get_object(self, bucket_name, object_name,
        ...
        :param version_id: Version ID of the object.
        :param extra_query_params: Extra query parameters for advanced usage.
        :param is_external: If set, return external URL.
        :return: URL string.
