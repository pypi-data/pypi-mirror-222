...
from .._private.website_compiler import WebsiteCompiler
...
class GitLibMixin:
    ...
    def clone(
        ...
        try:
            repo.index.read_tree(tree=repo.revparse_single(repo.head.raw_name).tree)
        ...
        if not isAttuneProject:
            raise NotAGitProjectException("Project cloned is not an Attune Design Project")
