...
class Model(Freezable):
    ...
    def get(self, attr):
        ...
        if isinstance(attr, str):
            ...
            raise FinesseException(
                f"model.get() should be provided with a str, ModelElement, Node, or Port, or some object that has a name or full_name attribute. Not {repr(attr)}"
            )
    ...
    def display_signal_blockdiagram(self, **kwargs):
        ...
        display_loops_blockdiag(self, **kwargs)
