...
class JobDetail(object):
    ...
    def __init__(self, id=None, origin=None, gear_id=None, gear_info=None, parent_info=None, previous_job_id=None, inputs=None, outputs=None, destination=None, tags=None, priority=None, state=None, attempt=None, created=None, modified=None, retried=None, config=None, request=None):  # noqa: E501
