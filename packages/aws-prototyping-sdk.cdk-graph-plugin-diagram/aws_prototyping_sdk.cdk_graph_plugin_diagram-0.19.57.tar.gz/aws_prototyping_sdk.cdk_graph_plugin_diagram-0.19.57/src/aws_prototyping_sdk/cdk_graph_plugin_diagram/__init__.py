...
class CdkGraphDiagramPlugin(
    ...
    def __init__(self, config: typing.Optional["IPluginConfig"] = None) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fb691de6ff57f45f780bec34eb6a4bb48bbce2027cf3bfb578f26d321d70c3e0)
...
class _IDiagramConfigBaseProxy:
    ...
    def filter_plan(
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[_aws_prototyping_sdk_cdk_graph_3c35d073.IGraphFilterPlan], jsii.get(self, "filterPlan"))
    ...
    def theme(
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[typing.Union["IGraphThemeConfigAlt", builtins.str]], jsii.get(self, "theme"))
...
def _typecheckingstub__fb691de6ff57f45f780bec34eb6a4bb48bbce2027cf3bfb578f26d321d70c3e0(
    config: typing.Optional[IPluginConfig] = None,
) -> None:
    """Type checking stubs"""
    pass
