...
def optimize_hyperparameters_bayesian(
    ...
    search_space = [
        ...
        Integer(4, 30, name="patiences"),
        Real(0.2, 2, name="rbf_kernel_lengthscale"),
        Real(0.2, 2, name="scale_rbf_kernel_outputscale"),
        Real(0.2, 2, name="periodic_kernel_lengthscale"),
        Real(0.2, 2, name="scale_periodic_kernel_outputscale"),
        Real(0.0001, 0.3, name="m"),
        Real(0.0001, 0.3, name="k"),
        Real(0.0001, 0.3, name="b"),
        Categorical(["minmax", "standard"], name="scaler_type"),
        Categorical(["True", "False"], name="scale_x_values"),
        Categorical(["True", "False"], name="random_init"),
    ]
