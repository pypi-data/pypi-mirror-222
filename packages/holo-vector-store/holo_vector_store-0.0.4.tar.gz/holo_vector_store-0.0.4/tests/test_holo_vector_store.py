...
def get_connection_string():
    ...
    return HoloVectorStore.connection_string_from_db_params(host, port, dbname, user, password)
...
def insert_example_data(holo: HoloVectorStore, use_metadata: bool = False, use_id: bool = False):
