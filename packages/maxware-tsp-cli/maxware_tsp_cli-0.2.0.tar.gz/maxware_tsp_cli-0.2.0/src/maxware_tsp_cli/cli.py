...
def print_versions(
    ...
    """
    Print maxware-tsp and Odoo Version info.
    """
    rich_print(f"maxware-tsp Version: [bold green]{__version__}[/bold green]")
...
def main_cli():
    ...
    help_text = "maxware-tsp CLI for Interacting with Odoo"
