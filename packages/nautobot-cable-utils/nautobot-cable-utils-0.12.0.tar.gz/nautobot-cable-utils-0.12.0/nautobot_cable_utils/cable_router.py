...
from nautobot.dcim.models import FrontPort, RearPort, Cable, Rack, Interface
...
class CablePathNewMember:
    ...
    termination_a: FrontPort | Interface = None
    termination_b: FrontPort | Interface = None
...
class CablePath:
    def __init__(self, termination_a, termination_a_type, termination_b, termination_b_type, cable_list_raw):
        ...
        cp_existing_members = list[CablePathExistingMember]()
        ...
        self.cp_members = list[CablePathExistingMember | CablePathNewMember]()
