...
__doc__ = """
This modules allows to manage downloadted AERONET database files from AERONET webpage.First read data and header with `gfatpy.aeronet.reader.reader` and `gfatpy.aeronet.reader.header`, respectively.
