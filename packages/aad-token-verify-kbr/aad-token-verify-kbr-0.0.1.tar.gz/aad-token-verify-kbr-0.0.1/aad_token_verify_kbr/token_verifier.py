...
def get_verified_payload(token: str, tenant_id: str = "common", audience_uris: List[str] = None, optional_kid:bool=True) -> Dict[str, Any]:
    ...
    Args:
        ...
        optional_kid (bool, optional): Whether or not to treat the kid as optional in accordance with RFC 7515 (https://www.rfc-editor.org/rfc/rfc7515#section-4.1.4). Defaults to True.
    Raises:
    ...
    kid = _get_kid_from_token_header(token, optional_kid) or ''
...
def _get_kid_from_token_header(token: str, optional_kid:bool) -> str:
    ...
    Raises:
        ...
        TokenParseError: If no KID was found in the header and optional_kid is false
    ...
    if not unverified_token_header.get("kid") and not optional_kid:
