...
from System.Collections.Generic import List_1, IComparer_1, Dictionary_2, KeyValuePair_2, IEnumerable_1, HashSet_1, IReadOnlyList_1, IEnumerator_1, IList_1
from TransformsAI.Animo.Rewards import RewardFunction
from System import Action_2, Exception, MulticastDelegate, IAsyncResult, AsyncCallback, Func_2, Action_1, Predicate_1, Array_1, IDisposable, Random, Func_3
...
class AStar(abc.ABC):
    @staticmethod
    def GetNextStepTo(grid: VoxelGrid, start: Vec2Int, end: Vec2Int, check: AStar.TraversalCheck = ...) -> typing.Optional[Vec2Int]: ...
    @staticmethod
