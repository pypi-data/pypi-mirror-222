...
from TransformsAI.Animo.Intents import Intent, UseIntent, HeldUseIntent, TurnIntent
...
class GiftIntent(HeldUseIntent):
    ...
    class Results(typing.SupportsInt):
        ...
        Tap : GiftIntent.Results # 1
        Give : GiftIntent.Results # 2
        Exchange : GiftIntent.Results # 3
...
class TapIntent(Intent):
    ...
    @Target.setter
    def Target(self, value: Actor) -> Actor: ...
    @property
    def TurnIntent(self) -> TurnIntent: ...
    @TurnIntent.setter
    def TurnIntent(self, value: TurnIntent) -> TurnIntent: ...
