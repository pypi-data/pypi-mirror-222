...
Installation
============
The Properties step is probably already installed in your SEAMM
...
check for `properties-step`. If it is not installed, or
...
The non-graphical installer is also straightforward::
  ...
  seamm-installer install --update properties-step
