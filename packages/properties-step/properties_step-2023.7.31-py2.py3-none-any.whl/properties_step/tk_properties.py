...
"""The graphical part of a Properties step"""
...
class TkProperties(seamm.TkNode):
    """
    The graphical part of a Properties step in a flowchart.
    ...
    self[widget] : dict
        ...
        contained in Properties_parameters.py

    See Also
    --------
    Properties, TkProperties,
    ...
    def create_dialog(self):
        ...
        based on what is specified in the Properties_parameters
        module.
        ...
        See Also
        --------
        TkProperties.reset_dialog
        """

        frame = super().create_dialog(title="Properties")
