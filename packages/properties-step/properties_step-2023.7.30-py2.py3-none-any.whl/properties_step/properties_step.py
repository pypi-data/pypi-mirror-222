...
class PropertiesStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the Properties step. It must be
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return properties_step.Properties(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return properties_step.TkProperties(canvas=canvas, **kwargs)
    ...
    def description(self):
        ...
        """
        return PropertiesStep.my_description
