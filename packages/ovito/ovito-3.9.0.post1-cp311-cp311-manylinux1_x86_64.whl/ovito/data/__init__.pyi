...
Typically, however, you don't need to work with this list directly, because the :py:class:`DataCollection` class provides several convenience accessor attributes for the different flavors of data objects in OVITO. For example, :py:attr:`DataCollection.particles` returns the :py:class:`Particles` object (by looking it up in the :py:attr:`objects` list for you). Dictionary-like views such as :py:attr:`DataCollection.tables` and :py:attr:`DataCollection.surfaces` provide key-based access to a particular class of data objects in the collection. 
...
.. seealso:: :py:meth:`Property.add_type_name`"""
        ...
...
Since the "*Position*" standard property is a property with three components, this :py:class:`Property` object is an array of shape (*N*,3).
...
If the property to be created already exists in the container, it gets replaced with a modifiable copy if necessary.
...
.. seealso:: :py:meth:`SurfaceMesh.connect_opposite_halfedges`, `SurfaceMeshVis.show_cap`"""
        ...
...
:param str|Property key: The name of the grid property to look up. May include the underscore suffix to make the property mutable. Alternatively, you can directly specify a :py:class:`Property` object from this :py:class:`VoxelGrid`.
