...
class IndexerOrder(_message.Message):
    __slots__ = ["order_id", "side", "quantums", "subticks", "good_til_block", "good_til_block_time", "time_in_force", "reduce_only", "client_metadata"]
