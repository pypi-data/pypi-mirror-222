...
class MsgStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.AcknowledgeBridge = channel.unary_unary(
                '/dydxprotocol.bridge.Msg/AcknowledgeBridge',
                request_serializer=dydxprotocol_dot_bridge_dot_tx__pb2.MsgAcknowledgeBridge.SerializeToString,
                response_deserializer=dydxprotocol_dot_bridge_dot_tx__pb2.MsgAcknowledgeBridgeResponse.FromString,
                )
...
class MsgServicer(object):
    ...
    def AcknowledgeBridge(self, request, context):
...
def add_MsgServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AcknowledgeBridge': grpc.unary_unary_rpc_method_handler(
                    servicer.AcknowledgeBridge,
                    request_deserializer=dydxprotocol_dot_bridge_dot_tx__pb2.MsgAcknowledgeBridge.FromString,
                    response_serializer=dydxprotocol_dot_bridge_dot_tx__pb2.MsgAcknowledgeBridgeResponse.SerializeToString,
            ),
...
class Msg(object):
    ...
    def AcknowledgeBridge(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/dydxprotocol.bridge.Msg/AcknowledgeBridge',
            dydxprotocol_dot_bridge_dot_tx__pb2.MsgAcknowledgeBridge.SerializeToString,
            dydxprotocol_dot_bridge_dot_tx__pb2.MsgAcknowledgeBridgeResponse.FromString,
