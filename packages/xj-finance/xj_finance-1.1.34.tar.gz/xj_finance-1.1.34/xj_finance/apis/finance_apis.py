    ...
    def list(self, *args, user_info, request_params, **kwargs, ):
        ...
        if account_params:
            ...
            account_ids, err = UserService.user_list(
                params=replace_key_in_list_dicts(account_params, {"account_name", "user_name"}))
            if not err:
                print(account_ids)
        ...
        if their_account_params:
            their_account_ids, err = UserService.user_list(
                params=replace_key_in_list_dicts(their_account_params,
                                                 {"their_account_name", "user_name", "their_real_name", "real_name"}))
            if not err:
