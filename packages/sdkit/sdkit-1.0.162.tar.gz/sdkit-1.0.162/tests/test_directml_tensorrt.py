...
def test_1_1__tensorRT__stable_diffusion_1_4_txt2img_works__64x64():
    ...
    image = generate_images(context, "Photograph of an astronaut riding a horse", seed=42, width=1024, height=768)[0]
...
if __name__ == "__main__":
    setup_module()
    test_1_1__tensorRT__stable_diffusion_1_4_txt2img_works__64x64()
