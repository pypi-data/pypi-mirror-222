...
class QoaClient(object):
    # Init QoA Client
    def __init__(self, client_conf: dict=None, connector_conf : dict=None, registration_url: str=None, logging_level=1):
        """
        The 'client_conf' contains the information about the client and its configuration in form of dictionary
        Example: 
        { 
            "client_id": "aaltosea1",
        ...
        Example: "http://127.0.0.1:5000/registration"
    ...
    def observeMetric(self, metric_name, value, category=0, cl="Gauge", des="", def_val=-1):
        ...
        metadata = {}
        metadata["stage"] = self.stageID
        metadata["instance"] = self.instanceID
        self.qoaReport.observeMetric(metric=self.metricList[metric_name],metadata=metadata)
    ...
    #     report[inference_id]["instance_id"] = self.instanceID
    #     self.qoaReport.observeMetric(report,quality=True,infer_quality=True)
    #     return inference_id
