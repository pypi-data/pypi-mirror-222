...
if __name__ == '__main__':
    ...
    config_path = os.path.expandvars(os.path.join(".", *["config", "lci_config.json"]))
    ...
    if os.path.exists(config_path):
        # load the config
        with open(config_path, mode="r", encoding="utf-8") as fpointer:
