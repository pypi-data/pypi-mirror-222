...
created_projects = []  # Global variable to store the list of created projects
...
def load_created_projects():
    if os.path.exists("zylo_projects.pkl"):
        with open("zylo_projects.pkl", "rb") as f:
            return pickle.load(f)
    return []

def save_created_projects(projects):
    with open("zylo_projects.pkl", "wb") as f:
...
def main():
    ...
    if args.command == 'startproject':
        ...
        urls_code = '''from app import home
