...
T = TypeVar("T", bound="GlueSchemaRegistryRequest")


@define
class GlueSchemaRegistryRequest:
    """
    Attributes:
        region (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        glue_schema_registry_request = cls(
            region=region,
            security=security,
            type=type,
        ...
        glue_schema_registry_request.additional_properties = d
        return glue_schema_registry_request
