...
) -> Optional[Union[NotFound, PublicSharedClusterResponse, ServerError, Unauthorized]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[NotFound, PublicSharedClusterResponse, ServerError, Unauthorized]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[NotFound, PublicSharedClusterResponse, ServerError, Unauthorized]
    """
