...
try:
    # for running on hub: if hermes_mwr_raw2l1 project is available write the name/version of this one to history attr
    import hermes_mwr_raw2l1 as mwr_raw2l1  # mwr_raw2l1 only used for history attr
except ModuleNotFoundError:
    # for any other usage: write the version of mwr_raw2l1  to history attr
    import mwr_raw2l1
