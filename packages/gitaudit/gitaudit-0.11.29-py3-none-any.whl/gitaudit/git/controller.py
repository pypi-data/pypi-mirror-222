...
class Git:
    ...
    def log(
        ...
        Args:
            ...
            num (int, optional): Limit the number of commits. Defaults to None which means all
                all commits will be shown.
    ...
    def _yield_line_log(
        ...
        ] + (other if other else []) + (["-n", str(num)] if num else [])
    ...
    def log_changelog(
        ...
        commit_count = num if num else self.commit_count(
            end_ref, start_ref, first_parent)
    ...
    def log_parentlog(
        ...
        commit_count = num if num else self.commit_count(end_ref, start_ref)
