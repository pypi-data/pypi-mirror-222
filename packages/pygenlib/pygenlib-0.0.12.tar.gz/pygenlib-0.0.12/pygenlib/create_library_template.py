...
def create_library_template(library_name, target_folder="."):
    ...
    # make a virtual environment in the target folder (check for windows or linux and use the appropriate command)
    if os.name == 'nt':
        os.system(f"cd {target_folder} && python -m venv venv")
    elif os.name == 'posix':
        os.system(f"cd {target_folder} && python3 -m venv venv")
