...
def title_id_identifier_tuples_kadi(instance: str,
    ...
    record.upload_string_to_file(item_tuples_string,"Used_identifiers_aaaaa-kitmt.csv",force=True)
...
def new_identifier_kadi(instance: str,
    ...
    # manager = KadiManager(instance)
    # record = manager.record(id=18224)
    # file_id = record.get_file_id(file_name="Used_identifiers_aaaaa-kitmt.csv")
    # file = Path(os.path.dirname(os.path.abspath(__file__)),"Used_identifiers_aaaaa-kitmt.csv")
...
def unused_identifiers_kadi(instance: str):
    ...
    record.upload_string_to_file(available_identifiers_string,"Unused_identifiers_aaaaa-kitmt.csv",force=True)
