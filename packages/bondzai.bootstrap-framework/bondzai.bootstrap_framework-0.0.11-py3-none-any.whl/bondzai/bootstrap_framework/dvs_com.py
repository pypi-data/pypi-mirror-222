...
from bondzai.davinsy_py.enums import EventOperationID, DBMTable, KPITypes
from bondzai.davinsy_py.davinsy import DAT_ATTRIBUTE
from bondzai.davinsy_py.davinsy import Table, VM_ATTRIBUTE
...
from bondzai.davinsy_py.model import CATTROWID, CMETALABEL, CROWID, CMeta_factory, VirtualModel, PreprocPhase
...
class DvsCom():
    ...
    def import_virtual_model(self,vm: VirtualModel,vm_table) : #-> Row, Dict
        ...
        logger.info("total vm size = %d, preprocSize is %d" % (rowsize, preprocSize))
        #logger.info("Created the VM table", vm_table.get_meta())
        ...
        row.set_attribute(VM_ATTRIBUTE.DBM_ATT_VM_DESC, desc)
        row.set_attribute(VM_ATTRIBUTE.DBM_ATT_VM_PREPROC_GRAPH_TRAIN, preproc[vmName][PreprocPhase.TRAINING].graph)
        row.set_attribute(VM_ATTRIBUTE.DBM_ATT_VM_PREPROC_GRAPH_INFER, preproc[vmName][PreprocPhase.INFERENCE].graph)
        row.set_attribute(VM_ATTRIBUTE.DBM_ATT_VM_DEEPLOMATH, deeplomath)
        row.set_attribute(VM_ATTRIBUTE.DBM_ATT_VM_POSTPROC, postproc)
