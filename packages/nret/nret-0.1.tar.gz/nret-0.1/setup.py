...
long_description = "Conaining tools to generate biophisical & biochemical input oints and link its distribution to LAI, then run the points through the PROSAIL-PRO radiative transfer model and set every hing for Gaussian Process model training."
