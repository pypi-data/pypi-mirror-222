...
def run_node():
    ...
    from .app import StarXMediaApplication

    print("Creating Application : {}".format(StarXMediaApplication))
    app = StarXMediaApplication(config=nodeconfig)
    app.run()
