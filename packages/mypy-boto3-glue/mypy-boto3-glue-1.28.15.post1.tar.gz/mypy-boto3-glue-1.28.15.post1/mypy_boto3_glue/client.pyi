...
class GlueClient(BaseClient):
    ...
    def batch_delete_partition(
        ...
        *,
        DatabaseName: str,
        TableName: str,
        PartitionsToDelete: Sequence[
            Union[PartitionValueListTypeDef, PartitionValueListOutputTypeDef]
        ],
        CatalogId: str = ...
    ) -> BatchDeletePartitionResponseTypeDef:
        """
    ...
    def create_crawler(
        ...
        *,
        Name: str,
        Role: str,
        Targets: Union[CrawlerTargetsTypeDef, CrawlerTargetsOutputTypeDef],
        DatabaseName: str = ...,
        Description: str = ...,
        Schedule: str = ...,
    ...
    def create_job(
        ...
        *,
        ...
        Connections: Union[ConnectionsListTypeDef, ConnectionsListOutputTypeDef] = ...,
        MaxRetries: int = ...,
        ...
        NumberOfWorkers: int = ...,
        WorkerType: WorkerTypeType = ...,
        CodeGenConfigurationNodes: Mapping[
            str, Union[CodeGenConfigurationNodeTypeDef, CodeGenConfigurationNodeOutputTypeDef]
        ] = ...,
    ...
    def create_ml_transform(
        ...
        *,
        Name: str,
        InputRecordTables: Sequence[Union[GlueTableTypeDef, GlueTableOutputTypeDef]],
    ...
    def create_script(
        self,
        *,
        DagNodes: Sequence[Union[CodeGenNodeTypeDef, CodeGenNodeOutputTypeDef]] = ...,
    ...
    def create_trigger(
        ...
        *,
        ...
        WorkflowName: str = ...,
        Schedule: str = ...,
        Predicate: Union[PredicateTypeDef, PredicateOutputTypeDef] = ...,
        Description: str = ...,
    ...
    def start_data_quality_rule_recommendation_run(
        self,
        *,
        DataSource: Union[DataSourceTypeDef, DataSourceOutputTypeDef],
        Role: str,
        NumberOfWorkers: int = ...,
        Timeout: int = ...,
    ...
    def start_data_quality_ruleset_evaluation_run(
        ...
        *,
        ...
        AdditionalDataSources: Mapping[str, Union[DataSourceTypeDef, DataSourceOutputTypeDef]] = ...
    ) -> StartDataQualityRulesetEvaluationRunResponseTypeDef:
        """
    ...
    def update_column_statistics_for_partition(
        ...
        *,
        ...
        TableName: str,
        PartitionValues: Sequence[str],
        ColumnStatisticsList: Sequence[
            Union[ColumnStatisticsTypeDef, ColumnStatisticsOutputTypeDef]
        ],
        CatalogId: str = ...
    ) -> UpdateColumnStatisticsForPartitionResponseTypeDef:
        """
