...
class JsonPatchSubmitTypesAssignment:
    ...
    webhook_configuration: Maybe[
        "t.Union[WebhookEnabledConfiguration, WebhookDisabledConfiguration]"
    ] = Nothing
    ...
    data_parser: t.ClassVar = rqa.Lazy(
        lambda: rqa.FixedMapping(
            ...
            rqa.OptionalArgument(
                ...
                parsers.make_union(
                    parsers.ParserFor.make(WebhookEnabledConfiguration),
                    parsers.ParserFor.make(WebhookDisabledConfiguration),
                ),
                doc=(
                    "The configuration for the Webhook upload for this"
                    " assignment"
                ),
            ),
            rqa.OptionalArgument(
