"""
Base class for Aioscrapy commands
"""
import os
from optparse import OptionGroup
from typing import Any, Dict

from aioscrapy.utils.conf import arglist_to_dict
from aioscrapy.exceptions import UsageError


class AioScrapyCommand:
...
class BaseRunSpiderCommand(AioScrapyCommand):
    """
    ...
    def process_options(self, args, opts):
        AioScrapyCommand.process_options(self, args, opts)
        try:
