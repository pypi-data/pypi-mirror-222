...
class HSFHandler(object):
    ...
    def from_hsf_file(cls, hsf_path, network):
        st, header = waveforms.hsf_to_obspy(hsf_path, print_out=False,
                                            experimental=False, groundmotion=False,
                                            return_head=True)
    ...
    @classmethod
    def read(cls, file_path, network, experimental=False, groundmotion=True):
