...
from app.exceptions import (
    ConfigurationException, FailedReindex, MissingArgument, ResultNotExpected, TimeoutException)
...
def wait_for_it(
    ...
    if action in task_actions:
        try:
            ...
            raise ResultNotExpected(f'Unable to find task_id {task_id}. Exception: {err}') from err
