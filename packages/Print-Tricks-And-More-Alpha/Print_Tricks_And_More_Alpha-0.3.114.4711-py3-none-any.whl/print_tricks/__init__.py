############################################################################
######################## Print Tricks & More - version 0.3.114 working ######
############################################################################
...
class pt:
    ...
    def props(
        ...
        # UTI._info(simp_trace_output, argsLen, args, argsOnly, strFront=strFront, strBack=strBack, function_str=function_str, mvl=mvl, end=end, sep=sep, file=file, flush=flush)
    ...
    def funcs(
        ...
        simp_trace_output = UTI._simple_trace(argsLen)
        (
            fileName,
            filePath,
            lineNo,
