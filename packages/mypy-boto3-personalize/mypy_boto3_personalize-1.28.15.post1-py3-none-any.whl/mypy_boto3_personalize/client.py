...
class PersonalizeClient(BaseClient):
    ...
    def create_campaign(
        ...
        *,
        ...
        campaignConfig: Union[CampaignConfigTypeDef, CampaignConfigOutputTypeDef] = ...,
        tags: Sequence[TagTypeDef] = ...
    ) -> CreateCampaignResponseTypeDef:
        """
    ...
    def create_recommender(
        ...
        *,
        ...
        datasetGroupArn: str,
        recipeArn: str,
        recommenderConfig: Union[RecommenderConfigTypeDef, RecommenderConfigOutputTypeDef] = ...,
        tags: Sequence[TagTypeDef] = ...
    ) -> CreateRecommenderResponseTypeDef:
        """
    ...
    def create_solution(
        ...
        *,
        ...
        recipeArn: str = ...,
        eventType: str = ...,
        solutionConfig: Union[SolutionConfigTypeDef, SolutionConfigOutputTypeDef] = ...,
        tags: Sequence[TagTypeDef] = ...
    ) -> CreateSolutionResponseTypeDef:
        """
