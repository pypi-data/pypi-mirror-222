...
def get_transform_factor(sec_code: str = None,
    ...
    if factor_list is None:
        factor_list = ['close']
    return TTDataClient.instance().get_transform_factor(**locals())
...
def get_synthesize_factor(stock_pool: list,
    ...
    :return:
    """
    return TTDataClient.instance().get_synthesize_factor(**locals())
...
def get_synthesize_portfolio(count: int = None,
    ...
    :return:
    """
    return TTDataClient.instance().get_synthesize_portfolio(**locals())
