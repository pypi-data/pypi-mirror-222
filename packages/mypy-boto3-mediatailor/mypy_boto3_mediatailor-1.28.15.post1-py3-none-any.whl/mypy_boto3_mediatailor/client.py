...
class MediaTailorClient(BaseClient):
    ...
    def create_prefetch_schedule(
        self,
        *,
        Consumption: Union[PrefetchConsumptionTypeDef, PrefetchConsumptionOutputTypeDef],
        Name: str,
        PlaybackConfigurationName: str,
        Retrieval: Union[PrefetchRetrievalTypeDef, PrefetchRetrievalOutputTypeDef],
        StreamId: str = ...
    ) -> CreatePrefetchScheduleResponseTypeDef:
        """
    ...
    def create_program(
        ...
        *,
        ...
        SourceLocationName: str,
        AdBreaks: Sequence[Union[AdBreakTypeDef, AdBreakOutputTypeDef]] = ...,
        LiveSourceName: str = ...,
        VodSourceName: str = ...
    ) -> CreateProgramResponseTypeDef:
        """
