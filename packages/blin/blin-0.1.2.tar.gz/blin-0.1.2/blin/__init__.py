...
def create_project(project_id, settings, key):
    ...
    Returns:
    str: result. Raises exception in case project was already created.
    """
...
def delete_project(project_id, key):
    ...
    Returns:
    str: result. Raises exception in case project was not deleted.
    """
...
class Project():
    ...
    def recall(self, name):
        """
        Returns learned command or text for given name
    ...
    def forget(self, name):
        ...
        Returns:
        str: result. Raises exception in case knowledge was not deleted. 
        """  
