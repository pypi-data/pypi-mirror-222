...
class AssertsTestdrive(SqlsTestdrive):
    ...
    def assert_testdrive_subscribe(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["customerName", "leadSourceCode", "modelId", "appointmentTime", "leadSanSourceCode", "model", "shopName", "activityCode", "phoneNumber", "shopId", "channel"])
        assert True, "数据比较不一致"
