...
class AssertsContentQuestion(SqlsContentQuestion):
    ...
    def assert_content_question_answerquestion(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["answerContent", "questionId", "author"])
        assert True, "数据比较不一致"
    ...
    def assert_content_question_getmanegequestionlist(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["endTime", "startTime", "status", "keyWord", "mobile"])
        assert True, "数据比较不一致"
