...
class AssertsContentSubject(SqlsContentSubject):
    ...
    def assert_content_subject_add(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["level", "type", "explain", "subjectName", "parentId", "status", "subPicUrl"])
        assert True, "数据比较不一致"
    ...
    def assert_content_subject_mobilesubject(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["parentId", "serial", "subjectId"])
        assert True, "数据比较不一致"
    ...
    def assert_content_subject_save(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["siftFlag", "isService", "delFlag", "level", "type", "explain", "isSearch", "subjectName", "parentId", "status", "subPicUrl", "subjectId"])
        assert True, "数据比较不一致"
