...
class AssertsContentCampmanager(SqlsContentCampmanager):
    ...
    def assert_content_campmanager_page(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["id", "sortord", "sortBody", "createBy", "name", "status"])
        assert True, "数据比较不一致"
    ...
    def assert_content_campmanager_insert(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["id", "city", "campDetail", "campTradeTime", "url", "content", "county", "ownerDiscount", "address", "discountExpEndTime", "province", "name", "discountExpBeginTime"])
        assert True, "数据比较不一致"
    ...
    def assert_content_campmanager_update(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["phone", "ownerDiscount", "discountExpEndTime", "areaCode", "discountExpBeginTime"])
        assert True, "数据比较不一致"
