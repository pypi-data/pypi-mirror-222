...
class AssertsOrderRightsRightsmanager(SqlsOrderRightsRightsmanager):
    ...
    def assert_order_rights_rightsmanager_getrightslist(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["status", "effectiveStartDate", "modelId", "rightsName"])
        assert True, "数据比较不一致"
    ...
    def assert_order_rights_rightsmanager_insert(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["orderType", "modelCode", "rightsId", "effectiveStartDate", "rightsType", "rightsName"])
        assert True, "数据比较不一致"
    ...
    def assert_order_rights_rightsmanager_update(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["effectiveEndDate", "rightsId", "effectiveStartDate", "Relation", "Content", "rightsName"])
        assert True, "数据比较不一致"
