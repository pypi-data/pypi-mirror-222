...
class AssertsOrderMainorder(SqlsOrderMainorder):
    ...
    def assert_order_mainorder_download(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["orderTypeToSort", "createEndTime", "payTimeToSort", "createTimeToSort", "createStartTime"])
        assert True, "数据比较不一致"
    ...
    def assert_order_mainorder_syncscrmextorder(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["potentialName", "scUid", "orderAllAmount", "syncMsg", "configCode", "ossId", "VIN", "soStatus", "custCertNo", "unitInvoiceTitle", "optionCode", "customerCtCode", "orderId", "colorCode", "isArrived", "updateTime", "scUname", "phone", "customerType", "syncStatus", "createTime", "orderNo", "soNo", "unitName", "chargePointEquity", "isTestDrive", "modelCode", "customerId", "deliveryData", "lifetimeWarrantyPrice", "seriesCode", "trimCode", "isLifetimeWarranty", "unitTaxNo", "dealerCode"])
        assert True, "数据比较不一致"
