...
class FunsCommonUser4C(AssertsCommonUser4C):
    ...
    def common_user4c_page(self, userSystemSource="$None$", size=10, regisTimeEnd="$None$", createTimeEnd="$None$", activitySource="$None$", current=1, type="$None$", lastLoginTimeEnd="$None$", regisTimeBegin="$None$", nickName="$None$", userId="$None$", lastLoginTimeStart="$None$", status="$None$", createTimeStart="$None$", mobile="$None$", memberSystemSource="$None$", ownerFlag="$None$", _assert=True,  **kwargs):
        """
    ...
    def common_user4c_vehicleinfo(self, mobile="$None$", size=10, userId="$None$", current=1, _assert=True,  **kwargs):
        """
    ...
    def common_user4c_download(self, userSystemSource="$None$", regisTimeEnd="$None$", createTimeEnd="$None$", activitySource="$None$", downloadType="$None$", userIds="$None$", type="$None$", lastLoginTimeEnd="$None$", regisTimeBegin="$None$", nickName="$None$", userId="$None$", lastLoginTimeStart="$None$", status="$None$", createTimeStart="$None$", mobile="$None$", memberSystemSource="$None$", ownerFlag="$None$", _assert=True,  **kwargs):
        """
    ...
    def common_user4c_beforepointsexport(self, userSystemSource="$None$", regisTimeEnd="$None$", createTimeEnd="$None$", activitySource="$None$", downloadType="$None$", userIds="$None$", type="$None$", lastLoginTimeEnd="$None$", regisTimeBegin="$None$", nickName="$None$", userId="$None$", lastLoginTimeStart="$None$", status="$None$", createTimeStart="$None$", mobile="$None$", memberSystemSource="$None$", ownerFlag="$None$", _assert=True,  **kwargs):
        """
    ...
    def common_user4c_insert(self, explain="$None$", nickName="$None$", avatarUrl="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def common_user4c_auditexport(self, phone="$None$", userType="$None$", userIds="$None$", registerType="$None$", nickName="$None$", userId="$None$", downloadType="$None$", userLabel="$None$", ownerFlag="$None$", _assert=True,  **kwargs):
        """
    ...
    def common_user4c_auditlist(self, checkStatus="$None$", pageSize="$None$", userName="$None$", registerType="$None$", nickName="$None$", userId="$None$", pageNum=1, mobile="$None$", _assert=True,  **kwargs):
        """
