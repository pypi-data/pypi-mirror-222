...
class FunsCommonSystemversion(AssertsCommonSystemversion):
    ...
    def common_systemversion_save(self, force="$None$", downloadUrl="$None$", size=10, versionId="$None$", content="$None$", remark="$None$", classify="$None$", version="$None$", publishStatus="$None$", name="$None$", _assert=True,  **kwargs):
        """
