...
class FunsCommonUserpointsmanage(AssertsCommonUserpointsmanage):
    ...
    def common_userpointsmanage_userpointsexport(self, endTime="$None$", logIds="$None$", nickName="$None$", beginTime="$None$", mobile="$None$", _assert=True,  **kwargs):
        """
    ...
    def common_userpointsmanage_page(self, mobile="$None$", endTime="$None$", nickName="$None$", beginTime="$None$", _assert=True,  **kwargs):
        """
    ...
    def common_userpointsmanage_manualchangeuserpoints(self, operateMark="$None$", pointChangType="$None$", taskName="$None$", userId="$None$", operateType="$None$", operatePoint="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def common_userpointsmanage_beforepointsexport(self, endTime="$None$", logIds="$None$", nickName="$None$", beginTime="$None$", mobile="$None$", _assert=True,  **kwargs):
        """
