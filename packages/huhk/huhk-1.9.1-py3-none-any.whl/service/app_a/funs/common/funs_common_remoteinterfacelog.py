...
class FunsCommonRemoteinterfacelog(AssertsCommonRemoteinterfacelog):
    ...
    def common_remoteinterfacelog_getlogpage(self, size=10, current=1, userName="$None$", endTime="$None$", startTime="$None$", interfaceType="$None$", mobile="$None$", _assert=True,  **kwargs):
        """
