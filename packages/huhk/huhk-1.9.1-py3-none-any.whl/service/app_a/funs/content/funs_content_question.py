...
class FunsContentQuestion(AssertsContentQuestion):
    ...
    def content_question_answerquestion(self, answerContent="$None$", questionId="$None$", author="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_question_getmanegequestionlist(self, size=10, current=1, endTime="$None$", startTime="$None$", status="$None$", keyWord="$None$", mobile="$None$", _assert=True,  **kwargs):
        """
