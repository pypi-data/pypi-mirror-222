...
class FunsContentActivitymanager(AssertsContentActivitymanager):
    ...
    def content_activitymanager_updateenrolltime(self, enrollTime="$None$", enrollStartTime="$None$", activityId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_activitymanager_page(self, city="$None$", activityTimeSort="$None$", activityId="$None$", target="$None$", endTime="$None$", beginTime="$None$", createTimeSort="$None$", province="$None$", title="$None$", status="$None$", pushTimeSort="$None$", _assert=True,  **kwargs):
        """
    ...
    def content_activitymanager_save(self, city="$None$", activityId="$None$", publishTime="$None$", content="$None$", province="$None$", title="$None$", status="$None$", limitPeople="$None$", enrollStartTime="$None$", agreementId="$None$", authId="$None$", beginTime="$None$", publishType="$None$", enrollTime="$None$", reason="$None$", activityPicURL="$None$", coordinate="$None$", customerGroup="$None$", needLimitPeople="$None$", endTime="$None$", needArea="$None$", activityAddr="$None$", county="$None$", activityPicUrl="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_activitymanager_update(self, city="$None$", activityId="$None$", publishTime="$None$", content="$None$", province="$None$", title="$None$", status="$None$", limitPeople="$None$", enrollStartTime="$None$", authId="$None$", beginTime="$None$", publishType="$None$", enrollTime="$None$", reason="$None$", activityPicURL="$None$", coordinate="$None$", customerGroup="$None$", needLimitPeople="$None$", endTime="$None$", needArea="$None$", activityAddr="$None$", county="$None$", activityPicUrl="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_activitymanager_publishupdate(self, activityIds="$None$", publishStatus="$None$", status="$None$", activityId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_activitymanager_activityexport(self, city="$None$", activityTimeSort="$None$", activityId="$None$", target="$None$", endTime="$None$", beginTime="$None$", createTimeSort="$None$", province="$None$", title="$None$", status="$None$", pushTimeSort="$None$", _assert=True,  **kwargs):
        """
