...
class FunsContentSubject(AssertsContentSubject):
    ...
    def content_subject_detailessay(self, subjectName="$None$", size=10, current=1, subjectId="$None$", _assert=True,  **kwargs):
        """
    ...
    def content_subject_add(self, level="$None$", type="$None$", explain="$None$", subjectName="$None$", parentId="$None$", status="$None$", subPicUrl="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_subject_mobilesubject(self, parentId="$None$", serial="$None$", subjectId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_subject_save(self, siftFlag="$None$", isService="$None$", delFlag="$None$", level="$None$", type="$None$", explain="$None$", isSearch="$None$", subjectName="$None$", parentId="$None$", status="$None$", subPicUrl="$None$", subjectId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
