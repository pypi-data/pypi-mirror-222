...
class FunsContentTopic4C(AssertsContentTopic4C):
    ...
    def content_topic4c_getcontentlist(self, current=1, topicId="$None$", size=10, _assert=True,  **kwargs):
        """
    ...
    def content_topic4c_list(self, topicId="$None$", size=10, current=1, endTime="$None$", createBy="$None$", startTime="$None$", keyWord="$None$", _assert=True,  **kwargs):
        """
    ...
    def content_topic4c_insert(self, topicId="$None$", topicTitle="$None$", author="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
