...
class FunsContentMaterial(AssertsContentMaterial, FunsContentMaterialGetmateriallist):
    ...
    def content_material_updategroup(self, groupId="$None$", groupName="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_material_getmateriallist(self, groupId="$None$", current=1, size=10, _assert=True,  **kwargs):
        """
