...
class FunsContentCampmanager(AssertsContentCampmanager):
    ...
    def content_campmanager_page(self, id="$None$", sortord="$None$", sortBody="$None$", createBy="$None$", name="$None$", status="$None$", _assert=True,  **kwargs):
        """
    ...
    def content_campmanager_insert(self, id="$None$", city="$None$", campDetail="$None$", campTradeTime="$None$", url="$None$", content="$None$", county="$None$", ownerDiscount="$None$", address="$None$", discountExpEndTime="$None$", province="$None$", name="$None$", discountExpBeginTime="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_campmanager_update(self, phone="$None$", ownerDiscount="$None$", discountExpEndTime="$None$", areaCode="$None$", discountExpBeginTime="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
