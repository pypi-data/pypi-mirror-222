...
class FunsContentComment(AssertsContentComment):
    ...
    def content_comment_download(self, EssayCommentIds="$None$", contentCommentIds="$None$", endTime="$None$", nickName="$None$", startTime="$None$", downloadType="$None$", status="$None$", keyWord="$None$", mobile="$None$", _assert=True,  **kwargs):
        """
    ...
    def content_comment_list(self, size=10, essayId="$None$", current=1, checkedStatus="$None$", endTime="$None$", nickName="$None$", startTime="$None$", commentType="$None$", keyWord="$None$", mobile="$None$", _assert=True,  **kwargs):
        """
