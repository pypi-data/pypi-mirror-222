...
class FunsRadarpointsUserpointsExchangeinfo(AssertsRadarpointsUserpointsExchangeinfo):
    ...
    def radarpoints_userpoints_exchangeinfo_pagelist(self, consigneeName="$None$", size=10, current=1, orderStartTime="$None$", orderEndTime="$None$", userId="$None$", goodsOrderId="$None$", mobile="$None$", _assert=True,  **kwargs):
        """
