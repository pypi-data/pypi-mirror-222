...
class FunsRadarpointsAdjustpointsAdjustBatch(AssertsRadarpointsAdjustpointsAdjustBatch):
    ...
    def radarpoints_adjustpoints_adjust_batch_save(self, redisKey="$None$", optAbility="$None$", file="$None$", optAbilityName="$None$", clientNotes="$None$", adjustNotes="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def radarpoints_adjustpoints_adjust_batch_import(self, field_34="$None$", list="$None$", field_35="$None$", file="$None$", clientNotes="$None$", adjustNotes="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
