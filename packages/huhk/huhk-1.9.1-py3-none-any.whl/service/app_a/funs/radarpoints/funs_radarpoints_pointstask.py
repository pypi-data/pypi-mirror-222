...
class FunsRadarpointsPointstask(AssertsRadarpointsPointstask):
    ...
    def radarpoints_pointstask_pagelist(self, dateLast="$None$", pointsConfigCode="$None$", size=10, dateBegin="$None$", getPointsQtySort="$None$", current=1, pointsTaskDateSort="$None$", mobile="$None$", pointsConfigName="$None$", _assert=True,  **kwargs):
        """
    ...
    def radarpoints_pointstask_export(self, dateLast="$None$", pointsConfigCode="$None$", dateBegin="$None$", getPointsQtySort="$None$", pointsTaskDateSort="$None$", mobile="$None$", pointsConfigName="$None$", _assert=True,  **kwargs):
        """
