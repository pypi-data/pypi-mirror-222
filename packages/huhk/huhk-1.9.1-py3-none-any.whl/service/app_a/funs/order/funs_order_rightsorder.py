...
class FunsOrderRightsorder(AssertsOrderRightsorder, FunsOrderRightsorderReceive):
    ...
    def order_rightsorder_export(self, payDateEnd="$None$", receiveDateBegin="$None$", rightsOrderId="$None$", receiveDateEnd="$None$", payDateBegin="$None$", useStatus="$None$", userId="$None$", orderMainId="$None$", mobile="$None$", rightsType="$None$", _assert=True,  **kwargs):
        """
    ...
    def order_rightsorder_insert(self, refundBillNo="$None$", receiveDate="$None$", payDate="$None$", rightsId="$None$", payBillNo="$None$", updateTime="$None$", updateId="$None$", payAmount="$None$", useStatus="$None$", userId="$None$", mobile="$None$", refundDate="$None$", createTime="$None$", orderMainId="$None$", createBy="$None$", rightsOrderId="$None$", rightsType="$None$", rightsName="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def order_rightsorder_page(self, payDateEnd="$None$", receiveDateBegin="$None$", rightsOrderId="$None$", size=10, receiveDateEnd="$None$", payDateBegin="$None$", current=1, useStatus="$None$", userId="$None$", orderMainId="$None$", mobile="$None$", rightsType="$None$", _assert=True,  **kwargs):
        """
    ...
    def order_rightsorder_getorderlist(self, receiveDate="$None$", useStatusList="$None$", orderMainId="$None$", mobile="$None$", rightsType="$None$", rightsNameList="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
