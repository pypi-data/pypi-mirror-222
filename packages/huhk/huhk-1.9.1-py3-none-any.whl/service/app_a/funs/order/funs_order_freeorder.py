...
class FunsOrderFreeorder(AssertsOrderFreeorder):
    ...
    def order_freeorder_download(self, modelId="$None$", channelName="$None$", regisTimeEnd="$None$", avatarUrl="$None$", userPolicyCode="$None$", privacyPolicyCode="$None$", userName="$None$", cityId="$None$", freeOrderId="$None$", createTime="$None$", nickName="$None$", provinceName="$None$", provinceId="$None$", regisTimeBegin="$None$", cityName="$None$", mobile="$None$", channel="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
