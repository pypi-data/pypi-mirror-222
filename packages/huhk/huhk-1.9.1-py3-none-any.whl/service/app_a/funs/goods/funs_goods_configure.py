...
class FunsGoodsConfigure(AssertsGoodsConfigure):
    ...
    def goods_configure_savecarconfigure(self, processColorList="$None$", salesVersionList="$None$", appearanceColorList="$None$", interiorColorList="$None$", optionalList="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
