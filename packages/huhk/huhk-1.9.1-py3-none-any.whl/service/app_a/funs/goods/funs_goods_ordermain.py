...
class FunsGoodsOrdermain(AssertsGoodsOrdermain):
    ...
    def goods_ordermain_orderexports(self, modelName="$None$", userName="$None$", testDriveIdStr="$None$", shopName="$None$", startTime="$None$", endTime="$None$", userMobile="$None$", billStatus="$None$", exportType="$None$", _assert=True,  **kwargs):
        """
    ...
    def goods_ordermain_getordermainpage(self, modelName="$None$", userName="$None$", shopName="$None$", startTime="$None$", endTime="$None$", userMobile="$None$", orderStatus="$None$", _assert=True,  **kwargs):
        """
