...
class FunsGoodsCarmodel(AssertsGoodsCarmodel):
    ...
    def goods_carmodel_savemanagecarmodel(self, depositStartTime="$None$", carDetailPics="$None$", preToDepositEndTime="$None$", configCode="$None$", price="$None$", status="$None$", sort="$None$", carCode="$None$", preStartTime="$None$", prePricePosters="$None$", carSimpleName="$None$", prePrice="$None$", version="$None$", preEndTime="$None$", posters="$None$", modelId="$None$", modelName="$None$", depositEndTime="$None$", brandName="$None$", sharePosters="$None$", carDetailUrl="$None$", depositPrice="$None$", depositPriceContent="$None$", promptDesc="$None$", modelCode="$None$", prePriceContent="$None$", carDetailType="$None$", preToDepositStartTime="$None$", carName="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def goods_carmodel_getmanagecarmodel(self, modelName="$None$", size=10, modelCode="$None$", operator="$None$", brandName="$None$", current=1, version="$None$", carName="$None$", status="$None$", carCode="$None$", _assert=True,  **kwargs):
        """
