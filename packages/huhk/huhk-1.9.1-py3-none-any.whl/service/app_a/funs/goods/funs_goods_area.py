...
class FunsGoodsArea(AssertsGoodsArea):
    ...
    def goods_area_insertrelation(self, dealerCode="$None$", areaIds="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def goods_area_getcitylist(self, pName="$None$", size=10, cName="$None$", current=1, cType="$None$", _assert=True,  **kwargs):
        """
