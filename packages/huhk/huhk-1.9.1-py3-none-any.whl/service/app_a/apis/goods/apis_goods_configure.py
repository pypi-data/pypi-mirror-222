...
def goods_configure_savecarconfigure(processColorList=None, salesVersionList=None, appearanceColorList=None, interiorColorList=None, optionalList=None, headers=None, **kwargs):
    """
    保存车型配置信息-Y
    up_time=1675650535
