...
def goods_carmodel_getmanagecarmodel(modelName=None, size=None, modelCode=None, operator=None, brandName=None, current=None, version=None, carName=None, status=None, carCode=None, headers=None, **kwargs):
    """
    车型列表-Y
    up_time=1675661996
