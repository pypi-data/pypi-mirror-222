...
def radarpoints_pointsconfig_page(pointsBegin=None, size=None, code=None, Current=None, pointsEnd=None, businessSceneType=None, name=None, status=None, pointsExpiration=None, headers=None, **kwargs):
    """
    积分配置 - 分页查询
    up_time=1680142594
...
def radarpoints_pointsconfig_insert(rulesPointsDayMax=None, remark=None, toast=None, points=None, businessSceneType=None, bpmId=None, userPointsDayMax=None, name=None, pointsExpiration=None, headers=None, **kwargs):
    """
    积分配置 -新增积分配置
    up_time=1680142659
...
def radarpoints_pointsconfig_update(id=None, code=None, rulesPointsDayMax=None, remark=None, toast=None, points=None, businessSceneType=None, userPointsDayMax=None, bpmId=None, name=None, pointsExpiration=None, headers=None, **kwargs):
    """
    积分配置 -修改积分配置
    up_time=1680142897
