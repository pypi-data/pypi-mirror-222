...
def radarpoints_adjustpoints_adjust_batch_save(redisKey=None, optAbility=None, file=None, optAbilityName=None, clientNotes=None, adjustNotes=None, headers=None, **kwargs):
    """
    积分调整 - 批量调整
    up_time=1677216489
...
def radarpoints_adjustpoints_adjust_batch_import(field_34=None, list=None, field_35=None, file=None, clientNotes=None, adjustNotes=None, headers=None, **kwargs):
    """
    积分调整 - 批量调整 - 导入excel
    up_time=1677216494
