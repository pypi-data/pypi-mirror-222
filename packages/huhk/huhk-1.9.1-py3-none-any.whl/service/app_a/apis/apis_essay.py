...
def essay_batch(batchType=None, essayId=None, headers=None, **kwargs):
    """
    文章-批量操作-Y
    up_time=1675736143
...
def essay_querylistcount(essayId=None, author=None, endTime=None, startTime=None, status=None, keyWord=None, subjectId=None, headers=None, **kwargs):
    """
    文章-获取列表状态数量-Y
    up_time=1675736107
