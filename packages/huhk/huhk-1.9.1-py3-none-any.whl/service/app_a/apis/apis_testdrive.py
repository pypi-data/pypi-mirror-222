...
def testdrive_subscribe(customerName=None, leadSourceCode=None, modelId=None, appointmentTime=None, leadSanSourceCode=None, model=None, shopName=None, activityCode=None, phoneNumber=None, shopId=None, channel=None, headers=None, **kwargs):
    """
    预约试驾
    up_time=1689560965
