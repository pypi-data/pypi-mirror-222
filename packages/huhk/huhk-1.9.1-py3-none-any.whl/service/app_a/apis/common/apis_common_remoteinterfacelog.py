...
def common_remoteinterfacelog_getlogpage(size=None, current=None, userName=None, endTime=None, startTime=None, interfaceType=None, mobile=None, headers=None, **kwargs):
    """
    查询三方日志接口-Y
    up_time=1675324564
