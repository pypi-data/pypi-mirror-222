...
def order_rights_rightsmanager_page(effectiveEndDate=None, size=None, modelCode=None, current=None, status=None, rightsName=None, headers=None, **kwargs):
    """
    权益 - 分页查询-Y
    up_time=1675409025
...
def order_rights_rightsmanager_getrightslist(status=None, effectiveStartDate=None, modelId=None, rightsName=None, headers=None, **kwargs):
    """
    权益订单 - 查询-Y
    up_time=1675669230
...
def order_rights_rightsmanager_insert(orderType=None, modelCode=None, rightsId=None, effectiveStartDate=None, rightsType=None, rightsName=None, headers=None, **kwargs):
    """
    权益-新增权益-Y
    up_time=1675669334
...
def order_rights_rightsmanager_update(effectiveEndDate=None, rightsId=None, effectiveStartDate=None, Relation=None, Content=None, rightsName=None, headers=None, **kwargs):
    """
    权益-修改权益-Y
    up_time=1675669374
