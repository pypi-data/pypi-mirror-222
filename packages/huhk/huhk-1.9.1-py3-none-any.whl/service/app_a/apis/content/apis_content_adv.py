...
def content_adv_save(pictureList=None, advPicUrl=None, advSerial=None, bindingFlag=None, version=None, advText=None, advPlaceId=None, advLinkUrl=None, jumpType=None, advId=None, jumpContent=None, headers=None, **kwargs):
    """
...
def content_adv_detailcontentadmin(size=None, essayKeyWords=None, current=None, orderByCommentCnt=None, headers=None, **kwargs):
    """
    点位内容-查询推荐页内容-Y
    up_time=1675673291
