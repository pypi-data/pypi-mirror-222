...
def content_campmanager_page(id=None, sortord=None, sortBody=None, createBy=None, name=None, status=None, headers=None, **kwargs):
    """
    营地服务列表 - 分页查询
    up_time=1681969132
...
def content_campmanager_insert(id=None, city=None, campDetail=None, campTradeTime=None, url=None, content=None, county=None, ownerDiscount=None, address=None, discountExpEndTime=None, province=None, name=None, discountExpBeginTime=None, headers=None, **kwargs):
    """
    新增营地
    up_time=1681967827
...
def content_campmanager_update(phone=None, ownerDiscount=None, discountExpEndTime=None, areaCode=None, discountExpBeginTime=None, headers=None, **kwargs):
    """
    编辑营地
    up_time=1681969876
