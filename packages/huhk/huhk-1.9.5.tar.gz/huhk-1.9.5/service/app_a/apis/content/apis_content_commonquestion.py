...
def content_commonquestion_update(content=None, title=None, essayId=None, headers=None, **kwargs):
    """
    常见问题-修改-Y
    up_time=1675681308
...
def content_commonquestion_add(content=None, title=None, essayId=None, headers=None, **kwargs):
    """
    常见问题-新增-Y
    up_time=1675681275
