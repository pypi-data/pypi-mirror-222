...
class AssertsCommonUser4C(SqlsCommonUser4C):
    ...
    def assert_common_user4c_page(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["userSystemSource", "regisTimeEnd", "createTimeEnd", "activitySource", "type", "lastLoginTimeEnd", "regisTimeBegin", "nickName", "userId", "lastLoginTimeStart", "status", "createTimeStart", "mobile", "memberSystemSource", "ownerFlag"])
        assert True, "数据比较不一致"
    ...
    def assert_common_user4c_download(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["userSystemSource", "regisTimeEnd", "createTimeEnd", "activitySource", "downloadType", "userIds", "type", "lastLoginTimeEnd", "regisTimeBegin", "nickName", "userId", "lastLoginTimeStart", "status", "createTimeStart", "mobile", "memberSystemSource", "ownerFlag"])
        assert True, "数据比较不一致"
    ...
    def assert_common_user4c_insert(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["explain", "nickName", "avatarUrl"])
        assert True, "数据比较不一致"
    ...
    def assert_common_user4c_auditexport(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["phone", "userType", "userIds", "registerType", "nickName", "userId", "downloadType", "userLabel", "ownerFlag"])
        assert True, "数据比较不一致"
    ...
    def assert_common_user4c_auditlist(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["checkStatus", "userName", "registerType", "nickName", "userId", "pageNum", "mobile"])
        assert True, "数据比较不一致"
