...
class AssertsCommonUserpointsmanage(SqlsCommonUserpointsmanage):
    ...
    def assert_common_userpointsmanage_userpointsexport(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["endTime", "logIds", "nickName", "beginTime", "mobile"])
        assert True, "数据比较不一致"
    ...
    def assert_common_userpointsmanage_page(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["mobile", "endTime", "nickName", "beginTime"])
        assert True, "数据比较不一致"
    ...
    def assert_common_userpointsmanage_manualchangeuserpoints(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["operateMark", "pointChangType", "taskName", "userId", "operateType", "operatePoint"])
        assert True, "数据比较不一致"
