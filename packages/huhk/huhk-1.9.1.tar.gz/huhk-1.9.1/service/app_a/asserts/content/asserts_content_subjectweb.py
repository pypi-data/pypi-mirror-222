...
class AssertsContentSubjectweb(SqlsContentSubjectweb):
    ...
    def assert_content_subjectweb_add(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["web", "siftFlag", "isService", "recommend", "level", "type", "serial", "siftPicUrl", "explain", "isSearch", "subjectRank", "subjectName", "parentId", "status", "subPicUrl"])
        assert True, "数据比较不一致"
    ...
    def assert_content_subjectweb_save(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["siftFlag", "isService", "delFlag", "type", "explain", "isSearch", "subjectName", "parentId", "status", "subPicUrl", "subjectId"])
        assert True, "数据比较不一致"
