...
class AssertsGoodsOrdermain(SqlsGoodsOrdermain):
    ...
    def assert_goods_ordermain_orderexports(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["modelName", "userName", "testDriveIdStr", "shopName", "startTime", "endTime", "userMobile", "billStatus", "exportType"])
        assert True, "数据比较不一致"
    ...
    def assert_goods_ordermain_getordermainpage(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["modelName", "userName", "shopName", "startTime", "endTime", "userMobile", "orderStatus"])
        assert True, "数据比较不一致"
