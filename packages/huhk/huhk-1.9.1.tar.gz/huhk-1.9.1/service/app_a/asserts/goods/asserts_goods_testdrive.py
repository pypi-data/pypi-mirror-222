...
class AssertsGoodsTestdrive(SqlsGoodsTestdrive):
    ...
    def assert_goods_testdrive_driveexports(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["userName", "testDriveIdStr", "shopName", "startTime", "endTime", "exportType", "mobile", "channel"])
        assert True, "数据比较不一致"
    ...
    def assert_goods_testdrive_page(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["userName", "shopName", "startTime", "endTime", "pageNum", "mobile", "channel"])
        assert True, "数据比较不一致"
