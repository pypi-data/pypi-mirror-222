...
class FunsContentAgreement(AssertsContentAgreement):
    ...
    def content_agreement_updatestatus(self, code="$None$", status="$None$", agreementId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_agreement_update(self, code="$None$", content="$None$", agreementId="$None$", version="$None$", name="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
