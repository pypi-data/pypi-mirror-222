...
class FunsContentSubjectweb(AssertsContentSubjectweb):
    ...
    def content_subjectweb_detailessay(self, size=10, current=1, subjectId="$None$", _assert=True,  **kwargs):
        """
    ...
    def content_subjectweb_add(self, web="$None$", siftFlag="$None$", isService="$None$", recommend="$None$", level="$None$", type="$None$", serial="$None$", siftPicUrl="$None$", explain="$None$", isSearch="$None$", subjectRank="$None$", subjectName="$None$", parentId="$None$", status="$None$", subPicUrl="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_subjectweb_save(self, siftFlag="$None$", isService="$None$", delFlag="$None$", type="$None$", explain="$None$", isSearch="$None$", subjectName="$None$", parentId="$None$", status="$None$", subPicUrl="$None$", subjectId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_subjectweb_detailessaynew(self, size=10, current=1, subjectId="$None$", _assert=True,  **kwargs):
        """
