...
class FunsContentEssayweb(AssertsContentEssayweb):
    ...
    def content_essayweb_add(self, essayId="$None$", publishChannel="$None$", publishTime="$None$", content="$None$", author="$None$", publishType="$None$", essPicUrl="$None$", title="$None$", status="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
