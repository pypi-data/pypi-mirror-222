...
class FunsContentEssay(AssertsContentEssay):
    ...
    def content_essay_searchbykey(self, Key="$None$", current=1, size=10, _assert=True,  **kwargs):
        """
    ...
    def content_essay_checklist(self, essayId="$None$", size=10, recommend="$None$", current=1, author="$None$", CreateTimeSortType="$None$", endTime="$None$", startTime="$None$", PublishTimeSortType="$None$", status="$None$", keyWord="$None$", StatusSortType="$None$", subjectId="$None$", _assert=True,  **kwargs):
        """
    ...
    def content_essay_list(self, essayId="$None$", size=10, recommend="$None$", current=1, author="$None$", CreateTimeSortType="$None$", endTime="$None$", startTime="$None$", PublishTimeSortType="$None$", status="$None$", keyWord="$None$", StatusSortType="$None$", subjectId="$None$", _assert=True,  **kwargs):
        """
    ...
    def content_essay_add(self, essayType="$None$", essayId="$None$", recommend="$None$", videoUrl="$None$", publishTime="$None$", content="$None$", author="$None$", publishType="$None$", essPicUrl="$None$", title="$None$", status="$None$", subjectId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_essay_getcommentlist(self, essayId="$None$", size=10, commentId="$None$", current=1, checkedStatus="$None$", endTime="$None$", startTime="$None$", parentId="$None$", keyWord="$None$", _assert=True,  **kwargs):
        """
