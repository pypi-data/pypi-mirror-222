...
class FunsContentAdv(AssertsContentAdv):
    ...
    def content_adv_save(self, pictureList="$None$", advPicUrl="$None$", advSerial="$None$", bindingFlag="$None$", version="$None$", advText="$None$", advPlaceId="$None$", advLinkUrl="$None$", jumpType="$None$", advId="$None$", jumpContent="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_adv_detailcontentadmin(self, size=10, essayKeyWords="$None$", current=1, orderByCommentCnt="$None$", _assert=True,  **kwargs):
        """
