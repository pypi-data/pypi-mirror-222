...
class FunsEssay(AssertsEssay):
    ...
    def essay_batch(self, batchType="$None$", essayId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
            url=/essay/batch
                params: essayId :  : 文章主键
    ...
    def essay_querylistcount(self, essayId="$None$", author="$None$", endTime="$None$", startTime="$None$", status="$None$", keyWord="$None$", subjectId="$None$", _assert=True,  **kwargs):
        """
