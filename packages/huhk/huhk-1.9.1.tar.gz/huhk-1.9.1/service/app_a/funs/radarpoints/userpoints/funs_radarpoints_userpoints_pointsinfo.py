...
class FunsRadarpointsUserpointsPointsinfo(AssertsRadarpointsUserpointsPointsinfo):
    ...
    def radarpoints_userpoints_pointsinfo_pagelist(self, size=10, changeTimeBegin="$None$", current=1, userId="$None$", businessSceneType="$None$", name="$None$", changeTimeEnd="$None$", _assert=True,  **kwargs):
        """
