...
class FunsRadarpointsAdjustpointsAdjustSingle(AssertsRadarpointsAdjustpointsAdjustSingle):
    ...
    def radarpoints_adjustpoints_adjust_single_save(self, optAbility="$None$", userId="$None$", clientNotes="$None$", qty="$None$", adjustNotes="$None$", pointsExpiration="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
