...
class FunsRadarpointsSummarystatistics(AssertsRadarpointsSummarystatistics):
    ...
    def radarpoints_summarystatistics_pagelist(self, flowTimeBefore="$None$", size=10, flowTimeEnd="$None$", current=1, _assert=True,  **kwargs):
        """
    ...
    def radarpoints_summarystatistics_export(self, size=10, flowTimeEnd="$None$", current=1, flowTimebefore="$None$", _assert=True,  **kwargs):
        """
