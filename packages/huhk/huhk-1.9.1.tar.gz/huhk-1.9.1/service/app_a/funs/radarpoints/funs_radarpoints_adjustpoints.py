...
class FunsRadarpointsAdjustpoints(AssertsRadarpointsAdjustpoints, FunsRadarpointsAdjustpointsAdjust):
    ...
    def radarpoints_adjustpoints_pagelist(self, size=10, optAbility="$None$", current=1, adjustTimeEnd="$None$", mobile="$None$", nickName="$None$", userId="$None$", optAbilityName="$None$", adjustNotes="$None$", adjustTimeBefore="$None$", _assert=True,  **kwargs):
        """
    ...
    def radarpoints_adjustpoints_export(self, size=10, optAbility="$None$", current=1, adjustTimeEnd="$None$", mobile="$None$", nickName="$None$", userId="$None$", optAbilityName="$None$", adjustNotes="$None$", adjustTimeBefore="$None$", _assert=True,  **kwargs):
        """
