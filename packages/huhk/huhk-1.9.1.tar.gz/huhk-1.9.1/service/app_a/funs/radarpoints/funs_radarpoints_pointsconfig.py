...
class FunsRadarpointsPointsconfig(AssertsRadarpointsPointsconfig):
    ...
    def radarpoints_pointsconfig_page(self, pointsBegin="$None$", size=10, code="$None$", Current="$None$", pointsEnd="$None$", businessSceneType="$None$", name="$None$", status="$None$", pointsExpiration="$None$", _assert=True,  **kwargs):
        """
    ...
    def radarpoints_pointsconfig_insert(self, rulesPointsDayMax="$None$", remark="$None$", toast="$None$", points="$None$", businessSceneType="$None$", bpmId="$None$", userPointsDayMax="$None$", name="$None$", pointsExpiration="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def radarpoints_pointsconfig_update(self, id="$None$", code="$None$", rulesPointsDayMax="$None$", remark="$None$", toast="$None$", points="$None$", businessSceneType="$None$", userPointsDayMax="$None$", bpmId="$None$", name="$None$", pointsExpiration="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
