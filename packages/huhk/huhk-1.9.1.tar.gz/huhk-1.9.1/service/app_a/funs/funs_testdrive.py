...
class FunsTestdrive(AssertsTestdrive):
    ...
    def testdrive_subscribe(self, customerName="$None$", leadSourceCode="$None$", modelId="$None$", appointmentTime="$None$", leadSanSourceCode="$None$", model="$None$", shopName="$None$", activityCode="$None$", phoneNumber="$None$", shopId="$None$", channel="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
