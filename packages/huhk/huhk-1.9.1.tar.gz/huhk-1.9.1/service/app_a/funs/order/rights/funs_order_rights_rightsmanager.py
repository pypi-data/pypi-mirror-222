...
class FunsOrderRightsRightsmanager(AssertsOrderRightsRightsmanager):
    ...
    def order_rights_rightsmanager_page(self, effectiveEndDate="$None$", size=10, modelCode="$None$", current=1, status="$None$", rightsName="$None$", _assert=True,  **kwargs):
        """
    ...
    def order_rights_rightsmanager_getrightslist(self, status="$None$", effectiveStartDate="$None$", modelId="$None$", rightsName="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def order_rights_rightsmanager_insert(self, orderType="$None$", modelCode="$None$", rightsId="$None$", effectiveStartDate="$None$", rightsType="$None$", rightsName="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def order_rights_rightsmanager_update(self, effectiveEndDate="$None$", rightsId="$None$", effectiveStartDate="$None$", Relation="$None$", Content="$None$", rightsName="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
