...
def content_essayweb_add(essayId=None, publishChannel=None, publishTime=None, content=None, author=None, publishType=None, essPicUrl=None, title=None, status=None, headers=None, **kwargs):
    """
    专题-后台官网专题新建文章-Y
    up_time=1675737086
