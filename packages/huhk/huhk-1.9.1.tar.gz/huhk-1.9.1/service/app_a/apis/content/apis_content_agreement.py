...
def content_agreement_updatestatus(code=None, status=None, agreementId=None, headers=None, **kwargs):
    """
    协议-停用启用协议-Y
    up_time=1675680241
...
def content_agreement_update(code=None, content=None, agreementId=None, version=None, name=None, headers=None, **kwargs):
    """
    协议-更新协议-Y
    up_time=1675680222
