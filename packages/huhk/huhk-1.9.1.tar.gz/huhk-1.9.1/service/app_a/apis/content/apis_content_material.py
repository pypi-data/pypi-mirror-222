...
def content_material_updategroup(groupId=None, groupName=None, headers=None, **kwargs):
    """
    素材-更新素材分组-Y
    up_time=1675651159
...
def content_material_getmateriallist(groupId=None, current=None, size=None, headers=None, **kwargs):
    """
    素材-根据素材组获取素材列表
    up_time=1675133826
