...
def goods_area_insertrelation(dealerCode=None, areaIds=None, headers=None, **kwargs):
    """
    后台管理-设置默认经销商-Y
    up_time=1675389550
...
def goods_area_getcitylist(pName=None, size=None, cName=None, current=None, cType=None, headers=None, **kwargs):
    """
    城市禁行列表查询-Y
    up_time=1675388494
