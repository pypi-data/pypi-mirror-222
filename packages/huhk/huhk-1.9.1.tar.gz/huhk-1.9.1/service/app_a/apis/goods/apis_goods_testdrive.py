...
def goods_testdrive_driveexports(userName=None, testDriveIdStr=None, shopName=None, startTime=None, endTime=None, exportType=None, mobile=None, channel=None, headers=None, **kwargs):
    """
    试驾列表文件导出接口-Y
    up_time=1675390810
...
def goods_testdrive_page(pageSize=None, userName=None, shopName=None, startTime=None, endTime=None, pageNum=None, mobile=None, channel=None, headers=None, **kwargs):
    """
    试驾查询接口-Y
    up_time=1675390631
