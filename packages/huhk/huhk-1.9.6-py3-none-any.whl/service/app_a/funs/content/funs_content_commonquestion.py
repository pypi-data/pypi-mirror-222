...
class FunsContentCommonquestion(AssertsContentCommonquestion):
    ...
    def content_commonquestion_update(self, content="$None$", title="$None$", essayId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_commonquestion_add(self, content="$None$", title="$None$", essayId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
