...
from diveplane.openapi.models import Project as BaseProject
from diveplane.reactor.client import get_client

if TYPE_CHECKING:
    from datetime import datetime
    from diveplane.openapi.models import AccountIdentity
...
class Project(BaseProject):
    ...
    client : ProjectClient, optional
        The Diveplane client instance to use. Must support the project API.
    """
    ...
    def client(self, client: ProjectClient) -> None:
        ...
        if not isinstance(client, ProjectClient):
            raise DiveplaneError("Projects are not supported by the active "
                                 "Diveplane client.")
        self._client = client
