...
ENV_CREATE_MAX_WAIT_TIME = 'DP_CLIENT_CREATE_MAX_WAIT_TIME'
...
class DiveplaneConfiguration:
    ...
    def get_max_create_time(self, max_wait_time=None, *, default=30):
        ...
        2. An environment variable `DP_CLIENT_CREATE_MAX_WAIT_TIME;
        3. A setting in the config.yaml file:
           Diveplane > options > create_max_wait_time; or
        ...
        if max_wait_time is None:
            ...
            # 2: ENV Variable named DP_CLIENT_CREATE_MAX_WAIT_TIME
            ...
            if env_value != sentinel:
                ...
                config_value = self.get_user_config_option(
                    'Diveplane', 'options', 'create_max_wait_time',
                    default=sentinel)
