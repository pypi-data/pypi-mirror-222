...
from diveplane.utilities.internals import deserialize_to_dataframe


class DiveplanePandasClientMixin:
    """
    Overrides Diveplane client methods to return data as pandas data types.

    Base: :class:`diveplane.client.AbstractDiveplaneClient`
    """

    def get_trainee_session_indices(self, *args, **kwargs) -> Index:
        """
        Base: :func:`diveplane.client.AbstractDiveplaneClient.get_trainee_session_indices`.
    ...
    def get_trainee_session_training_indices(self, *args, **kwargs) -> Index:
        """
        Base: :func:`diveplane.client.AbstractDiveplaneClient.get_trainee_session_training_indices`.
    ...
    def react_group(self, *args, **kwargs) -> DataFrame:
        """
        Base: :func:`diveplane.client.AbstractDiveplaneClient.react_group`.
    ...
    def get_cases(self, trainee_id: str, *args, **kwargs) -> DataFrame:
        """
        Base: :func:`diveplane.client.AbstractDiveplaneClient.get_cases`.
    ...
    def get_extreme_cases(
        ...
        """
        Base: :func:`diveplane.client.AbstractDiveplaneClient.get_extreme_cases`.
    ...
    def get_feature_conviction(self, *args, **kwargs) -> DataFrame:
        """
        Base: :func:`diveplane.client.AbstractDiveplaneClient.get_feature_conviction`.
    ...
    def get_feature_residuals(self, *args, **kwargs) -> DataFrame:
        """
        Base: :func:`diveplane.client.AbstractDiveplaneClient.get_feature_residuals`.
    ...
    def get_feature_mda(self, *args, **kwargs):
        """
        Base: :func:`diveplane.client.AbstractDiveplaneClient.get_feature_mda`.
    ...
    def get_feature_contributions(self, *args, **kwargs) -> DataFrame:
        """
        Base: :func:`diveplane.client.AbstractDiveplaneClient.get_feature_contributions`.
    ...
    def get_prediction_stats(self, *args, **kwargs) -> DataFrame:
        """
        Base: :func:`diveplane.client.AbstractDiveplaneClient.get_prediction_stats`.
    ...
    def get_marginal_stats(self, *args, **kwargs) -> DataFrame:
        """
        Base: :func:`diveplane.client.AbstractDiveplaneClient.get_marginal_stats`.
    ...
    def react_series(
        ...
        """
        Base: :func:`diveplane.client.AbstractDiveplaneClient.react_series`.
    ...
    def react(self, trainee_id, *args, **kwargs) -> Dict[str, Union[DataFrame, Dict]]:
        """
        Base: :func:`diveplane.client.AbstractDiveplaneClient.react`.
    ...
    def get_distances(self, *args, **kwargs) -> Dict[str, Union[DataFrame, List]]:
        """
        base: :func:`diveplane.client.AbstractDiveplaneClient.get_distances`.
...
def get_diveplane_pandas_client(**kwargs):
    """
    ...
    AbstractDiveplaneClient
        An instantiated subclass of AbstractDiveplaneClient constructed with
        the DiveplanePandasClientMixin.
    """
    ...
    # the pandas mixin
    class DiveplanePandasClient(DiveplanePandasClientMixin, client_class):  # noqa
        pass

    client_params.update(kwargs)
    return DiveplanePandasClient(**client_params)  # noqa


DiveplanePandasClient = get_diveplane_pandas_client
