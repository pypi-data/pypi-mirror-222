...
def log_to_dateformat(lines: str) -> str:
    """The function converts the first line of a log file to a date format.
    Parameters
    ----------
    lines : str
        The lines are the lines of the log file.
    Returns
    -------
    str
    ...
    first_line = lines[0]
    lastest_timestamp = first_line.split(' ')
