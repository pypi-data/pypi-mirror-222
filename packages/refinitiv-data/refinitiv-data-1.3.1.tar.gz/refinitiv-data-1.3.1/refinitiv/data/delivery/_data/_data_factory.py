...
class BaseDataFactory(Generic[TypeData]):
    ...
    def create_data(self, raw: Any, owner_: "BaseResponse", **kwargs) -> TypeData:
    ...
    def create_data_success(self, raw: Any, owner_: "BaseResponse", **kwargs) -> TypeData:
        return self.data_class(raw=raw, _owner=owner_, _kwargs=kwargs)

    def create_data_fail(self, raw: Any, owner_: "BaseResponse", **kwargs) -> TypeData:
