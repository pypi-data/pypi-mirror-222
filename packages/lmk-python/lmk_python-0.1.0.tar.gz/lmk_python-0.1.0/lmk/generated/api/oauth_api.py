...
class OauthApi(object):
    ...
    @validate_arguments
    def initiate_oauth(self, initiate_oauth_request : InitiateOauthRequest, **kwargs) -> InitiateOauthResponse:  # noqa: E501
        """initiate_oauth  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.initiate_oauth(initiate_oauth_request, async_req=True)
        >>> result = thread.get()

        :param initiate_oauth_request: (required)
        :type initiate_oauth_request: InitiateOauthRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: InitiateOauthResponse
        """
        kwargs['_return_http_data_only'] = True
        return self.initiate_oauth_with_http_info(initiate_oauth_request, **kwargs)  # noqa: E501

    @validate_arguments
    def initiate_oauth_with_http_info(self, initiate_oauth_request : InitiateOauthRequest, **kwargs):  # noqa: E501
        """initiate_oauth  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.initiate_oauth_with_http_info(initiate_oauth_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(InitiateOauthResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'initiate_oauth_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        # process the body parameter
        _body_params = None
        if _params['initiate_oauth_request']:
            _body_params = _params['initiate_oauth_request']
