...
class SearchResponse(BaseModel):
    ...
    __properties = ["results", "total", "continuationToken"]
    ...
    def from_dict(cls, obj: dict) -> SearchResponse:
        ...
        _obj = SearchResponse.parse_obj({
            "results": [SearchResponseResultsInner.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
            "total": obj.get("total"),
