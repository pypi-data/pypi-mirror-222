...
class EventSearchResultResponse(BaseModel):
    ...
    __properties = ["resultType", "eventId", "sessionId", "userId", "actor", "message", "contentType", "channels", "createdAt"]

    @validator('result_type')
    def result_type_validate_enum(cls, v):
        if v not in ('event'):
            raise ValueError("must validate the enum values ('event')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventSearchResultResponse:
        """Create an instance of EventSearchResultResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventSearchResultResponse:
        """Create an instance of EventSearchResultResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EventSearchResultResponse.parse_obj(obj)

        _obj = EventSearchResultResponse.parse_obj({
