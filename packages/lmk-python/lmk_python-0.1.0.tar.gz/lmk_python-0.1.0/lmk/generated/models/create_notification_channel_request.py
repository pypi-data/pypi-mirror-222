...
class CreateNotificationChannelRequest(BaseModel):
    ...
    """
    payload: CreateNotificationChannelRequestPayload = ...
    name: StrictStr = ...
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateNotificationChannelRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateNotificationChannelRequest:
        """Create an instance of CreateNotificationChannelRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateNotificationChannelRequest.parse_obj(obj)

        _obj = CreateNotificationChannelRequest.parse_obj({
