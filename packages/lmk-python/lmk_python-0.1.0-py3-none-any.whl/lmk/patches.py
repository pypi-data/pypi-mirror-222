...
from lmk.generated.models.create_notification_channel_request_payload import (
    CreateNotificationChannelRequestPayload,
)
...
def patch():
    ...
    @patch_method(CreateNotificationChannelRequestPayload, "__repr__")
