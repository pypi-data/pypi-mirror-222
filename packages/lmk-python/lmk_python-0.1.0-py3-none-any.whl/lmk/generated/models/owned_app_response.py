...
class OwnedAppResponse(BaseModel):
    ...
    __properties = ["appId", "name", "iconUrl", "description", "introWarningMarkdown", "clientId", "clientSecret", "redirectUris", "createdAt", "lastUpdatedAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OwnedAppResponse:
        """Create an instance of OwnedAppResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OwnedAppResponse:
        """Create an instance of OwnedAppResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return OwnedAppResponse.parse_obj(obj)

        _obj = OwnedAppResponse.parse_obj({
