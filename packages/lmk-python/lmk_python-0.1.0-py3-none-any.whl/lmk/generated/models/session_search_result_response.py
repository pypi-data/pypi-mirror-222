...
class SessionSearchResultResponse(BaseModel):
    ...
    result_type: StrictStr = Field(..., alias="resultType")
    ...
    __properties = ["state", "resultType", "sessionId", "name", "type", "createdAt", "createdByActor", "lastUpdatedAt", "lastUpdatedByActor", "endedAt", "endedByActor"]

    @validator('result_type')
    def result_type_validate_enum(cls, v):
        if v not in ('session'):
            raise ValueError("must validate the enum values ('session')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SessionSearchResultResponse:
        """Create an instance of SessionSearchResultResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SessionSearchResultResponse:
        """Create an instance of SessionSearchResultResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SessionSearchResultResponse.parse_obj(obj)

        _obj = SessionSearchResultResponse.parse_obj({
