...
class DeployResources(Model):
    ...
    def __init__(self, workloads=None, services=None, configs=None, secrets=None, persistent_volume_claims=None, ingress=None, service_monitors=None, roles=None, role_bindings=None, custom_manifests=None):  # noqa: E501
