**SHE Cryptography**
========================
The expansion of SHE is **Secure Hybrid Encryption**. It is a hybrid and lightweight cryptographic system that transforms plaintext into ciphertext so that secret communication is to be ensured.
