...
from openapi_server.models.config_templates_inner import ConfigTemplatesInner  # noqa: E501
...
class Config(Model):
    ...
    def __init__(self, name=None, labels=None, annotations=None, files=None, templates=None):  # noqa: E501
        ...
        :type templates: List[ConfigTemplatesInner]
        """
        self.openapi_types = {
            'name': str,
            'labels': List[str],
            ...
            'files': List[str],
            'templates': List[ConfigTemplatesInner]
        }
    ...
    def templates(self):
        ...
        :rtype: List[ConfigTemplatesInner]
        """
