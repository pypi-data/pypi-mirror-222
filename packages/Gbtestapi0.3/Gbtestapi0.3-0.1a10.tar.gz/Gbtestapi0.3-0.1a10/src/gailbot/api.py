...
# @Last Modified time: 2023-08-01 04:26:13
...
class GailBot:
    ...
    # can porbablu get rid of user prob doesnt need it
    ...
    # nice to have source = earliest rep in pipeline
    ...
    # TODO: check how useful this is; not a must have; its a maybe
    ...
    # aka get all_profile data; maybe: can be potentially removed because maybe not as useful
    ...
    # front end does not use this bc no interface rn; nice to keep; hard to maintain correctness
    # bc invovles deleting and moving the files so be careful
    ...
    # TODO: rename to remove_profile, delete if alr exist
    ...
    # TODO: rename to is_profile, delete if that alr exist
    ...
    # maybe removed - same as other in_used; it's a checker function
    ...
    # maybe - remove if you can get_profile_data
    ...
    # remove - check if covered by get_default_profile_setting_name
    ...
    # remove - don't want users to mess around with the default setting
    ...
    # can be removed bc it might just give user warning on the front end
