...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def clamped_parts(self) -> 'List[_1465.ClampedSection]':
    ...
    def clamped_parts(self, value: 'List[_1465.ClampedSection]'):
    ...
    @property
    def joint_geometry(self) -> '_1470.JointGeometries':
        ...
        return constructor.new_from_mastapy('mastapy.bolts._1470', 'JointGeometries')(value) if value is not None else None

    @joint_geometry.setter
    def joint_geometry(self, value: '_1470.JointGeometries'):
    ...
    @property
    def rolled_before_or_after_heat_treatment(self) -> '_1473.RolledBeforeOrAfterHeatTreatment':
        """RolledBeforeOrAfterHeatTreatment: 'RolledBeforeOrAfterHeatTreatment' is the original name of this property."""
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Bolts.RolledBeforeOrAfterHeatTreatment')
        return constructor.new_from_mastapy('mastapy.bolts._1473', 'RolledBeforeOrAfterHeatTreatment')(value) if value is not None else None

    @rolled_before_or_after_heat_treatment.setter
    def rolled_before_or_after_heat_treatment(self, value: '_1473.RolledBeforeOrAfterHeatTreatment'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Bolts.RolledBeforeOrAfterHeatTreatment')
    ...
    @property
    def bolt_geometry(self) -> '_1458.BoltGeometry':
    ...
    @property
    def material_of_bolt(self) -> '_1460.BoltMaterial':
    ...
    @property
    def material_of_nut(self) -> '_1456.BoltedJointMaterial':
    ...
    @property
    def material_of_tapped_thread(self) -> '_1456.BoltedJointMaterial':
    ...
    @property
    def clamped_sections(self) -> 'List[_1465.ClampedSection]':
