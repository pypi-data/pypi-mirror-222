...
class MaterialPropertiesReporting(_0.APIBase):
    ...
    @property
    def elastic_modulus_components(self) -> '_205.ElasticModulusOrthotropicComponents':
    ...
    @property
    def poissons_ratio_components(self) -> '_218.PoissonRatioOrthotropicComponents':
    ...
    @property
    def shear_modulus_components(self) -> '_220.ShearModulusOrthotropicComponents':
    ...
    @property
    def thermal_expansion_coefficient_components(self) -> '_221.ThermalExpansionOrthotropicComponents':
