...
if TYPE_CHECKING:
    from mastapy.fe_tools.vis_tools_visualisation.enums import _1228
...
class CoordinateSystemReporting(_0.APIBase):
    ...
    @property
    def type_(self) -> '_1228.CoordinateSystemType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.FETools.VisToolsVisualisation.Enums.CoordinateSystemType')
        return constructor.new_from_mastapy('mastapy.fe_tools.vis_tools_visualisation.enums._1228', 'CoordinateSystemType')(value) if value is not None else None
