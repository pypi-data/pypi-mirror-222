...
class DrawStyleForFE(_0.APIBase):
    ...
    def line_option(self) -> '_59.FEMeshElementEntityOption':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.NodalAnalysis.FEMeshElementEntityOption')
        return constructor.new_from_mastapy('mastapy.nodal_analysis._59', 'FEMeshElementEntityOption')(value) if value is not None else None

    @line_option.setter
    def line_option(self, value: '_59.FEMeshElementEntityOption'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.NodalAnalysis.FEMeshElementEntityOption')
