...
class EigenvalueOptions(_0.APIBase):
    ...
    @property
    def mass_matrix_type(self) -> '_197.MassMatrixType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.NodalAnalysis.DevToolsAnalyses.MassMatrixType')
        return constructor.new_from_mastapy('mastapy.nodal_analysis.dev_tools_analyses._197', 'MassMatrixType')(value) if value is not None else None

    @mass_matrix_type.setter
    def mass_matrix_type(self, value: '_197.MassMatrixType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.NodalAnalysis.DevToolsAnalyses.MassMatrixType')
    ...
    @property
    def overall_amls_cutoff_factor(self) -> 'float':
        """float: 'OverallAMLSCutoffFactor' is the original name of this property."""
    ...
    def overall_amls_cutoff_factor(self, value: 'float'):
        self.wrapped.OverallAMLSCutoffFactor = float(value) if value is not None else 0.0

    @property
    def reduced_amls_cutoff_factor(self) -> 'float':
        """float: 'ReducedAMLSCutoffFactor' is the original name of this property."""
    ...
    def reduced_amls_cutoff_factor(self, value: 'float'):
        self.wrapped.ReducedAMLSCutoffFactor = float(value) if value is not None else 0.0
