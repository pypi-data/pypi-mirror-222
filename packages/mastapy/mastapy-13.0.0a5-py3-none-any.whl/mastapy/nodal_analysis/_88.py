...
class TransientSolverOptions(_0.APIBase):
    ...
    def damping_scaling_for_initial_transients(self) -> '_56.DampingScalingTypeForInitialTransients':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.NodalAnalysis.DampingScalingTypeForInitialTransients')
        return constructor.new_from_mastapy('mastapy.nodal_analysis._56', 'DampingScalingTypeForInitialTransients')(value) if value is not None else None
    ...
    def damping_scaling_for_initial_transients(self, value: '_56.DampingScalingTypeForInitialTransients'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.NodalAnalysis.DampingScalingTypeForInitialTransients')
    ...
    @property
    def result_logging_frequency(self) -> '_83.ResultLoggingFrequency':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.NodalAnalysis.ResultLoggingFrequency')
        return constructor.new_from_mastapy('mastapy.nodal_analysis._83', 'ResultLoggingFrequency')(value) if value is not None else None

    @result_logging_frequency.setter
    def result_logging_frequency(self, value: '_83.ResultLoggingFrequency'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.NodalAnalysis.ResultLoggingFrequency')
    ...
    @property
    def solver_tolerance_input_method(self) -> '_90.TransientSolverToleranceInputMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.NodalAnalysis.TransientSolverToleranceInputMethod')
        return constructor.new_from_mastapy('mastapy.nodal_analysis._90', 'TransientSolverToleranceInputMethod')(value) if value is not None else None

    @solver_tolerance_input_method.setter
    def solver_tolerance_input_method(self, value: '_90.TransientSolverToleranceInputMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.NodalAnalysis.TransientSolverToleranceInputMethod')
