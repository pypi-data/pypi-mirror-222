...
class FEMeshingProblem(_0.APIBase):
    ...
    def type_(self) -> '_63.FEMeshingProblems':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.NodalAnalysis.FEMeshingProblems')
        return constructor.new_from_mastapy('mastapy.nodal_analysis._63', 'FEMeshingProblems')(value) if value is not None else None
