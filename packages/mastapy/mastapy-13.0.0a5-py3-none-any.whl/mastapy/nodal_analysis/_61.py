...
class FEMeshingOptions(_0.APIBase):
    ...
    @property
    def element_shape(self) -> '_92.VolumeElementShape':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.NodalAnalysis.VolumeElementShape')
        return constructor.new_from_mastapy('mastapy.nodal_analysis._92', 'VolumeElementShape')(value) if value is not None else None

    @element_shape.setter
    def element_shape(self, value: '_92.VolumeElementShape'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.NodalAnalysis.VolumeElementShape')
