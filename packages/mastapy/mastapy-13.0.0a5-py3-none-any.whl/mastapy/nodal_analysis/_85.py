...
class ShaftFEMeshingOptions(_61.FEMeshingOptions):
    ...
    def meshing_diameter_for_gear(self) -> '_76.MeshingDiameterForGear':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.NodalAnalysis.MeshingDiameterForGear')
        return constructor.new_from_mastapy('mastapy.nodal_analysis._76', 'MeshingDiameterForGear')(value) if value is not None else None

    @meshing_diameter_for_gear.setter
    def meshing_diameter_for_gear(self, value: '_76.MeshingDiameterForGear'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.NodalAnalysis.MeshingDiameterForGear')
