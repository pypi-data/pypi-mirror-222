...
class ElmerResultsViewable(_0.APIBase):
    ...
    class _Cast_ElmerResultsViewable:
        ...
        def electric_machine_mechanical_results_viewable(self):
            from mastapy.electric_machines.results import _1316
            
            return self._parent._cast(_1316.ElectricMachineMechanicalResultsViewable)

        @property
        def electric_machine_results_viewable(self):
            from mastapy.electric_machines.results import _1328
            
            return self._parent._cast(_1328.ElectricMachineResultsViewable)
    ...
    @property
    def scaling_draw_style(self) -> '_1839.ScalingDrawStyle':
