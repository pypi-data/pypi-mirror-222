...
class RingFittingThermalResults(_0.APIBase):
    ...
    class _Cast_RingFittingThermalResults:
        ...
        def inner_ring_fitting_thermal_results(self):
            ...
            return self._parent._cast(_2097.InnerRingFittingThermalResults)

        @property
        def outer_ring_fitting_thermal_results(self):
            from mastapy.bearings.bearing_results.rolling.fitting import _2099
            
            return self._parent._cast(_2099.OuterRingFittingThermalResults)
    ...
    @property
    def interference_values(self) -> 'List[_2098.InterferenceComponents]':
