...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    class _Cast_LoadedPlainJournalBearingRow:
        ...
        def loaded_plain_oil_fed_journal_bearing_row(self):
            ...
            return self._parent._cast(_2112.LoadedPlainOilFedJournalBearingRow)
    ...
    def row(self) -> '_1865.BearingRow':
        ...
        return constructor.new_from_mastapy('mastapy.bearings._1865', 'BearingRow')(value) if value is not None else None
