...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.rolling.xml_import import _2164, _2163
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_2164.BearingImportFile]':
    ...
    @property
    def variables(self) -> 'List[_2163.AbstractXmlVariableAssignment]':
