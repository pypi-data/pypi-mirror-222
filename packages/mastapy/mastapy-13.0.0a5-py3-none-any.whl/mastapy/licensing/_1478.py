...
if TYPE_CHECKING:
    from mastapy.licensing import _7538, _7539, _7540
...
class LicenceServer:
    ...
    @staticmethod
    def update_server_settings(server_details: '_7538.LicenceServerDetails'):
    ...
    @staticmethod
    def get_server_settings() -> '_7538.LicenceServerDetails':
    ...
    @staticmethod
    def get_licensed_module_details() -> 'Iterable[_7539.ModuleDetails]':
    ...
    @staticmethod
    def get_available_module_details() -> 'Iterable[_7539.ModuleDetails]':
    ...
    @staticmethod
    def get_requested_module_statuses() -> 'Iterable[_7540.ModuleLicenceStatus]':
