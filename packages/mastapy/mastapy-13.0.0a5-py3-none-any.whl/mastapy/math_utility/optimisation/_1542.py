...
class ParetoOptimisationStrategyChartInformation(_0.APIBase):
    ...
    def select_chart_type(self) -> 'ParetoOptimisationStrategyChartInformation.ScatterOrBarChart':
        ...
        return constructor.new_from_mastapy('mastapy.math_utility.optimisation.ParetoOptimisationStrategyChartInformation.ParetoOptimisationStrategyChartInformation', 'ScatterOrBarChart')(value) if value is not None else None
    ...
    @property
    def bars(self) -> 'List[_1541.ParetoOptimisationStrategyBars]':
