...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def differential_gain_vs_time_and_error(self) -> '_1556.GriddedSurfaceAccessor':
    ...
    def differential_gain_vs_time_and_error(self, value: '_1556.GriddedSurfaceAccessor'):
    ...
    @property
    def integral_gain_vs_time_and_error(self) -> '_1556.GriddedSurfaceAccessor':
    ...
    def integral_gain_vs_time_and_error(self, value: '_1556.GriddedSurfaceAccessor'):
    ...
    @property
    def proportional_gain_vs_time_and_error(self) -> '_1556.GriddedSurfaceAccessor':
    ...
    def proportional_gain_vs_time_and_error(self, value: '_1556.GriddedSurfaceAccessor'):
    ...
    @property
    def update_method(self) -> '_1513.PIDControlUpdateMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.MathUtility.PIDControlUpdateMethod')
        return constructor.new_from_mastapy('mastapy.math_utility._1513', 'PIDControlUpdateMethod')(value) if value is not None else None

    @update_method.setter
    def update_method(self, value: '_1513.PIDControlUpdateMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.MathUtility.PIDControlUpdateMethod')
