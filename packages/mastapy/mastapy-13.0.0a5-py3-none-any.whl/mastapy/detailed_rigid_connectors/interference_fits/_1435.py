...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.interference_fits import _1433, _1434, _1438
...
class InterferenceFitDesign(_1377.DetailedRigidConnectorDesign):
    """InterferenceFitDesign
    ...
    @property
    def assembly_method(self) -> '_1433.AssemblyMethods':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.DetailedRigidConnectors.InterferenceFits.AssemblyMethods')
        return constructor.new_from_mastapy('mastapy.detailed_rigid_connectors.interference_fits._1433', 'AssemblyMethods')(value) if value is not None else None

    @assembly_method.setter
    def assembly_method(self, value: '_1433.AssemblyMethods'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.DetailedRigidConnectors.InterferenceFits.AssemblyMethods')
    ...
    @property
    def calculation_method(self) -> '_1434.CalculationMethods':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.DetailedRigidConnectors.InterferenceFits.CalculationMethods')
        return constructor.new_from_mastapy('mastapy.detailed_rigid_connectors.interference_fits._1434', 'CalculationMethods')(value) if value is not None else None

    @calculation_method.setter
    def calculation_method(self, value: '_1434.CalculationMethods'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.DetailedRigidConnectors.InterferenceFits.CalculationMethods')
