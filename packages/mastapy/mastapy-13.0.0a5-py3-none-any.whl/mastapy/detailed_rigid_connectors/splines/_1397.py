...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1412
...
class SAESplineHalfDesign(_1409.StandardSplineHalfDesign):
    """SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1412.SAESplineTolerances':
