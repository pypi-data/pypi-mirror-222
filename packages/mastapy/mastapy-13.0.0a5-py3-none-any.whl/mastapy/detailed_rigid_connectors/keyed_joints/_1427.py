...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.keyed_joints import _1428, _1430
...
class KeyedJointDesign(_1435.InterferenceFitDesign):
    """KeyedJointDesign
    ...
    @property
    def geometry_type(self) -> '_1428.KeyTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.DetailedRigidConnectors.KeyedJoints.KeyTypes')
        return constructor.new_from_mastapy('mastapy.detailed_rigid_connectors.keyed_joints._1428', 'KeyTypes')(value) if value is not None else None

    @geometry_type.setter
    def geometry_type(self, value: '_1428.KeyTypes'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.DetailedRigidConnectors.KeyedJoints.KeyTypes')
    ...
    @property
    def number_of_keys(self) -> '_1430.NumberOfKeys':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.DetailedRigidConnectors.KeyedJoints.NumberOfKeys')
        return constructor.new_from_mastapy('mastapy.detailed_rigid_connectors.keyed_joints._1430', 'NumberOfKeys')(value) if value is not None else None

    @number_of_keys.setter
    def number_of_keys(self, value: '_1430.NumberOfKeys'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.DetailedRigidConnectors.KeyedJoints.NumberOfKeys')
