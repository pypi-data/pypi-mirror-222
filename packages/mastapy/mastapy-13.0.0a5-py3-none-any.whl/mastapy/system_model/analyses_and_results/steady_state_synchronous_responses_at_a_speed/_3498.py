...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3499, _3497
...
class BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed(_3503.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def bevel_differential_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3499.BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3497.BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed]':
