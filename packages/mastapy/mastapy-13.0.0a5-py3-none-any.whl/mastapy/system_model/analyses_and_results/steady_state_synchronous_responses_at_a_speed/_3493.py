...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import (
        _3494, _3496, _3498, _3505,
        _3506, _3528, _3509, _3514,
        _3516, _3529, _3532, _3534,
        _3542, _3540, _3543, _3549,
        _3556, _3559, _3561, _3562,
        _3564, _3568, _3571, _3572,
        _3573, _3575, _3577, _3581,
        _3582, _3586, _3590, _3593,
        _3596, _3603, _3606, _3608,
        _3611, _3614
    )
...
class AssemblySteadyStateSynchronousResponseAtASpeed(_3486.AbstractAssemblySteadyStateSynchronousResponseAtASpeed):
    """AssemblySteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def bearings(self) -> 'List[_3494.BearingSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_3496.BeltDriveSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3498.BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3505.BoltedJointSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_3506.BoltSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_3528.CVTSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_3509.ClutchSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3514.ConceptCouplingSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3516.ConceptGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3529.CycloidalAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3532.CycloidalDiscSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3534.CylindricalGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_3542.FEPartSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3540.FaceGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3543.FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3549.HypoidGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3556.KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3559.KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_3561.MassDiscSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_3562.MeasurementComponentSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_3564.OilSealSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3568.PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3571.PlanetCarrierSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_3572.PointLoadSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_3573.PowerLoadSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_3575.RingPinsSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3577.RollingRingAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3581.ShaftHubConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_3582.ShaftSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3586.SpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3590.SpringDamperSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3593.StraightBevelDiffGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3596.StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_3603.SynchroniserSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_3606.TorqueConverterSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3608.UnbalancedMassSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3611.WormGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3614.ZerolBevelGearSetSteadyStateSynchronousResponseAtASpeed]':
