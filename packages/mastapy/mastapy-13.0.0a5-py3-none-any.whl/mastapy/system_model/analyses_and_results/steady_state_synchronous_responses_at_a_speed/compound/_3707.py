...
class RollingRingAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3714.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """RollingRingAssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3577.RollingRingAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3577.RollingRingAssemblySteadyStateSynchronousResponseAtASpeed]':
