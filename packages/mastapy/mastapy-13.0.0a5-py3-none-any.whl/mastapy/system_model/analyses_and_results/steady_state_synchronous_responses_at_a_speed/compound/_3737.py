...
class UnbalancedMassCompoundSteadyStateSynchronousResponseAtASpeed(_3738.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """UnbalancedMassCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3608.UnbalancedMassSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3608.UnbalancedMassSteadyStateSynchronousResponseAtASpeed]':
