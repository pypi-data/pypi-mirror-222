...
class RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3681.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """RollingRingConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3578.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3578.RollingRingConnectionSteadyStateSynchronousResponseAtASpeed]':
