...
class ClutchConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3654.CouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """ClutchConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3507.ClutchConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3507.ClutchConnectionSteadyStateSynchronousResponseAtASpeed]':
