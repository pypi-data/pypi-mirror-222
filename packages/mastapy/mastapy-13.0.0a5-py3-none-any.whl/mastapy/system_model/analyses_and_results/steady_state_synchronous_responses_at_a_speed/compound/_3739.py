...
class WormGearCompoundSteadyStateSynchronousResponseAtASpeed(_3674.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """WormGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3612.WormGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3612.WormGearSteadyStateSynchronousResponseAtASpeed]':
