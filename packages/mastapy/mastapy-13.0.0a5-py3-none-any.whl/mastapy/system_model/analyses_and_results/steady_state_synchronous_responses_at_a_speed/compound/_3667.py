...
class DatumCompoundSteadyStateSynchronousResponseAtASpeed(_3641.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """DatumCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3537.DatumSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3537.DatumSteadyStateSynchronousResponseAtASpeed]':
