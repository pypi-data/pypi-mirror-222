...
class SynchroniserHalfCompoundSteadyStateSynchronousResponseAtASpeed(_3731.SynchroniserPartCompoundSteadyStateSynchronousResponseAtASpeed):
    """SynchroniserHalfCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3600.SynchroniserHalfSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3600.SynchroniserHalfSteadyStateSynchronousResponseAtASpeed]':
