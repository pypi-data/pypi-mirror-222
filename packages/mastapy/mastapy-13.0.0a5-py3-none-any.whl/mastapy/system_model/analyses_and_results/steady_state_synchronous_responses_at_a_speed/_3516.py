...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3517, _3515
...
class ConceptGearSetSteadyStateSynchronousResponseAtASpeed(_3545.GearSetSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def concept_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3517.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3515.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed]':
