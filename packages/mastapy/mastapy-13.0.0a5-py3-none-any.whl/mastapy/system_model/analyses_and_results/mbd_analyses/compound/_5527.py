...
class ComponentCompoundMultibodyDynamicsAnalysis(_5581.PartCompoundMultibodyDynamicsAnalysis):
    """ComponentCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5378.ComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5378.ComponentMultibodyDynamicsAnalysis]':
