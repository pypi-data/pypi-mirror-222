...
class SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis(_5502.AbstractAssemblyCompoundMultibodyDynamicsAnalysis):
    """SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5462.SpecialisedAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5462.SpecialisedAssemblyMultibodyDynamicsAnalysis]':
