...
class BevelGearCompoundMultibodyDynamicsAnalysis(_5506.AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis):
    """BevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5369.BevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5369.BevelGearMultibodyDynamicsAnalysis]':
