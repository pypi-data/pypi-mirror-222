...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5555, _5556
...
class FaceGearSetCompoundMultibodyDynamicsAnalysis(_5562.GearSetCompoundMultibodyDynamicsAnalysis):
    """FaceGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5408.FaceGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5555.FaceGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5556.FaceGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5408.FaceGearSetMultibodyDynamicsAnalysis]':
