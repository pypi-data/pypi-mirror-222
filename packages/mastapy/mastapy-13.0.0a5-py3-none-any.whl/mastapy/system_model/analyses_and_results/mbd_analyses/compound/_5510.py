...
class BearingCompoundMultibodyDynamicsAnalysis(_5538.ConnectorCompoundMultibodyDynamicsAnalysis):
    """BearingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5359.BearingMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5359.BearingMultibodyDynamicsAnalysis]':
