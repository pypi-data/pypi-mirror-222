...
class StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis(_5607.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5475.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5475.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
