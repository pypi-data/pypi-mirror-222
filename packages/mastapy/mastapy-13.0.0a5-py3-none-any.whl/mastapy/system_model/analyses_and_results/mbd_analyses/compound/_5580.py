...
class OilSealCompoundMultibodyDynamicsAnalysis(_5538.ConnectorCompoundMultibodyDynamicsAnalysis):
    """OilSealCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5439.OilSealMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5439.OilSealMultibodyDynamicsAnalysis]':
