...
class StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis(_5519.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5469.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5469.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
