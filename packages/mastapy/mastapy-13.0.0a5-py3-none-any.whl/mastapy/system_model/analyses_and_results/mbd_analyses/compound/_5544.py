...
class CVTPulleyCompoundMultibodyDynamicsAnalysis(_5590.PulleyCompoundMultibodyDynamicsAnalysis):
    """CVTPulleyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5395.CVTPulleyMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5395.CVTPulleyMultibodyDynamicsAnalysis]':
