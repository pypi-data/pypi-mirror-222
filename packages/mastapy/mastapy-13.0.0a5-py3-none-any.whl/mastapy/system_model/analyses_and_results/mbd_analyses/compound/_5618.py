...
class SynchroniserSleeveCompoundMultibodyDynamicsAnalysis(_5617.SynchroniserPartCompoundMultibodyDynamicsAnalysis):
    """SynchroniserSleeveCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5480.SynchroniserSleeveMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5480.SynchroniserSleeveMultibodyDynamicsAnalysis]':
