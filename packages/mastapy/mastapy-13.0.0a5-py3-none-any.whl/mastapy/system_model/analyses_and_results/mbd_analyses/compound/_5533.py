...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5531, _5532
...
class ConceptGearSetCompoundMultibodyDynamicsAnalysis(_5562.GearSetCompoundMultibodyDynamicsAnalysis):
    """ConceptGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5384.ConceptGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5531.ConceptGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5532.ConceptGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5384.ConceptGearSetMultibodyDynamicsAnalysis]':
