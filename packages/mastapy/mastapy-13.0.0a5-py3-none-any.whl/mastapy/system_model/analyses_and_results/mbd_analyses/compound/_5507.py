...
class AGMAGleasonConicalGearMeshCompoundMultibodyDynamicsAnalysis(_5535.ConicalGearMeshCompoundMultibodyDynamicsAnalysis):
    """AGMAGleasonConicalGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5354.AGMAGleasonConicalGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5354.AGMAGleasonConicalGearMeshMultibodyDynamicsAnalysis]':
