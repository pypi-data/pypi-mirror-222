...
class CycloidalDiscCompoundMultibodyDynamicsAnalysis(_5503.AbstractShaftCompoundMultibodyDynamicsAnalysis):
    """CycloidalDiscCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5398.CycloidalDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5398.CycloidalDiscMultibodyDynamicsAnalysis]':
