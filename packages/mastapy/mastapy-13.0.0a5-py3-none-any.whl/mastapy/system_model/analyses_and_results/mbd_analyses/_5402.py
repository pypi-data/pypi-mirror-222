...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5401, _5400
...
class CylindricalGearSetMultibodyDynamicsAnalysis(_5414.GearSetMultibodyDynamicsAnalysis):
    """CylindricalGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5401.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gears_multibody_dynamics_analysis(self) -> 'List[_5401.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_meshes_multibody_dynamics_analysis(self) -> 'List[_5400.CylindricalGearMeshMultibodyDynamicsAnalysis]':
