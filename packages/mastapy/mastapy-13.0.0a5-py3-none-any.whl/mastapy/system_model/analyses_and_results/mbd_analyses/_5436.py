...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5422, _5456, _5461
...
class MBDRunUpAnalysisOptions(_7502.AbstractAnalysisOptions['_6773.TimeSeriesLoadCase']):
    """MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5422.InputVelocityForRunUpProcessingType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InputVelocityForRunUpProcessingType')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.mbd_analyses._5422', 'InputVelocityForRunUpProcessingType')(value) if value is not None else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5422.InputVelocityForRunUpProcessingType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InputVelocityForRunUpProcessingType')
    ...
    @property
    def run_up_driving_mode(self) -> '_5456.RunUpDrivingMode':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.RunUpDrivingMode')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.mbd_analyses._5456', 'RunUpDrivingMode')(value) if value is not None else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5456.RunUpDrivingMode'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.RunUpDrivingMode')
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5461.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ShapeOfInitialAccelerationPeriodForRunUp')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.mbd_analyses._5461', 'ShapeOfInitialAccelerationPeriodForRunUp')(value) if value is not None else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5461.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ShapeOfInitialAccelerationPeriodForRunUp')
