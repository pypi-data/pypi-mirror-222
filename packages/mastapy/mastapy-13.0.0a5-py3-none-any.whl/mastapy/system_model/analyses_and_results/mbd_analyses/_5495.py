...
class ZerolBevelGearSetMultibodyDynamicsAnalysis(_5370.BevelGearSetMultibodyDynamicsAnalysis):
    """ZerolBevelGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5494.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5494.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5493.ZerolBevelGearMeshMultibodyDynamicsAnalysis]':
