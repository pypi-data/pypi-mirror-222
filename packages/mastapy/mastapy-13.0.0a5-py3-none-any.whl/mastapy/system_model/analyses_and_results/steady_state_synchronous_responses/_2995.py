...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2996, _2994
...
class ConceptGearSetSteadyStateSynchronousResponse(_3025.GearSetSteadyStateSynchronousResponse):
    """ConceptGearSetSteadyStateSynchronousResponse
    ...
    @property
    def concept_gears_steady_state_synchronous_response(self) -> 'List[_2996.ConceptGearSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response(self) -> 'List[_2994.ConceptGearMeshSteadyStateSynchronousResponse]':
