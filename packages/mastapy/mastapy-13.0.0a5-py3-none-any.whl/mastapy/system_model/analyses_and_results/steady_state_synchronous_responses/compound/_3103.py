...
class AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponse(_3131.ConicalGearMeshCompoundSteadyStateSynchronousResponse):
    """AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2969.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2969.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponse]':
