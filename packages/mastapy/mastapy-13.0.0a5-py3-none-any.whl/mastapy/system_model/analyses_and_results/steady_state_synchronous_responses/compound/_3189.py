...
class RollingRingAssemblyCompoundSteadyStateSynchronousResponse(_3196.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """RollingRingAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3057.RollingRingAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3057.RollingRingAssemblySteadyStateSynchronousResponse]':
