...
class ConicalGearMeshCompoundSteadyStateSynchronousResponse(_3157.GearMeshCompoundSteadyStateSynchronousResponse):
    """ConicalGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2997.ConicalGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2997.ConicalGearMeshSteadyStateSynchronousResponse]':
