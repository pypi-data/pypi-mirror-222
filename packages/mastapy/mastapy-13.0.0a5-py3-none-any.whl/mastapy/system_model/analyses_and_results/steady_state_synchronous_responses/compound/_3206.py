...
class StraightBevelGearCompoundSteadyStateSynchronousResponse(_3114.BevelGearCompoundSteadyStateSynchronousResponse):
    """StraightBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3079.StraightBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3079.StraightBevelGearSteadyStateSynchronousResponse]':
