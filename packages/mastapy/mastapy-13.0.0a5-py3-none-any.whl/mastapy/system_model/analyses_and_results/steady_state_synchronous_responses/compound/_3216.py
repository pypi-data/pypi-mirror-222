...
class TorqueConverterConnectionCompoundSteadyStateSynchronousResponse(_3136.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """TorqueConverterConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3086.TorqueConverterConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3086.TorqueConverterConnectionSteadyStateSynchronousResponse]':
