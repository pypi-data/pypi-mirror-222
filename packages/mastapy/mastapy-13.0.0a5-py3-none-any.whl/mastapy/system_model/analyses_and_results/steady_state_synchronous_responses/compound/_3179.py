...
class PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse(_3136.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3046.PartToPartShearCouplingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3046.PartToPartShearCouplingConnectionSteadyStateSynchronousResponse]':
