...
class SpiralBevelGearCompoundSteadyStateSynchronousResponse(_3114.BevelGearCompoundSteadyStateSynchronousResponse):
    """SpiralBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3067.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3067.SpiralBevelGearSteadyStateSynchronousResponse]':
