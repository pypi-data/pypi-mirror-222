...
class ComponentCompoundSteadyStateSynchronousResponse(_3177.PartCompoundSteadyStateSynchronousResponse):
    """ComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2990.ComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2990.ComponentSteadyStateSynchronousResponse]':
