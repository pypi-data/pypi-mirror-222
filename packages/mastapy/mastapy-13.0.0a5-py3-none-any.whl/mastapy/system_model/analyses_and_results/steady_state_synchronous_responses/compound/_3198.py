...
class SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse(_3115.BevelGearMeshCompoundSteadyStateSynchronousResponse):
    """SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3065.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3065.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
