...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3014, _3012
...
class CylindricalGearSetSteadyStateSynchronousResponse(_3025.GearSetSteadyStateSynchronousResponse):
    """CylindricalGearSetSteadyStateSynchronousResponse
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response(self) -> 'List[_3014.CylindricalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response(self) -> 'List[_3012.CylindricalGearMeshSteadyStateSynchronousResponse]':
