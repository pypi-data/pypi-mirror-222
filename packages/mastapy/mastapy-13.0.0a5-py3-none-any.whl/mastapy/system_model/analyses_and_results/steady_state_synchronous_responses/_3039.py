...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3040, _3038
...
class KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponse(_3033.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3040.KlingelnbergCycloPalloidSpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3038.KlingelnbergCycloPalloidSpiralBevelGearMeshSteadyStateSynchronousResponse]':
