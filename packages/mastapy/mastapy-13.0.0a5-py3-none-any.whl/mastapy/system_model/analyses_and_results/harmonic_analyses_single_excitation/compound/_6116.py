...
class BearingCompoundHarmonicAnalysisOfSingleExcitation(_6144.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    """BearingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5986.BearingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5986.BearingHarmonicAnalysisOfSingleExcitation]':
