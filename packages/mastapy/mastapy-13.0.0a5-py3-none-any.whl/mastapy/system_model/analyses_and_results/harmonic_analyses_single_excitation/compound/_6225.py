...
class TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation(_6145.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    """TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6097.TorqueConverterHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6097.TorqueConverterHarmonicAnalysisOfSingleExcitation]':
