...
class FEPartCompoundHarmonicAnalysisOfSingleExcitation(_6110.AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation):
    """FEPartCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6034.FEPartHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6034.FEPartHarmonicAnalysisOfSingleExcitation]':
