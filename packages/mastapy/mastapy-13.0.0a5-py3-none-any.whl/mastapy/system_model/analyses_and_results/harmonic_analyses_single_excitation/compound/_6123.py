...
class BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation(_6119.BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5993.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5993.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
