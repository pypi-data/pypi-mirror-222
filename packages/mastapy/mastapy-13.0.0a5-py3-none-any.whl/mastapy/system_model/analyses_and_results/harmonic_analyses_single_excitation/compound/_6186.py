...
class OilSealCompoundHarmonicAnalysisOfSingleExcitation(_6144.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    """OilSealCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6057.OilSealHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6057.OilSealHarmonicAnalysisOfSingleExcitation]':
