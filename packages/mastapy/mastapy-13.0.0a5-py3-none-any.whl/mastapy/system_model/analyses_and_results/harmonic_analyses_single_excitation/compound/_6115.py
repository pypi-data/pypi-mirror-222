...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import (
        _6116, _6118, _6121, _6128,
        _6127, _6149, _6129, _6134,
        _6139, _6151, _6153, _6157,
        _6164, _6163, _6165, _6172,
        _6179, _6182, _6183, _6184,
        _6186, _6188, _6193, _6194,
        _6195, _6197, _6199, _6204,
        _6203, _6209, _6210, _6215,
        _6218, _6221, _6225, _6229,
        _6233, _6236
    )
...
class AssemblyCompoundHarmonicAnalysisOfSingleExcitation(_6108.AbstractAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """AssemblyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5985.AssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bearings(self) -> 'List[_6116.BearingCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def belt_drives(self) -> 'List[_6118.BeltDriveCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6121.BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6128.BoltedJointCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bolts(self) -> 'List[_6127.BoltCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cv_ts(self) -> 'List[_6149.CVTCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def clutches(self) -> 'List[_6129.ClutchCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6134.ConceptCouplingCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6139.ConceptGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6151.CycloidalAssemblyCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6153.CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6157.CylindricalGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def fe_parts(self) -> 'List[_6164.FEPartCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6163.FaceGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6165.FlexiblePinAssemblyCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6172.HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6179.KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6182.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def mass_discs(self) -> 'List[_6183.MassDiscCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def measurement_components(self) -> 'List[_6184.MeasurementComponentCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def oil_seals(self) -> 'List[_6186.OilSealCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6188.PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6193.PlanetCarrierCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def point_loads(self) -> 'List[_6194.PointLoadCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def power_loads(self) -> 'List[_6195.PowerLoadCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def ring_pins(self) -> 'List[_6197.RingPinsCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6199.RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6204.ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def shafts(self) -> 'List[_6203.ShaftCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6209.SpiralBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6210.SpringDamperCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6215.StraightBevelDiffGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6218.StraightBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def synchronisers(self) -> 'List[_6221.SynchroniserCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def torque_converters(self) -> 'List[_6225.TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6229.UnbalancedMassCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6233.WormGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6236.ZerolBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5985.AssemblyHarmonicAnalysisOfSingleExcitation]':
