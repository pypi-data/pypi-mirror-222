...
class BoltCompoundHarmonicAnalysisOfSingleExcitation(_6133.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """BoltCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5998.BoltHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5998.BoltHarmonicAnalysisOfSingleExcitation]':
