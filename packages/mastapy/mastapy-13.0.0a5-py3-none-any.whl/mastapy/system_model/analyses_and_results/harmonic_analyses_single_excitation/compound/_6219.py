...
class StraightBevelPlanetGearCompoundHarmonicAnalysisOfSingleExcitation(_6213.StraightBevelDiffGearCompoundHarmonicAnalysisOfSingleExcitation):
    """StraightBevelPlanetGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6090.StraightBevelPlanetGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6090.StraightBevelPlanetGearHarmonicAnalysisOfSingleExcitation]':
