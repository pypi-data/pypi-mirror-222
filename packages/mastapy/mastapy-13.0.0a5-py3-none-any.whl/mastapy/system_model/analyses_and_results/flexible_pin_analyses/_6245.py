...
class WindTurbineCertificationReport(_6237.CombinationAnalysis):
    """WindTurbineCertificationReport
    ...
    def ldd(self) -> 'list_with_selected_item.ListWithSelectedItem_DutyCycle':
        ...
        return constructor.new_from_mastapy('mastapy._internal.implicit.list_with_selected_item', 'ListWithSelectedItem_DutyCycle')(temp) if temp is not None else None
    ...
    @property
    def design(self) -> '_2457.RootAssembly':
    ...
    @property
    def extreme_load_case_static_analysis(self) -> '_2782.RootAssemblySystemDeflection':
    ...
    @property
    def ldd_static_analysis(self) -> '_2928.RootAssemblyCompoundSystemDeflection':
    ...
    @property
    def nominal_load_case_static_analysis(self) -> '_2782.RootAssemblySystemDeflection':
