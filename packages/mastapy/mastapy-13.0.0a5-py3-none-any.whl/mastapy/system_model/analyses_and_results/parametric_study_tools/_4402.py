...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.parametric_study_tools import _4401, _4400
...
class StraightBevelGearSetParametricStudyTool(_4292.BevelGearSetParametricStudyTool):
    """StraightBevelGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_gears_parametric_study_tool(self) -> 'List[_4401.StraightBevelGearParametricStudyTool]':
    ...
    @property
    def straight_bevel_meshes_parametric_study_tool(self) -> 'List[_4400.StraightBevelGearMeshParametricStudyTool]':
