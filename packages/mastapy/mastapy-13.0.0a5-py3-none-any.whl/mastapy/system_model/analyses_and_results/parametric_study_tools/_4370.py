...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.parametric_study_tools import _4361, _4358, _4326
...
class ParametricStudyVariable(_2630.AnalysisCaseVariable):
    """ParametricStudyVariable
    ...
    class _Cast_ParametricStudyVariable:
        ...
        def analysis_case_variable(self):
            return self._parent._cast(_2630.AnalysisCaseVariable)
    ...
    @property
    def dimension(self) -> '_4361.ParametricStudyDimension':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.ParametricStudyDimension')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.parametric_study_tools._4361', 'ParametricStudyDimension')(value) if value is not None else None

    @dimension.setter
    def dimension(self, value: '_4361.ParametricStudyDimension'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.ParametricStudyDimension')
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4358.MonteCarloDistribution':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.MonteCarloDistribution')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.parametric_study_tools._4358', 'MonteCarloDistribution')(value) if value is not None else None

    @distribution.setter
    def distribution(self, value: '_4358.MonteCarloDistribution'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.MonteCarloDistribution')
    ...
    @property
    def doe_variable_setter(self) -> '_4326.DesignOfExperimentsVariableSetter':
