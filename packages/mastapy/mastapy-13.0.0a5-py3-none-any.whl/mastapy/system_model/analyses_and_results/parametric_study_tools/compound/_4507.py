...
class PointLoadCompoundParametricStudyTool(_4543.VirtualComponentCompoundParametricStudyTool):
    """PointLoadCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4378.PointLoadParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4378.PointLoadParametricStudyTool]':
