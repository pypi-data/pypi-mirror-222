...
class DatumCompoundParametricStudyTool(_4446.ComponentCompoundParametricStudyTool):
    """DatumCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4325.DatumParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4325.DatumParametricStudyTool]':
