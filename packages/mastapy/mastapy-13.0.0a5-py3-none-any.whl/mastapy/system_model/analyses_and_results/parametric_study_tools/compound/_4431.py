...
class BeltDriveCompoundParametricStudyTool(_4519.SpecialisedAssemblyCompoundParametricStudyTool):
    """BeltDriveCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4284.BeltDriveParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4284.BeltDriveParametricStudyTool]':
