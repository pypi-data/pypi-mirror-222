...
class SpringDamperHalfCompoundParametricStudyTool(_4460.CouplingHalfCompoundParametricStudyTool):
    """SpringDamperHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4395.SpringDamperHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4395.SpringDamperHalfParametricStudyTool]':
