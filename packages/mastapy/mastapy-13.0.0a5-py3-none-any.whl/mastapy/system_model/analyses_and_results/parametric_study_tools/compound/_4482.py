...
class GuideDxfModelCompoundParametricStudyTool(_4446.ComponentCompoundParametricStudyTool):
    """GuideDxfModelCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4342.GuideDxfModelParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4342.GuideDxfModelParametricStudyTool]':
