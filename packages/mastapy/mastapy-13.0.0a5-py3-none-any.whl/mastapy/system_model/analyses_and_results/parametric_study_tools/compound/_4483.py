...
class HypoidGearCompoundParametricStudyTool(_4425.AGMAGleasonConicalGearCompoundParametricStudyTool):
    """HypoidGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4344.HypoidGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4344.HypoidGearParametricStudyTool]':
