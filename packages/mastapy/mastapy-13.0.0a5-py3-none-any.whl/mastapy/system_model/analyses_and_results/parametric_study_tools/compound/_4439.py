...
class BevelGearSetCompoundParametricStudyTool(_4427.AGMAGleasonConicalGearSetCompoundParametricStudyTool):
    """BevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4292.BevelGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4292.BevelGearSetParametricStudyTool]':
