...
class ConceptCouplingCompoundParametricStudyTool(_4458.CouplingCompoundParametricStudyTool):
    """ConceptCouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4302.ConceptCouplingParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4302.ConceptCouplingParametricStudyTool]':
