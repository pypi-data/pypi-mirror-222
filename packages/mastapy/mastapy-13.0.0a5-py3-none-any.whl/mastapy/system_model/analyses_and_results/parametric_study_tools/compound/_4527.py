...
class StraightBevelDiffGearMeshCompoundParametricStudyTool(_4438.BevelGearMeshCompoundParametricStudyTool):
    """StraightBevelDiffGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4397.StraightBevelDiffGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4397.StraightBevelDiffGearMeshParametricStudyTool]':
