...
class StraightBevelGearCompoundParametricStudyTool(_4437.BevelGearCompoundParametricStudyTool):
    """StraightBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4401.StraightBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4401.StraightBevelGearParametricStudyTool]':
