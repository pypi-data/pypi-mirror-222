...
class ShaftHubConnectionCompoundParametricStudyTool(_4457.ConnectorCompoundParametricStudyTool):
    """ShaftHubConnectionCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4387.ShaftHubConnectionParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4387.ShaftHubConnectionParametricStudyTool]':
