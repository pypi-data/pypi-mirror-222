...
class PlanetCarrierCompoundParametricStudyTool(_4498.MountableComponentCompoundParametricStudyTool):
    """PlanetCarrierCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4377.PlanetCarrierParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4377.PlanetCarrierParametricStudyTool]':
