...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.parametric_study_tools import _4328, _4281
    from mastapy.system_model.part_model import _2416
    from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import (
        _4429, _4431, _4434, _4441,
        _4440, _4462, _4442, _4447,
        _4452, _4464, _4466, _4470,
        _4477, _4476, _4478, _4485,
        _4492, _4495, _4496, _4497,
        _4499, _4501, _4506, _4507,
        _4508, _4510, _4512, _4517,
        _4516, _4522, _4523, _4528,
        _4531, _4534, _4538, _4542,
        _4546, _4549
    )
...
class AssemblyCompoundParametricStudyTool(_4421.AbstractAssemblyCompoundParametricStudyTool):
    """AssemblyCompoundParametricStudyTool
    ...
    @property
    def all_duty_cycle_results(self) -> '_4328.DutyCycleResultsForAllComponents':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4281.AssemblyParametricStudyTool]':
    ...
    @property
    def bearings(self) -> 'List[_4429.BearingCompoundParametricStudyTool]':
    ...
    @property
    def belt_drives(self) -> 'List[_4431.BeltDriveCompoundParametricStudyTool]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4434.BevelDifferentialGearSetCompoundParametricStudyTool]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4441.BoltedJointCompoundParametricStudyTool]':
    ...
    @property
    def bolts(self) -> 'List[_4440.BoltCompoundParametricStudyTool]':
    ...
    @property
    def cv_ts(self) -> 'List[_4462.CVTCompoundParametricStudyTool]':
    ...
    @property
    def clutches(self) -> 'List[_4442.ClutchCompoundParametricStudyTool]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4447.ConceptCouplingCompoundParametricStudyTool]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4452.ConceptGearSetCompoundParametricStudyTool]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4464.CycloidalAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4466.CycloidalDiscCompoundParametricStudyTool]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4470.CylindricalGearSetCompoundParametricStudyTool]':
    ...
    @property
    def fe_parts(self) -> 'List[_4477.FEPartCompoundParametricStudyTool]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4476.FaceGearSetCompoundParametricStudyTool]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4478.FlexiblePinAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4485.HypoidGearSetCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4492.KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4495.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def mass_discs(self) -> 'List[_4496.MassDiscCompoundParametricStudyTool]':
    ...
    @property
    def measurement_components(self) -> 'List[_4497.MeasurementComponentCompoundParametricStudyTool]':
    ...
    @property
    def oil_seals(self) -> 'List[_4499.OilSealCompoundParametricStudyTool]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4501.PartToPartShearCouplingCompoundParametricStudyTool]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4506.PlanetCarrierCompoundParametricStudyTool]':
    ...
    @property
    def point_loads(self) -> 'List[_4507.PointLoadCompoundParametricStudyTool]':
    ...
    @property
    def power_loads(self) -> 'List[_4508.PowerLoadCompoundParametricStudyTool]':
    ...
    @property
    def ring_pins(self) -> 'List[_4510.RingPinsCompoundParametricStudyTool]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4512.RollingRingAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4517.ShaftHubConnectionCompoundParametricStudyTool]':
    ...
    @property
    def shafts(self) -> 'List[_4516.ShaftCompoundParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4522.SpiralBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4523.SpringDamperCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4528.StraightBevelDiffGearSetCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4531.StraightBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def synchronisers(self) -> 'List[_4534.SynchroniserCompoundParametricStudyTool]':
    ...
    @property
    def torque_converters(self) -> 'List[_4538.TorqueConverterCompoundParametricStudyTool]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4542.UnbalancedMassCompoundParametricStudyTool]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4546.WormGearSetCompoundParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4549.ZerolBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4281.AssemblyParametricStudyTool]':
