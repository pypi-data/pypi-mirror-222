...
class ConnectorCompoundParametricStudyTool(_4498.MountableComponentCompoundParametricStudyTool):
    """ConnectorCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4310.ConnectorParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4310.ConnectorParametricStudyTool]':
