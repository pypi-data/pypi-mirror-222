...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.parametric_study_tools import _4344, _4343
...
class HypoidGearSetParametricStudyTool(_4280.AGMAGleasonConicalGearSetParametricStudyTool):
    """HypoidGearSetParametricStudyTool
    ...
    @property
    def hypoid_gears_parametric_study_tool(self) -> 'List[_4344.HypoidGearParametricStudyTool]':
    ...
    @property
    def hypoid_meshes_parametric_study_tool(self) -> 'List[_4343.HypoidGearMeshParametricStudyTool]':
