...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.static_loads import _6785, _6895
    from mastapy.system_model import _2196, _2190
    from mastapy.system_model.analyses_and_results.parametric_study_tools import _4369, _4370
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6895.ParametricStudyType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.StaticLoads.ParametricStudyType')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.static_loads._6895', 'ParametricStudyType')(value) if value is not None else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6895.ParametricStudyType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.StaticLoads.ParametricStudyType')
    ...
    @property
    def external_full_fe_loader(self) -> '_2196.ExternalFullFELoader':
    ...
    @property
    def step_results(self) -> 'List[_4369.ParametricStudyToolStepResult]':
    ...
    @property
    def study_variables(self) -> 'List[_4370.ParametricStudyVariable]':
    ...
    @property
    def parametric_study_logging_variables(self) -> 'List[_2630.AnalysisCaseVariable]':
    ...
    def add_logging_variable(self, design_entity: '_2190.DesignEntity', path: 'List[str]') -> '_2630.AnalysisCaseVariable':
    ...
    def add_study_variable(self, design_entity: '_2190.DesignEntity', path: 'List[str]') -> '_4370.ParametricStudyVariable':
    ...
    def data_logger_for(self, design_entity: '_2190.DesignEntity') -> '_1566.DataLogger':
    ...
    def move_study_variable_down(self, study_variable: '_4370.ParametricStudyVariable'):
    ...
    def move_study_variable_up(self, study_variable: '_4370.ParametricStudyVariable'):
    ...
    def remove_logging_variable(self, analysis_variable: '_2630.AnalysisCaseVariable'):
    ...
    def remove_study_variable(self, study_variable: '_4370.ParametricStudyVariable'):
