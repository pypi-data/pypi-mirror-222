...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.parametric_study_tools import (
        _4328, _4282, _4284, _4287,
        _4293, _4294, _4315, _4297,
        _4302, _4305, _4317, _4319,
        _4323, _4337, _4336, _4338,
        _4345, _4352, _4355, _4356,
        _4357, _4360, _4374, _4377,
        _4378, _4379, _4381, _4383,
        _4387, _4388, _4393, _4396,
        _4399, _4402, _4406, _4410,
        _4413, _4417, _4420
    )
...
class AssemblyParametricStudyTool(_4274.AbstractAssemblyParametricStudyTool):
    """AssemblyParametricStudyTool
    ...
    @property
    def all_duty_cycle_results(self) -> 'List[_4328.DutyCycleResultsForAllComponents]':
    ...
    @property
    def bearings(self) -> 'List[_4282.BearingParametricStudyTool]':
    ...
    @property
    def belt_drives(self) -> 'List[_4284.BeltDriveParametricStudyTool]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4287.BevelDifferentialGearSetParametricStudyTool]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4293.BoltedJointParametricStudyTool]':
    ...
    @property
    def bolts(self) -> 'List[_4294.BoltParametricStudyTool]':
    ...
    @property
    def cv_ts(self) -> 'List[_4315.CVTParametricStudyTool]':
    ...
    @property
    def clutches(self) -> 'List[_4297.ClutchParametricStudyTool]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4302.ConceptCouplingParametricStudyTool]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4305.ConceptGearSetParametricStudyTool]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4317.CycloidalAssemblyParametricStudyTool]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4319.CycloidalDiscParametricStudyTool]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4323.CylindricalGearSetParametricStudyTool]':
    ...
    @property
    def fe_parts(self) -> 'List[_4337.FEPartParametricStudyTool]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4336.FaceGearSetParametricStudyTool]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4338.FlexiblePinAssemblyParametricStudyTool]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4345.HypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4352.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4355.KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def mass_discs(self) -> 'List[_4356.MassDiscParametricStudyTool]':
    ...
    @property
    def measurement_components(self) -> 'List[_4357.MeasurementComponentParametricStudyTool]':
    ...
    @property
    def oil_seals(self) -> 'List[_4360.OilSealParametricStudyTool]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4374.PartToPartShearCouplingParametricStudyTool]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4377.PlanetCarrierParametricStudyTool]':
    ...
    @property
    def point_loads(self) -> 'List[_4378.PointLoadParametricStudyTool]':
    ...
    @property
    def power_loads(self) -> 'List[_4379.PowerLoadParametricStudyTool]':
    ...
    @property
    def ring_pins(self) -> 'List[_4381.RingPinsParametricStudyTool]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4383.RollingRingAssemblyParametricStudyTool]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4387.ShaftHubConnectionParametricStudyTool]':
    ...
    @property
    def shafts(self) -> 'List[_4388.ShaftParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4393.SpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4396.SpringDamperParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4399.StraightBevelDiffGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4402.StraightBevelGearSetParametricStudyTool]':
    ...
    @property
    def synchronisers(self) -> 'List[_4406.SynchroniserParametricStudyTool]':
    ...
    @property
    def torque_converters(self) -> 'List[_4410.TorqueConverterParametricStudyTool]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4413.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4417.WormGearSetParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4420.ZerolBevelGearSetParametricStudyTool]':
