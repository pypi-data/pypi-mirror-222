...
class PartToPartShearCouplingAdvancedSystemDeflection(_7277.CouplingAdvancedSystemDeflection):
    """PartToPartShearCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2770.PartToPartShearCouplingSystemDeflection]':
