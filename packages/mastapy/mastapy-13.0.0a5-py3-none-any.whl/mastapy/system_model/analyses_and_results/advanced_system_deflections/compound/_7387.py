...
class BevelDifferentialSunGearCompoundAdvancedSystemDeflection(_7383.BevelDifferentialGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialSunGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7254.BevelDifferentialSunGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7254.BevelDifferentialSunGearAdvancedSystemDeflection]':
