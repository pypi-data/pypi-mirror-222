...
class StraightBevelDiffGearCompoundAdvancedSystemDeflection(_7388.BevelGearCompoundAdvancedSystemDeflection):
    """StraightBevelDiffGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7347.StraightBevelDiffGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7347.StraightBevelDiffGearAdvancedSystemDeflection]':
