...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7480, _7481
...
class StraightBevelGearSetCompoundAdvancedSystemDeflection(_7390.BevelGearSetCompoundAdvancedSystemDeflection):
    """StraightBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7352.StraightBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7480.StraightBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7481.StraightBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7352.StraightBevelGearSetAdvancedSystemDeflection]':
