...
class ConicalGearMeshCompoundAdvancedSystemDeflection(_7431.GearMeshCompoundAdvancedSystemDeflection):
    """ConicalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7272.ConicalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7272.ConicalGearMeshAdvancedSystemDeflection]':
