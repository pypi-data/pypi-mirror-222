...
class DatumCompoundAdvancedSystemDeflection(_7397.ComponentCompoundAdvancedSystemDeflection):
    """DatumCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7292.DatumAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7292.DatumAdvancedSystemDeflection]':
