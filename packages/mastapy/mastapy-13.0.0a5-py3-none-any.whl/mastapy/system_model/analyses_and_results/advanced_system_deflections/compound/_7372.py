...
class AbstractAssemblyCompoundAdvancedSystemDeflection(_7451.PartCompoundAdvancedSystemDeflection):
    """AbstractAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7236.AbstractAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7236.AbstractAssemblyAdvancedSystemDeflection]':
