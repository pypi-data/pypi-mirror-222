...
class HypoidGearMeshCompoundAdvancedSystemDeflection(_7377.AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection):
    """HypoidGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7304.HypoidGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7304.HypoidGearMeshAdvancedSystemDeflection]':
