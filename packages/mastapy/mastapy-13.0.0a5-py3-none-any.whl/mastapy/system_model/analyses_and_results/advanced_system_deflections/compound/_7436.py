...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7434, _7435
...
class HypoidGearSetCompoundAdvancedSystemDeflection(_7378.AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection):
    """HypoidGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7305.HypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_gears_compound_advanced_system_deflection(self) -> 'List[_7434.HypoidGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_meshes_compound_advanced_system_deflection(self) -> 'List[_7435.HypoidGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7305.HypoidGearSetAdvancedSystemDeflection]':
