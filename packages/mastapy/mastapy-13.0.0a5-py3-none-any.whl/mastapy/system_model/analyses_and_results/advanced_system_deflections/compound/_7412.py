...
class CVTBeltConnectionCompoundAdvancedSystemDeflection(_7381.BeltConnectionCompoundAdvancedSystemDeflection):
    """CVTBeltConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7281.CVTBeltConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7281.CVTBeltConnectionAdvancedSystemDeflection]':
