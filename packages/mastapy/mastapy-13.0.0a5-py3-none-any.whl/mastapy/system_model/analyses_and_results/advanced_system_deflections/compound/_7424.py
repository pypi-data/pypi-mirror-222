...
class ExternalCADModelCompoundAdvancedSystemDeflection(_7397.ComponentCompoundAdvancedSystemDeflection):
    """ExternalCADModelCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7293.ExternalCADModelAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7293.ExternalCADModelAdvancedSystemDeflection]':
