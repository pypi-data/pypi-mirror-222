...
class PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection(_7411.CouplingHalfCompoundAdvancedSystemDeflection):
    """PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7324.PartToPartShearCouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7324.PartToPartShearCouplingHalfAdvancedSystemDeflection]':
