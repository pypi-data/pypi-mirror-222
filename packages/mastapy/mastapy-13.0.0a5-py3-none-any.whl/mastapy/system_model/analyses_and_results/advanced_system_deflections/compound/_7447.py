...
class MassDiscCompoundAdvancedSystemDeflection(_7494.VirtualComponentCompoundAdvancedSystemDeflection):
    """MassDiscCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7317.MassDiscAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7317.MassDiscAdvancedSystemDeflection]':
