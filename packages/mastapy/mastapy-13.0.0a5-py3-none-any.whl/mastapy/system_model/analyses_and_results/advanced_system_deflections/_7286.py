...
class CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection(_7239.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection):
    """CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2719.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
