...
class SpiralBevelGearAdvancedSystemDeflection(_7255.BevelGearAdvancedSystemDeflection):
    """SpiralBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_401.SpiralBevelGearRating':
    ...
    @property
    def component_load_case(self) -> '_6921.SpiralBevelGearLoadCase':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2791.SpiralBevelGearSystemDeflection]':
