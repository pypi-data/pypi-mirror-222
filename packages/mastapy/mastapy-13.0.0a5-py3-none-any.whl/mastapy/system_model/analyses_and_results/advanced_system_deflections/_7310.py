...
class KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection(_7307.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2755.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
