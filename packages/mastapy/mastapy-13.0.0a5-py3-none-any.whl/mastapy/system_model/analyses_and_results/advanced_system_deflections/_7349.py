...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7347, _7348
...
class StraightBevelDiffGearSetAdvancedSystemDeflection(_7257.BevelGearSetAdvancedSystemDeflection):
    """StraightBevelDiffGearSetAdvancedSystemDeflection
    ...
    @property
    def straight_bevel_diff_gears_advanced_system_deflection(self) -> 'List[_7347.StraightBevelDiffGearAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_meshes_advanced_system_deflection(self) -> 'List[_7348.StraightBevelDiffGearMeshAdvancedSystemDeflection]':
