...
class SpringDamperConnectionAdvancedSystemDeflection(_7278.CouplingConnectionAdvancedSystemDeflection):
    """SpringDamperConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2792.SpringDamperConnectionSystemDeflection]':
