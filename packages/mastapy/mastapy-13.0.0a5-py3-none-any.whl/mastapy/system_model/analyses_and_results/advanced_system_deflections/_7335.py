...
class RollingRingConnectionAdvancedSystemDeflection(_7306.InterMountableComponentConnectionAdvancedSystemDeflection):
    """RollingRingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2780.RollingRingConnectionSystemDeflection]':
