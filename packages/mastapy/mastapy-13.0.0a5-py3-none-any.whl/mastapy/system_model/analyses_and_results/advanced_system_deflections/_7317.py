...
class MassDiscAdvancedSystemDeflection(_7365.VirtualComponentAdvancedSystemDeflection):
    """MassDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2761.MassDiscSystemDeflection]':
