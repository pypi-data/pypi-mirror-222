...
class TorqueConverterAdvancedSystemDeflection(_7277.CouplingAdvancedSystemDeflection):
    """TorqueConverterAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2812.TorqueConverterSystemDeflection]':
