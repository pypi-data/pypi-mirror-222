...
class StraightBevelDiffGearAdvancedSystemDeflection(_7255.BevelGearAdvancedSystemDeflection):
    """StraightBevelDiffGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2797.StraightBevelDiffGearSystemDeflection]':
