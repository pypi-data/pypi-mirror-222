...
class FaceGearAdvancedSystemDeflection(_7299.GearAdvancedSystemDeflection):
    """FaceGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_446.FaceGearRating':
    ...
    @property
    def component_load_case(self) -> '_6852.FaceGearLoadCase':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2738.FaceGearSystemDeflection]':
