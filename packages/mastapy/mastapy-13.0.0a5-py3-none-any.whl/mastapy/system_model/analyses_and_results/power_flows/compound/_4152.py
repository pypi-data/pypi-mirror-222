...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows.compound import (
        _4153, _4155, _4158, _4165,
        _4164, _4186, _4166, _4171,
        _4176, _4188, _4190, _4194,
        _4201, _4200, _4202, _4209,
        _4216, _4219, _4220, _4221,
        _4223, _4225, _4230, _4231,
        _4232, _4234, _4236, _4241,
        _4240, _4246, _4247, _4252,
        _4255, _4258, _4262, _4266,
        _4270, _4273
    )
...
class AssemblyCompoundPowerFlow(_4145.AbstractAssemblyCompoundPowerFlow):
    """AssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4019.AssemblyPowerFlow]':
    ...
    @property
    def bearings(self) -> 'List[_4153.BearingCompoundPowerFlow]':
    ...
    @property
    def belt_drives(self) -> 'List[_4155.BeltDriveCompoundPowerFlow]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4158.BevelDifferentialGearSetCompoundPowerFlow]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4165.BoltedJointCompoundPowerFlow]':
    ...
    @property
    def bolts(self) -> 'List[_4164.BoltCompoundPowerFlow]':
    ...
    @property
    def cv_ts(self) -> 'List[_4186.CVTCompoundPowerFlow]':
    ...
    @property
    def clutches(self) -> 'List[_4166.ClutchCompoundPowerFlow]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4171.ConceptCouplingCompoundPowerFlow]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4176.ConceptGearSetCompoundPowerFlow]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4188.CycloidalAssemblyCompoundPowerFlow]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4190.CycloidalDiscCompoundPowerFlow]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4194.CylindricalGearSetCompoundPowerFlow]':
    ...
    @property
    def fe_parts(self) -> 'List[_4201.FEPartCompoundPowerFlow]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4200.FaceGearSetCompoundPowerFlow]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4202.FlexiblePinAssemblyCompoundPowerFlow]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4209.HypoidGearSetCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4216.KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4219.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def mass_discs(self) -> 'List[_4220.MassDiscCompoundPowerFlow]':
    ...
    @property
    def measurement_components(self) -> 'List[_4221.MeasurementComponentCompoundPowerFlow]':
    ...
    @property
    def oil_seals(self) -> 'List[_4223.OilSealCompoundPowerFlow]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4225.PartToPartShearCouplingCompoundPowerFlow]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4230.PlanetCarrierCompoundPowerFlow]':
    ...
    @property
    def point_loads(self) -> 'List[_4231.PointLoadCompoundPowerFlow]':
    ...
    @property
    def power_loads(self) -> 'List[_4232.PowerLoadCompoundPowerFlow]':
    ...
    @property
    def ring_pins(self) -> 'List[_4234.RingPinsCompoundPowerFlow]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4236.RollingRingAssemblyCompoundPowerFlow]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4241.ShaftHubConnectionCompoundPowerFlow]':
    ...
    @property
    def shafts(self) -> 'List[_4240.ShaftCompoundPowerFlow]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4246.SpiralBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4247.SpringDamperCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4252.StraightBevelDiffGearSetCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4255.StraightBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def synchronisers(self) -> 'List[_4258.SynchroniserCompoundPowerFlow]':
    ...
    @property
    def torque_converters(self) -> 'List[_4262.TorqueConverterCompoundPowerFlow]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4266.UnbalancedMassCompoundPowerFlow]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4270.WormGearSetCompoundPowerFlow]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4273.ZerolBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4019.AssemblyPowerFlow]':
