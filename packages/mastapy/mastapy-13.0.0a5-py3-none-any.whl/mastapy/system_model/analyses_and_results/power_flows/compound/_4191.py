...
class CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow(_4148.AbstractShaftToMountableComponentConnectionCompoundPowerFlow):
    """CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4057.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4057.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
