...
class BevelDifferentialPlanetGearCompoundPowerFlow(_4156.BevelDifferentialGearCompoundPowerFlow):
    """BevelDifferentialPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4026.BevelDifferentialPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4026.BevelDifferentialPlanetGearPowerFlow]':
