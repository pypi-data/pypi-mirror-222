...
class ExternalCADModelCompoundPowerFlow(_4170.ComponentCompoundPowerFlow):
    """ExternalCADModelCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4065.ExternalCADModelPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4065.ExternalCADModelPowerFlow]':
