...
class RingPinsCompoundPowerFlow(_4222.MountableComponentCompoundPowerFlow):
    """RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4104.RingPinsPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4104.RingPinsPowerFlow]':
