...
class PointLoadCompoundPowerFlow(_4267.VirtualComponentCompoundPowerFlow):
    """PointLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4099.PointLoadPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4099.PointLoadPowerFlow]':
