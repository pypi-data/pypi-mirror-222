...
class CycloidalDiscCentralBearingConnectionCompoundPowerFlow(_4169.CoaxialConnectionCompoundPowerFlow):
    """CycloidalDiscCentralBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4056.CycloidalDiscCentralBearingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4056.CycloidalDiscCentralBearingConnectionPowerFlow]':
