...
class SynchroniserPartCompoundPowerFlow(_4184.CouplingHalfCompoundPowerFlow):
    """SynchroniserPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4129.SynchroniserPartPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4129.SynchroniserPartPowerFlow]':
