...
class RingPinsToDiscConnectionCompoundPowerFlow(_4210.InterMountableComponentConnectionCompoundPowerFlow):
    """RingPinsToDiscConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4105.RingPinsToDiscConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4105.RingPinsToDiscConnectionPowerFlow]':
