...
class PowerLoadCompoundPowerFlow(_4267.VirtualComponentCompoundPowerFlow):
    """PowerLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4102.PowerLoadPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4102.PowerLoadPowerFlow]':
