...
class ConceptGearMeshCompoundPowerFlow(_4204.GearMeshCompoundPowerFlow):
    """ConceptGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4041.ConceptGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4041.ConceptGearMeshPowerFlow]':
