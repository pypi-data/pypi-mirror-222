...
class ShaftCompoundPowerFlow(_4146.AbstractShaftCompoundPowerFlow):
    """ShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4111.ShaftPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4111.ShaftPowerFlow]':
