...
class OilSealCompoundPowerFlow(_4181.ConnectorCompoundPowerFlow):
    """OilSealCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4091.OilSealPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4091.OilSealPowerFlow]':
