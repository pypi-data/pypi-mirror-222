...
class StraightBevelGearMeshCompoundPowerFlow(_4162.BevelGearMeshCompoundPowerFlow):
    """StraightBevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4123.StraightBevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4123.StraightBevelGearMeshPowerFlow]':
