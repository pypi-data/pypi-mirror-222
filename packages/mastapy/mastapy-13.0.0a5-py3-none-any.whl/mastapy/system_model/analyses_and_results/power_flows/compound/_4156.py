...
class BevelDifferentialGearCompoundPowerFlow(_4161.BevelGearCompoundPowerFlow):
    """BevelDifferentialGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4024.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4024.BevelDifferentialGearPowerFlow]':
