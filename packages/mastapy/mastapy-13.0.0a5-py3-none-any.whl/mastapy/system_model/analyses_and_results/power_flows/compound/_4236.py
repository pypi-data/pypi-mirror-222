...
class RollingRingAssemblyCompoundPowerFlow(_4243.SpecialisedAssemblyCompoundPowerFlow):
    """RollingRingAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4106.RollingRingAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4106.RollingRingAssemblyPowerFlow]':
