...
class WormGearSetPowerFlow(_4073.GearSetPowerFlow):
    """WormGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4140.WormGearPowerFlow]':
    ...
    @property
    def worm_gears_power_flow(self) -> 'List[_4140.WormGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4139.WormGearMeshPowerFlow]':
    ...
    @property
    def worm_meshes_power_flow(self) -> 'List[_4139.WormGearMeshPowerFlow]':
