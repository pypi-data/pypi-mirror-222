...
class CVTPulleySystemDeflection(_2775.PulleySystemDeflection):
    """CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4054.CVTPulleyPowerFlow':
    ...
    @property
    def fixed_sheave_contact_results(self) -> 'List[_1553.NodeResults]':
    ...
    @property
    def moving_sheave_contact_results(self) -> 'List[_1553.NodeResults]':
