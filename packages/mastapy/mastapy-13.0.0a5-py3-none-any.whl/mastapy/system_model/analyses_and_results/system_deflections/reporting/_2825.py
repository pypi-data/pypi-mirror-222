...
class FlexibleGearChart(_0.APIBase):
    ...
    def planets(self) -> 'list_with_selected_item.ListWithSelectedItem_CylindricalGearSystemDeflection':
        ...
        return constructor.new_from_mastapy('mastapy._internal.implicit.list_with_selected_item', 'ListWithSelectedItem_CylindricalGearSystemDeflection')(temp) if temp is not None else None
    ...
    @property
    def chart(self) -> '_1844.LegacyChartMathChartDefinition':
