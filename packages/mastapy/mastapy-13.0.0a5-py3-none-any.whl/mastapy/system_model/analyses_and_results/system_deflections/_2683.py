...
class BevelDifferentialGearMeshSystemDeflection(_2688.BevelGearMeshSystemDeflection):
    """BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def rating(self) -> '_551.BevelGearMeshRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_551.BevelGearMeshRating':
    ...
    @property
    def power_flow_results(self) -> '_4023.BevelDifferentialGearMeshPowerFlow':
