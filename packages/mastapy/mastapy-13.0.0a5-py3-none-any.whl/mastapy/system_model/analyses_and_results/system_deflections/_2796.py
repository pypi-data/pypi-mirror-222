...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.system_deflections import _2797, _2795
...
class StraightBevelDiffGearSetSystemDeflection(_2689.BevelGearSetSystemDeflection):
    """StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4122.StraightBevelDiffGearSetPowerFlow':
    ...
    @property
    def straight_bevel_diff_gears_system_deflection(self) -> 'List[_2797.StraightBevelDiffGearSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2795.StraightBevelDiffGearMeshSystemDeflection]':
