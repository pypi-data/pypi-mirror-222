...
class AbstractAssemblySystemDeflection(_2767.PartSystemDeflection):
    """AbstractAssemblySystemDeflection
    ...
    @property
    def components_with_unknown_mass_properties(self) -> 'List[_2697.ComponentSystemDeflection]':
    ...
    @property
    def components_with_zero_mass_properties(self) -> 'List[_2697.ComponentSystemDeflection]':
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_2830.RigidlyConnectedComponentGroupSystemDeflection]':
    ...
    @property
    def power_flow_results(self) -> '_4012.AbstractAssemblyPowerFlow':
