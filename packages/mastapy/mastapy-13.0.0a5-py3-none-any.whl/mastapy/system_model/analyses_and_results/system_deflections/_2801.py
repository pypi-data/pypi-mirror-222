...
class StraightBevelPlanetGearSystemDeflection(_2797.StraightBevelDiffGearSystemDeflection):
    """StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4126.StraightBevelPlanetGearPowerFlow':
