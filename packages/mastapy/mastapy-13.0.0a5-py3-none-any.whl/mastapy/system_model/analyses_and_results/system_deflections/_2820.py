...
class WormGearSystemDeflection(_2743.GearSystemDeflection):
    """WormGearSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_372.WormGearRating':
    ...
    @property
    def power_flow_results(self) -> '_4140.WormGearPowerFlow':
