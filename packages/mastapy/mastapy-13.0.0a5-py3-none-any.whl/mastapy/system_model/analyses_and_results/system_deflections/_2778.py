...
class RingPinToDiscContactReporting(_0.APIBase):
    ...
    @property
    def contact(self) -> '_2832.SplineFlankContactReporting':
    ...
    @property
    def information_at_ring_pin_to_disc_contact_point_from_geometry(self) -> '_6877.InformationAtRingPinToDiscContactPointFromGeometry':
    ...
    @property
    def information_for_contact_points_along_face_width(self) -> 'List[_2748.InformationForContactAtPointAlongFaceWidth]':
