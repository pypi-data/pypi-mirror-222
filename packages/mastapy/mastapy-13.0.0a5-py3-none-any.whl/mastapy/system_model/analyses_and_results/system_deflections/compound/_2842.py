...
class BeltConnectionCompoundSystemDeflection(_2899.InterMountableComponentConnectionCompoundSystemDeflection):
    """BeltConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2681.BeltConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2681.BeltConnectionSystemDeflection]':
