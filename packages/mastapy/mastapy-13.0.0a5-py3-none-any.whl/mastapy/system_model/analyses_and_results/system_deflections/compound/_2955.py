...
class TorqueConverterTurbineCompoundSystemDeflection(_2872.CouplingHalfCompoundSystemDeflection):
    """TorqueConverterTurbineCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2813.TorqueConverterTurbineSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2813.TorqueConverterTurbineSystemDeflection]':
