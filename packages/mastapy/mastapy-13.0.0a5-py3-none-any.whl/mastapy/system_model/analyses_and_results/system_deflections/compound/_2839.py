...
class AGMAGleasonConicalGearSetCompoundSystemDeflection(_2867.ConicalGearSetCompoundSystemDeflection):
    """AGMAGleasonConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2672.AGMAGleasonConicalGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2672.AGMAGleasonConicalGearSetSystemDeflection]':
