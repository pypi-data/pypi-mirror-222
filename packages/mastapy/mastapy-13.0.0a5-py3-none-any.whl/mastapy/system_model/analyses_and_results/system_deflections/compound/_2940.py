...
class StraightBevelDiffGearCompoundSystemDeflection(_2849.BevelGearCompoundSystemDeflection):
    """StraightBevelDiffGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2797.StraightBevelDiffGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2797.StraightBevelDiffGearSystemDeflection]':
