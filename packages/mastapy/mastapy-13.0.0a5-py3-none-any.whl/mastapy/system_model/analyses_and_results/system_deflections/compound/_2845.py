...
class BevelDifferentialGearMeshCompoundSystemDeflection(_2850.BevelGearMeshCompoundSystemDeflection):
    """BevelDifferentialGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2683.BevelDifferentialGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2683.BevelDifferentialGearMeshSystemDeflection]':
