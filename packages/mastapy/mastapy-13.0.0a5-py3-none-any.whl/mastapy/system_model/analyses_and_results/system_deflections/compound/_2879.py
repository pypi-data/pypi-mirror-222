...
class CycloidalDiscPlanetaryBearingConnectionCompoundSystemDeflection(_2836.AbstractShaftToMountableComponentConnectionCompoundSystemDeflection):
    """CycloidalDiscPlanetaryBearingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2719.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2719.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
