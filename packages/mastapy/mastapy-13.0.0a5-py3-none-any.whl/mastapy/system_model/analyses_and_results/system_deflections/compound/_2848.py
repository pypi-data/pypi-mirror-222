...
class BevelDifferentialSunGearCompoundSystemDeflection(_2844.BevelDifferentialGearCompoundSystemDeflection):
    """BevelDifferentialSunGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2687.BevelDifferentialSunGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2687.BevelDifferentialSunGearSystemDeflection]':
