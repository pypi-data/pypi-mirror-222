...
class TorqueConverterCompoundSystemDeflection(_2870.CouplingCompoundSystemDeflection):
    """TorqueConverterCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2812.TorqueConverterSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2812.TorqueConverterSystemDeflection]':
