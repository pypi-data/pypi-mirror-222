...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.system_deflections.compound import _2844, _2845
...
class BevelDifferentialGearSetCompoundSystemDeflection(_2851.BevelGearSetCompoundSystemDeflection):
    """BevelDifferentialGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2684.BevelDifferentialGearSetSystemDeflection]':
    ...
    @property
    def bevel_differential_gears_compound_system_deflection(self) -> 'List[_2844.BevelDifferentialGearCompoundSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_compound_system_deflection(self) -> 'List[_2845.BevelDifferentialGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2684.BevelDifferentialGearSetSystemDeflection]':
