...
class ComponentCompoundSystemDeflection(_2913.PartCompoundSystemDeflection):
    """ComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2697.ComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2697.ComponentSystemDeflection]':
