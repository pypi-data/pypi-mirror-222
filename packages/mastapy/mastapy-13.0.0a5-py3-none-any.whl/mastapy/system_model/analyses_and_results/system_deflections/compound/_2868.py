...
class ConnectionCompoundSystemDeflection(_7505.ConnectionCompoundAnalysis):
    """ConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2709.ConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2709.ConnectionSystemDeflection]':
