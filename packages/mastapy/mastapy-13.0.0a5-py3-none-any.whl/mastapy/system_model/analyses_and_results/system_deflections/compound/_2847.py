...
class BevelDifferentialPlanetGearCompoundSystemDeflection(_2844.BevelDifferentialGearCompoundSystemDeflection):
    """BevelDifferentialPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2686.BevelDifferentialPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2686.BevelDifferentialPlanetGearSystemDeflection]':
