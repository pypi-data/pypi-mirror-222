...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.system_deflections.compound import _2896, _2897
...
class HypoidGearSetCompoundSystemDeflection(_2839.AGMAGleasonConicalGearSetCompoundSystemDeflection):
    """HypoidGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2746.HypoidGearSetSystemDeflection]':
    ...
    @property
    def hypoid_gears_compound_system_deflection(self) -> 'List[_2896.HypoidGearCompoundSystemDeflection]':
    ...
    @property
    def hypoid_meshes_compound_system_deflection(self) -> 'List[_2897.HypoidGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2746.HypoidGearSetSystemDeflection]':
