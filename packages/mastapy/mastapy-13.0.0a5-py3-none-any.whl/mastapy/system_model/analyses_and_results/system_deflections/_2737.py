...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.system_deflections import _2738, _2736
...
class FaceGearSetSystemDeflection(_2742.GearSetSystemDeflection):
    """FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4068.FaceGearSetPowerFlow':
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2738.FaceGearSystemDeflection]':
    ...
    @property
    def face_meshes_system_deflection(self) -> 'List[_2736.FaceGearMeshSystemDeflection]':
