...
class PlanetCarrierSystemDeflection(_2764.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4098.PlanetCarrierPowerFlow':
    ...
    @property
    def windup(self) -> 'List[_2828.PlanetCarrierWindup]':
