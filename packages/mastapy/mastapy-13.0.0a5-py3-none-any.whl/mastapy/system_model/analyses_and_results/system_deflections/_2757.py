...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.system_deflections import _2758, _2756
...
class KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection(_2751.KlingelnbergCycloPalloidConicalGearSetSystemDeflection):
    """KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4087.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_system_deflection(self) -> 'List[_2758.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_system_deflection(self) -> 'List[_2756.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection]':
