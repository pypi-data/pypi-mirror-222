...
class ConceptCouplingConnectionSystemDeflection(_2711.CouplingConnectionSystemDeflection):
    """ConceptCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4038.ConceptCouplingConnectionPowerFlow':
