...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.critical_speed_analyses import (
        ...
        _6530, _6554, _6533, _6538,
        _6542, _6556, _6558, _6562,
        _6569, _6568, _6570, _6577,
        _6584, _6587, _6588, _6589,
        _6591, _6594, _6598, _6599,
        _6600, _6602, _6604, _6609,
        _6608, _6614, _6616, _6620,
        _6623, _6626, _6631, _6634,
        _6638, _6641
    )
...
class AssemblyCriticalSpeedAnalysis(_6511.AbstractAssemblyCriticalSpeedAnalysis):
    """AssemblyCriticalSpeedAnalysis
    ...
    @property
    def bearings(self) -> 'List[_6519.BearingCriticalSpeedAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6521.BeltDriveCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6524.BevelDifferentialGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6531.BoltedJointCriticalSpeedAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6530.BoltCriticalSpeedAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6554.CVTCriticalSpeedAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6533.ClutchCriticalSpeedAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6538.ConceptCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6542.ConceptGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6556.CycloidalAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6558.CycloidalDiscCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6562.CylindricalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6569.FEPartCriticalSpeedAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6568.FaceGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6570.FlexiblePinAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6577.HypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6584.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6587.KlingelnbergCycloPalloidSpiralBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6588.MassDiscCriticalSpeedAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6589.MeasurementComponentCriticalSpeedAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6591.OilSealCriticalSpeedAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6594.PartToPartShearCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6598.PlanetCarrierCriticalSpeedAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6599.PointLoadCriticalSpeedAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6600.PowerLoadCriticalSpeedAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6602.RingPinsCriticalSpeedAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6604.RollingRingAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6609.ShaftHubConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6608.ShaftCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6614.SpiralBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6616.SpringDamperCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6620.StraightBevelDiffGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6623.StraightBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6626.SynchroniserCriticalSpeedAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6631.TorqueConverterCriticalSpeedAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6634.UnbalancedMassCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6638.WormGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6641.ZerolBevelGearSetCriticalSpeedAnalysis]':
