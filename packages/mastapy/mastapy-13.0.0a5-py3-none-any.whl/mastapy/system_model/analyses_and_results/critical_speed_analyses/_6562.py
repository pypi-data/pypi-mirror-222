...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6560, _6561
...
class CylindricalGearSetCriticalSpeedAnalysis(_6573.GearSetCriticalSpeedAnalysis):
    """CylindricalGearSetCriticalSpeedAnalysis
    ...
    @property
    def cylindrical_gears_critical_speed_analysis(self) -> 'List[_6560.CylindricalGearCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_meshes_critical_speed_analysis(self) -> 'List[_6561.CylindricalGearMeshCriticalSpeedAnalysis]':
