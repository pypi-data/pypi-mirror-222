...
class PartToPartShearCouplingConnectionCompoundCriticalSpeedAnalysis(_6680.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """PartToPartShearCouplingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6593.PartToPartShearCouplingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6593.PartToPartShearCouplingConnectionCriticalSpeedAnalysis]':
