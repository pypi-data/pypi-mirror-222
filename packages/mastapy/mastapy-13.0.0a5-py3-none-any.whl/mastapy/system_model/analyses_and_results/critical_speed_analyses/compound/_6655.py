...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6653, _6654
...
class BevelDifferentialGearSetCompoundCriticalSpeedAnalysis(_6660.BevelGearSetCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6524.BevelDifferentialGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_critical_speed_analysis(self) -> 'List[_6653.BevelDifferentialGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_critical_speed_analysis(self) -> 'List[_6654.BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6524.BevelDifferentialGearSetCriticalSpeedAnalysis]':
