...
class GuideDxfModelCompoundCriticalSpeedAnalysis(_6667.ComponentCompoundCriticalSpeedAnalysis):
    """GuideDxfModelCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6574.GuideDxfModelCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6574.GuideDxfModelCriticalSpeedAnalysis]':
