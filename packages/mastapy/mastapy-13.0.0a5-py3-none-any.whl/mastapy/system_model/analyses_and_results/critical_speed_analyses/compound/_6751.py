...
class StraightBevelGearMeshCompoundCriticalSpeedAnalysis(_6659.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """StraightBevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6622.StraightBevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6622.StraightBevelGearMeshCriticalSpeedAnalysis]':
