...
class DatumCompoundCriticalSpeedAnalysis(_6667.ComponentCompoundCriticalSpeedAnalysis):
    """DatumCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6564.DatumCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6564.DatumCriticalSpeedAnalysis]':
