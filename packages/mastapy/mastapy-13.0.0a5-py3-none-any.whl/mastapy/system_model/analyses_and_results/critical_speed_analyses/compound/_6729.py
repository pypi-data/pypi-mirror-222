...
class PowerLoadCompoundCriticalSpeedAnalysis(_6764.VirtualComponentCompoundCriticalSpeedAnalysis):
    """PowerLoadCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6600.PowerLoadCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6600.PowerLoadCriticalSpeedAnalysis]':
