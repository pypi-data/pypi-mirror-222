...
class PartCompoundCriticalSpeedAnalysis(_7512.PartCompoundAnalysis):
    """PartCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6592.PartCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6592.PartCriticalSpeedAnalysis]':
