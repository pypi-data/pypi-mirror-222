...
class BevelDifferentialGearCompoundCriticalSpeedAnalysis(_6658.BevelGearCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6522.BevelDifferentialGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6522.BevelDifferentialGearCriticalSpeedAnalysis]':
