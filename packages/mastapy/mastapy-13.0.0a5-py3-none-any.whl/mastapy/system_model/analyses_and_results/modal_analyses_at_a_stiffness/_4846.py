...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4845, _4844
...
class BevelDifferentialGearSetModalAnalysisAtAStiffness(_4851.BevelGearSetModalAnalysisAtAStiffness):
    """BevelDifferentialGearSetModalAnalysisAtAStiffness
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4845.BevelDifferentialGearModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4844.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
