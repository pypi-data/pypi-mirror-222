...
class CouplingConnectionCompoundModalAnalysisAtAStiffness(_5028.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """CouplingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4870.CouplingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4870.CouplingConnectionModalAnalysisAtAStiffness]':
