...
class SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness(_4980.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4933.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4933.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
