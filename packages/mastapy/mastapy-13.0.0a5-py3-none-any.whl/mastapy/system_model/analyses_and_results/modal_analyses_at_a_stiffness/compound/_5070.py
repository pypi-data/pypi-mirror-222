...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5068, _5069
...
class StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness(_4981.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4941.StraightBevelDiffGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5068.StraightBevelDiffGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5069.StraightBevelDiffGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4941.StraightBevelDiffGearSetModalAnalysisAtAStiffness]':
