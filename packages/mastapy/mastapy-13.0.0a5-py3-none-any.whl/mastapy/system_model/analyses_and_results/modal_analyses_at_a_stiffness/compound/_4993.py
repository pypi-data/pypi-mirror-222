...
class ConceptGearMeshCompoundModalAnalysisAtAStiffness(_5022.GearMeshCompoundModalAnalysisAtAStiffness):
    """ConceptGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4862.ConceptGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4862.ConceptGearMeshModalAnalysisAtAStiffness]':
