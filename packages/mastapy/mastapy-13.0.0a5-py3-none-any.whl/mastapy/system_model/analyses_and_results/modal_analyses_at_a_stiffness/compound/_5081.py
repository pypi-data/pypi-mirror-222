...
class TorqueConverterConnectionCompoundModalAnalysisAtAStiffness(_5001.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """TorqueConverterConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4951.TorqueConverterConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4951.TorqueConverterConnectionModalAnalysisAtAStiffness]':
