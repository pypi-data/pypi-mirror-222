...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5071, _5072
...
class StraightBevelGearSetCompoundModalAnalysisAtAStiffness(_4981.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """StraightBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4944.StraightBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5071.StraightBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5072.StraightBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4944.StraightBevelGearSetModalAnalysisAtAStiffness]':
