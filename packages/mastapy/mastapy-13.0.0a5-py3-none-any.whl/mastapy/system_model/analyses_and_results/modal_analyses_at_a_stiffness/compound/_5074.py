...
class StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness(_5068.StraightBevelDiffGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4945.StraightBevelPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4945.StraightBevelPlanetGearModalAnalysisAtAStiffness]':
