...
class CylindricalGearMeshCompoundModalAnalysisAtAStiffness(_5022.GearMeshCompoundModalAnalysisAtAStiffness):
    """CylindricalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4880.CylindricalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4880.CylindricalGearMeshModalAnalysisAtAStiffness]':
