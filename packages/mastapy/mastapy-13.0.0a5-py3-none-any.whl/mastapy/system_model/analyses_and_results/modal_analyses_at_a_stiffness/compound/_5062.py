...
class SpiralBevelGearCompoundModalAnalysisAtAStiffness(_4979.BevelGearCompoundModalAnalysisAtAStiffness):
    """SpiralBevelGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4934.SpiralBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4934.SpiralBevelGearModalAnalysisAtAStiffness]':
