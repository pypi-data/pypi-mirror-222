...
class TorqueConverterPumpCompoundModalAnalysisAtAStiffness(_5002.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """TorqueConverterPumpCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4953.TorqueConverterPumpModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4953.TorqueConverterPumpModalAnalysisAtAStiffness]':
