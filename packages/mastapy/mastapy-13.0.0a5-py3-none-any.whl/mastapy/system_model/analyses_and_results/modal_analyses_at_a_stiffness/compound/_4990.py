...
class ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness(_5001.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4859.ConceptCouplingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4859.ConceptCouplingConnectionModalAnalysisAtAStiffness]':
