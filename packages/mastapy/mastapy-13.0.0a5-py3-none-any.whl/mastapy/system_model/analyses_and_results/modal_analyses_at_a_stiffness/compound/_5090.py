...
class ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness(_4980.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4960.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4960.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
