...
class BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness(_4980.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4844.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4844.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
