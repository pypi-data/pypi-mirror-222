...
class RollingRingCompoundModalAnalysisAtAStiffness(_5002.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """RollingRingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4927.RollingRingModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4927.RollingRingModalAnalysisAtAStiffness]':
