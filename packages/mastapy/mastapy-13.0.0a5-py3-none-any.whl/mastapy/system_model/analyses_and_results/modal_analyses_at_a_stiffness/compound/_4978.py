...
class BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness(_4974.BevelDifferentialGearCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4848.BevelDifferentialSunGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4848.BevelDifferentialSunGearModalAnalysisAtAStiffness]':
