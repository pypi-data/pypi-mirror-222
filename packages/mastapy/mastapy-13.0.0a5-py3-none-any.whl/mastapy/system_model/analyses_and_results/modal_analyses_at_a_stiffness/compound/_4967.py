...
class AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness(_4995.ConicalGearCompoundModalAnalysisAtAStiffness):
    """AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4838.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4838.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
