...
class FaceGearCompoundModalAnalysisAtAStiffness(_5021.GearCompoundModalAnalysisAtAStiffness):
    """FaceGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4888.FaceGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4888.FaceGearModalAnalysisAtAStiffness]':
