...
class DatumCompoundModalAnalysisAtAStiffness(_4988.ComponentCompoundModalAnalysisAtAStiffness):
    """DatumCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4884.DatumModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4884.DatumModalAnalysisAtAStiffness]':
