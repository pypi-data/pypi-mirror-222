...
class ZerolBevelGearCompoundModalAnalysisAtAStiffness(_4979.BevelGearCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4961.ZerolBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4961.ZerolBevelGearModalAnalysisAtAStiffness]':
