...
class FEPartCompoundModalAnalysisAtASpeed(_5223.AbstractShaftOrHousingCompoundModalAnalysisAtASpeed):
    """FEPartCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5148.FEPartModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5148.FEPartModalAnalysisAtASpeed]':
