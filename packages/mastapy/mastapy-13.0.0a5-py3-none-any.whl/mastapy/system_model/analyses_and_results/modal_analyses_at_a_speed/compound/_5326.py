...
class StraightBevelDiffGearCompoundModalAnalysisAtASpeed(_5237.BevelGearCompoundModalAnalysisAtASpeed):
    """StraightBevelDiffGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5198.StraightBevelDiffGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5198.StraightBevelDiffGearModalAnalysisAtASpeed]':
