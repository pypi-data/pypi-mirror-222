...
class BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed(_5238.BevelGearMeshCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5103.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5103.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
