...
class SynchroniserHalfCompoundModalAnalysisAtASpeed(_5336.SynchroniserPartCompoundModalAnalysisAtASpeed):
    """SynchroniserHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5205.SynchroniserHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5205.SynchroniserHalfModalAnalysisAtASpeed]':
