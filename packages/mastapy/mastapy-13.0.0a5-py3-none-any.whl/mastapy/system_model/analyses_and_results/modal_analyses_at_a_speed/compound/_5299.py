...
class OilSealCompoundModalAnalysisAtASpeed(_5257.ConnectorCompoundModalAnalysisAtASpeed):
    """OilSealCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5170.OilSealModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5170.OilSealModalAnalysisAtASpeed]':
