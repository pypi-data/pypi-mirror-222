...
class ConceptGearMeshCompoundModalAnalysisAtASpeed(_5280.GearMeshCompoundModalAnalysisAtASpeed):
    """ConceptGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5121.ConceptGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5121.ConceptGearMeshModalAnalysisAtASpeed]':
