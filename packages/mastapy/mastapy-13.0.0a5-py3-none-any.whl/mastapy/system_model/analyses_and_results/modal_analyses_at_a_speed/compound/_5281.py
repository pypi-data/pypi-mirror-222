...
class GearSetCompoundModalAnalysisAtASpeed(_5319.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """GearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5152.GearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5152.GearSetModalAnalysisAtASpeed]':
