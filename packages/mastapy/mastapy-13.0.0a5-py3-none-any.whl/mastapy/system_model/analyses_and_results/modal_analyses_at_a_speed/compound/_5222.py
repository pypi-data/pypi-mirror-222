...
class AbstractShaftCompoundModalAnalysisAtASpeed(_5223.AbstractShaftOrHousingCompoundModalAnalysisAtASpeed):
    """AbstractShaftCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5093.AbstractShaftModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5093.AbstractShaftModalAnalysisAtASpeed]':
