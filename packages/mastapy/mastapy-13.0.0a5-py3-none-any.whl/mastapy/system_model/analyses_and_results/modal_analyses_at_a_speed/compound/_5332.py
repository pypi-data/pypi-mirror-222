...
class StraightBevelPlanetGearCompoundModalAnalysisAtASpeed(_5326.StraightBevelDiffGearCompoundModalAnalysisAtASpeed):
    """StraightBevelPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5203.StraightBevelPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5203.StraightBevelPlanetGearModalAnalysisAtASpeed]':
