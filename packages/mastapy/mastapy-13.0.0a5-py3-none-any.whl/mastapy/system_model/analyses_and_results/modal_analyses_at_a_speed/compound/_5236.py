...
class BevelDifferentialSunGearCompoundModalAnalysisAtASpeed(_5232.BevelDifferentialGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialSunGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5107.BevelDifferentialSunGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5107.BevelDifferentialSunGearModalAnalysisAtASpeed]':
