...
class AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed(_5255.ConicalGearSetCompoundModalAnalysisAtASpeed):
    """AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5098.AGMAGleasonConicalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5098.AGMAGleasonConicalGearSetModalAnalysisAtASpeed]':
