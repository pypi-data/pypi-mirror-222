...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5250, _5251
...
class ConceptGearSetCompoundModalAnalysisAtASpeed(_5281.GearSetCompoundModalAnalysisAtASpeed):
    """ConceptGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5123.ConceptGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5250.ConceptGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5251.ConceptGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5123.ConceptGearSetModalAnalysisAtASpeed]':
