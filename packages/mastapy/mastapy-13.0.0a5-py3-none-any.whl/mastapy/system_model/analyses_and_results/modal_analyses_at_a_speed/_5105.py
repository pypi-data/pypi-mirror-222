...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5104, _5103
...
class BevelDifferentialGearSetModalAnalysisAtASpeed(_5110.BevelGearSetModalAnalysisAtASpeed):
    """BevelDifferentialGearSetModalAnalysisAtASpeed
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_speed(self) -> 'List[_5104.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis_at_a_speed(self) -> 'List[_5103.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
