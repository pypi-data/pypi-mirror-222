...
class ZerolBevelGearSetModalAnalysis(_4568.BevelGearSetModalAnalysis):
    """ZerolBevelGearSetModalAnalysis
    ...
    @property
    def zerol_bevel_gears_modal_analysis(self) -> 'List[_4690.ZerolBevelGearModalAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis(self) -> 'List[_4689.ZerolBevelGearMeshModalAnalysis]':
