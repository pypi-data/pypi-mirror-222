...
class TorqueConverterConnectionCompoundModalAnalysis(_4742.CouplingConnectionCompoundModalAnalysis):
    """TorqueConverterConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4677.TorqueConverterConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4677.TorqueConverterConnectionModalAnalysis]':
