...
class GearMeshCompoundModalAnalysis(_4769.InterMountableComponentConnectionCompoundModalAnalysis):
    """GearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4612.GearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4612.GearMeshModalAnalysis]':
