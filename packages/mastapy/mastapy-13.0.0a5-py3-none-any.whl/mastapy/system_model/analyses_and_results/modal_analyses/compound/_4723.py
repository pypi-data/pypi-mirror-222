...
class BoltCompoundModalAnalysis(_4729.ComponentCompoundModalAnalysis):
    """BoltCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4570.BoltModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4570.BoltModalAnalysis]':
