...
class PlanetaryConnectionCompoundModalAnalysis(_4801.ShaftToMountableComponentConnectionCompoundModalAnalysis):
    """PlanetaryConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4642.PlanetaryConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4642.PlanetaryConnectionModalAnalysis]':
