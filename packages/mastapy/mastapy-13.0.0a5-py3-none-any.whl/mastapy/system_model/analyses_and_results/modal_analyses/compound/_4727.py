...
class ClutchHalfCompoundModalAnalysis(_4743.CouplingHalfCompoundModalAnalysis):
    """ClutchHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4572.ClutchHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4572.ClutchHalfModalAnalysis]':
