...
class CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis(_4707.AbstractShaftToMountableComponentConnectionCompoundModalAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4597.CycloidalDiscPlanetaryBearingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4597.CycloidalDiscPlanetaryBearingConnectionModalAnalysis]':
