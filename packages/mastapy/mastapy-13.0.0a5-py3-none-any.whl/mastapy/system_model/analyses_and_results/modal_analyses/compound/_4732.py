...
class ConceptCouplingHalfCompoundModalAnalysis(_4743.CouplingHalfCompoundModalAnalysis):
    """ConceptCouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4577.ConceptCouplingHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4577.ConceptCouplingHalfModalAnalysis]':
