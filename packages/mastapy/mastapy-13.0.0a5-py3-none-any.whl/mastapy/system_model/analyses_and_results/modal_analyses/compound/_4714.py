...
class BeltDriveCompoundModalAnalysis(_4802.SpecialisedAssemblyCompoundModalAnalysis):
    """BeltDriveCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4560.BeltDriveModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4560.BeltDriveModalAnalysis]':
