...
class PulleyCompoundModalAnalysis(_4743.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4647.PulleyModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4647.PulleyModalAnalysis]':
