...
class PlanetaryGearSetCompoundModalAnalysis(_4753.CylindricalGearSetCompoundModalAnalysis):
    """PlanetaryGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4643.PlanetaryGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4643.PlanetaryGearSetModalAnalysis]':
