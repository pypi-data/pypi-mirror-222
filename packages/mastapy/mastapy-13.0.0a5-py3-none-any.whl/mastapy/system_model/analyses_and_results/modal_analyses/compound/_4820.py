...
class SynchroniserSleeveCompoundModalAnalysis(_4819.SynchroniserPartCompoundModalAnalysis):
    """SynchroniserSleeveCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4676.SynchroniserSleeveModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4676.SynchroniserSleeveModalAnalysis]':
