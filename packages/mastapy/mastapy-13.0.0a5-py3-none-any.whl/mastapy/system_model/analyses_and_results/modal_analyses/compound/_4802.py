...
class SpecialisedAssemblyCompoundModalAnalysis(_4704.AbstractAssemblyCompoundModalAnalysis):
    """SpecialisedAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4658.SpecialisedAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4658.SpecialisedAssemblyModalAnalysis]':
