...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    def analysis_type(self) -> '_52.BarModelAnalysisType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.NodalAnalysis.BarModelAnalysisType')
        return constructor.new_from_mastapy('mastapy.nodal_analysis._52', 'BarModelAnalysisType')(value) if value is not None else None

    @analysis_type.setter
    def analysis_type(self, value: '_52.BarModelAnalysisType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.NodalAnalysis.BarModelAnalysisType')
    ...
    def coordinate_system(self) -> 'list_with_selected_item.ListWithSelectedItem_FEPart':
        ...
        return constructor.new_from_mastapy('mastapy._internal.implicit.list_with_selected_item', 'ListWithSelectedItem_FEPart')(temp) if temp is not None else None
    ...
    def set_fe_file_to_include(self, file_path: 'str', format_: '_166.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0):
