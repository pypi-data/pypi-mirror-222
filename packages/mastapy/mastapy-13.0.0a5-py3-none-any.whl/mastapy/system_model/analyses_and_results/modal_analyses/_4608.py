...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4607, _4606
...
class FaceGearSetModalAnalysis(_4614.GearSetModalAnalysis):
    ...
    @property
    def system_deflection_results(self) -> '_2737.FaceGearSetSystemDeflection':
    ...
    @property
    def face_gears_modal_analysis(self) -> 'List[_4607.FaceGearModalAnalysis]':
    ...
    @property
    def face_meshes_modal_analysis(self) -> 'List[_4606.FaceGearMeshModalAnalysis]':
