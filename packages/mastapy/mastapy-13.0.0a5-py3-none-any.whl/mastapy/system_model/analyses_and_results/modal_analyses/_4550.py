...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4612, _4575
...
class AbstractAssemblyModalAnalysis(_4638.PartModalAnalysis):
    """AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4575.ComponentModalAnalysis]':
