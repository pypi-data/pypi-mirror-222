...
class BevelDifferentialGearMeshCompoundDynamicAnalysis(_6393.BevelGearMeshCompoundDynamicAnalysis):
    """BevelDifferentialGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6258.BevelDifferentialGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6258.BevelDifferentialGearMeshDynamicAnalysis]':
