...
class ShaftToMountableComponentConnectionCompoundDynamicAnalysis(_6379.AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """ShaftToMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6344.ShaftToMountableComponentConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6344.ShaftToMountableComponentConnectionDynamicAnalysis]':
