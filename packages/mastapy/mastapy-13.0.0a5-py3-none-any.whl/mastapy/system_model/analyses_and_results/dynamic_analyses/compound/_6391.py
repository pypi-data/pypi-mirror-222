...
class BevelDifferentialSunGearCompoundDynamicAnalysis(_6387.BevelDifferentialGearCompoundDynamicAnalysis):
    """BevelDifferentialSunGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6261.BevelDifferentialSunGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6261.BevelDifferentialSunGearDynamicAnalysis]':
