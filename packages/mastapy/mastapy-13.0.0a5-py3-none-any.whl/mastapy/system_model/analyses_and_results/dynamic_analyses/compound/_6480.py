...
class SpringDamperHalfCompoundDynamicAnalysis(_6415.CouplingHalfCompoundDynamicAnalysis):
    """SpringDamperHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6351.SpringDamperHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6351.SpringDamperHalfDynamicAnalysis]':
