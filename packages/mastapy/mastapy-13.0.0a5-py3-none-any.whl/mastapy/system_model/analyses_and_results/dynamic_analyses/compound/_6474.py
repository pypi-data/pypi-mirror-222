...
class SpecialisedAssemblyCompoundDynamicAnalysis(_6376.AbstractAssemblyCompoundDynamicAnalysis):
    """SpecialisedAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6345.SpecialisedAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6345.SpecialisedAssemblyDynamicAnalysis]':
