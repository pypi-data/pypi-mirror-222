...
class BevelDifferentialPlanetGearCompoundDynamicAnalysis(_6387.BevelDifferentialGearCompoundDynamicAnalysis):
    """BevelDifferentialPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6260.BevelDifferentialPlanetGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6260.BevelDifferentialPlanetGearDynamicAnalysis]':
