...
class PointLoadCompoundDynamicAnalysis(_6498.VirtualComponentCompoundDynamicAnalysis):
    """PointLoadCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6333.PointLoadDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6333.PointLoadDynamicAnalysis]':
