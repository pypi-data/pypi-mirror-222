...
class AGMAGleasonConicalGearSetCompoundDynamicAnalysis(_6410.ConicalGearSetCompoundDynamicAnalysis):
    """AGMAGleasonConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6252.AGMAGleasonConicalGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6252.AGMAGleasonConicalGearSetDynamicAnalysis]':
