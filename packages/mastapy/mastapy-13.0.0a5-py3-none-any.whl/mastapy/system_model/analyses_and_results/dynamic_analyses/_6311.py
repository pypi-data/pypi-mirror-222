...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6309, _6310
...
class HypoidGearSetDynamicAnalysis(_6252.AGMAGleasonConicalGearSetDynamicAnalysis):
    """HypoidGearSetDynamicAnalysis
    ...
    @property
    def hypoid_gears_dynamic_analysis(self) -> 'List[_6309.HypoidGearDynamicAnalysis]':
    ...
    @property
    def hypoid_meshes_dynamic_analysis(self) -> 'List[_6310.HypoidGearMeshDynamicAnalysis]':
