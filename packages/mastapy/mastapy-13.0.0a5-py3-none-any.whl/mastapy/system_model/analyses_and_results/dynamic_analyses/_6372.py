...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6370, _6371
...
class WormGearSetDynamicAnalysis(_6307.GearSetDynamicAnalysis):
    """WormGearSetDynamicAnalysis
    ...
    @property
    def worm_gears_dynamic_analysis(self) -> 'List[_6370.WormGearDynamicAnalysis]':
    ...
    @property
    def worm_meshes_dynamic_analysis(self) -> 'List[_6371.WormGearMeshDynamicAnalysis]':
