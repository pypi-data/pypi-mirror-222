...
class SpiralBevelGearMeshHarmonicAnalysis(_5669.BevelGearMeshHarmonicAnalysis):
    """SpiralBevelGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2789.SpiralBevelGearMeshSystemDeflection':
