...
class SynchroniserHalfCompoundHarmonicAnalysis(_5964.SynchroniserPartCompoundHarmonicAnalysis):
    """SynchroniserHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5797.SynchroniserHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5797.SynchroniserHalfHarmonicAnalysis]':
