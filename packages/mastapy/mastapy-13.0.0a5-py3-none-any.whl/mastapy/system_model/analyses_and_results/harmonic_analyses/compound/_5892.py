...
class CycloidalAssemblyCompoundHarmonicAnalysis(_5947.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """CycloidalAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5696.CycloidalAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5696.CycloidalAssemblyHarmonicAnalysis]':
