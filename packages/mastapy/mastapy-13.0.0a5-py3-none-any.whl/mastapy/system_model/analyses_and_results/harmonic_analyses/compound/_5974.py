...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5972, _5973
...
class WormGearSetCompoundHarmonicAnalysis(_5909.GearSetCompoundHarmonicAnalysis):
    """WormGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5810.WormGearSetHarmonicAnalysis]':
    ...
    @property
    def worm_gears_compound_harmonic_analysis(self) -> 'List[_5972.WormGearCompoundHarmonicAnalysis]':
    ...
    @property
    def worm_meshes_compound_harmonic_analysis(self) -> 'List[_5973.WormGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5810.WormGearSetHarmonicAnalysis]':
