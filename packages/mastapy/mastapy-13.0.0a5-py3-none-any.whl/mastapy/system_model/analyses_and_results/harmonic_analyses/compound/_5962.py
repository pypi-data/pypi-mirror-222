...
class SynchroniserCompoundHarmonicAnalysis(_5947.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """SynchroniserCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5798.SynchroniserHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5798.SynchroniserHarmonicAnalysis]':
