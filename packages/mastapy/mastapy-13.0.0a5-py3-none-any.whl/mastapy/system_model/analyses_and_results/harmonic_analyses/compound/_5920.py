...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5918, _5919
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis(_5917.KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5750.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_harmonic_analysis(self) -> 'List[_5918.KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_harmonic_analysis(self) -> 'List[_5919.KlingelnbergCycloPalloidHypoidGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5750.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]':
