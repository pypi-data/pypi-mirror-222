...
class ZerolBevelGearMeshCompoundHarmonicAnalysis(_5866.BevelGearMeshCompoundHarmonicAnalysis):
    """ZerolBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5812.ZerolBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5812.ZerolBevelGearMeshHarmonicAnalysis]':
