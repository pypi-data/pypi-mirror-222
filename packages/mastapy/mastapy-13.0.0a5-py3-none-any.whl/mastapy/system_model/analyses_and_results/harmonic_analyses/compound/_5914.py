...
class InterMountableComponentConnectionCompoundHarmonicAnalysis(_5884.ConnectionCompoundHarmonicAnalysis):
    """InterMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5744.InterMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5744.InterMountableComponentConnectionHarmonicAnalysis]':
