...
class StraightBevelGearCompoundHarmonicAnalysis(_5865.BevelGearCompoundHarmonicAnalysis):
    """StraightBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5792.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5792.StraightBevelGearHarmonicAnalysis]':
