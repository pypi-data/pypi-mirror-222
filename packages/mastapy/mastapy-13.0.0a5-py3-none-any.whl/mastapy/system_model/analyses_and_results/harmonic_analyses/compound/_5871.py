...
class ClutchConnectionCompoundHarmonicAnalysis(_5887.CouplingConnectionCompoundHarmonicAnalysis):
    """ClutchConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5673.ClutchConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5673.ClutchConnectionHarmonicAnalysis]':
