...
class KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis(_5881.ConicalGearCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5745.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5745.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis]':
