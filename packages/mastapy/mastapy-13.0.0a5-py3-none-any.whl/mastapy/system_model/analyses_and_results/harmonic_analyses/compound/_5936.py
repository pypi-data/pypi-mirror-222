...
class PowerLoadCompoundHarmonicAnalysis(_5971.VirtualComponentCompoundHarmonicAnalysis):
    """PowerLoadCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5767.PowerLoadHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5767.PowerLoadHarmonicAnalysis]':
