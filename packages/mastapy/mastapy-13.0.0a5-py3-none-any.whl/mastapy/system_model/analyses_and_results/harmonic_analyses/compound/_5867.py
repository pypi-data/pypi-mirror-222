...
class BevelGearSetCompoundHarmonicAnalysis(_5855.AGMAGleasonConicalGearSetCompoundHarmonicAnalysis):
    """BevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5670.BevelGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5670.BevelGearSetHarmonicAnalysis]':
