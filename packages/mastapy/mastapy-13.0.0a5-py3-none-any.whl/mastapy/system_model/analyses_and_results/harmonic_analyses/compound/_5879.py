...
class ConceptGearMeshCompoundHarmonicAnalysis(_5908.GearMeshCompoundHarmonicAnalysis):
    """ConceptGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5683.ConceptGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5683.ConceptGearMeshHarmonicAnalysis]':
