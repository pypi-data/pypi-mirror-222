...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5789, _5790
...
class StraightBevelDiffGearSetHarmonicAnalysis(_5670.BevelGearSetHarmonicAnalysis):
    """StraightBevelDiffGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2796.StraightBevelDiffGearSetSystemDeflection':
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5789.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_harmonic_analysis(self) -> 'List[_5789.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5790.StraightBevelDiffGearMeshHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_harmonic_analysis(self) -> 'List[_5790.StraightBevelDiffGearMeshHarmonicAnalysis]':
