...
class ResultLocationSelectionGroups(_0.APIBase):
    ...
    def display_location_selection(self) -> 'ResultLocationSelectionGroups.DisplayLocationSelectionOption':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ResultLocationSelectionGroups+DisplayLocationSelectionOption')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.harmonic_analyses.results.ResultLocationSelectionGroups.ResultLocationSelectionGroups', 'DisplayLocationSelectionOption')(value) if value is not None else None
    ...
    def display_location_selection(self, value: 'ResultLocationSelectionGroups.DisplayLocationSelectionOption'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ResultLocationSelectionGroups+DisplayLocationSelectionOption')
    ...
    def select_result_location_group(self) -> 'list_with_selected_item.ListWithSelectedItem_ResultLocationSelectionGroup':
        ...
        return constructor.new_from_mastapy('mastapy._internal.implicit.list_with_selected_item', 'ListWithSelectedItem_ResultLocationSelectionGroup')(temp) if temp is not None else None
    ...
    @property
    def selected_result_location_group(self) -> '_5821.ResultLocationSelectionGroup':
    ...
    @property
    def result_location_groups(self) -> 'List[_5821.ResultLocationSelectionGroup]':
