...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5741, _5742
...
class HypoidGearSetHarmonicAnalysis(_5658.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """HypoidGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5741.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def hypoid_gears_harmonic_analysis(self) -> 'List[_5741.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5742.HypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def hypoid_meshes_harmonic_analysis(self) -> 'List[_5742.HypoidGearMeshHarmonicAnalysis]':
