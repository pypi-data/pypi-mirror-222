...
class ZerolBevelGearSetHarmonicAnalysis(_5670.BevelGearSetHarmonicAnalysis):
    """ZerolBevelGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5811.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_harmonic_analysis(self) -> 'List[_5811.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5812.ZerolBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_harmonic_analysis(self) -> 'List[_5812.ZerolBevelGearMeshHarmonicAnalysis]':
