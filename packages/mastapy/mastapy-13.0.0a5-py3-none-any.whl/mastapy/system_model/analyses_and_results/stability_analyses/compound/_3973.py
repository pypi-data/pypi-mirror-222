...
class ShaftHubConnectionCompoundStabilityAnalysis(_3913.ConnectorCompoundStabilityAnalysis):
    """ShaftHubConnectionCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3841.ShaftHubConnectionStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3841.ShaftHubConnectionStabilityAnalysis]':
