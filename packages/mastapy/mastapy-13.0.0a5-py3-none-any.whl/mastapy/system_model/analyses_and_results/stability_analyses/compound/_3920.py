...
class CycloidalAssemblyCompoundStabilityAnalysis(_3975.SpecialisedAssemblyCompoundStabilityAnalysis):
    """CycloidalAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3789.CycloidalAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3789.CycloidalAssemblyStabilityAnalysis]':
