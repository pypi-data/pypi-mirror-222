...
class HypoidGearMeshCompoundStabilityAnalysis(_3882.AGMAGleasonConicalGearMeshCompoundStabilityAnalysis):
    """HypoidGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3808.HypoidGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3808.HypoidGearMeshStabilityAnalysis]':
