...
class FaceGearCompoundStabilityAnalysis(_3935.GearCompoundStabilityAnalysis):
    """FaceGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3801.FaceGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3801.FaceGearStabilityAnalysis]':
