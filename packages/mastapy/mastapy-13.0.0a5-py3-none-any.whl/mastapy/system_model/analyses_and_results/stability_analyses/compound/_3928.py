...
class DatumCompoundStabilityAnalysis(_3902.ComponentCompoundStabilityAnalysis):
    """DatumCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3797.DatumStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3797.DatumStabilityAnalysis]':
