...
class ConceptCouplingConnectionCompoundStabilityAnalysis(_3915.CouplingConnectionCompoundStabilityAnalysis):
    """ConceptCouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3771.ConceptCouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3771.ConceptCouplingConnectionStabilityAnalysis]':
