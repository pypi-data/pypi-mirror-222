...
class BearingCompoundStabilityAnalysis(_3913.ConnectorCompoundStabilityAnalysis):
    """BearingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3753.BearingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3753.BearingStabilityAnalysis]':
