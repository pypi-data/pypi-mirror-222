...
class KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis(_3943.KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3817.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3817.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
