...
class PlanetaryGearSetCompoundStabilityAnalysis(_3926.CylindricalGearSetCompoundStabilityAnalysis):
    """PlanetaryGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3830.PlanetaryGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3830.PlanetaryGearSetStabilityAnalysis]':
