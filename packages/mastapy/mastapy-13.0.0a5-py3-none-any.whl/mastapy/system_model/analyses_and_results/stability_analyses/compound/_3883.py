...
class AGMAGleasonConicalGearSetCompoundStabilityAnalysis(_3911.ConicalGearSetCompoundStabilityAnalysis):
    """AGMAGleasonConicalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3750.AGMAGleasonConicalGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3750.AGMAGleasonConicalGearSetStabilityAnalysis]':
