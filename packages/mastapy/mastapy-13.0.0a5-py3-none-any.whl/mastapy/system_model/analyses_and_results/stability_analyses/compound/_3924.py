...
class CylindricalGearCompoundStabilityAnalysis(_3935.GearCompoundStabilityAnalysis):
    """CylindricalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3795.CylindricalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3795.CylindricalGearStabilityAnalysis]':
