...
class StraightBevelDiffGearCompoundStabilityAnalysis(_3893.BevelGearCompoundStabilityAnalysis):
    """StraightBevelDiffGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3855.StraightBevelDiffGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3855.StraightBevelDiffGearStabilityAnalysis]':
