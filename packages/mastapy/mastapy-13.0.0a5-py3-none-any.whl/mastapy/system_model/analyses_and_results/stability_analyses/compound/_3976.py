...
class SpiralBevelGearCompoundStabilityAnalysis(_3893.BevelGearCompoundStabilityAnalysis):
    """SpiralBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3847.SpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3847.SpiralBevelGearStabilityAnalysis]':
