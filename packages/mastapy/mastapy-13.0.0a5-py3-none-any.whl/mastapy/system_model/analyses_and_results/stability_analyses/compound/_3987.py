...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3985, _3986
...
class StraightBevelGearSetCompoundStabilityAnalysis(_3895.BevelGearSetCompoundStabilityAnalysis):
    """StraightBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3857.StraightBevelGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_stability_analysis(self) -> 'List[_3985.StraightBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_stability_analysis(self) -> 'List[_3986.StraightBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3857.StraightBevelGearSetStabilityAnalysis]':
