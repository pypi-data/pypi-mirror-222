...
class ZerolBevelGearMeshCompoundStabilityAnalysis(_3894.BevelGearMeshCompoundStabilityAnalysis):
    """ZerolBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3874.ZerolBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3874.ZerolBevelGearMeshStabilityAnalysis]':
