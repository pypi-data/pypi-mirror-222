...
class UnbalancedMassCompoundStabilityAnalysis(_3999.VirtualComponentCompoundStabilityAnalysis):
    """UnbalancedMassCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3869.UnbalancedMassStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3869.UnbalancedMassStabilityAnalysis]':
