...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.stability_analyses import _3758, _3756
...
class BevelDifferentialGearSetStabilityAnalysis(_3762.BevelGearSetStabilityAnalysis):
    """BevelDifferentialGearSetStabilityAnalysis
    ...
    @property
    def bevel_differential_gears_stability_analysis(self) -> 'List[_3758.BevelDifferentialGearStabilityAnalysis]':
    ...
    @property
    def bevel_differential_meshes_stability_analysis(self) -> 'List[_3756.BevelDifferentialGearMeshStabilityAnalysis]':
