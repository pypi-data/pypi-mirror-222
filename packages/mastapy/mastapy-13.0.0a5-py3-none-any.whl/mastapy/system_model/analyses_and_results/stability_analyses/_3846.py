...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.stability_analyses import _3847, _3845
...
class SpiralBevelGearSetStabilityAnalysis(_3762.BevelGearSetStabilityAnalysis):
    """SpiralBevelGearSetStabilityAnalysis
    ...
    @property
    def spiral_bevel_gears_stability_analysis(self) -> 'List[_3847.SpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_stability_analysis(self) -> 'List[_3845.SpiralBevelGearMeshStabilityAnalysis]':
