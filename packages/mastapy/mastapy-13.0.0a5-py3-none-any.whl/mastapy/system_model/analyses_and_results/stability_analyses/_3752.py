...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.stability_analyses import (
        _3753, _3755, _3757, _3764,
        _3765, _3788, _3768, _3773,
        _3775, _3789, _3792, _3794,
        _3802, _3800, _3803, _3809,
        _3816, _3819, _3821, _3822,
        _3824, _3828, _3831, _3832,
        _3833, _3835, _3837, _3841,
        _3842, _3846, _3850, _3854,
        _3857, _3864, _3867, _3869,
        _3872, _3875
    )
...
class AssemblyStabilityAnalysis(_3745.AbstractAssemblyStabilityAnalysis):
    """AssemblyStabilityAnalysis
    ...
    @property
    def bearings(self) -> 'List[_3753.BearingStabilityAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_3755.BeltDriveStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3757.BevelDifferentialGearSetStabilityAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3764.BoltedJointStabilityAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_3765.BoltStabilityAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_3788.CVTStabilityAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_3768.ClutchStabilityAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3773.ConceptCouplingStabilityAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3775.ConceptGearSetStabilityAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3789.CycloidalAssemblyStabilityAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3792.CycloidalDiscStabilityAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3794.CylindricalGearSetStabilityAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_3802.FEPartStabilityAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3800.FaceGearSetStabilityAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3803.FlexiblePinAssemblyStabilityAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3809.HypoidGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3816.KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3819.KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_3821.MassDiscStabilityAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_3822.MeasurementComponentStabilityAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_3824.OilSealStabilityAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3828.PartToPartShearCouplingStabilityAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3831.PlanetCarrierStabilityAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_3832.PointLoadStabilityAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_3833.PowerLoadStabilityAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_3835.RingPinsStabilityAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3837.RollingRingAssemblyStabilityAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3841.ShaftHubConnectionStabilityAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_3842.ShaftStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3846.SpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3850.SpringDamperStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3854.StraightBevelDiffGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3857.StraightBevelGearSetStabilityAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_3864.SynchroniserStabilityAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_3867.TorqueConverterStabilityAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3869.UnbalancedMassStabilityAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3872.WormGearSetStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3875.ZerolBevelGearSetStabilityAnalysis]':
