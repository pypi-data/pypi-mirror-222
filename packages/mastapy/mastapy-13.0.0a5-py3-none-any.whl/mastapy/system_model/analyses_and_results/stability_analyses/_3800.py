...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.stability_analyses import _3801, _3799
...
class FaceGearSetStabilityAnalysis(_3805.GearSetStabilityAnalysis):
    """FaceGearSetStabilityAnalysis
    ...
    @property
    def face_gears_stability_analysis(self) -> 'List[_3801.FaceGearStabilityAnalysis]':
    ...
    @property
    def face_meshes_stability_analysis(self) -> 'List[_3799.FaceGearMeshStabilityAnalysis]':
