...
class SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation(_7222.SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserHalfCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7092.SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7092.SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation]':
