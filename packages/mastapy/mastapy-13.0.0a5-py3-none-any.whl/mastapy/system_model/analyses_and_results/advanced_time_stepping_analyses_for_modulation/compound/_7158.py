...
class DatumCompoundAdvancedTimeSteppingAnalysisForModulation(_7132.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """DatumCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7028.DatumAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7028.DatumAdvancedTimeSteppingAnalysisForModulation]':
