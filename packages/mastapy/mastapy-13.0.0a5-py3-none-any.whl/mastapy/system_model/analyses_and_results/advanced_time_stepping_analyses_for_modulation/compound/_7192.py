...
class PlanetCarrierCompoundAdvancedTimeSteppingAnalysisForModulation(_7184.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PlanetCarrierCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7063.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7063.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]':
