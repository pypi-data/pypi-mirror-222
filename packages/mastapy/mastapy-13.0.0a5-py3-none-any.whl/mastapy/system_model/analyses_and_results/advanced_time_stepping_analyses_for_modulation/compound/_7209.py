...
class SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation(_7144.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7080.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7080.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
