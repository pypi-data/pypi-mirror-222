...
class BoltCompoundAdvancedTimeSteppingAnalysisForModulation(_7132.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BoltCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6996.BoltAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6996.BoltAdvancedTimeSteppingAnalysisForModulation]':
