...
class HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7112.AGMAGleasonConicalGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7041.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7041.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
