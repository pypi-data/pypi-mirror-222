...
class ComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7186.PartCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7002.ComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7002.ComponentAdvancedTimeSteppingAnalysisForModulation]':
