...
class CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation(_7024.CylindricalGearAdvancedTimeSteppingAnalysisForModulation):
    """CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2732.CylindricalPlanetGearSystemDeflection':
