...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7040, _7041
...
class HypoidGearSetAdvancedTimeSteppingAnalysisForModulation(_6982.AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def hypoid_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7040.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7041.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
