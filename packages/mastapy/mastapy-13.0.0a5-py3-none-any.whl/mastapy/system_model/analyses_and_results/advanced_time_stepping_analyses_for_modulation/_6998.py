...
class ClutchAdvancedTimeSteppingAnalysisForModulation(_7014.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """ClutchAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2695.ClutchSystemDeflection':
