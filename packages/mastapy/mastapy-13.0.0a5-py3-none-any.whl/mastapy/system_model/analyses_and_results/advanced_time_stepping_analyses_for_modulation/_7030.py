...
class FaceGearAdvancedTimeSteppingAnalysisForModulation(_7035.GearAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2738.FaceGearSystemDeflection':
