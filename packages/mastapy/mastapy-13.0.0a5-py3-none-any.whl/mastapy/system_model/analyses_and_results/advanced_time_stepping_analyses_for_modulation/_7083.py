...
class StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation(_6993.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2797.StraightBevelDiffGearSystemDeflection':
