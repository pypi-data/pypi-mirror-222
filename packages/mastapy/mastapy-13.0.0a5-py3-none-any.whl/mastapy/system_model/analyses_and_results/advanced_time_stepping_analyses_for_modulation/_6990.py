...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6988, _6989
...
class BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation(_6995.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2684.BevelDifferentialGearSetSystemDeflection':
    ...
    @property
    def bevel_differential_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6988.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bevel_differential_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6989.BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation]':
