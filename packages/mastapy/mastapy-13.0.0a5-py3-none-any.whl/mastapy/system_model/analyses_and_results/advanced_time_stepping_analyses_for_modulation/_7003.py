...
class ConceptCouplingAdvancedTimeSteppingAnalysisForModulation(_7014.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2701.ConceptCouplingSystemDeflection':
