...
class BearingAdvancedTimeSteppingAnalysisForModulation(_7013.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    """BearingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2680.BearingSystemDeflection':
