...
class StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation(_7083.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2801.StraightBevelPlanetGearSystemDeflection':
