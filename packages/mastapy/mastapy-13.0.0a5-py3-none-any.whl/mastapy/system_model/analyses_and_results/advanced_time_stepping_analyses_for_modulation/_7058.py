...
class PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation(_7014.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2770.PartToPartShearCouplingSystemDeflection':
