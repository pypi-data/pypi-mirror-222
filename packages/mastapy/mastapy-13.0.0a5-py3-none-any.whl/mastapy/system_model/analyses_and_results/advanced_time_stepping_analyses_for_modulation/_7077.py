...
class SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation(_6993.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2791.SpiralBevelGearSystemDeflection':
