...
class BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation(_6988.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2687.BevelDifferentialSunGearSystemDeflection':
