...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7104, _7105
...
class ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6995.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2822.ZerolBevelGearSetSystemDeflection':
    ...
    @property
    def zerol_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7104.ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def zerol_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7105.ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
