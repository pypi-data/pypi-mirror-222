...
class RingPinsAdvancedTimeSteppingAnalysisForModulation(_7055.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2776.RingPinsSystemDeflection':
