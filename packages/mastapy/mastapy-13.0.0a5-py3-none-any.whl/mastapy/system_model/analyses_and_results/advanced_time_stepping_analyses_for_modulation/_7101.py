...
class WormGearAdvancedTimeSteppingAnalysisForModulation(_7035.GearAdvancedTimeSteppingAnalysisForModulation):
    """WormGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2820.WormGearSystemDeflection':
