...
class SynchroniserHalfCompoundSteadyStateSynchronousResponseOnAShaft(_3472.SynchroniserPartCompoundSteadyStateSynchronousResponseOnAShaft):
    """SynchroniserHalfCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3341.SynchroniserHalfSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3341.SynchroniserHalfSteadyStateSynchronousResponseOnAShaft]':
