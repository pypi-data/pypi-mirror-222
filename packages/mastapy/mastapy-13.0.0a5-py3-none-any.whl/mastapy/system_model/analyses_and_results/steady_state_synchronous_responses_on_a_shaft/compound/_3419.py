...
class HypoidGearCompoundSteadyStateSynchronousResponseOnAShaft(_3361.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """HypoidGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3291.HypoidGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3291.HypoidGearSteadyStateSynchronousResponseOnAShaft]':
