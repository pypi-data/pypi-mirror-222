...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft(_3472.SynchroniserPartCompoundSteadyStateSynchronousResponseOnAShaft):
    """SynchroniserSleeveCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3343.SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3343.SynchroniserSleeveSteadyStateSynchronousResponseOnAShaft]':
