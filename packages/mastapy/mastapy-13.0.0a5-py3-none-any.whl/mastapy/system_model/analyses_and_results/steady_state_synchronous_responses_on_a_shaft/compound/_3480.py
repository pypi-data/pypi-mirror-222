...
class WormGearCompoundSteadyStateSynchronousResponseOnAShaft(_3415.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """WormGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3353.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3353.WormGearSteadyStateSynchronousResponseOnAShaft]':
