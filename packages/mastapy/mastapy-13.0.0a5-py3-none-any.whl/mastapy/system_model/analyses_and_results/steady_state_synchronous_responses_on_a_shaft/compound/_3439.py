...
class PartToPartShearCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft(_3396.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    """PartToPartShearCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3308.PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3308.PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft]':
