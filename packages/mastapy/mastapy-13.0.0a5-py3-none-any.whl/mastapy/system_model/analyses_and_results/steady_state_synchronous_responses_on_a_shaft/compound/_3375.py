...
class BevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft(_3363.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponseOnAShaft):
    """BevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3244.BevelGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3244.BevelGearSetSteadyStateSynchronousResponseOnAShaft]':
