...
class StraightBevelPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft(_3462.StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3339.StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3339.StraightBevelPlanetGearSteadyStateSynchronousResponseOnAShaft]':
