...
class ComponentCompoundSteadyStateSynchronousResponseOnAShaft(_3436.PartCompoundSteadyStateSynchronousResponseOnAShaft):
    """ComponentCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3252.ComponentSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3252.ComponentSteadyStateSynchronousResponseOnAShaft]':
