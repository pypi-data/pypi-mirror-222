...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3353, _3351
...
class WormGearSetSteadyStateSynchronousResponseOnAShaft(_3286.GearSetSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def worm_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3353.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3351.WormGearMeshSteadyStateSynchronousResponseOnAShaft]':
