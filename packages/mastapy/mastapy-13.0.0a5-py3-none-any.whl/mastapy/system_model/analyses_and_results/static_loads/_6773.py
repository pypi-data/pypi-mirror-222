...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results import _2621, _2602
...
class TimeSeriesLoadCase(_6771.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    def multibody_dynamics_analysis(self) -> '_2621.MultibodyDynamicsAnalysis':
    ...
    @property
    def driva_analysis_options(self) -> '_5435.MBDAnalysisOptions':
    ...
    @property
    def time_series_load_case_group(self) -> '_5644.TimeSeriesLoadCaseGroup':
    ...
    def duplicate(self, new_load_case_group: '_5644.TimeSeriesLoadCaseGroup', name: Optional['str'] = 'None') -> 'TimeSeriesLoadCase':
