...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_results.rolling.dysla import _2101
    from mastapy.bearings.tolerances import _1901, _1907
...
class BearingLoadCase(_6818.ConnectorLoadCase):
    """BearingLoadCase
    ...
    @property
    def bearing_stiffness_model(self) -> '_5360.BearingStiffnessModel':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.BearingStiffnessModel')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.mbd_analyses._5360', 'BearingStiffnessModel')(value) if value is not None else None

    @bearing_stiffness_model.setter
    def bearing_stiffness_model(self, value: '_5360.BearingStiffnessModel'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.BearingStiffnessModel')
        self.wrapped.BearingStiffnessModel = value

    @property
    def bearing_stiffness_model_used_in_analysis(self) -> '_5360.BearingStiffnessModel':
    ...
    @property
    def include_fitting_effects(self) -> '_1580.LoadCaseOverrideOption':
    ...
    def include_fitting_effects(self, value: '_1580.LoadCaseOverrideOption'):
    ...
    def include_heat_emitted_by_lubricant_in_thermal_limiting_speed_calculation(self, value: 'bool'):
        self.wrapped.IncludeHeatEmittedByLubricantInThermalLimitingSpeedCalculation = bool(value) if value is not None else False
    ...
    @property
    def include_ring_ovality(self) -> '_1580.LoadCaseOverrideOption':
    ...
    def include_ring_ovality(self, value: '_1580.LoadCaseOverrideOption'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Utility.LoadCaseOverrideOption')
        self.wrapped.IncludeRingOvality = value

    @property
    def include_thermal_expansion_effects(self) -> '_1580.LoadCaseOverrideOption':
    ...
    def include_thermal_expansion_effects(self, value: '_1580.LoadCaseOverrideOption'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Utility.LoadCaseOverrideOption')
    ...
    @property
    def dynamic_analysis_options(self) -> '_2101.DynamicBearingAnalysisOptions':
    ...
    @property
    def inner_ring_detail(self) -> '_1901.RaceDetail':
    ...
    @property
    def left_ring_detail(self) -> '_1901.RaceDetail':
    ...
    @property
    def outer_ring_detail(self) -> '_1901.RaceDetail':
    ...
    @property
    def right_ring_detail(self) -> '_1901.RaceDetail':
