...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6930, _6931
...
class StraightBevelGearSetLoadCase(_6797.BevelGearSetLoadCase):
    """StraightBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6930.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6930.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6931.StraightBevelGearMeshLoadCase]':
