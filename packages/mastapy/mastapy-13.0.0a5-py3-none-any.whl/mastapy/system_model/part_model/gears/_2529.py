...
class StraightBevelGear(_2501.BevelGear):
    """StraightBevelGear
    ...
    @property
    def bevel_gear_design(self) -> '_958.StraightBevelGearDesign':
    ...
    @property
    def straight_bevel_gear_design(self) -> '_958.StraightBevelGearDesign':
