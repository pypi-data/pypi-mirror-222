...
class WormGearSet(_2514.GearSet):
    """WormGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_956.WormGearSetDesign':
    ...
    @property
    def worm_gear_set_design(self) -> '_956.WormGearSetDesign':
    ...
    @property
    def worm_gears(self) -> 'List[_2533.WormGear]':
    ...
    @property
    def worm_meshes(self) -> 'List[_2312.WormGearMesh]':
