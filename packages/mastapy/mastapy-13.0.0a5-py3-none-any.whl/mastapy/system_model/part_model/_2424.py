...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results import _1950, _1951
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    class _Cast_BearingRaceMountingOptions:
        ...
        def inner_bearing_race_mounting_options(self):
            ...
            return self._parent._cast(_2441.InnerBearingRaceMountingOptions)

        @property
        def outer_bearing_race_mounting_options(self):
            from mastapy.system_model.part_model import _2450
            
            return self._parent._cast(_2450.OuterBearingRaceMountingOptions)
    ...
    @property
    def mounting_sleeve_material(self) -> '_243.BearingMaterial':
