...
class GuideModelUsage(_0.APIBase):
    ...
    def alignment_method(self) -> 'GuideModelUsage.AlignmentOptions':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.PartModel.GuideModelUsage+AlignmentOptions')
        return constructor.new_from_mastapy('mastapy.system_model.part_model.GuideModelUsage.GuideModelUsage', 'AlignmentOptions')(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: 'GuideModelUsage.AlignmentOptions'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.PartModel.GuideModelUsage+AlignmentOptions')
