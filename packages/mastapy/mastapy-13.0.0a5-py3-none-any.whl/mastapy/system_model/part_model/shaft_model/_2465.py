...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2438, _2439, _2447
...
class Shaft(_2418.AbstractShaft):
    """Shaft
    ...
    def cad_model(self) -> 'list_with_selected_item.ListWithSelectedItem_GuideDxfModel':
        ...
        return constructor.new_from_mastapy('mastapy._internal.implicit.list_with_selected_item', 'ListWithSelectedItem_GuideDxfModel')(temp) if temp is not None else None
    ...
    @property
    def guide_image(self) -> '_2439.GuideImage':
    ...
    @property
    def fe_substructure_replacing_this(self) -> '_2366.FESubstructure':
    ...
    def mount_component(self, component: '_2447.MountableComponent', offset: 'float'):
