...
class SpecifiedConcentricPartGroupDrawingOrder(_0.APIBase):
    ...
    def concentric_group(self) -> 'list_with_selected_item.ListWithSelectedItem_ConcentricPartGroup':
        ...
        return constructor.new_from_mastapy('mastapy._internal.implicit.list_with_selected_item', 'ListWithSelectedItem_ConcentricPartGroup')(temp) if temp is not None else None
