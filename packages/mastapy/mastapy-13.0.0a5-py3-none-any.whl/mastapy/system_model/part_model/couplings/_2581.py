...
if TYPE_CHECKING:
    from mastapy.math_utility.stiffness_calculators import _1527
...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def contact_position(self) -> '_1527.IndividualContactPosition':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.MathUtility.StiffnessCalculators.IndividualContactPosition')
        return constructor.new_from_mastapy('mastapy.math_utility.stiffness_calculators._1527', 'IndividualContactPosition')(value) if value is not None else None
    ...
    @property
    def microgeometry_clearance_chart(self) -> '_1854.TwoDChartDefinition':
    ...
    @property
    def crowning(self) -> '_2567.CrowningSpecification':
