...
if TYPE_CHECKING:
    from mastapy.system_model.fe import _2340, _2347
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2340.AlignmentMethodForRaceBearing':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.FE.AlignmentMethodForRaceBearing')
        return constructor.new_from_mastapy('mastapy.system_model.fe._2340', 'AlignmentMethodForRaceBearing')(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2340.AlignmentMethodForRaceBearing'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.FE.AlignmentMethodForRaceBearing')
    ...
    @property
    def links(self) -> 'List[_2347.BearingRaceNodeLink]':
