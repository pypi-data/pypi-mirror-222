...
class FESubstructureWithSelectionForStaticAnalysis(_2373.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_2383.NodeBoundaryConditionStaticAnalysis]':
    ...
    @property
    def displacement_results(self) -> 'List[_1555.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def force_results(self) -> 'List[_1555.VectorWithLinearAndAngularComponents]':
