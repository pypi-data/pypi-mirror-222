...
class ElectricMachineDynamicLoadData(_0.APIBase):
    ...
    @property
    def electric_machine_data_sets(self) -> 'List[_2356.ElectricMachineDataSet]':
    ...
    def add_electric_machine_data_set(self, name: 'str') -> '_2356.ElectricMachineDataSet':
    ...
    def add_electric_machine_data_set_from_masta_dynamic_force_analysis(self, analysis: '_1330.IHaveDynamicForceResults', slice_index: 'Optional[int]') -> '_2356.ElectricMachineDataSet':
