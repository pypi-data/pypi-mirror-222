...
if TYPE_CHECKING:
    from mastapy.system_model.fe import _2354, _2355
...
class NodeBoundaryConditionStaticAnalysis(_0.APIBase):
    ...
    @property
    def boundary_conditions_angular(self) -> 'List[_2354.DegreeOfFreedomBoundaryConditionAngular]':
    ...
    @property
    def boundary_conditions_linear(self) -> 'List[_2355.DegreeOfFreedomBoundaryConditionLinear]':
