...
if TYPE_CHECKING:
    from mastapy.math_utility import _1482, _1481
...
class AlignConnectedComponentOptions(_0.APIBase):
    ...
    @property
    def component_direction_normal_to_surface(self) -> '_1482.Axis':
    ...
    def component_direction_normal_to_surface(self, value: '_1482.Axis'):
    ...
    @property
    def fe_axis_approximately_in_perpendicular_direction(self) -> '_1481.AlignmentAxis':
    ...
    def fe_axis_approximately_in_perpendicular_direction(self, value: '_1481.AlignmentAxis'):
    ...
    @property
    def first_component_alignment_axis(self) -> '_1482.Axis':
    ...
    def first_component_alignment_axis(self, value: '_1482.Axis'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.MathUtility.Axis')
        self.wrapped.FirstComponentAlignmentAxis = value

    @property
    def first_fe_alignment_axis(self) -> '_1481.AlignmentAxis':
    ...
    def first_fe_alignment_axis(self, value: '_1481.AlignmentAxis'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.MathUtility.AlignmentAxis')
