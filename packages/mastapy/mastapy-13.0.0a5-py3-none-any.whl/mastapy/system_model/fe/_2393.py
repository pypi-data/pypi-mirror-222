...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    def file_type(self) -> 'SystemDeflectionFEExportOptions.ExportType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.FE.SystemDeflectionFEExportOptions+ExportType')
        return constructor.new_from_mastapy('mastapy.system_model.fe.SystemDeflectionFEExportOptions.SystemDeflectionFEExportOptions', 'ExportType')(value) if value is not None else None

    @file_type.setter
    def file_type(self, value: 'SystemDeflectionFEExportOptions.ExportType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.FE.SystemDeflectionFEExportOptions+ExportType')
    ...
    @property
    def links(self) -> 'List[_2387.PerLinkExportOptions]':
    ...
    @property
    def nodes(self) -> 'List[_2388.PerNodeExportOptions]':
    ...
    def set_alternative_fe_mesh_file(self, file_path: 'str', format_: '_166.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0):
    ...
    def set_fe_mesh_file_to_include(self, file_path: 'str', format_: '_166.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0):
