...
class FESubstructureWithSelectionForModalAnalysis(_2373.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_187.FEModelModalAnalysisDrawStyle':
    ...
    @property
    def full_fe_mode_shapes_at_condensation_nodes(self) -> 'List[_2370.FESubstructureNodeModeShapes]':
