...
if TYPE_CHECKING:
    from mastapy.system_model.fe import (
        _2339, _2345, _2394, _2371,
        _2341, _2367, _2378, _2364,
        _2379, _2368, _2392, _2374,
        _2375, _2376, _2377
    )
    from mastapy.system_model.part_model import _2427, _2431, _2436
...
class FESubstructure(_66.FEStiffness):
    ...
    @property
    def alignment_method(self) -> '_2339.AlignmentMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.FE.AlignmentMethod')
        return constructor.new_from_mastapy('mastapy.system_model.fe._2339', 'AlignmentMethod')(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2339.AlignmentMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.FE.AlignmentMethod')
    ...
    @property
    def bearing_node_alignment(self) -> '_2345.BearingNodeAlignmentOption':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.FE.BearingNodeAlignmentOption')
        return constructor.new_from_mastapy('mastapy.system_model.fe._2345', 'BearingNodeAlignmentOption')(value) if value is not None else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2345.BearingNodeAlignmentOption'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.FE.BearingNodeAlignmentOption')
    ...
    def component_to_align_to(self) -> 'list_with_selected_item.ListWithSelectedItem_Component':
        ...
        return constructor.new_from_mastapy('mastapy._internal.implicit.list_with_selected_item', 'ListWithSelectedItem_Component')(temp) if temp is not None else None
    ...
    def datum(self) -> 'list_with_selected_item.ListWithSelectedItem_Datum':
        ...
        return constructor.new_from_mastapy('mastapy._internal.implicit.list_with_selected_item', 'ListWithSelectedItem_Datum')(temp) if temp is not None else None
    ...
    def gravity_force_source(self) -> '_70.GravityForceSource':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.NodalAnalysis.GravityForceSource')
        return constructor.new_from_mastapy('mastapy.nodal_analysis._70', 'GravityForceSource')(value) if value is not None else None
    ...
    @property
    def acoustic_radiation_efficiency(self) -> '_235.AcousticRadiationEfficiency':
    ...
    @property
    def alignment_using_axial_node_positions(self) -> '_2341.AlignmentUsingAxialNodePositions':
    ...
    @property
    def alignment_to_component(self) -> '_2207.RelativeComponentAlignment[_2427.Component]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2427.Component](temp) if temp is not None else None

    @property
    def cms_model(self) -> '_225.CMSModel':
    ...
    @property
    def coordinate_system(self) -> '_1489.CoordinateSystem3D':
    ...
    @property
    def export(self) -> '_2367.FESubstructureExportOptions':
    ...
    @property
    def fe_meshing_options(self) -> '_85.ShaftFEMeshingOptions':
    ...
    @property
    def sound_pressure_enclosure(self) -> '_281.SoundPressureEnclosure':
    ...
    @property
    def gear_meshing_options(self) -> 'List[_2378.GearMeshingOptions]':
    ...
    @property
    def geometries(self) -> 'List[_2364.FEStiffnessGeometry]':
    ...
    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2379.IndependentMASTACreatedCondensationNode]':
    ...
    @property
    def links(self) -> 'List[_2401.FELink]':
    ...
    @property
    def replaced_shafts(self) -> 'List[_2465.Shaft]':
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2392.ReplacedShaftSelectionHelper]':
    ...
    @property
    def thermal_expansion_displacements(self) -> 'List[_1555.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def thermal_expansion_forces(self) -> 'List[_1555.VectorWithLinearAndAngularComponents]':
    ...
    def convert_shafts_to_fe(self, operation: '_60.FEMeshingOperation', export_file_name: 'str'):
        ...
        operation = conversion.mp_to_pn_enum(operation, 'SMT.MastaAPI.NodalAnalysis.FEMeshingOperation')
        export_file_name = str(export_file_name)
        self.wrapped.ConvertShaftsToFE(operation, export_file_name if export_file_name else '')

    def create_fe_substructure_with_selection_components(self) -> '_2374.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2375.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2376.FESubstructureWithSelectionForModalAnalysis':
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2377.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_166.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7525.TaskProgress'] = None):
        ...
        format_ = conversion.mp_to_pn_enum(format_, 'SMT.MastaAPI.NodalAnalysis.FeExportUtility.FEExportFormat')
    ...
    def import_node_positions(self, file_name: 'str', distance_unit: '_1601.Unit'):
    ...
    def import_reduced_stiffness(self, file_name: 'str', distance_unit: '_1601.Unit', force_unit: '_1601.Unit'):
    ...
    def links_for(self, node: '_2368.FESubstructureNode') -> 'List[_2401.FELink]':
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7525.TaskProgress'):
        """ 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def load_stl_geometry(self, length_unit: '_1601.Unit', file_name: 'str'):
