...
class SystemDirectoryPopulator(_0.APIBase):
    ...
    def copy_from(self) -> 'SystemDirectoryPopulator.SetupFrom':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Utility.SystemDirectoryPopulator+SetupFrom')
        return constructor.new_from_mastapy('mastapy.utility.SystemDirectoryPopulator.SystemDirectoryPopulator', 'SetupFrom')(value) if value is not None else None

    @copy_from.setter
    def copy_from(self, value: 'SystemDirectoryPopulator.SetupFrom'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Utility.SystemDirectoryPopulator+SetupFrom')
    ...
    def selected_version(self) -> 'list_with_selected_item.ListWithSelectedItem_SystemDirectory':
        ...
        return constructor.new_from_mastapy('mastapy._internal.implicit.list_with_selected_item', 'ListWithSelectedItem_SystemDirectory')(temp) if temp is not None else None
    ...
    @property
    def current_version(self) -> '_1591.SystemDirectory':
    ...
    @property
    def version_to_copy(self) -> '_1591.SystemDirectory':
