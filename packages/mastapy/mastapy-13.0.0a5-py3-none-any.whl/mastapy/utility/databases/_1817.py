...
TValue = TypeVar('TValue', bound='_1818.NamedDatabaseItem')


class NamedDatabase(_1820.SQLDatabase['_1819.NamedKey', TValue]):
    """NamedDatabase
    ...
    def duplicate(self, new_name: 'str', item: '_1818.NamedDatabaseItem') -> '_1818.NamedDatabaseItem':
    ...
    def rename(self, item: '_1818.NamedDatabaseItem', new_name: 'str') -> 'bool':
