...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def input_type(self) -> '_236.AcousticRadiationEfficiencyInputType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Materials.AcousticRadiationEfficiencyInputType')
        return constructor.new_from_mastapy('mastapy.materials._236', 'AcousticRadiationEfficiencyInputType')(value) if value is not None else None

    @input_type.setter
    def input_type(self, value: '_236.AcousticRadiationEfficiencyInputType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Materials.AcousticRadiationEfficiencyInputType')
    ...
    @property
    def radiation_efficiency_curve(self) -> '_1525.Vector2DListAccessor':
    ...
    def radiation_efficiency_curve(self, value: '_1525.Vector2DListAccessor'):
