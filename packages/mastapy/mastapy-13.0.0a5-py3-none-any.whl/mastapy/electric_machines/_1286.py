...
class RotorInternalLayerSpecification(_0.APIBase):
    ...
    class _Cast_RotorInternalLayerSpecification:
        ...
        def u_shaped_layer_specification(self):
            ...
            return self._parent._cast(_1301.UShapedLayerSpecification)

        @property
        def v_shaped_magnet_layer_specification(self):
            from mastapy.electric_machines import _1302
            
            return self._parent._cast(_1302.VShapedMagnetLayerSpecification)
    ...
    @property
    def magnets(self) -> '_1274.MagnetForLayer':
