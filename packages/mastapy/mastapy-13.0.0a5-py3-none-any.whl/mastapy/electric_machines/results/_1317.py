...
class ElectricMachineResults(_0.APIBase):
    ...
    class _Cast_ElectricMachineResults:
        ...
        def on_load_electric_machine_results(self):
            ...
            return self._parent._cast(_1335.OnLoadElectricMachineResults)

        @property
        def open_circuit_electric_machine_results(self):
            from mastapy.electric_machines.results import _1336
            
            return self._parent._cast(_1336.OpenCircuitElectricMachineResults)
    ...
    @property
    def flux_density_in_air_gap_chart_at_time_0(self) -> '_1854.TwoDChartDefinition':
    ...
    @property
    def force_density_in_air_gap_mst_chart_at_time_0(self) -> '_1854.TwoDChartDefinition':
    ...
    @property
    def results_timesteps(self) -> 'List[_1326.ElectricMachineResultsTimeStep]':
    ...
    @property
    def results_for_conductor_turns(self) -> 'List[_1318.ElectricMachineResultsForConductorTurn]':
    ...
    @property
    def results_for_line_to_line(self) -> 'List[_1320.ElectricMachineResultsForLineToLine]':
    ...
    @property
    def results_for_phases(self) -> 'List[_1322.ElectricMachineResultsForPhase]':
