...
_NON_LINEAR_DQ_MODEL_GENERATOR_SETTINGS = python_net_import('SMT.MastaAPI.ElectricMachines.Results', 'NonLinearDQModelGeneratorSettings')
...
class NonLinearDQModelGeneratorSettings(_0.APIBase):
    ...
    class _Cast_NonLinearDQModelGeneratorSettings:
        ...
        def __init__(self, parent: 'NonLinearDQModelGeneratorSettings'):
            self._parent = parent

        @property
        def non_linear_dq_model_generator_settings(self) -> 'NonLinearDQModelGeneratorSettings':
            return self._parent
    ...
    def __init__(self, instance_to_wrap: 'NonLinearDQModelGeneratorSettings.TYPE'):
    ...
    def exponent_for_ac_winding_loss_temperature_scaling(self, value: 'float'):
        self.wrapped.ExponentForACWindingLossTemperatureScaling = float(value) if value is not None else 0.0
    ...
    def include_ac_winding_losses(self, value: 'bool'):
        self.wrapped.IncludeACWindingLosses = bool(value) if value is not None else False
    ...
    @property
    def cast_to(self) -> 'NonLinearDQModelGeneratorSettings._Cast_NonLinearDQModelGeneratorSettings':
