...
class CoolingDuctLayerSpecification(_0.APIBase):
    ...
    @property
    def shape(self) -> '_1250.CoolingDuctShape':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.ElectricMachines.CoolingDuctShape')
        return constructor.new_from_mastapy('mastapy.electric_machines._1250', 'CoolingDuctShape')(value) if value is not None else None

    @shape.setter
    def shape(self, value: '_1250.CoolingDuctShape'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.ElectricMachines.CoolingDuctShape')
