...
T = TypeVar('T', bound='_682.ProcessSimulationInput')
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    class _Cast_ProcessSimulationNew:
        ...
        def hobbing_process_simulation_new(self):
            ...
            return self._parent._cast(_670.HobbingProcessSimulationNew)
        ...
        def worm_grinding_process_simulation_new(self):
            ...
            return self._parent._cast(_697.WormGrindingProcessSimulationNew)
    ...
    @property
    def gear_tooth_shape_calculation(self) -> '_678.ProcessGearShape':
    ...
    @property
    def lead_calculation(self) -> '_679.ProcessLeadCalculation':
    ...
    @property
    def pitch_calculation(self) -> '_680.ProcessPitchCalculation':
    ...
    @property
    def profile_calculation(self) -> '_681.ProcessProfileCalculation':
    ...
    @property
    def total_modification_calculation(self) -> '_685.ProcessTotalModificationCalculation':
