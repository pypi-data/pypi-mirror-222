...
class PlungeShaverOutputs(_0.APIBase):
    ...
    class _Cast_PlungeShaverOutputs:
        ...
        def real_plunge_shaver_outputs(self):
            ...
            return self._parent._cast(_651.RealPlungeShaverOutputs)

        @property
        def virtual_plunge_shaver_outputs(self):
            from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _654
            
            return self._parent._cast(_654.VirtualPlungeShaverOutputs)
    ...
    @property
    def calculation_details(self) -> '_646.PlungeShaverGeneration':
