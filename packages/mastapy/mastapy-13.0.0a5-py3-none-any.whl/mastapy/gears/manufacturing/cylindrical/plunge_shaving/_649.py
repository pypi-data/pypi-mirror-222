...
class PlungeShaverSettings(_0.APIBase):
    ...
    @property
    def lead_display_method(self) -> '_642.MicroGeometryDefinitionMethod':
    ...
    def lead_display_method(self, value: '_642.MicroGeometryDefinitionMethod'):
    ...
    @property
    def profile_display_method(self) -> '_642.MicroGeometryDefinitionMethod':
    ...
    def profile_display_method(self, value: '_642.MicroGeometryDefinitionMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Manufacturing.Cylindrical.PlungeShaving.MicroGeometryDefinitionMethod')
