...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _729, _734
...
class CutterSimulationCalc(_0.APIBase):
    ...
    class _Cast_CutterSimulationCalc:
        ...
        def form_wheel_grinding_simulation_calculator(self):
            ...
            return self._parent._cast(_735.FormWheelGrindingSimulationCalculator)
    ...
    @property
    def gear(self) -> '_729.CylindricalCutterSimulatableGear':
    ...
    @property
    def stock_removed_at_designed_sap(self) -> '_734.FinishStockPoint':
    ...
    @property
    def stock_removed_at_reference_diameter(self) -> '_734.FinishStockPoint':
    ...
    @property
    def stock_removed_at_rough_tip_form(self) -> '_734.FinishStockPoint':
    ...
    @property
    def finish_stock_indexed_arcs(self) -> 'List[_734.FinishStockPoint]':
    ...
    @property
    def gear_fillet_points(self) -> 'List[_726.NamedPoint]':
    ...
    @property
    def main_profile_finish_stock(self) -> 'List[_734.FinishStockPoint]':
