...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.bevel import _795, _809
...
class ManufacturingMachine(_1818.NamedDatabaseItem):
    """ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_795.MachineTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.Manufacturing.Bevel.MachineTypes')
        return constructor.new_from_mastapy('mastapy.gears.manufacturing.bevel._795', 'MachineTypes')(value) if value is not None else None

    @machine_type.setter
    def machine_type(self, value: '_795.MachineTypes'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Manufacturing.Bevel.MachineTypes')
    ...
    @property
    def wheel_formate_machine_type(self) -> '_809.WheelFormatMachineTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.Manufacturing.Bevel.WheelFormatMachineTypes')
        return constructor.new_from_mastapy('mastapy.gears.manufacturing.bevel._809', 'WheelFormatMachineTypes')(value) if value is not None else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_809.WheelFormatMachineTypes'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Manufacturing.Bevel.WheelFormatMachineTypes')
