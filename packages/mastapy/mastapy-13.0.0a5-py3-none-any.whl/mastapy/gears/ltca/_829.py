...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def gear_load_distribution_analysis(self) -> '_853.CylindricalGearLoadDistributionAnalysis':
    ...
    @property
    def other_gear_load_distribution_analysis(self) -> '_853.CylindricalGearLoadDistributionAnalysis':
    ...
    @property
    def worst_contact_charts(self) -> '_1207.CylindricalGearWorstLTCAContactCharts':
    ...
    @property
    def worst_contact_charts_as_text_files(self) -> '_1206.CylindricalGearWorstLTCAContactChartDataAsTextFile':
    ...
    @property
    def contact_charts(self) -> 'List[_1205.CylindricalGearLTCAContactCharts]':
    ...
    @property
    def contact_charts_as_text_files(self) -> 'List[_1204.CylindricalGearLTCAContactChartDataAsTextFile]':
    ...
    def contact_patch_as_text(self, result_type: '_824.ContactResultType', include_tip_contact: 'bool', file_name_with_path: 'str', start_rotation_index: Optional['int'] = 0):
        ...
        result_type = conversion.mp_to_pn_enum(result_type, 'SMT.MastaAPI.Gears.LTCA.ContactResultType')
    ...
    def contact_patch(self, result_type: '_824.ContactResultType', include_tip_contact: 'bool', start_rotation_index: Optional['int'] = 0) -> '_1505.GriddedSurface':
    ...
    def contact_patch_detailed(self, result_type: '_824.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int', start_rotation_index: Optional['int'] = 0) -> '_1505.GriddedSurface':
        """ 'ContactPatch' is the original name of this method.
