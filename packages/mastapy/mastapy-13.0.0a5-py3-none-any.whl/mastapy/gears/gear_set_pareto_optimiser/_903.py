...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1540, _1537, _1531
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def remove_candidates_with(self) -> '_912.LargerOrSmaller':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearSetParetoOptimiser.LargerOrSmaller')
        return constructor.new_from_mastapy('mastapy.gears.gear_set_pareto_optimiser._912', 'LargerOrSmaller')(value) if value is not None else None

    @remove_candidates_with.setter
    def remove_candidates_with(self, value: '_912.LargerOrSmaller'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearSetParetoOptimiser.LargerOrSmaller')
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1540.ParetoOptimisationStrategy':
    ...
    @property
    def chart_details(self) -> 'List[_901.ChartInfoBase[TAnalysis, TCandidate]]':
    ...
    @property
    def filters(self) -> 'List[_1537.ParetoOptimisationFilter]':
    ...
    @property
    def input_setters(self) -> 'List[_1531.InputSetter[TAnalysis]]':
    ...
    @property
    def optimisation_targets(self) -> 'List[_919.OptimisationTarget[TAnalysis]]':
    ...
    @property
    def reasons_for_invalid_candidates(self) -> 'List[_934.ReasonsForInvalidDesigns]':
