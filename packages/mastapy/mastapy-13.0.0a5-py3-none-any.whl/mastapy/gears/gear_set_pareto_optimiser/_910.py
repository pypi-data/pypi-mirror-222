...
class HypoidGearSetParetoOptimiser(_909.GearSetParetoOptimiser):
    """HypoidGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_984.HypoidGearSetDesign':
    ...
    @property
    def all_candidate_gear_sets(self) -> 'List[_984.HypoidGearSetDesign]':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_984.HypoidGearSetDesign]':
