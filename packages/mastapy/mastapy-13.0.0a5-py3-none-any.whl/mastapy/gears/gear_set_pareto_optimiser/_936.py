...
class StraightBevelGearSetParetoOptimiser(_909.GearSetParetoOptimiser):
    """StraightBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_960.StraightBevelGearSetDesign':
    ...
    @property
    def all_candidate_gear_sets(self) -> 'List[_960.StraightBevelGearSetDesign]':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_960.StraightBevelGearSetDesign]':
