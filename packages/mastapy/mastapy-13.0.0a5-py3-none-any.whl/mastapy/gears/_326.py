...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1078, _1011
...
class GearSetDesignGroup(_0.APIBase):
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_1078.TolerancedMetalMeasurements':
    ...
    def default_rough_toleranced_metal_measurement(self, value: '_1078.TolerancedMetalMeasurements'):
    ...
    @property
    def cylindrical_gear_design_constraint_settings(self) -> '_1011.CylindricalGearDesignConstraints':
    ...
    @property
    def general_transmission_properties(self) -> '_254.GeneralTransmissionProperties':
    ...
    @property
    def settings(self) -> '_452.CylindricalGearDesignAndRatingSettingsItem':
