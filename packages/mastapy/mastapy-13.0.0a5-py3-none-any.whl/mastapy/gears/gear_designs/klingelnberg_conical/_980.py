...
class KlingelnbergConicalGearSetDesign(_1152.ConicalGearSetDesign):
    """KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_1164.KlingelnbergFinishingMethods':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Conical.KlingelnbergFinishingMethods')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.conical._1164', 'KlingelnbergFinishingMethods')(value) if value is not None else None

    @gear_finish.setter
    def gear_finish(self, value: '_1164.KlingelnbergFinishingMethods'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Conical.KlingelnbergFinishingMethods')
    ...
    @property
    def conical_meshes(self) -> 'List[_979.KlingelnbergConicalGearMeshDesign]':
    ...
    @property
    def klingelnberg_conical_meshes(self) -> 'List[_979.KlingelnbergConicalGearMeshDesign]':
