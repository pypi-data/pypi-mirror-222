...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.klingelnberg_hypoid import _974, _975
...
class KlingelnbergCycloPalloidHypoidGearSetDesign(_980.KlingelnbergConicalGearSetDesign):
    """KlingelnbergCycloPalloidHypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_974.KlingelnbergCycloPalloidHypoidGearDesign]':
    ...
    @property
    def klingelnberg_conical_meshes(self) -> 'List[_975.KlingelnbergCycloPalloidHypoidGearMeshDesign]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes(self) -> 'List[_975.KlingelnbergCycloPalloidHypoidGearMeshDesign]':
