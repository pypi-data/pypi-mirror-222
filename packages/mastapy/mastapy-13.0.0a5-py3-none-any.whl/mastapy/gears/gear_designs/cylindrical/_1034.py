...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1035, _1009, _1015
...
class CylindricalMeshedGear(_0.APIBase):
    ...
    @property
    def left_flank(self) -> '_1035.CylindricalMeshedGearFlank':
    ...
    @property
    def right_flank(self) -> '_1035.CylindricalMeshedGearFlank':
    ...
    @property
    def flanks(self) -> 'List[_1035.CylindricalMeshedGearFlank]':
    ...
    @property
    def both_flanks(self) -> '_1035.CylindricalMeshedGearFlank':
    ...
    @property
    def mesh(self) -> '_1015.CylindricalGearMeshDesign':
