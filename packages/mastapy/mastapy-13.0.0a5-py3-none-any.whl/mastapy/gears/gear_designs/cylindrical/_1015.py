...
if TYPE_CHECKING:
    from mastapy.gears import _316, _333
    from mastapy.gears.gear_designs.cylindrical import (
        _1024, _1083, _996, _1025,
        _1016, _1009, _1034
    )
...
class CylindricalGearMeshDesign(_946.GearMeshDesign):
    ...
    @property
    def centre_distance_change_method(self) -> '_316.CentreDistanceChangeMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.CentreDistanceChangeMethod')
        return constructor.new_from_mastapy('mastapy.gears._316', 'CentreDistanceChangeMethod')(value) if value is not None else None

    @centre_distance_change_method.setter
    def centre_distance_change_method(self, value: '_316.CentreDistanceChangeMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.CentreDistanceChangeMethod')
    ...
    @property
    def filter_cutoff_wavelength(self) -> 'float':
    ...
    def filter_cutoff_wavelength(self, value: 'float'):
    ...
    @property
    def profile_modification(self) -> '_1024.CylindricalGearProfileModifications':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CylindricalGearProfileModifications')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.cylindrical._1024', 'CylindricalGearProfileModifications')(value) if value is not None else None

    @profile_modification.setter
    def profile_modification(self, value: '_1024.CylindricalGearProfileModifications'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CylindricalGearProfileModifications')
    ...
    @property
    def type_of_mechanism_housing(self) -> '_1083.TypeOfMechanismHousing':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.TypeOfMechanismHousing')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.cylindrical._1083', 'TypeOfMechanismHousing')(value) if value is not None else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_1083.TypeOfMechanismHousing'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.TypeOfMechanismHousing')
    ...
    @property
    def valid_normal_module_range(self) -> '_1479.Range':
    ...
    @property
    def backlash_specification(self) -> '_996.BacklashSpecification':
    ...
    @property
    def left_flank(self) -> '_1016.CylindricalGearMeshFlankDesign':
    ...
    @property
    def right_flank(self) -> '_1016.CylindricalGearMeshFlankDesign':
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_1034.CylindricalMeshedGear]':
    ...
    @property
    def flanks(self) -> 'List[_1016.CylindricalGearMeshFlankDesign]':
    ...
    @property
    def both_flanks(self) -> '_1016.CylindricalGearMeshFlankDesign':
    ...
    @property
    def gear_a(self) -> '_1009.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_1009.CylindricalGearDesign':
