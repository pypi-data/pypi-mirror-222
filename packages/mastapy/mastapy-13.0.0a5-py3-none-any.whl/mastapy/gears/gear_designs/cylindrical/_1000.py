...
class CrossedAxisCylindricalGearPair(_0.APIBase):
    ...
    class _Cast_CrossedAxisCylindricalGearPair:
        ...
        def crossed_axis_cylindrical_gear_pair_line_contact(self):
            ...
            return self._parent._cast(_1001.CrossedAxisCylindricalGearPairLineContact)

        @property
        def crossed_axis_cylindrical_gear_pair_point_contact(self):
            from mastapy.gears.gear_designs.cylindrical import _1002
            
            return self._parent._cast(_1002.CrossedAxisCylindricalGearPairPointContact)
    ...
    @property
    def shaver(self) -> '_729.CylindricalCutterSimulatableGear':
