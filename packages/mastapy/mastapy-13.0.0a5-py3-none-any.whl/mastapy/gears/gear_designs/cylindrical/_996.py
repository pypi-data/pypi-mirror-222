...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1054, _1033
...
class BacklashSpecification(_1064.RelativeValuesSpecification['BacklashSpecification']):
    """BacklashSpecification
    ...
    @property
    def left_flank(self) -> '_1054.LinearBacklashSpecification':
        """LinearBacklashSpecification: 'LeftFlank' is the original name of this property.
    ...
    @property
    def right_flank(self) -> '_1054.LinearBacklashSpecification':
        """LinearBacklashSpecification: 'RightFlank' is the original name of this property.
    ...
    @property
    def angular_backlash(self) -> 'List[_1033.CylindricalMeshAngularBacklash]':
    ...
    @property
    def flanks(self) -> 'List[_1054.LinearBacklashSpecification]':
        """List[LinearBacklashSpecification]: 'Flanks' is the original name of this property.
    ...
    @property
    def both_flanks(self) -> '_1054.LinearBacklashSpecification':
        """LinearBacklashSpecification: 'BothFlanks' is the original name of this property.
