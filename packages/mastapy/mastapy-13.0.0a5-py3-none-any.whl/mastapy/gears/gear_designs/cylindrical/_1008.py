...
class CylindricalGearDefaults(_1585.PerMachineSettings):
    """CylindricalGearDefaults
    ...
    @property
    def finish_stock_type(self) -> '_1086.FinishStockType':
    ...
    def finish_stock_type(self, value: '_1086.FinishStockType'):
    ...
    @property
    def system_of_fits_defaults(self) -> '_1136.DIN3967SystemOfGearFits':
