...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1009, _1004
...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    class _Cast_CylindricalGearAbstractRack:
        ...
        def cylindrical_gear_pinion_type_cutter(self):
            ...
            return self._parent._cast(_1020.CylindricalGearPinionTypeCutter)
    ...
    @property
    def left_flank(self) -> '_1004.CylindricalGearAbstractRackFlank':
    ...
    @property
    def right_flank(self) -> '_1004.CylindricalGearAbstractRackFlank':
    ...
    @property
    def shaper_for_agma_rating(self) -> '_711.CylindricalGearShaper':
    ...
    @property
    def flanks(self) -> 'List[_1004.CylindricalGearAbstractRackFlank]':
    ...
    @property
    def both_flanks(self) -> '_1004.CylindricalGearAbstractRackFlank':
