...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1127, _1121
...
class MeshedCylindricalGearFlankMicroGeometry(_0.APIBase):
    ...
    @property
    def involute_inspection_points(self) -> 'List[_1127.TotalProfileReliefWithDeviation]':
    ...
    @property
    def profile_form_relief_points(self) -> 'List[_1121.ProfileFormReliefWithDeviation]':
