...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1003, _1009
...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    class _Cast_CylindricalGearAbstractRackFlank:
        ...
        def cylindrical_gear_pinion_type_cutter_flank(self):
            ...
            return self._parent._cast(_1021.CylindricalGearPinionTypeCutterFlank)

        @property
        def standard_rack_flank(self):
            from mastapy.gears.gear_designs.cylindrical import _1073
            
            return self._parent._cast(_1073.StandardRackFlank)
    ...
    def protuberance_specification(self) -> 'CylindricalGearAbstractRackFlank.ProtuberanceSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CylindricalGearAbstractRackFlank+ProtuberanceSpecificationMethod')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank.CylindricalGearAbstractRackFlank', 'ProtuberanceSpecificationMethod')(value) if value is not None else None
    ...
    def protuberance_specification(self, value: 'CylindricalGearAbstractRackFlank.ProtuberanceSpecificationMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CylindricalGearAbstractRackFlank+ProtuberanceSpecificationMethod')
    ...
    @property
    def cutter(self) -> '_1003.CylindricalGearAbstractRack':
    ...
    @property
    def gear(self) -> '_1009.CylindricalGearDesign':
