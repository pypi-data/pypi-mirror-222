...
class CylindricalMeshedGearFlank(_0.APIBase):
    ...
    @property
    def end_of_active_profile(self) -> '_1022.CylindricalGearProfileMeasurement':
    ...
    @property
    def start_of_active_profile(self) -> '_1022.CylindricalGearProfileMeasurement':
    ...
    @property
    def working_pitch(self) -> '_1022.CylindricalGearProfileMeasurement':
