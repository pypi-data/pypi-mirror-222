...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _999, _1044
...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    @property
    def create_new_suitable_cutters(self) -> '_999.CreateNewSuitableCutterOption':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CreateNewSuitableCutterOption')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.cylindrical._999', 'CreateNewSuitableCutterOption')(value) if value is not None else None

    @create_new_suitable_cutters.setter
    def create_new_suitable_cutters(self, value: '_999.CreateNewSuitableCutterOption'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CreateNewSuitableCutterOption')
    ...
    @property
    def use_as_design_mode_geometry(self) -> '_999.CreateNewSuitableCutterOption':
    ...
    def use_as_design_mode_geometry(self, value: '_999.CreateNewSuitableCutterOption'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CreateNewSuitableCutterOption')
        self.wrapped.UseAsDesignModeGeometry = value

    @property
    def gears(self) -> 'List[_1044.GearManufacturingConfigSetupViewModel]':
