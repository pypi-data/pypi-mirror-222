...
class FaceGearWheelDesign(_986.FaceGearDesign):
    """FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_987.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Face.FaceGearDiameterFaceWidthSpecificationMethod')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.face._987', 'FaceGearDiameterFaceWidthSpecificationMethod')(value) if value is not None else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_987.FaceGearDiameterFaceWidthSpecificationMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Face.FaceGearDiameterFaceWidthSpecificationMethod')
