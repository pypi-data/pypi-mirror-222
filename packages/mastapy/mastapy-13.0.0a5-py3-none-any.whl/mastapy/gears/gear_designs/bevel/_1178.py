...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.bevel import _1187, _1185, _1186
...
class BevelGearSetDesign(_1191.AGMAGleasonConicalGearSetDesign):
    """BevelGearSetDesign
    ...
    @property
    def backlash_distribution_rule(self) -> '_1147.BacklashDistributionRule':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Conical.BacklashDistributionRule')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.conical._1147', 'BacklashDistributionRule')(value) if value is not None else None

    @backlash_distribution_rule.setter
    def backlash_distribution_rule(self, value: '_1147.BacklashDistributionRule'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Conical.BacklashDistributionRule')
        self.wrapped.BacklashDistributionRule = value

    @property
    def backlash_used_for_tooth_thickness_calculation(self) -> '_1509.MaxMinMean':
        ...
        return constructor.new_from_mastapy('mastapy.math_utility._1509', 'MaxMinMean')(value) if value is not None else None

    @backlash_used_for_tooth_thickness_calculation.setter
    def backlash_used_for_tooth_thickness_calculation(self, value: '_1509.MaxMinMean'):
    ...
    @property
    def round_cutter_specifications(self) -> '_1187.WheelFinishCutterPointWidthRestrictionMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Bevel.WheelFinishCutterPointWidthRestrictionMethod')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.bevel._1187', 'WheelFinishCutterPointWidthRestrictionMethod')(value) if value is not None else None

    @round_cutter_specifications.setter
    def round_cutter_specifications(self, value: '_1187.WheelFinishCutterPointWidthRestrictionMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Bevel.WheelFinishCutterPointWidthRestrictionMethod')
    ...
    @property
    def tooth_proportions_input_method(self) -> '_1185.ToothProportionsInputMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Bevel.ToothProportionsInputMethod')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.bevel._1185', 'ToothProportionsInputMethod')(value) if value is not None else None

    @tooth_proportions_input_method.setter
    def tooth_proportions_input_method(self, value: '_1185.ToothProportionsInputMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Bevel.ToothProportionsInputMethod')
        self.wrapped.ToothProportionsInputMethod = value

    @property
    def tooth_taper_root_line_tilt_method(self) -> '_345.SpiralBevelRootLineTilt':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.SpiralBevelRootLineTilt')
        return constructor.new_from_mastapy('mastapy.gears._345', 'SpiralBevelRootLineTilt')(value) if value is not None else None

    @tooth_taper_root_line_tilt_method.setter
    def tooth_taper_root_line_tilt_method(self, value: '_345.SpiralBevelRootLineTilt'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.SpiralBevelRootLineTilt')
