...
class PlasticSNCurve(_0.APIBase):
    ...
    class _Cast_PlasticSNCurve:
        ...
        def plastic_sn_curve_for_the_specified_operating_conditions(self):
            ...
            return self._parent._cast(_492.PlasticSNCurveForTheSpecifiedOperatingConditions)
    ...
    @property
    def material(self) -> '_600.PlasticCylindricalGearMaterial':
    ...
    @property
    def bending_stress_cycle_data(self) -> 'List[_283.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
    ...
    @property
    def contact_stress_cycle_data(self) -> 'List[_284.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
