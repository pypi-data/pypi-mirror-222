...
class CylindricalGearMaterial(_591.GearMaterial):
    """CylindricalGearMaterial
    ...
    @property
    def heat_treatment_distortion_control(self) -> '_599.ManufactureRating':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.Materials.ManufactureRating')
        return constructor.new_from_mastapy('mastapy.gears.materials._599', 'ManufactureRating')(value) if value is not None else None

    @heat_treatment_distortion_control.setter
    def heat_treatment_distortion_control(self, value: '_599.ManufactureRating'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Materials.ManufactureRating')
        self.wrapped.HeatTreatmentDistortionControl = value

    @property
    def heat_treatment_process_development(self) -> '_599.ManufactureRating':
    ...
    def heat_treatment_process_development(self, value: '_599.ManufactureRating'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Materials.ManufactureRating')
        self.wrapped.HeatTreatmentProcessDevelopment = value

    @property
    def machine_process_development(self) -> '_599.ManufactureRating':
    ...
    def machine_process_development(self, value: '_599.ManufactureRating'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Materials.ManufactureRating')
        self.wrapped.MachineProcessDevelopment = value

    @property
    def manufacturability(self) -> '_599.ManufactureRating':
    ...
    def manufacturability(self, value: '_599.ManufactureRating'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Materials.ManufactureRating')
