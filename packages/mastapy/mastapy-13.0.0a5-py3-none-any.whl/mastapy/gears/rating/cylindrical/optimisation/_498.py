...
class CylindricalGearSetRatingOptimisationHelper(_0.APIBase):
    ...
    @property
    def helix_angle_optimisation_results(self) -> '_499.OptimisationResultsPair[_502.SafetyFactorOptimisationStepResultAngle]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_502.SafetyFactorOptimisationStepResultAngle](temp) if temp is not None else None

    @property
    def normal_module_optimisation_results(self) -> '_499.OptimisationResultsPair[_504.SafetyFactorOptimisationStepResultShortLength]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_504.SafetyFactorOptimisationStepResultShortLength](temp) if temp is not None else None

    @property
    def pressure_angle_optimisation_results(self) -> '_499.OptimisationResultsPair[_502.SafetyFactorOptimisationStepResultAngle]':
    ...
    @property
    def profile_shift_coefficient_optimisation_results(self) -> '_499.OptimisationResultsPair[_503.SafetyFactorOptimisationStepResultNumber]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_503.SafetyFactorOptimisationStepResultNumber](temp) if temp is not None else None

    @property
    def all_helix_angle_optimisation_results(self) -> 'List[_500.SafetyFactorOptimisationResults[_502.SafetyFactorOptimisationStepResultAngle]]':
    ...
    @property
    def all_normal_module_optimisation_results(self) -> 'List[_500.SafetyFactorOptimisationResults[_504.SafetyFactorOptimisationStepResultShortLength]]':
    ...
    @property
    def all_normal_pressure_angle_optimisation_results(self) -> 'List[_500.SafetyFactorOptimisationResults[_502.SafetyFactorOptimisationStepResultAngle]]':
    ...
    @property
    def all_profile_shift_optimisation_results(self) -> 'List[_500.SafetyFactorOptimisationResults[_503.SafetyFactorOptimisationStepResultNumber]]':
    ...
    @property
    def helix_angle_and_normal_pressure_angle_optimisation_results(self) -> 'List[_500.SafetyFactorOptimisationResults[_502.SafetyFactorOptimisationStepResultAngle]]':
