...
class PlasticGearVDI2736AbstractMeshSingleFlankRating(_515.ISO6336AbstractMeshSingleFlankRating):
    """PlasticGearVDI2736AbstractMeshSingleFlankRating
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_488.PlasticGearVDI2736AbstractGearSingleFlankRating]':
    ...
    @property
    def plastic_vdi2736_cylindrical_gear_single_flank_ratings(self) -> 'List[_488.PlasticGearVDI2736AbstractGearSingleFlankRating]':
