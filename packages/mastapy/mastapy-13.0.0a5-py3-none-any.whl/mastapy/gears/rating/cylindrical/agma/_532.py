...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1024, _1068
    from mastapy.gears.rating.cylindrical.agma import _534, _531
...
class AGMA2101MeshSingleFlankRating(_465.CylindricalMeshSingleFlankRating):
    ...
    @property
    def scuffing_temperature_method(self) -> '_1068.ScuffingTemperatureMethodsAGMA':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.ScuffingTemperatureMethodsAGMA')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.cylindrical._1068', 'ScuffingTemperatureMethodsAGMA')(value) if value is not None else None
    ...
    @property
    def thermal_reduction_factor_factors_and_exponents(self) -> '_534.ThermalReductionFactorFactorsAndExponents':
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_531.AGMA2101GearSingleFlankRating]':
    ...
    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_531.AGMA2101GearSingleFlankRating]':
