...
class ShaftSectionEndDamageResults(_0.APIBase):
    ...
    @property
    def section_end(self) -> '_84.SectionEnd':
        ...
        return constructor.new_from_mastapy('mastapy.nodal_analysis._84', 'SectionEnd')(value) if value is not None else None
    ...
    @property
    def sn_curve(self) -> '_279.SNCurve':
    ...
    @property
    def sn_curve_axial(self) -> '_279.SNCurve':
    ...
    @property
    def sn_curve_bending_x(self) -> '_279.SNCurve':
    ...
    @property
    def sn_curve_bending_y(self) -> '_279.SNCurve':
    ...
    @property
    def sn_curve_torsional(self) -> '_279.SNCurve':
