...
class ElectricMachineDataSet(_0.APIBase):
    ...
    def node_for_first_tooth(self) -> 'list_with_selected_item.ListWithSelectedItem_FESubstructureNode':
        ...
        return constructor.new_from_mastapy('mastapy._internal.implicit.list_with_selected_item', 'ListWithSelectedItem_FESubstructureNode')(temp) if temp is not None else None
    ...
    @property
    def torque_ripple_input_type(self) -> '_6944.TorqueRippleInputType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.StaticLoads.TorqueRippleInputType')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.static_loads._6944', 'TorqueRippleInputType')(value) if value is not None else None

    @torque_ripple_input_type.setter
    def torque_ripple_input_type(self, value: '_6944.TorqueRippleInputType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.StaticLoads.TorqueRippleInputType')
    ...
    def add_or_replace_excitation_data_with_amplitudes_phases_and_fe_node(self, harmonic_load_data_type: '_1372.HarmonicLoadDataType', node: '_2368.FESubstructureNode', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7526.MeasurementType'):
        ...
        fourier_series_measurement_type = conversion.mp_to_pn_enum(fourier_series_measurement_type, 'SMT.MastaAPIUtility.UnitsAndMeasurements.MeasurementType')
    ...
    def add_or_replace_excitation_data_with_fe_node(self, harmonic_load_data_type: '_1372.HarmonicLoadDataType', node: '_2368.FESubstructureNode', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7526.MeasurementType'):
        """ 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_amplitudes_and_phases(self, harmonic_load_data_type: '_1372.HarmonicLoadDataType', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7526.MeasurementType'):
        """ 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def add_or_replace_excitation_data(self, harmonic_load_data_type: '_1372.HarmonicLoadDataType', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7526.MeasurementType'):
        """ 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def multiple_fourier_series_interpolator_for(self, harmonic_load_data_type: '_1372.HarmonicLoadDataType') -> '_1511.MultipleFourierSeriesInterpolator':
    ...
    def multiple_fourier_series_interpolator_for_with_fe_node(self, harmonic_load_data_type: '_1372.HarmonicLoadDataType', node: '_2368.FESubstructureNode') -> '_1511.MultipleFourierSeriesInterpolator':
        """ 'MultipleFourierSeriesInterpolatorFor' is the original name of this method.
