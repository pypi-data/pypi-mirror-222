...
if TYPE_CHECKING:
    from mastapy.system_model.fe.version_comparer import _2399, _2395
...
class FESubstructureVersionComparer(_0.APIBase):
    ...
    @property
    def load_cases_to_run(self) -> '_2399.LoadCasesToRun':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.FE.VersionComparer.LoadCasesToRun')
        return constructor.new_from_mastapy('mastapy.system_model.fe.version_comparer._2399', 'LoadCasesToRun')(value) if value is not None else None

    @load_cases_to_run.setter
    def load_cases_to_run(self, value: '_2399.LoadCasesToRun'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.FE.VersionComparer.LoadCasesToRun')
    ...
    @property
    def design_results(self) -> 'List[_2395.DesignResults]':
