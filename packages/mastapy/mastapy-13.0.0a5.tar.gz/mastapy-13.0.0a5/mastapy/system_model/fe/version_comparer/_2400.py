...
if TYPE_CHECKING:
    from mastapy.math_utility.measured_vectors import _1555, _1553
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def displacement_change(self) -> '_1555.VectorWithLinearAndAngularComponents':
    ...
    @property
    def new_result(self) -> '_1553.NodeResults':
    ...
    @property
    def original_result(self) -> '_1553.NodeResults':
