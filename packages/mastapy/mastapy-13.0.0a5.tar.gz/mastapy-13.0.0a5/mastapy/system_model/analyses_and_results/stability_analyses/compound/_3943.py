...
class KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis(_3909.ConicalGearCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3814.KlingelnbergCycloPalloidConicalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3814.KlingelnbergCycloPalloidConicalGearStabilityAnalysis]':
