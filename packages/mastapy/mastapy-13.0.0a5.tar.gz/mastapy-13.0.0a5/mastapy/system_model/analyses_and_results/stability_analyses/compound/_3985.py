...
class StraightBevelGearCompoundStabilityAnalysis(_3893.BevelGearCompoundStabilityAnalysis):
    """StraightBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3858.StraightBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3858.StraightBevelGearStabilityAnalysis]':
