...
class SpiralBevelGearMeshCompoundStabilityAnalysis(_3894.BevelGearMeshCompoundStabilityAnalysis):
    """SpiralBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3845.SpiralBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3845.SpiralBevelGearMeshStabilityAnalysis]':
