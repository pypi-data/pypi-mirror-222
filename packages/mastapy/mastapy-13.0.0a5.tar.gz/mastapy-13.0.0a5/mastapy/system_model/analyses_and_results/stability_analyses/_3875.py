...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.stability_analyses import _3876, _3874
...
class ZerolBevelGearSetStabilityAnalysis(_3762.BevelGearSetStabilityAnalysis):
    """ZerolBevelGearSetStabilityAnalysis
    ...
    @property
    def zerol_bevel_gears_stability_analysis(self) -> 'List[_3876.ZerolBevelGearStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_stability_analysis(self) -> 'List[_3874.ZerolBevelGearMeshStabilityAnalysis]':
