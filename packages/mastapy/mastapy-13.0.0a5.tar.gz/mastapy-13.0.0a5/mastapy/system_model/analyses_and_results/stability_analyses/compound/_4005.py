...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.stability_analyses.compound import _4003, _4004
...
class ZerolBevelGearSetCompoundStabilityAnalysis(_3895.BevelGearSetCompoundStabilityAnalysis):
    """ZerolBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3875.ZerolBevelGearSetStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_stability_analysis(self) -> 'List[_4003.ZerolBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_stability_analysis(self) -> 'List[_4004.ZerolBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3875.ZerolBevelGearSetStabilityAnalysis]':
