...
class PartToPartShearCouplingHalfCompoundStabilityAnalysis(_3916.CouplingHalfCompoundStabilityAnalysis):
    """PartToPartShearCouplingHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3827.PartToPartShearCouplingHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3827.PartToPartShearCouplingHalfStabilityAnalysis]':
