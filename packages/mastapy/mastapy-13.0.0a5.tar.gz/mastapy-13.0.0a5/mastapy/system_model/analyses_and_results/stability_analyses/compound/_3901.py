...
class CoaxialConnectionCompoundStabilityAnalysis(_3974.ShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """CoaxialConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3769.CoaxialConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3769.CoaxialConnectionStabilityAnalysis]':
