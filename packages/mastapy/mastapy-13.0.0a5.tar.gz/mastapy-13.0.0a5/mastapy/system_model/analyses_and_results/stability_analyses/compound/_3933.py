...
class FEPartCompoundStabilityAnalysis(_3879.AbstractShaftOrHousingCompoundStabilityAnalysis):
    """FEPartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3802.FEPartStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3802.FEPartStabilityAnalysis]':
