...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.stability_analyses.compound import (
        _3885, _3887, _3890, _3897,
        _3896, _3918, _3898, _3903,
        _3908, _3920, _3922, _3926,
        _3933, _3932, _3934, _3941,
        _3948, _3951, _3952, _3953,
        _3955, _3957, _3962, _3963,
        _3964, _3966, _3968, _3973,
        _3972, _3978, _3979, _3984,
        _3987, _3990, _3994, _3998,
        _4002, _4005
    )
...
class AssemblyCompoundStabilityAnalysis(_3877.AbstractAssemblyCompoundStabilityAnalysis):
    """AssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3752.AssemblyStabilityAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_3885.BearingCompoundStabilityAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_3887.BeltDriveCompoundStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3890.BevelDifferentialGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3897.BoltedJointCompoundStabilityAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_3896.BoltCompoundStabilityAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_3918.CVTCompoundStabilityAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_3898.ClutchCompoundStabilityAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3903.ConceptCouplingCompoundStabilityAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3908.ConceptGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3920.CycloidalAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3922.CycloidalDiscCompoundStabilityAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3926.CylindricalGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_3933.FEPartCompoundStabilityAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3932.FaceGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3934.FlexiblePinAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3941.HypoidGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3948.KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3951.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_3952.MassDiscCompoundStabilityAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_3953.MeasurementComponentCompoundStabilityAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_3955.OilSealCompoundStabilityAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3957.PartToPartShearCouplingCompoundStabilityAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3962.PlanetCarrierCompoundStabilityAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_3963.PointLoadCompoundStabilityAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_3964.PowerLoadCompoundStabilityAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_3966.RingPinsCompoundStabilityAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3968.RollingRingAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3973.ShaftHubConnectionCompoundStabilityAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_3972.ShaftCompoundStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3978.SpiralBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3979.SpringDamperCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3984.StraightBevelDiffGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3987.StraightBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_3990.SynchroniserCompoundStabilityAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_3994.TorqueConverterCompoundStabilityAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3998.UnbalancedMassCompoundStabilityAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4002.WormGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4005.ZerolBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3752.AssemblyStabilityAnalysis]':
