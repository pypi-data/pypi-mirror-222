...
class BevelGearSetCompoundStabilityAnalysis(_3883.AGMAGleasonConicalGearSetCompoundStabilityAnalysis):
    """BevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3762.BevelGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3762.BevelGearSetStabilityAnalysis]':
