...
class ConicalGearMeshCompoundModalAnalysisAtASpeed(_5280.GearMeshCompoundModalAnalysisAtASpeed):
    """ConicalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5124.ConicalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5124.ConicalGearMeshModalAnalysisAtASpeed]':
