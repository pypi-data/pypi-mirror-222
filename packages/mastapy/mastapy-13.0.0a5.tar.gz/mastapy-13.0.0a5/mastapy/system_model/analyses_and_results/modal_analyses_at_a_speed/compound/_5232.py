...
class BevelDifferentialGearCompoundModalAnalysisAtASpeed(_5237.BevelGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5104.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5104.BevelDifferentialGearModalAnalysisAtASpeed]':
