...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import (
        _5229, _5231, _5234, _5241,
        _5240, _5262, _5242, _5247,
        _5252, _5264, _5266, _5270,
        _5277, _5276, _5278, _5285,
        _5292, _5295, _5296, _5297,
        _5299, _5301, _5306, _5307,
        _5308, _5310, _5312, _5317,
...
class AssemblyCompoundModalAnalysisAtASpeed(_5221.AbstractAssemblyCompoundModalAnalysisAtASpeed):
    """AssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5099.AssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def bearings(self) -> 'List[_5229.BearingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_5231.BeltDriveCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5234.BevelDifferentialGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5241.BoltedJointCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_5240.BoltCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_5262.CVTCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_5242.ClutchCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5247.ConceptCouplingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5252.ConceptGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5264.CycloidalAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5266.CycloidalDiscCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5270.CylindricalGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_5277.FEPartCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5276.FaceGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5278.FlexiblePinAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5285.HypoidGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5292.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5295.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_5296.MassDiscCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_5297.MeasurementComponentCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_5299.OilSealCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5301.PartToPartShearCouplingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5306.PlanetCarrierCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_5307.PointLoadCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_5308.PowerLoadCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_5310.RingPinsCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5312.RollingRingAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5317.ShaftHubConnectionCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_5316.ShaftCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5322.SpiralBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5323.SpringDamperCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5328.StraightBevelDiffGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5331.StraightBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_5334.SynchroniserCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_5338.TorqueConverterCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5342.UnbalancedMassCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5346.WormGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5349.ZerolBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5099.AssemblyModalAnalysisAtASpeed]':
