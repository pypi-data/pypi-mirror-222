...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5232, _5233
...
class BevelDifferentialGearSetCompoundModalAnalysisAtASpeed(_5239.BevelGearSetCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5105.BevelDifferentialGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5232.BevelDifferentialGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5233.BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5105.BevelDifferentialGearSetModalAnalysisAtASpeed]':
