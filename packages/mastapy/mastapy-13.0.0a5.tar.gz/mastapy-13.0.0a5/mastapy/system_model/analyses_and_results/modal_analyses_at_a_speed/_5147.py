...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5146, _5145
...
class FaceGearSetModalAnalysisAtASpeed(_5152.GearSetModalAnalysisAtASpeed):
    """FaceGearSetModalAnalysisAtASpeed
    ...
    @property
    def face_gears_modal_analysis_at_a_speed(self) -> 'List[_5146.FaceGearModalAnalysisAtASpeed]':
    ...
    @property
    def face_meshes_modal_analysis_at_a_speed(self) -> 'List[_5145.FaceGearMeshModalAnalysisAtASpeed]':
