...
class RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed(_5286.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5182.RingPinsToDiscConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5182.RingPinsToDiscConnectionModalAnalysisAtASpeed]':
