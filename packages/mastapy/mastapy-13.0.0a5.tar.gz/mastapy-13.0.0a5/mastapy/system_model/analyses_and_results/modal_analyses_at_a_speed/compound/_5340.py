...
class TorqueConverterPumpCompoundModalAnalysisAtASpeed(_5260.CouplingHalfCompoundModalAnalysisAtASpeed):
    """TorqueConverterPumpCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5211.TorqueConverterPumpModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5211.TorqueConverterPumpModalAnalysisAtASpeed]':
