...
class PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed(_5259.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5172.PartToPartShearCouplingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5172.PartToPartShearCouplingConnectionModalAnalysisAtASpeed]':
