...
class InterMountableComponentConnectionCompoundModalAnalysisAtASpeed(_5256.ConnectionCompoundModalAnalysisAtASpeed):
    """InterMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5157.InterMountableComponentConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5157.InterMountableComponentConnectionModalAnalysisAtASpeed]':
