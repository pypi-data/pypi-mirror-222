...
class PartToPartShearCouplingHalfCompoundModalAnalysisAtASpeed(_5260.CouplingHalfCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5173.PartToPartShearCouplingHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5173.PartToPartShearCouplingHalfModalAnalysisAtASpeed]':
