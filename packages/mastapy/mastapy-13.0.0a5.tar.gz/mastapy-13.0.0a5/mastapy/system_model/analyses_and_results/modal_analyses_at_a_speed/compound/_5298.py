...
class MountableComponentCompoundModalAnalysisAtASpeed(_5246.ComponentCompoundModalAnalysisAtASpeed):
    """MountableComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5169.MountableComponentModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5169.MountableComponentModalAnalysisAtASpeed]':
