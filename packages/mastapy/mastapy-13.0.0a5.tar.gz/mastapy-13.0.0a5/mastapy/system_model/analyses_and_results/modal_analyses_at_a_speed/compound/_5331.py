...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5329, _5330
...
class StraightBevelGearSetCompoundModalAnalysisAtASpeed(_5239.BevelGearSetCompoundModalAnalysisAtASpeed):
    """StraightBevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5202.StraightBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5329.StraightBevelGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5330.StraightBevelGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5202.StraightBevelGearSetModalAnalysisAtASpeed]':
