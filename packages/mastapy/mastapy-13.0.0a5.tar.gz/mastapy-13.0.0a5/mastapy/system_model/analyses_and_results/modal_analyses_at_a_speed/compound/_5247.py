...
class ConceptCouplingCompoundModalAnalysisAtASpeed(_5258.CouplingCompoundModalAnalysisAtASpeed):
    """ConceptCouplingCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5120.ConceptCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5120.ConceptCouplingModalAnalysisAtASpeed]':
