...
class SpiralBevelGearMeshCompoundModalAnalysisAtASpeed(_5238.BevelGearMeshCompoundModalAnalysisAtASpeed):
    """SpiralBevelGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5191.SpiralBevelGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5191.SpiralBevelGearMeshModalAnalysisAtASpeed]':
