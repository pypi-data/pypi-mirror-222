...
class CycloidalDiscCompoundModalAnalysisAtASpeed(_5222.AbstractShaftCompoundModalAnalysisAtASpeed):
    """CycloidalDiscCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5137.CycloidalDiscModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5137.CycloidalDiscModalAnalysisAtASpeed]':
