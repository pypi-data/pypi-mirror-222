...
class PulleyCompoundModalAnalysisAtASpeed(_5260.CouplingHalfCompoundModalAnalysisAtASpeed):
    """PulleyCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5180.PulleyModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5180.PulleyModalAnalysisAtASpeed]':
