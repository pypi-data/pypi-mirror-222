...
class TorqueConverterConnectionCompoundModalAnalysisAtASpeed(_5259.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """TorqueConverterConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5209.TorqueConverterConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5209.TorqueConverterConnectionModalAnalysisAtASpeed]':
