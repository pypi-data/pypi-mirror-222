...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5274, _5275
...
class FaceGearSetCompoundModalAnalysisAtASpeed(_5281.GearSetCompoundModalAnalysisAtASpeed):
    """FaceGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5147.FaceGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def face_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5274.FaceGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def face_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5275.FaceGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5147.FaceGearSetModalAnalysisAtASpeed]':
