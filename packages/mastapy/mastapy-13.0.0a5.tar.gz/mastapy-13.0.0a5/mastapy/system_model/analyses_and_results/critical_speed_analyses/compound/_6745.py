...
class SpringDamperConnectionCompoundCriticalSpeedAnalysis(_6680.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """SpringDamperConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6615.SpringDamperConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6615.SpringDamperConnectionCriticalSpeedAnalysis]':
