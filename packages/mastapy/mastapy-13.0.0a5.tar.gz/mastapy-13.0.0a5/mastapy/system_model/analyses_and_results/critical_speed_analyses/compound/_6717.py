...
class MassDiscCompoundCriticalSpeedAnalysis(_6764.VirtualComponentCompoundCriticalSpeedAnalysis):
    """MassDiscCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6588.MassDiscCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6588.MassDiscCriticalSpeedAnalysis]':
