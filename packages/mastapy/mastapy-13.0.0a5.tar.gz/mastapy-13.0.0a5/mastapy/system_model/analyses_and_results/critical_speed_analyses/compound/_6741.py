...
class SpiralBevelGearCompoundCriticalSpeedAnalysis(_6658.BevelGearCompoundCriticalSpeedAnalysis):
    """SpiralBevelGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6612.SpiralBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6612.SpiralBevelGearCriticalSpeedAnalysis]':
