...
class SynchroniserHalfCompoundCriticalSpeedAnalysis(_6757.SynchroniserPartCompoundCriticalSpeedAnalysis):
    """SynchroniserHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6627.SynchroniserHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6627.SynchroniserHalfCriticalSpeedAnalysis]':
