...
class CycloidalDiscCompoundCriticalSpeedAnalysis(_6643.AbstractShaftCompoundCriticalSpeedAnalysis):
    """CycloidalDiscCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6558.CycloidalDiscCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6558.CycloidalDiscCriticalSpeedAnalysis]':
