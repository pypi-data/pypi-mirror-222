...
class AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis(_6675.ConicalGearMeshCompoundCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6516.AGMAGleasonConicalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6516.AGMAGleasonConicalGearMeshCriticalSpeedAnalysis]':
