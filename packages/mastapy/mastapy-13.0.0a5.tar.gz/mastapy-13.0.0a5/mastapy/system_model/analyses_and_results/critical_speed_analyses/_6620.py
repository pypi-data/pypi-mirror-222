...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6618, _6619
...
class StraightBevelDiffGearSetCriticalSpeedAnalysis(_6529.BevelGearSetCriticalSpeedAnalysis):
    """StraightBevelDiffGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_diff_gears_critical_speed_analysis(self) -> 'List[_6618.StraightBevelDiffGearCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_critical_speed_analysis(self) -> 'List[_6619.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
