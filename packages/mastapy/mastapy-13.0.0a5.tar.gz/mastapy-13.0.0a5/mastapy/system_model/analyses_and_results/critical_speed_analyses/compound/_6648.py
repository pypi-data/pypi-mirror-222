...
class AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis(_6676.ConicalGearSetCompoundCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6517.AGMAGleasonConicalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6517.AGMAGleasonConicalGearSetCriticalSpeedAnalysis]':
