...
class FEPartCompoundCriticalSpeedAnalysis(_6644.AbstractShaftOrHousingCompoundCriticalSpeedAnalysis):
    """FEPartCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6569.FEPartCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6569.FEPartCriticalSpeedAnalysis]':
