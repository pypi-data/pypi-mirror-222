...
class CVTPulleyCompoundCriticalSpeedAnalysis(_6730.PulleyCompoundCriticalSpeedAnalysis):
    """CVTPulleyCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6555.CVTPulleyCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6555.CVTPulleyCriticalSpeedAnalysis]':
