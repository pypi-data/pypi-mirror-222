...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6747, _6748
...
class StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis(_6660.BevelGearSetCompoundCriticalSpeedAnalysis):
    """StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6620.StraightBevelDiffGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_critical_speed_analysis(self) -> 'List[_6747.StraightBevelDiffGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_critical_speed_analysis(self) -> 'List[_6748.StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6620.StraightBevelDiffGearSetCriticalSpeedAnalysis]':
