...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6522, _6523
...
class BevelDifferentialGearSetCriticalSpeedAnalysis(_6529.BevelGearSetCriticalSpeedAnalysis):
    """BevelDifferentialGearSetCriticalSpeedAnalysis
    ...
    @property
    def bevel_differential_gears_critical_speed_analysis(self) -> 'List[_6522.BevelDifferentialGearCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_meshes_critical_speed_analysis(self) -> 'List[_6523.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
