...
class ZerolBevelGearMeshCompoundCriticalSpeedAnalysis(_6659.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """ZerolBevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6640.ZerolBevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6640.ZerolBevelGearMeshCriticalSpeedAnalysis]':
