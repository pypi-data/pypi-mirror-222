...
class AbstractAssemblyCompoundCriticalSpeedAnalysis(_6721.PartCompoundCriticalSpeedAnalysis):
    """AbstractAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6511.AbstractAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6511.AbstractAssemblyCriticalSpeedAnalysis]':
