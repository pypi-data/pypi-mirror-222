...
class KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis(_6708.KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6582.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6582.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
