...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6639, _6640
...
class ZerolBevelGearSetCriticalSpeedAnalysis(_6529.BevelGearSetCriticalSpeedAnalysis):
    """ZerolBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def zerol_bevel_gears_critical_speed_analysis(self) -> 'List[_6639.ZerolBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_critical_speed_analysis(self) -> 'List[_6640.ZerolBevelGearMeshCriticalSpeedAnalysis]':
