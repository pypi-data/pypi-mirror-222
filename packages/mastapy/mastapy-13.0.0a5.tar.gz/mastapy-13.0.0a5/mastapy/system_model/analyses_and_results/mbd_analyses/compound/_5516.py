...
class BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis(_5513.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5366.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5366.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
