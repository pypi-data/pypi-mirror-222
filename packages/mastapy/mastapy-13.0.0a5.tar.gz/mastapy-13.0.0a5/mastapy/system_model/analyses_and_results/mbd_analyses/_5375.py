...
class ClutchMultibodyDynamicsAnalysis(_5392.CouplingMultibodyDynamicsAnalysis):
    """ClutchMultibodyDynamicsAnalysis
    ...
    @property
    def clutch_connection(self) -> '_5373.ClutchConnectionMultibodyDynamicsAnalysis':
