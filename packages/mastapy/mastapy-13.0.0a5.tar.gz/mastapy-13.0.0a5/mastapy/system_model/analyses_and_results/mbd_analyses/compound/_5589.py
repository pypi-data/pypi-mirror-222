...
class PowerLoadCompoundMultibodyDynamicsAnalysis(_5624.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """PowerLoadCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5448.PowerLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5448.PowerLoadMultibodyDynamicsAnalysis]':
