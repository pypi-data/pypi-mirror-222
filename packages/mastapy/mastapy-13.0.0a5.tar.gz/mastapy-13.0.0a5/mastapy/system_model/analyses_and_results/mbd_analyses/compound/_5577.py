...
class MassDiscCompoundMultibodyDynamicsAnalysis(_5624.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """MassDiscCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5433.MassDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5433.MassDiscMultibodyDynamicsAnalysis]':
