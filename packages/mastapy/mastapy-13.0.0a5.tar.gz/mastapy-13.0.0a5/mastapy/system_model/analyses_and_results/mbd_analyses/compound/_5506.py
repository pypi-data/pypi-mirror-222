...
class AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis(_5534.ConicalGearCompoundMultibodyDynamicsAnalysis):
    """AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5355.AGMAGleasonConicalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5355.AGMAGleasonConicalGearMultibodyDynamicsAnalysis]':
