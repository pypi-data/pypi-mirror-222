...
class ConceptCouplingCompoundMultibodyDynamicsAnalysis(_5539.CouplingCompoundMultibodyDynamicsAnalysis):
    """ConceptCouplingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5381.ConceptCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5381.ConceptCouplingMultibodyDynamicsAnalysis]':
