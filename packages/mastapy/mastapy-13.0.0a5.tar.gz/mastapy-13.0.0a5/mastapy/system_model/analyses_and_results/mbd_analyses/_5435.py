...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.mbd_analyses import (
        _5357, _5360, _5412, _5457,
        _5419, _5420, _5436
    )
    from mastapy.system_model.part_model import _2455
    from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _5501
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_5357.AnalysisTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.AnalysisTypes')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.mbd_analyses._5357', 'AnalysisTypes')(value) if value is not None else None

    @analysis_type.setter
    def analysis_type(self, value: '_5357.AnalysisTypes'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.AnalysisTypes')
    ...
    @property
    def method_to_define_period(self) -> '_5419.InertiaAdjustedLoadCasePeriodMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.mbd_analyses._5419', 'InertiaAdjustedLoadCasePeriodMethod')(value) if value is not None else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_5419.InertiaAdjustedLoadCasePeriodMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod')
    ...
    @property
    def static_load_cases_to_create(self) -> '_5420.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.mbd_analyses._5420', 'InertiaAdjustedLoadCaseResultsToCreate')(value) if value is not None else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_5420.InertiaAdjustedLoadCaseResultsToCreate'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate')
    ...
    @property
    def external_interface_options(self) -> '_5501.DynamicExternalInterfaceOptions':
    ...
    @property
    def run_up_analysis_options(self) -> '_5436.MBDRunUpAnalysisOptions':
    ...
    @property
    def transient_solver_options(self) -> '_88.TransientSolverOptions':
