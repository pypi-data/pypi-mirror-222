...
class SpringDamperConnectionCompoundMultibodyDynamicsAnalysis(_5540.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """SpringDamperConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5466.SpringDamperConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5466.SpringDamperConnectionMultibodyDynamicsAnalysis]':
