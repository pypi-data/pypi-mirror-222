...
class HypoidGearMeshCompoundMultibodyDynamicsAnalysis(_5507.AGMAGleasonConicalGearMeshCompoundMultibodyDynamicsAnalysis):
    """HypoidGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5416.HypoidGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5416.HypoidGearMeshMultibodyDynamicsAnalysis]':
