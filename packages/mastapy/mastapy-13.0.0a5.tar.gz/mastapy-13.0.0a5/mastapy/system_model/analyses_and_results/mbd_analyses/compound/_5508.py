...
class AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis(_5536.ConicalGearSetCompoundMultibodyDynamicsAnalysis):
    """AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5356.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5356.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis]':
