...
class PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis(_5539.CouplingCompoundMultibodyDynamicsAnalysis):
    """PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5443.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5443.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
