...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses.compound import (
        _5510, _5512, _5515, _5522,
        _5521, _5543, _5523, _5528,
        _5533, _5545, _5547, _5551,
        _5558, _5557, _5559, _5566,
        _5573, _5576, _5577, _5578,
        _5580, _5582, _5587, _5588,
        _5589, _5591, _5593, _5598,
        _5597, _5603, _5604, _5609,
        _5612, _5615, _5619, _5623,
        _5627, _5630
    )
...
class AssemblyCompoundMultibodyDynamicsAnalysis(_5502.AbstractAssemblyCompoundMultibodyDynamicsAnalysis):
    """AssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5358.AssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_5510.BearingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5512.BeltDriveCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5515.BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5522.BoltedJointCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5521.BoltCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5543.CVTCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5523.ClutchCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5528.ConceptCouplingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5533.ConceptGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5545.CycloidalAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5547.CycloidalDiscCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5551.CylindricalGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5558.FEPartCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5557.FaceGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5559.FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5566.HypoidGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5573.KlingelnbergCycloPalloidHypoidGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5576.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5577.MassDiscCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5578.MeasurementComponentCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5580.OilSealCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5582.PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5587.PlanetCarrierCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5588.PointLoadCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5589.PowerLoadCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5591.RingPinsCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5593.RollingRingAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5598.ShaftHubConnectionCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5597.ShaftCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5603.SpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5604.SpringDamperCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5609.StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5612.StraightBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5615.SynchroniserCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5619.TorqueConverterCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5623.UnbalancedMassCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5627.WormGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5630.ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5358.AssemblyMultibodyDynamicsAnalysis]':
