...
class SpiralBevelGearCompoundMultibodyDynamicsAnalysis(_5518.BevelGearCompoundMultibodyDynamicsAnalysis):
    """SpiralBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5464.SpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5464.SpiralBevelGearMultibodyDynamicsAnalysis]':
