...
class ClutchCompoundPowerFlow(_4182.CouplingCompoundPowerFlow):
    """ClutchCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4035.ClutchPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4035.ClutchPowerFlow]':
