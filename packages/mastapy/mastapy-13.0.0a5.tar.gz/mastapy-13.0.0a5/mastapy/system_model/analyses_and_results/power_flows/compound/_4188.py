...
class CycloidalAssemblyCompoundPowerFlow(_4243.SpecialisedAssemblyCompoundPowerFlow):
    """CycloidalAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4055.CycloidalAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4055.CycloidalAssemblyPowerFlow]':
