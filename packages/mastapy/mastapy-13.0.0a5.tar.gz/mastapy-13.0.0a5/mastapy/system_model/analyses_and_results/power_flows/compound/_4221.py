...
class MeasurementComponentCompoundPowerFlow(_4267.VirtualComponentCompoundPowerFlow):
    """MeasurementComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4089.MeasurementComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4089.MeasurementComponentPowerFlow]':
