...
class AbstractShaftToMountableComponentConnectionCompoundPowerFlow(_4180.ConnectionCompoundPowerFlow):
    """AbstractShaftToMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4015.AbstractShaftToMountableComponentConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4015.AbstractShaftToMountableComponentConnectionPowerFlow]':
