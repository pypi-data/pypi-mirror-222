...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import _4115, _4114
...
class SpiralBevelGearSetPowerFlow(_4030.BevelGearSetPowerFlow):
    """SpiralBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4115.SpiralBevelGearPowerFlow]':
    ...
    @property
    def spiral_bevel_gears_power_flow(self) -> 'List[_4115.SpiralBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4114.SpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def spiral_bevel_meshes_power_flow(self) -> 'List[_4114.SpiralBevelGearMeshPowerFlow]':
