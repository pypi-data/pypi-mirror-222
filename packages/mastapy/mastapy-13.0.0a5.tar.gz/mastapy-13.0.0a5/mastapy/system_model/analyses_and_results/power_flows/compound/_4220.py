...
class MassDiscCompoundPowerFlow(_4267.VirtualComponentCompoundPowerFlow):
    """MassDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4088.MassDiscPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4088.MassDiscPowerFlow]':
