...
class ClutchHalfCompoundPowerFlow(_4184.CouplingHalfCompoundPowerFlow):
    """ClutchHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4034.ClutchHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4034.ClutchHalfPowerFlow]':
