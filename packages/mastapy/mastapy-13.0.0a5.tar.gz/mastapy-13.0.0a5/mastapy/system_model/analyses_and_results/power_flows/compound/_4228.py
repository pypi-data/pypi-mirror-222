...
class PlanetaryConnectionCompoundPowerFlow(_4242.ShaftToMountableComponentConnectionCompoundPowerFlow):
    """PlanetaryConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4096.PlanetaryConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4096.PlanetaryConnectionPowerFlow]':
