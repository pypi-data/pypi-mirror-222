...
class StraightBevelGearCompoundPowerFlow(_4161.BevelGearCompoundPowerFlow):
    """StraightBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4124.StraightBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4124.StraightBevelGearPowerFlow]':
