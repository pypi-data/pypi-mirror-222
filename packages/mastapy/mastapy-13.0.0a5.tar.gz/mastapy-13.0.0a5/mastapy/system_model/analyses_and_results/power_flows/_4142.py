...
class ZerolBevelGearMeshPowerFlow(_4028.BevelGearMeshPowerFlow):
    """ZerolBevelGearMeshPowerFlow
    ...
    @property
    def rating(self) -> '_367.ZerolBevelGearMeshRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_367.ZerolBevelGearMeshRating':
