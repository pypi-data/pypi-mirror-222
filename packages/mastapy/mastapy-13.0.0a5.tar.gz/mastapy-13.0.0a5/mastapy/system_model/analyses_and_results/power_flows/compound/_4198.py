...
class FaceGearCompoundPowerFlow(_4203.GearCompoundPowerFlow):
    """FaceGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4067.FaceGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4067.FaceGearPowerFlow]':
