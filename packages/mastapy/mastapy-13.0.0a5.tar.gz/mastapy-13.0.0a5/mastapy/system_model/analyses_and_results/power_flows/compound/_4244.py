...
class SpiralBevelGearCompoundPowerFlow(_4161.BevelGearCompoundPowerFlow):
    """SpiralBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4115.SpiralBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4115.SpiralBevelGearPowerFlow]':
