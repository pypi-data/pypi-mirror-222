...
class ConceptGearCompoundPowerFlow(_4203.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4042.ConceptGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4042.ConceptGearPowerFlow]':
