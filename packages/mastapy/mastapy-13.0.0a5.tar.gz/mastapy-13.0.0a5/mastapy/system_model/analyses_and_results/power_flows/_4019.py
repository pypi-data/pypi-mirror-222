...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import (
        _4020, _4022, _4025, _4031,
        _4032, _4053, _4035, _4040,
        _4043, _4055, _4058, _4062,
        _4069, _4068, _4070, _4077,
        _4084, _4087, _4073, _4088,
        _4089, _4091, _4095, _4098,
        _4099, _4102, _4104, _4106,
        _4110, _4111, _4116, _4119,
        _4122, _4125, _4130, _4134,
        _4137, _4141, _4144
    )
...
class AssemblyPowerFlow(_4012.AbstractAssemblyPowerFlow):
    """AssemblyPowerFlow
    ...
    @property
    def bearings(self) -> 'List[_4020.BearingPowerFlow]':
    ...
    @property
    def belt_drives(self) -> 'List[_4022.BeltDrivePowerFlow]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4025.BevelDifferentialGearSetPowerFlow]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4031.BoltedJointPowerFlow]':
    ...
    @property
    def bolts(self) -> 'List[_4032.BoltPowerFlow]':
    ...
    @property
    def cv_ts(self) -> 'List[_4053.CVTPowerFlow]':
    ...
    @property
    def clutches(self) -> 'List[_4035.ClutchPowerFlow]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4040.ConceptCouplingPowerFlow]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4043.ConceptGearSetPowerFlow]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4055.CycloidalAssemblyPowerFlow]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4058.CycloidalDiscPowerFlow]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4062.CylindricalGearSetPowerFlow]':
    ...
    @property
    def fe_parts(self) -> 'List[_4069.FEPartPowerFlow]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4068.FaceGearSetPowerFlow]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4070.FlexiblePinAssemblyPowerFlow]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4077.HypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4084.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4087.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_4073.GearSetPowerFlow]':
    ...
    @property
    def mass_discs(self) -> 'List[_4088.MassDiscPowerFlow]':
    ...
    @property
    def measurement_components(self) -> 'List[_4089.MeasurementComponentPowerFlow]':
    ...
    @property
    def oil_seals(self) -> 'List[_4091.OilSealPowerFlow]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4095.PartToPartShearCouplingPowerFlow]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4098.PlanetCarrierPowerFlow]':
    ...
    @property
    def point_loads(self) -> 'List[_4099.PointLoadPowerFlow]':
    ...
    @property
    def power_loads(self) -> 'List[_4102.PowerLoadPowerFlow]':
    ...
    @property
    def ring_pins(self) -> 'List[_4104.RingPinsPowerFlow]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4106.RollingRingAssemblyPowerFlow]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4110.ShaftHubConnectionPowerFlow]':
    ...
    @property
    def shafts(self) -> 'List[_4111.ShaftPowerFlow]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4116.SpiralBevelGearSetPowerFlow]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4119.SpringDamperPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4122.StraightBevelDiffGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4125.StraightBevelGearSetPowerFlow]':
    ...
    @property
    def synchronisers(self) -> 'List[_4130.SynchroniserPowerFlow]':
    ...
    @property
    def torque_converters(self) -> 'List[_4134.TorqueConverterPowerFlow]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4137.UnbalancedMassPowerFlow]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4141.WormGearSetPowerFlow]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4144.ZerolBevelGearSetPowerFlow]':
