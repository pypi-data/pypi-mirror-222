...
class AGMAGleasonConicalGearSetCompoundPowerFlow(_4179.ConicalGearSetCompoundPowerFlow):
    """AGMAGleasonConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4018.AGMAGleasonConicalGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4018.AGMAGleasonConicalGearSetPowerFlow]':
