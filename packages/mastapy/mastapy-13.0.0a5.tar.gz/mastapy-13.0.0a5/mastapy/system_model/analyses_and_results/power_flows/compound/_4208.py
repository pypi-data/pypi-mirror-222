...
class HypoidGearMeshCompoundPowerFlow(_4150.AGMAGleasonConicalGearMeshCompoundPowerFlow):
    """HypoidGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4075.HypoidGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4075.HypoidGearMeshPowerFlow]':
