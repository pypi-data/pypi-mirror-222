...
class RollingRingConnectionCompoundPowerFlow(_4210.InterMountableComponentConnectionCompoundPowerFlow):
    """RollingRingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4107.RollingRingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4107.RollingRingConnectionPowerFlow]':
