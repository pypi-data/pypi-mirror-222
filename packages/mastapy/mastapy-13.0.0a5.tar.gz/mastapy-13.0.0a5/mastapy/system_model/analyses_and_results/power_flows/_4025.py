...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import _4024, _4023
...
class BevelDifferentialGearSetPowerFlow(_4030.BevelGearSetPowerFlow):
    """BevelDifferentialGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4024.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def bevel_differential_gears_power_flow(self) -> 'List[_4024.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4023.BevelDifferentialGearMeshPowerFlow]':
    ...
    @property
    def bevel_differential_meshes_power_flow(self) -> 'List[_4023.BevelDifferentialGearMeshPowerFlow]':
