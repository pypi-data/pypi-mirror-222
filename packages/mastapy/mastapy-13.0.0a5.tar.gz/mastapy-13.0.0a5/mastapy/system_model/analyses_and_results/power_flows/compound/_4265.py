...
class TorqueConverterTurbineCompoundPowerFlow(_4184.CouplingHalfCompoundPowerFlow):
    """TorqueConverterTurbineCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4136.TorqueConverterTurbinePowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4136.TorqueConverterTurbinePowerFlow]':
