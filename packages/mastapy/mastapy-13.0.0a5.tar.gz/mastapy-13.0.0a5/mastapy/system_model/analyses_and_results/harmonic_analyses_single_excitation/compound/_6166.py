...
class GearCompoundHarmonicAnalysisOfSingleExcitation(_6185.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """GearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6036.GearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6036.GearHarmonicAnalysisOfSingleExcitation]':
