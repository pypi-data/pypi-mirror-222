...
class RootAssemblyHarmonicAnalysisOfSingleExcitation(_5985.AssemblyHarmonicAnalysisOfSingleExcitation):
    """RootAssemblyHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def harmonic_analysis_of_single_excitation_inputs(self) -> '_6040.HarmonicAnalysisOfSingleExcitation':
