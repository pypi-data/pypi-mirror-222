...
class FaceGearCompoundHarmonicAnalysisOfSingleExcitation(_6166.GearCompoundHarmonicAnalysisOfSingleExcitation):
    """FaceGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6031.FaceGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6031.FaceGearHarmonicAnalysisOfSingleExcitation]':
