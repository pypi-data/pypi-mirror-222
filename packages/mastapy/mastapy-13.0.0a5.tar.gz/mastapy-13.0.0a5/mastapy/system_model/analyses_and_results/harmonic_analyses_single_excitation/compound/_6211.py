...
class SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6146.CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6081.SpringDamperConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6081.SpringDamperConnectionHarmonicAnalysisOfSingleExcitation]':
