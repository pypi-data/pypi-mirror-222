...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6087, _6088
...
class StraightBevelGearSetHarmonicAnalysisOfSingleExcitation(_5996.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """StraightBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def straight_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6087.StraightBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6088.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
