...
class SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation(_6223.SynchroniserPartCompoundHarmonicAnalysisOfSingleExcitation):
    """SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6095.SynchroniserSleeveHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6095.SynchroniserSleeveHarmonicAnalysisOfSingleExcitation]':
