...
class PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6205.ShaftToMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6062.PlanetaryConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6062.PlanetaryConnectionHarmonicAnalysisOfSingleExcitation]':
