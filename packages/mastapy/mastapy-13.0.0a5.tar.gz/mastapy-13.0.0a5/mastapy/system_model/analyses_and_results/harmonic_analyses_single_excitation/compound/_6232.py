...
class WormGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_6167.GearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    """WormGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6103.WormGearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6103.WormGearMeshHarmonicAnalysisOfSingleExcitation]':
