...
class CouplingCompoundHarmonicAnalysisOfSingleExcitation(_6206.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """CouplingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6017.CouplingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6017.CouplingHarmonicAnalysisOfSingleExcitation]':
