...
class SpringDamperCompoundHarmonicAnalysisOfSingleExcitation(_6145.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    """SpringDamperCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6083.SpringDamperHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6083.SpringDamperHarmonicAnalysisOfSingleExcitation]':
