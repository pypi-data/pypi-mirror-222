...
class RollingRingAssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_3455.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    """RollingRingAssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3318.RollingRingAssemblySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3318.RollingRingAssemblySteadyStateSynchronousResponseOnAShaft]':
