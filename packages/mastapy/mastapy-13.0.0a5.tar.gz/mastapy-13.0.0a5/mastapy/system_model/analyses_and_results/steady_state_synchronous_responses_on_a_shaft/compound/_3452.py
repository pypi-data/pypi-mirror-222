...
class ShaftCompoundSteadyStateSynchronousResponseOnAShaft(_3358.AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft):
    """ShaftCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3323.ShaftSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3323.ShaftSteadyStateSynchronousResponseOnAShaft]':
