...
class RootAssemblySteadyStateSynchronousResponseOnAShaft(_3234.AssemblySteadyStateSynchronousResponseOnAShaft):
    """RootAssemblySteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def steady_state_synchronous_response_on_a_shaft_inputs(self) -> '_3332.SteadyStateSynchronousResponseOnAShaft':
