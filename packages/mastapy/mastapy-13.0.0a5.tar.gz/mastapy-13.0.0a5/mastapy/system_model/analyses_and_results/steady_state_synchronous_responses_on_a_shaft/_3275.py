...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3276, _3274
...
class CylindricalGearSetSteadyStateSynchronousResponseOnAShaft(_3286.GearSetSteadyStateSynchronousResponseOnAShaft):
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3276.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3274.CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft]':
