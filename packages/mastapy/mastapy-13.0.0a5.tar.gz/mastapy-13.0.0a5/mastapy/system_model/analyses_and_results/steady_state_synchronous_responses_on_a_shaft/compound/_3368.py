...
class BevelDifferentialGearCompoundSteadyStateSynchronousResponseOnAShaft(_3373.BevelGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """BevelDifferentialGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3240.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3240.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft]':
