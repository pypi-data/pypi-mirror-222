...
class SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft(_3394.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    """SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3331.SpringDamperSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3331.SpringDamperSteadyStateSynchronousResponseOnAShaft]':
