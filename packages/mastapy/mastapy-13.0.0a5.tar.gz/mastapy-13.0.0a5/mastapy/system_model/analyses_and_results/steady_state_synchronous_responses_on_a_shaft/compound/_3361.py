...
class AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseOnAShaft(_3389.ConicalGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3233.AGMAGleasonConicalGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3233.AGMAGleasonConicalGearSteadyStateSynchronousResponseOnAShaft]':
