...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3224, _3225
...
class ZerolBevelGearSetCompoundSteadyStateSynchronousResponse(_3116.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """ZerolBevelGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3096.ZerolBevelGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_gears_compound_steady_state_synchronous_response(self) -> 'List[_3224.ZerolBevelGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3225.ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3096.ZerolBevelGearSetSteadyStateSynchronousResponse]':
