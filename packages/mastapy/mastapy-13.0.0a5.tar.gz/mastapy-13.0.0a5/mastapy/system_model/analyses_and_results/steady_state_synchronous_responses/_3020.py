...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3021, _3019
...
class FaceGearSetSteadyStateSynchronousResponse(_3025.GearSetSteadyStateSynchronousResponse):
    """FaceGearSetSteadyStateSynchronousResponse
    ...
    @property
    def face_gears_steady_state_synchronous_response(self) -> 'List[_3021.FaceGearSteadyStateSynchronousResponse]':
    ...
    @property
    def face_meshes_steady_state_synchronous_response(self) -> 'List[_3019.FaceGearMeshSteadyStateSynchronousResponse]':
