...
class FaceGearMeshCompoundSteadyStateSynchronousResponse(_3157.GearMeshCompoundSteadyStateSynchronousResponse):
    """FaceGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3019.FaceGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3019.FaceGearMeshSteadyStateSynchronousResponse]':
