...
class ConceptGearCompoundSteadyStateSynchronousResponse(_3156.GearCompoundSteadyStateSynchronousResponse):
    """ConceptGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2996.ConceptGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2996.ConceptGearSteadyStateSynchronousResponse]':
