...
class WormGearMeshCompoundSteadyStateSynchronousResponse(_3157.GearMeshCompoundSteadyStateSynchronousResponse):
    """WormGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3092.WormGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3092.WormGearMeshSteadyStateSynchronousResponse]':
