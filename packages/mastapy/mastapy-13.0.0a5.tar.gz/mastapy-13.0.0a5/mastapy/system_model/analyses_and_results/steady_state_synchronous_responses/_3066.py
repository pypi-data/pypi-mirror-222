...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3067, _3065
...
class SpiralBevelGearSetSteadyStateSynchronousResponse(_2982.BevelGearSetSteadyStateSynchronousResponse):
    """SpiralBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def spiral_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3067.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3065.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
