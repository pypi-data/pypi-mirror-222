...
class ShaftCompoundSteadyStateSynchronousResponse(_3099.AbstractShaftCompoundSteadyStateSynchronousResponse):
    """ShaftCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3062.ShaftSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3062.ShaftSteadyStateSynchronousResponse]':
