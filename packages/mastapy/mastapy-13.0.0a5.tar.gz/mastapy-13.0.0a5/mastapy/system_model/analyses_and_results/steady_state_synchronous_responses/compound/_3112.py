...
class BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse(_3109.BevelDifferentialGearCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2979.BevelDifferentialPlanetGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2979.BevelDifferentialPlanetGearSteadyStateSynchronousResponse]':
