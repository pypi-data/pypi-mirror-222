...
class StraightBevelPlanetGearCompoundSteadyStateSynchronousResponse(_3203.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse):
    """StraightBevelPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3080.StraightBevelPlanetGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3080.StraightBevelPlanetGearSteadyStateSynchronousResponse]':
