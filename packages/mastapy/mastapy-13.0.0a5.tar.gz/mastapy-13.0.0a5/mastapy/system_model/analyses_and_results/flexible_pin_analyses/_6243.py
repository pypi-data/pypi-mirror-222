...
class FlexiblePinAnalysisOptions(_0.APIBase):
    ...
    @property
    def extreme_load_case_for_stop_start(self) -> '_6772.StaticLoadCase':
    ...
    def extreme_load_case_for_stop_start(self, value: '_6772.StaticLoadCase'):
    ...
    @property
    def nominal_load_case_for_stop_start(self) -> '_6772.StaticLoadCase':
    ...
    def nominal_load_case_for_stop_start(self, value: '_6772.StaticLoadCase'):
