...
class SynchroniserPartCompoundDynamicAnalysis(_6415.CouplingHalfCompoundDynamicAnalysis):
    """SynchroniserPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6362.SynchroniserPartDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6362.SynchroniserPartDynamicAnalysis]':
