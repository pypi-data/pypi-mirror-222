...
class CycloidalDiscPlanetaryBearingConnectionCompoundDynamicAnalysis(_6379.AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6292.CycloidalDiscPlanetaryBearingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6292.CycloidalDiscPlanetaryBearingConnectionDynamicAnalysis]':
