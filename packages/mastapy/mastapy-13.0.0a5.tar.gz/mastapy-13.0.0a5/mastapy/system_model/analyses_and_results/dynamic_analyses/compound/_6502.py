...
class ZerolBevelGearCompoundDynamicAnalysis(_6392.BevelGearCompoundDynamicAnalysis):
    """ZerolBevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6373.ZerolBevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6373.ZerolBevelGearDynamicAnalysis]':
