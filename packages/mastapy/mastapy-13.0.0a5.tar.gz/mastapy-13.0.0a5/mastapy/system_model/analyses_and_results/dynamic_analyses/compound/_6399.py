...
class ClutchHalfCompoundDynamicAnalysis(_6415.CouplingHalfCompoundDynamicAnalysis):
    """ClutchHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6269.ClutchHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6269.ClutchHalfDynamicAnalysis]':
