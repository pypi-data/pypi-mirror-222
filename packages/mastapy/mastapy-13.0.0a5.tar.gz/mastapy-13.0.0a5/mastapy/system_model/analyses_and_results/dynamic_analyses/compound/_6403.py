...
class ConceptCouplingConnectionCompoundDynamicAnalysis(_6414.CouplingConnectionCompoundDynamicAnalysis):
    """ConceptCouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6272.ConceptCouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6272.ConceptCouplingConnectionDynamicAnalysis]':
