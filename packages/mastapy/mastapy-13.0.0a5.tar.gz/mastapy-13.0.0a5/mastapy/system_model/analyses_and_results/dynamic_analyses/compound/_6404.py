...
class ConceptCouplingHalfCompoundDynamicAnalysis(_6415.CouplingHalfCompoundDynamicAnalysis):
    """ConceptCouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6274.ConceptCouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6274.ConceptCouplingHalfDynamicAnalysis]':
