...
class ExternalCADModelCompoundDynamicAnalysis(_6401.ComponentCompoundDynamicAnalysis):
    """ExternalCADModelCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6299.ExternalCADModelDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6299.ExternalCADModelDynamicAnalysis]':
