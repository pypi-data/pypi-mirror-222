...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6300, _6301
...
class FaceGearSetDynamicAnalysis(_6307.GearSetDynamicAnalysis):
    """FaceGearSetDynamicAnalysis
    ...
    @property
    def face_gears_dynamic_analysis(self) -> 'List[_6300.FaceGearDynamicAnalysis]':
    ...
    @property
    def face_meshes_dynamic_analysis(self) -> 'List[_6301.FaceGearMeshDynamicAnalysis]':
