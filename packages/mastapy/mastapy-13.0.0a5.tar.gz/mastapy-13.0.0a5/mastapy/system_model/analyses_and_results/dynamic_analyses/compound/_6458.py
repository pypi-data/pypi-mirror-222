...
class PartToPartShearCouplingHalfCompoundDynamicAnalysis(_6415.CouplingHalfCompoundDynamicAnalysis):
    """PartToPartShearCouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6329.PartToPartShearCouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6329.PartToPartShearCouplingHalfDynamicAnalysis]':
