...
class StraightBevelDiffGearCompoundDynamicAnalysis(_6392.BevelGearCompoundDynamicAnalysis):
    """StraightBevelDiffGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6352.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6352.StraightBevelDiffGearDynamicAnalysis]':
