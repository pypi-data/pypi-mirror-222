...
class PulleyCompoundDynamicAnalysis(_6415.CouplingHalfCompoundDynamicAnalysis):
    """PulleyCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6335.PulleyDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6335.PulleyDynamicAnalysis]':
