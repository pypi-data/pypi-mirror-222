...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3612, _3610
...
class WormGearSetSteadyStateSynchronousResponseAtASpeed(_3545.GearSetSteadyStateSynchronousResponseAtASpeed):
    """WormGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def worm_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3612.WormGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def worm_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3610.WormGearMeshSteadyStateSynchronousResponseAtASpeed]':
