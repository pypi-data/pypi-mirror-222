...
class SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3616.AbstractAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3584.SpecialisedAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3584.SpecialisedAssemblySteadyStateSynchronousResponseAtASpeed]':
