...
class BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed(_3714.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3505.BoltedJointSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3505.BoltedJointSteadyStateSynchronousResponseAtASpeed]':
