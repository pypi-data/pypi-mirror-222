...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import (
        _3624, _3626, _3629, _3636,
        _3635, _3657, _3637, _3642,
        _3647, _3659, _3661, _3665,
        _3672, _3671, _3673, _3680,
        _3687, _3690, _3691, _3692,
        _3694, _3696, _3701, _3702,
        _3703, _3705, _3707, _3712,
        _3711, _3717, _3718, _3723,
        _3726, _3729, _3733, _3737,
        _3741, _3744
    )
...
class AssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3616.AbstractAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """AssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3493.AssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bearings(self) -> 'List[_3624.BearingCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_3626.BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3629.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3636.BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_3635.BoltCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_3657.CVTCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_3637.ClutchCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3642.ConceptCouplingCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3647.ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3659.CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3661.CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3665.CylindricalGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_3672.FEPartCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3671.FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3673.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3680.HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3687.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3690.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_3691.MassDiscCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_3692.MeasurementComponentCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_3694.OilSealCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3696.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3701.PlanetCarrierCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_3702.PointLoadCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_3703.PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_3705.RingPinsCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3707.RollingRingAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3712.ShaftHubConnectionCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_3711.ShaftCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3717.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3718.SpringDamperCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3723.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3726.StraightBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_3729.SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_3733.TorqueConverterCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3737.UnbalancedMassCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3741.WormGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3744.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3493.AssemblySteadyStateSynchronousResponseAtASpeed]':
