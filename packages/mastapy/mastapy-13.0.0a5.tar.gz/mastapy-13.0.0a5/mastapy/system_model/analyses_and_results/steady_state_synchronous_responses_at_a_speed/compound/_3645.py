...
class ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed(_3674.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3517.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3517.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
