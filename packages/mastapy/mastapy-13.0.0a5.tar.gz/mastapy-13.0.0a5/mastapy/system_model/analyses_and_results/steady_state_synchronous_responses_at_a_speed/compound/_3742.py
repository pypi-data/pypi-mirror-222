...
class ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed(_3632.BevelGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3615.ZerolBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3615.ZerolBevelGearSteadyStateSynchronousResponseAtASpeed]':
