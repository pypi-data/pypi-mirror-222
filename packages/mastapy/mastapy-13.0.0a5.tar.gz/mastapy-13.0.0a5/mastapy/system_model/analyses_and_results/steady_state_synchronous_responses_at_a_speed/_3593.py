...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3594, _3592
...
class StraightBevelDiffGearSetSteadyStateSynchronousResponseAtASpeed(_3503.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelDiffGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def straight_bevel_diff_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3594.StraightBevelDiffGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_diff_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3592.StraightBevelDiffGearMeshSteadyStateSynchronousResponseAtASpeed]':
