...
class ExternalCADModelCompoundSteadyStateSynchronousResponseAtASpeed(_3641.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """ExternalCADModelCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3538.ExternalCADModelSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3538.ExternalCADModelSteadyStateSynchronousResponseAtASpeed]':
