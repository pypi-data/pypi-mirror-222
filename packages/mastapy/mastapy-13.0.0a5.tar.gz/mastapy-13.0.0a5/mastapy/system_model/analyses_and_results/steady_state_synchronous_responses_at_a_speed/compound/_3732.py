...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed(_3731.SynchroniserPartCompoundSteadyStateSynchronousResponseAtASpeed):
    """SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3602.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3602.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
