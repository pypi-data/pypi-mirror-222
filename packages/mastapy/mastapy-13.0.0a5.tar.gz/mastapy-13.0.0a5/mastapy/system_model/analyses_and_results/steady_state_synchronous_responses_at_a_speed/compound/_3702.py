...
class PointLoadCompoundSteadyStateSynchronousResponseAtASpeed(_3738.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """PointLoadCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3572.PointLoadSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3572.PointLoadSteadyStateSynchronousResponseAtASpeed]':
