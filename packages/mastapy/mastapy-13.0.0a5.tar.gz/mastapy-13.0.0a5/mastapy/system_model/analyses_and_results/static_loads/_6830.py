...
class CylindricalGearManufactureError(_6859.GearManufactureError):
    """CylindricalGearManufactureError
    ...
    @property
    def pitch_errors_left_flank(self) -> '_1525.Vector2DListAccessor':
    ...
    def pitch_errors_left_flank(self, value: '_1525.Vector2DListAccessor'):
        self.wrapped.PitchErrorsLeftFlank = value

    @property
    def pitch_errors_right_flank(self) -> '_1525.Vector2DListAccessor':
    ...
    def pitch_errors_right_flank(self, value: '_1525.Vector2DListAccessor'):
