...
if TYPE_CHECKING:
    ...
    from mastapy.system_model import _2203, _2205, _2204
    from mastapy.math_utility.measured_data import _1556
    from mastapy.system_model.fe import _2356
    from mastapy.system_model.analyses_and_results.static_loads import _6945, _6839
...
class PowerLoadLoadCase(_6949.VirtualComponentLoadCase):
    """PowerLoadLoadCase
    ...
    @property
    def constant_resistance_coefficient_time_profile(self) -> '_1525.Vector2DListAccessor':
    ...
    def constant_resistance_coefficient_time_profile(self, value: '_1525.Vector2DListAccessor'):
    ...
    @property
    def drag_torque_specification_method(self) -> '_2203.PowerLoadDragTorqueSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.PowerLoadDragTorqueSpecificationMethod')
        return constructor.new_from_mastapy('mastapy.system_model._2203', 'PowerLoadDragTorqueSpecificationMethod')(value) if value is not None else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_2203.PowerLoadDragTorqueSpecificationMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.PowerLoadDragTorqueSpecificationMethod')
        self.wrapped.DragTorqueSpecificationMethod = value

    @property
    def drag_torque_vs_speed_and_time(self) -> '_1556.GriddedSurfaceAccessor':
    ...
    def drag_torque_vs_speed_and_time(self, value: '_1556.GriddedSurfaceAccessor'):
    ...
    def electric_machine_data_set_selector(self) -> 'list_with_selected_item.ListWithSelectedItem_ElectricMachineDataSet':
        ...
        return constructor.new_from_mastapy('mastapy._internal.implicit.list_with_selected_item', 'ListWithSelectedItem_ElectricMachineDataSet')(temp) if temp is not None else None
    ...
    @property
    def engine_throttle_time_profile(self) -> '_1525.Vector2DListAccessor':
    ...
    def engine_throttle_time_profile(self, value: '_1525.Vector2DListAccessor'):
    ...
    @property
    def linear_resistance_coefficient_time_profile(self) -> '_1525.Vector2DListAccessor':
    ...
    def linear_resistance_coefficient_time_profile(self, value: '_1525.Vector2DListAccessor'):
    ...
    @property
    def quadratic_resistance_coefficient_time_profile(self) -> '_1525.Vector2DListAccessor':
    ...
    def quadratic_resistance_coefficient_time_profile(self, value: '_1525.Vector2DListAccessor'):
    ...
    @property
    def speed_vs_time(self) -> '_1525.Vector2DListAccessor':
    ...
    def speed_vs_time(self, value: '_1525.Vector2DListAccessor'):
    ...
    @property
    def target_speed_input_type(self) -> '_2205.PowerLoadPIDControlSpeedInputType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.PowerLoadPIDControlSpeedInputType')
        return constructor.new_from_mastapy('mastapy.system_model._2205', 'PowerLoadPIDControlSpeedInputType')(value) if value is not None else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_2205.PowerLoadPIDControlSpeedInputType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.PowerLoadPIDControlSpeedInputType')
        self.wrapped.TargetSpeedInputType = value

    @property
    def target_speed_vs_time(self) -> '_1525.Vector2DListAccessor':
    ...
    def target_speed_vs_time(self, value: '_1525.Vector2DListAccessor'):
    ...
    @property
    def torque_vs_angle(self) -> '_1525.Vector2DListAccessor':
    ...
    def torque_vs_angle(self, value: '_1525.Vector2DListAccessor'):
        self.wrapped.TorqueVsAngle = value

    @property
    def torque_vs_angle_and_speed(self) -> '_1556.GriddedSurfaceAccessor':
    ...
    def torque_vs_angle_and_speed(self, value: '_1556.GriddedSurfaceAccessor'):
        self.wrapped.TorqueVsAngleAndSpeed = value

    @property
    def torque_vs_time(self) -> '_1525.Vector2DListAccessor':
    ...
    def torque_vs_time(self, value: '_1525.Vector2DListAccessor'):
    ...
    def velocity_first_order_lag_cutoff_frequency(self, value: 'float'):
        self.wrapped.VelocityFirstOrderLagCutoffFrequency = float(value) if value is not None else 0.0
    ...
    def velocity_first_order_lag_time_constant(self, value: 'float'):
        self.wrapped.VelocityFirstOrderLagTimeConstant = float(value) if value is not None else 0.0

    @property
    def wheel_slip_model(self) -> '_5489.WheelSlipType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.WheelSlipType')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.mbd_analyses._5489', 'WheelSlipType')(value) if value is not None else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5489.WheelSlipType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.WheelSlipType')
    ...
    @property
    def coefficient_of_friction_with_ground(self) -> '_97.NonDimensionalInputComponent':
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1567.PIDControlSettings':
    ...
    @property
    def pid_control_settings(self) -> '_1567.PIDControlSettings':
    ...
    def get_harmonic_load_data_for_import(self) -> '_6839.ElectricMachineHarmonicLoadData':
