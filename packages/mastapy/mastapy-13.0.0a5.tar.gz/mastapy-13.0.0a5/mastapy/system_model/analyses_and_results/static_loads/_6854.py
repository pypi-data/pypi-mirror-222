...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6852, _6853
...
class FaceGearSetLoadCase(_6863.GearSetLoadCase):
    """FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6852.FaceGearLoadCase]':
    ...
    @property
    def face_gears_load_case(self) -> 'List[_6852.FaceGearLoadCase]':
    ...
    @property
    def face_meshes_load_case(self) -> 'List[_6853.FaceGearMeshLoadCase]':
