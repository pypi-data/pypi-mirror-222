...
class GearSetHarmonicLoadData(_1370.HarmonicLoadDataBase):
    """GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6861.GearMeshTEOrderType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.StaticLoads.GearMeshTEOrderType')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.static_loads._6861', 'GearMeshTEOrderType')(value) if value is not None else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6861.GearMeshTEOrderType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.StaticLoads.GearMeshTEOrderType')
