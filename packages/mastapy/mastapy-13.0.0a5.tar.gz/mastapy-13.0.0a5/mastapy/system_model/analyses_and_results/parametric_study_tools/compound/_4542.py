...
class UnbalancedMassCompoundParametricStudyTool(_4543.VirtualComponentCompoundParametricStudyTool):
    """UnbalancedMassCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4413.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4413.UnbalancedMassParametricStudyTool]':
