...
class RingPinsParametricStudyTool(_4359.MountableComponentParametricStudyTool):
    """RingPinsParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2776.RingPinsSystemDeflection]':
