...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.parametric_study_tools import _4335, _4334
...
class FaceGearSetParametricStudyTool(_4341.GearSetParametricStudyTool):
    """FaceGearSetParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2737.FaceGearSetSystemDeflection]':
    ...
    @property
    def face_gears_parametric_study_tool(self) -> 'List[_4335.FaceGearParametricStudyTool]':
    ...
    @property
    def face_meshes_parametric_study_tool(self) -> 'List[_4334.FaceGearMeshParametricStudyTool]':
