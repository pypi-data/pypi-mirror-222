...
class SpringDamperConnectionCompoundParametricStudyTool(_4459.CouplingConnectionCompoundParametricStudyTool):
    """SpringDamperConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4394.SpringDamperConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4394.SpringDamperConnectionParametricStudyTool]':
