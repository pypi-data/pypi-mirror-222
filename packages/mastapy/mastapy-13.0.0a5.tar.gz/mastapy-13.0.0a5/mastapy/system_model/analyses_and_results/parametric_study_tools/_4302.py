...
class ConceptCouplingParametricStudyTool(_4313.CouplingParametricStudyTool):
    """ConceptCouplingParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2701.ConceptCouplingSystemDeflection]':
