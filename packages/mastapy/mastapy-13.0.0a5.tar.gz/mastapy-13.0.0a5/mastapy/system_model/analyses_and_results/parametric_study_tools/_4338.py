...
class FlexiblePinAssemblyParametricStudyTool(_4390.SpecialisedAssemblyParametricStudyTool):
    """FlexiblePinAssemblyParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2740.FlexiblePinAssemblySystemDeflection]':
