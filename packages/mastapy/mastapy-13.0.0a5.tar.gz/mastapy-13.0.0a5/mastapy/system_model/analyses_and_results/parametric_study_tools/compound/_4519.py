...
class SpecialisedAssemblyCompoundParametricStudyTool(_4421.AbstractAssemblyCompoundParametricStudyTool):
    """SpecialisedAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4390.SpecialisedAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4390.SpecialisedAssemblyParametricStudyTool]':
