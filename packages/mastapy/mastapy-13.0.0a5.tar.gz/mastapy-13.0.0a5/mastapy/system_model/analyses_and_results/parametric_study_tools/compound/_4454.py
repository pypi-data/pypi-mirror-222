...
class ConicalGearMeshCompoundParametricStudyTool(_4480.GearMeshCompoundParametricStudyTool):
    """ConicalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4306.ConicalGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4306.ConicalGearMeshParametricStudyTool]':
