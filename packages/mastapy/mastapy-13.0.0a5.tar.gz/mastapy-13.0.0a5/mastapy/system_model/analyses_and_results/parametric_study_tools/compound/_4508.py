...
class PowerLoadCompoundParametricStudyTool(_4543.VirtualComponentCompoundParametricStudyTool):
    """PowerLoadCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4379.PowerLoadParametricStudyTool]':
    ...
    @property
    def load_cases(self) -> 'List[_6907.PowerLoadLoadCase]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4379.PowerLoadParametricStudyTool]':
