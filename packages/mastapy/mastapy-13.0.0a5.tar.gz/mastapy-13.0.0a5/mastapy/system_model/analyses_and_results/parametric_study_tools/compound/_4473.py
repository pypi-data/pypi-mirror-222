...
class ExternalCADModelCompoundParametricStudyTool(_4446.ComponentCompoundParametricStudyTool):
    """ExternalCADModelCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4333.ExternalCADModelParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4333.ExternalCADModelParametricStudyTool]':
