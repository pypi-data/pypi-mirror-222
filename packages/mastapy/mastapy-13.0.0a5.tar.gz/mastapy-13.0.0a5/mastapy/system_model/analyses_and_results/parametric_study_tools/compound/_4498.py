...
class MountableComponentCompoundParametricStudyTool(_4446.ComponentCompoundParametricStudyTool):
    """MountableComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4359.MountableComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4359.MountableComponentParametricStudyTool]':
