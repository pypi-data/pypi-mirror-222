...
class WormGearMeshCompoundParametricStudyTool(_4480.GearMeshCompoundParametricStudyTool):
    """WormGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4415.WormGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4415.WormGearMeshParametricStudyTool]':
