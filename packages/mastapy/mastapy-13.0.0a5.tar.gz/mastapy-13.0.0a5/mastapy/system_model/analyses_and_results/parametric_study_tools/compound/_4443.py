...
class ClutchConnectionCompoundParametricStudyTool(_4459.CouplingConnectionCompoundParametricStudyTool):
    """ClutchConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4295.ClutchConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4295.ClutchConnectionParametricStudyTool]':
