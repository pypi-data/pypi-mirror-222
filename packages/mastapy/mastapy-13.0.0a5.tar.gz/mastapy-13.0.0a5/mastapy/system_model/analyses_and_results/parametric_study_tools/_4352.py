...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.parametric_study_tools import _4351, _4350
...
class KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool(_4349.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool):
    """KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_parametric_study_tool(self) -> 'List[_4351.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_parametric_study_tool(self) -> 'List[_4350.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool]':
