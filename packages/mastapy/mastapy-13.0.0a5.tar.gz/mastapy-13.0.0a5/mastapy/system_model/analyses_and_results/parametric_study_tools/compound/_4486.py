...
class InterMountableComponentConnectionCompoundParametricStudyTool(_4456.ConnectionCompoundParametricStudyTool):
    """InterMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4346.InterMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4346.InterMountableComponentConnectionParametricStudyTool]':
