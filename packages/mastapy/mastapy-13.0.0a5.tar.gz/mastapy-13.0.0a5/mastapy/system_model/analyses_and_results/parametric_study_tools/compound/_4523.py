...
class SpringDamperCompoundParametricStudyTool(_4458.CouplingCompoundParametricStudyTool):
    """SpringDamperCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4396.SpringDamperParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4396.SpringDamperParametricStudyTool]':
