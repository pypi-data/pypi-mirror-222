...
class BevelDifferentialGearMeshCompoundParametricStudyTool(_4438.BevelGearMeshCompoundParametricStudyTool):
    """BevelDifferentialGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4285.BevelDifferentialGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4285.BevelDifferentialGearMeshParametricStudyTool]':
