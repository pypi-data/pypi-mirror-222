...
class WormGearMeshParametricStudyTool(_4339.GearMeshParametricStudyTool):
    """WormGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2818.WormGearMeshSystemDeflection]':
