...
class BearingCompoundAdvancedTimeSteppingAnalysisForModulation(_7143.ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BearingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6985.BearingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6985.BearingAdvancedTimeSteppingAnalysisForModulation]':
