...
class ExternalCADModelAdvancedTimeSteppingAnalysisForModulation(_7002.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """ExternalCADModelAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2734.ExternalCADModelSystemDeflection':
