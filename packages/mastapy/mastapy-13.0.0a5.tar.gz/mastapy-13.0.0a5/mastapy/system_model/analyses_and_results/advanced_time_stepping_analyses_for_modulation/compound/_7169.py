...
class HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7111.AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7040.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7040.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
