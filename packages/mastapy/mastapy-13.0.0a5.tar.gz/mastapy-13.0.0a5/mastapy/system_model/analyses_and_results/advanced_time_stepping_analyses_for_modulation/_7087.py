...
class StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6994.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2798.StraightBevelGearMeshSystemDeflection':
