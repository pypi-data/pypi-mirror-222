...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7077, _7078
...
class SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6995.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2790.SpiralBevelGearSetSystemDeflection':
    ...
    @property
    def spiral_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7077.SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spiral_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7078.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
