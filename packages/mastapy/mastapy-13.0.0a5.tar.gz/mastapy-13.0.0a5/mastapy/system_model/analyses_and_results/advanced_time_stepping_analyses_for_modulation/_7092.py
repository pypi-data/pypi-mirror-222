...
class SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation(_7093.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2803.SynchroniserHalfSystemDeflection':
