...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7169, _7170
...
class HypoidGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7113.AGMAGleasonConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7042.HypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7169.HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7170.HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7042.HypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
