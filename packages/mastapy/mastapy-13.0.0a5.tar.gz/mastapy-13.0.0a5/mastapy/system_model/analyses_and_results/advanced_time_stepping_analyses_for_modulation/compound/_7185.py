...
class OilSealCompoundAdvancedTimeSteppingAnalysisForModulation(_7143.ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation):
    """OilSealCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7056.OilSealAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7056.OilSealAdvancedTimeSteppingAnalysisForModulation]':
