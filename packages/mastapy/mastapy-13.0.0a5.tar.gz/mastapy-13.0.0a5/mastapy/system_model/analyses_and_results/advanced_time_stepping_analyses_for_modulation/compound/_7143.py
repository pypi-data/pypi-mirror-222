...
class ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation(_7184.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7013.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7013.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
