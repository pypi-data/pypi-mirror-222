...
class SpringDamperAdvancedTimeSteppingAnalysisForModulation(_7014.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2794.SpringDamperSystemDeflection':
