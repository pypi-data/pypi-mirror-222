...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7101, _7102
...
class WormGearSetAdvancedTimeSteppingAnalysisForModulation(_7037.GearSetAdvancedTimeSteppingAnalysisForModulation):
    """WormGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def worm_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7101.WormGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def worm_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7102.WormGearMeshAdvancedTimeSteppingAnalysisForModulation]':
