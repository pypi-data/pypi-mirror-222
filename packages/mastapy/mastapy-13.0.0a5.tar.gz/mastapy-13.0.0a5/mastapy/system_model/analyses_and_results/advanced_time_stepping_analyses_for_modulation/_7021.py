...
class CycloidalDiscAdvancedTimeSteppingAnalysisForModulation(_6974.AbstractShaftAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2720.CycloidalDiscSystemDeflection':
