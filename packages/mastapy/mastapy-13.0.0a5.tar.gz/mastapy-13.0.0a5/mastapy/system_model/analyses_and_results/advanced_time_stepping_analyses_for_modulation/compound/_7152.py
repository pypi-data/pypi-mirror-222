...
class CycloidalDiscCompoundAdvancedTimeSteppingAnalysisForModulation(_7108.AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7021.CycloidalDiscAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7021.CycloidalDiscAdvancedTimeSteppingAnalysisForModulation]':
