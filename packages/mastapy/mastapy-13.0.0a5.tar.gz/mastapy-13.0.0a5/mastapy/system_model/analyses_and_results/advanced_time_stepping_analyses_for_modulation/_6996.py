...
class BoltAdvancedTimeSteppingAnalysisForModulation(_7002.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """BoltAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2692.BoltSystemDeflection':
