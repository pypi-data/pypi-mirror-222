...
class SpringDamperConnectionCompoundModalAnalysisAtAStiffness(_5001.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """SpringDamperConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4936.SpringDamperConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4936.SpringDamperConnectionModalAnalysisAtAStiffness]':
