...
class AGMAGleasonConicalGearSetCompoundModalAnalysisAtAStiffness(_4997.ConicalGearSetCompoundModalAnalysisAtAStiffness):
    """AGMAGleasonConicalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4839.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4839.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness]':
