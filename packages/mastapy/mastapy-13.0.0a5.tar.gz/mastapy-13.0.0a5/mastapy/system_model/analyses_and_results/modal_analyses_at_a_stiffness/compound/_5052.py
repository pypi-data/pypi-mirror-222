...
class RingPinsCompoundModalAnalysisAtAStiffness(_5040.MountableComponentCompoundModalAnalysisAtAStiffness):
    """RingPinsCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4923.RingPinsModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4923.RingPinsModalAnalysisAtAStiffness]':
