...
class ConceptGearCompoundModalAnalysisAtAStiffness(_5021.GearCompoundModalAnalysisAtAStiffness):
    """ConceptGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4863.ConceptGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4863.ConceptGearModalAnalysisAtAStiffness]':
