...
class PointLoadCompoundModalAnalysisAtAStiffness(_5085.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """PointLoadCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4920.PointLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4920.PointLoadModalAnalysisAtAStiffness]':
