...
class ClutchCompoundModalAnalysisAtAStiffness(_5000.CouplingCompoundModalAnalysisAtAStiffness):
    """ClutchCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4856.ClutchModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4856.ClutchModalAnalysisAtAStiffness]':
