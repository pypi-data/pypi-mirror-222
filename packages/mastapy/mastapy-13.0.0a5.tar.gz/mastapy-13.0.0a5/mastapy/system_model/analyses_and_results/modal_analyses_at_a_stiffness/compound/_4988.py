...
class ComponentCompoundModalAnalysisAtAStiffness(_5042.PartCompoundModalAnalysisAtAStiffness):
    """ComponentCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4858.ComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4858.ComponentModalAnalysisAtAStiffness]':
