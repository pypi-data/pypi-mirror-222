...
class CVTCompoundModalAnalysisAtAStiffness(_4973.BeltDriveCompoundModalAnalysisAtAStiffness):
    """CVTCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4874.CVTModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4874.CVTModalAnalysisAtAStiffness]':
