...
class CycloidalAssemblyCompoundModalAnalysisAtAStiffness(_5061.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """CycloidalAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4876.CycloidalAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4876.CycloidalAssemblyModalAnalysisAtAStiffness]':
