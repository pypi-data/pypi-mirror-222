...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4881, _4880
...
class CylindricalGearSetModalAnalysisAtAStiffness(_4894.GearSetModalAnalysisAtAStiffness):
    """CylindricalGearSetModalAnalysisAtAStiffness
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4881.CylindricalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4880.CylindricalGearMeshModalAnalysisAtAStiffness]':
