...
class ExternalCADModelCompoundModalAnalysisAtAStiffness(_4988.ComponentCompoundModalAnalysisAtAStiffness):
    """ExternalCADModelCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4886.ExternalCADModelModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4886.ExternalCADModelModalAnalysisAtAStiffness]':
