...
class PlanetCarrierCompoundModalAnalysisAtAStiffness(_5040.MountableComponentCompoundModalAnalysisAtAStiffness):
    """PlanetCarrierCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4919.PlanetCarrierModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4919.PlanetCarrierModalAnalysisAtAStiffness]':
