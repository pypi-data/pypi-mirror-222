...
class ConicalGearCompoundModalAnalysisAtAStiffness(_5021.GearCompoundModalAnalysisAtAStiffness):
    """ConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4866.ConicalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4866.ConicalGearModalAnalysisAtAStiffness]':
