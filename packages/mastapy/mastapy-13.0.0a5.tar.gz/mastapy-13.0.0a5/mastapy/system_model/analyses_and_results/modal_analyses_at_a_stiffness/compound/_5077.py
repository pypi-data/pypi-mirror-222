...
class SynchroniserHalfCompoundModalAnalysisAtAStiffness(_5078.SynchroniserPartCompoundModalAnalysisAtAStiffness):
    """SynchroniserHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4947.SynchroniserHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4947.SynchroniserHalfModalAnalysisAtAStiffness]':
