...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5025, _5026
...
class HypoidGearSetCompoundModalAnalysisAtAStiffness(_4969.AGMAGleasonConicalGearSetCompoundModalAnalysisAtAStiffness):
    """HypoidGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4898.HypoidGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5025.HypoidGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5026.HypoidGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4898.HypoidGearSetModalAnalysisAtAStiffness]':
