...
class ConicalGearMeshCompoundModalAnalysisAtAStiffness(_5022.GearMeshCompoundModalAnalysisAtAStiffness):
    """ConicalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4865.ConicalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4865.ConicalGearMeshModalAnalysisAtAStiffness]':
