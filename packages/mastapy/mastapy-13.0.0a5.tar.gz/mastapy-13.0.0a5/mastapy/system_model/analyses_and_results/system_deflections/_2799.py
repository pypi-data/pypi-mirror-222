...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.system_deflections import _2800, _2798
...
class StraightBevelGearSetSystemDeflection(_2689.BevelGearSetSystemDeflection):
    """StraightBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4125.StraightBevelGearSetPowerFlow':
    ...
    @property
    def straight_bevel_gears_system_deflection(self) -> 'List[_2800.StraightBevelGearSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_system_deflection(self) -> 'List[_2798.StraightBevelGearMeshSystemDeflection]':
