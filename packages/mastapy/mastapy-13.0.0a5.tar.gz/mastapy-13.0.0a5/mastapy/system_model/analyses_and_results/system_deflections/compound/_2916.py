...
class PartToPartShearCouplingHalfCompoundSystemDeflection(_2872.CouplingHalfCompoundSystemDeflection):
    """PartToPartShearCouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2769.PartToPartShearCouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2769.PartToPartShearCouplingHalfSystemDeflection]':
