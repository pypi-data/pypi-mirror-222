...
class CycloidalDiscCentralBearingConnectionSystemDeflection(_2696.CoaxialConnectionSystemDeflection):
    """CycloidalDiscCentralBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4056.CycloidalDiscCentralBearingConnectionPowerFlow':
