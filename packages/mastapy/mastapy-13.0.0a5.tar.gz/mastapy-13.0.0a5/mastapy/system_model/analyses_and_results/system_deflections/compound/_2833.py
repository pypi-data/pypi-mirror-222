...
class AbstractAssemblyCompoundSystemDeflection(_2913.PartCompoundSystemDeflection):
    """AbstractAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2667.AbstractAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2667.AbstractAssemblySystemDeflection]':
