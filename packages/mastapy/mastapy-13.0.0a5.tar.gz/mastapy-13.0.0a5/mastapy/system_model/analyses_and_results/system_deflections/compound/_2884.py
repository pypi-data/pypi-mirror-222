...
class DatumCompoundSystemDeflection(_2858.ComponentCompoundSystemDeflection):
    """DatumCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2733.DatumSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2733.DatumSystemDeflection]':
