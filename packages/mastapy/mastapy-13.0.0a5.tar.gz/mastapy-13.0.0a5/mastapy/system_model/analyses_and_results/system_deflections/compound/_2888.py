...
class FaceGearMeshCompoundSystemDeflection(_2893.GearMeshCompoundSystemDeflection):
    """FaceGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2736.FaceGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2736.FaceGearMeshSystemDeflection]':
