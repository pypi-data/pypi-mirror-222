...
class CoaxialConnectionSystemDeflection(_2787.ShaftToMountableComponentConnectionSystemDeflection):
    """CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4036.CoaxialConnectionPowerFlow':
