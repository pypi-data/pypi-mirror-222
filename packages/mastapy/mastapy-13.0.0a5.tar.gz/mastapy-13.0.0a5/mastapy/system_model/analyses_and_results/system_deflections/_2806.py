...
class SynchroniserSystemDeflection(_2788.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4130.SynchroniserPowerFlow':
    ...
    @property
    def cones(self) -> 'List[_2803.SynchroniserHalfSystemDeflection]':
