...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.system_deflections import _2791, _2789
...
class SpiralBevelGearSetSystemDeflection(_2689.BevelGearSetSystemDeflection):
    """SpiralBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4116.SpiralBevelGearSetPowerFlow':
    ...
    @property
    def spiral_bevel_gears_system_deflection(self) -> 'List[_2791.SpiralBevelGearSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_system_deflection(self) -> 'List[_2789.SpiralBevelGearMeshSystemDeflection]':
