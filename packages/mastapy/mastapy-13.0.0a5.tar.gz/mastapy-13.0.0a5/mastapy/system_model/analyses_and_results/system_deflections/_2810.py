...
class TorqueConverterConnectionSystemDeflection(_2711.CouplingConnectionSystemDeflection):
    """TorqueConverterConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4133.TorqueConverterConnectionPowerFlow':
