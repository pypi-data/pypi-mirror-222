...
class ConicalGearCompoundSystemDeflection(_2892.GearCompoundSystemDeflection):
    """ConicalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_535.ConicalGearDutyCycleRating':
    ...
    @property
    def conical_duty_cycle_rating(self) -> '_535.ConicalGearDutyCycleRating':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2708.ConicalGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2708.ConicalGearSystemDeflection]':
