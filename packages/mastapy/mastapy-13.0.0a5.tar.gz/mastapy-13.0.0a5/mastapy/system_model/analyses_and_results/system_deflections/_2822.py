...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.system_deflections import _2823, _2821
...
class ZerolBevelGearSetSystemDeflection(_2689.BevelGearSetSystemDeflection):
    """ZerolBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4144.ZerolBevelGearSetPowerFlow':
    ...
    @property
    def zerol_bevel_gears_system_deflection(self) -> 'List[_2823.ZerolBevelGearSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_system_deflection(self) -> 'List[_2821.ZerolBevelGearMeshSystemDeflection]':
