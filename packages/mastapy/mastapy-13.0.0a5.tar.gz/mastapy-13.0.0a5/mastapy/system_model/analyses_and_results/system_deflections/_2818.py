...
class WormGearMeshSystemDeflection(_2741.GearMeshSystemDeflection):
    """WormGearMeshSystemDeflection
    ...
    @property
    def rating(self) -> '_371.WormGearMeshRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_371.WormGearMeshRating':
    ...
    @property
    def power_flow_results(self) -> '_4139.WormGearMeshPowerFlow':
