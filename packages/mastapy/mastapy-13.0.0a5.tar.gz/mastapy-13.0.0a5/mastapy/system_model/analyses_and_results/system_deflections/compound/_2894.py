...
class GearSetCompoundSystemDeflection(_2933.SpecialisedAssemblyCompoundSystemDeflection):
    """GearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2742.GearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2742.GearSetSystemDeflection]':
