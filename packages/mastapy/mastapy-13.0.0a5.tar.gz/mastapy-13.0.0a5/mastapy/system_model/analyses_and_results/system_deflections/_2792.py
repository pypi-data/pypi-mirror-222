...
class SpringDamperConnectionSystemDeflection(_2711.CouplingConnectionSystemDeflection):
    """SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4117.SpringDamperConnectionPowerFlow':
