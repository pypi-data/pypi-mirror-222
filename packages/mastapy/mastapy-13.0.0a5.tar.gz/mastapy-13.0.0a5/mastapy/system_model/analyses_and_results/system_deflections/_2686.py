...
class BevelDifferentialPlanetGearSystemDeflection(_2685.BevelDifferentialGearSystemDeflection):
    """BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4026.BevelDifferentialPlanetGearPowerFlow':
