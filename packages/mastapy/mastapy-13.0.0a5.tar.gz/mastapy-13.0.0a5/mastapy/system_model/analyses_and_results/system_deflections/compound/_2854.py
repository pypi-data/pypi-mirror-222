...
class ClutchCompoundSystemDeflection(_2870.CouplingCompoundSystemDeflection):
    """ClutchCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2695.ClutchSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2695.ClutchSystemDeflection]':
