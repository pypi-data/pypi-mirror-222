...
class CycloidalAssemblySystemDeflection(_2788.SpecialisedAssemblySystemDeflection):
    """CycloidalAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4055.CycloidalAssemblyPowerFlow':
    ...
    @property
    def ring_pins_to_disc_connections(self) -> 'List[_2777.RingPinsToDiscConnectionSystemDeflection]':
