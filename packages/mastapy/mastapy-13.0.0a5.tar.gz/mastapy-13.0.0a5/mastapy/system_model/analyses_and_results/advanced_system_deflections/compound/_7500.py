...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7498, _7499
...
class ZerolBevelGearSetCompoundAdvancedSystemDeflection(_7390.BevelGearSetCompoundAdvancedSystemDeflection):
    """ZerolBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7371.ZerolBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7498.ZerolBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7499.ZerolBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7371.ZerolBevelGearSetAdvancedSystemDeflection]':
