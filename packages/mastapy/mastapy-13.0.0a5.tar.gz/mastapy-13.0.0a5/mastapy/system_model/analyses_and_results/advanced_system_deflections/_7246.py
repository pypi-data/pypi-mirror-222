...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_system_deflections import (
        _7247, _7249, _7252, _7259,
        _7258, _7280, _7260, _7265,
        _7270, _7283, _7284, _7289,
        _7297, _7296, _7298, _7305,
        _7312, _7315, _7317, _7318,
        _7320, _7322, _7327, _7328,
        _7329, _7331, _7334, _7338,
        _7337, _7343, _7344, _7349,
        _7352, _7355, _7359, _7364,
        _7368, _7371
    )
...
class AssemblyAdvancedSystemDeflection(_7236.AbstractAssemblyAdvancedSystemDeflection):
    """AssemblyAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2674.AssemblySystemDeflection]':
    ...
    @property
    def bearings(self) -> 'List[_7247.BearingAdvancedSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_7249.BeltDriveAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_7252.BevelDifferentialGearSetAdvancedSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_7259.BoltedJointAdvancedSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_7258.BoltAdvancedSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_7280.CVTAdvancedSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_7260.ClutchAdvancedSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_7265.ConceptCouplingAdvancedSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_7270.ConceptGearSetAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_7283.CycloidalAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_7284.CycloidalDiscAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_7289.CylindricalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_7297.FEPartAdvancedSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_7296.FaceGearSetAdvancedSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_7298.FlexiblePinAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7305.HypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7312.KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7315.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_7317.MassDiscAdvancedSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_7318.MeasurementComponentAdvancedSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_7320.OilSealAdvancedSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7322.PartToPartShearCouplingAdvancedSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7327.PlanetCarrierAdvancedSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_7328.PointLoadAdvancedSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_7329.PowerLoadAdvancedSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_7331.RingPinsAdvancedSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7334.RollingRingAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7338.ShaftHubConnectionAdvancedSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_7337.ShaftAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7343.SpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7344.SpringDamperAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7349.StraightBevelDiffGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7352.StraightBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_7355.SynchroniserAdvancedSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_7359.TorqueConverterAdvancedSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7364.UnbalancedMassAdvancedSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7368.WormGearSetAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7371.ZerolBevelGearSetAdvancedSystemDeflection]':
