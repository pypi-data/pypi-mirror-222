...
class StraightBevelDiffGearMeshAdvancedSystemDeflection(_7256.BevelGearMeshAdvancedSystemDeflection):
    """StraightBevelDiffGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2795.StraightBevelDiffGearMeshSystemDeflection]':
