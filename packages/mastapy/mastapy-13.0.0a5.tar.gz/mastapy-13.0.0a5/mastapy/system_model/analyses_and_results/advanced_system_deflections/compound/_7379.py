...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import (
        _7380, _7382, _7385, _7392,
        _7391, _7413, _7393, _7398,
        _7403, _7415, _7417, _7421,
        _7428, _7427, _7429, _7436,
        _7443, _7446, _7447, _7448,
        _7450, _7452, _7457, _7458,
        _7459, _7461, _7463, _7468,
        _7467, _7473, _7474, _7479,
        _7482, _7485, _7489, _7493,
        _7497, _7500
    )
...
class AssemblyCompoundAdvancedSystemDeflection(_7372.AbstractAssemblyCompoundAdvancedSystemDeflection):
    """AssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7246.AssemblyAdvancedSystemDeflection]':
    ...
    @property
    def bearings(self) -> 'List[_7380.BearingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_7382.BeltDriveCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_7385.BevelDifferentialGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_7392.BoltedJointCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_7391.BoltCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_7413.CVTCompoundAdvancedSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_7393.ClutchCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_7398.ConceptCouplingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_7403.ConceptGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_7415.CycloidalAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_7417.CycloidalDiscCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_7421.CylindricalGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_7428.FEPartCompoundAdvancedSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_7427.FaceGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_7429.FlexiblePinAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7436.HypoidGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7443.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7446.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_7447.MassDiscCompoundAdvancedSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_7448.MeasurementComponentCompoundAdvancedSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_7450.OilSealCompoundAdvancedSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7452.PartToPartShearCouplingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7457.PlanetCarrierCompoundAdvancedSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_7458.PointLoadCompoundAdvancedSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_7459.PowerLoadCompoundAdvancedSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_7461.RingPinsCompoundAdvancedSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7463.RollingRingAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7468.ShaftHubConnectionCompoundAdvancedSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_7467.ShaftCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7473.SpiralBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7474.SpringDamperCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7479.StraightBevelDiffGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7482.StraightBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_7485.SynchroniserCompoundAdvancedSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_7489.TorqueConverterCompoundAdvancedSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7493.UnbalancedMassCompoundAdvancedSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7497.WormGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7500.ZerolBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7246.AssemblyAdvancedSystemDeflection]':
