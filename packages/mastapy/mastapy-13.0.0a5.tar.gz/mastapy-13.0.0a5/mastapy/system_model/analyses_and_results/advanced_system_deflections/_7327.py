...
class PlanetCarrierAdvancedSystemDeflection(_7319.MountableComponentAdvancedSystemDeflection):
    """PlanetCarrierAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2772.PlanetCarrierSystemDeflection]':
