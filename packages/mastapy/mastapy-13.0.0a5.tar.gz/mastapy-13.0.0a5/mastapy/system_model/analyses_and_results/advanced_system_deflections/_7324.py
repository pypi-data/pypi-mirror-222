...
class PartToPartShearCouplingHalfAdvancedSystemDeflection(_7279.CouplingHalfAdvancedSystemDeflection):
    """PartToPartShearCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2769.PartToPartShearCouplingHalfSystemDeflection]':
