...
class SpringDamperHalfAdvancedSystemDeflection(_7279.CouplingHalfAdvancedSystemDeflection):
    """SpringDamperHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2793.SpringDamperHalfSystemDeflection]':
