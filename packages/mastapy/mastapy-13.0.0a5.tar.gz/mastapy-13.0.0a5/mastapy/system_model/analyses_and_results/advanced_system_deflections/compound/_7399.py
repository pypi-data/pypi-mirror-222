...
class ConceptCouplingConnectionCompoundAdvancedSystemDeflection(_7410.CouplingConnectionCompoundAdvancedSystemDeflection):
    """ConceptCouplingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7266.ConceptCouplingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7266.ConceptCouplingConnectionAdvancedSystemDeflection]':
