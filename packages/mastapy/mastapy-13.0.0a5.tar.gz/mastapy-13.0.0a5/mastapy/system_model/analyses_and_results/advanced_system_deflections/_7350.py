...
class StraightBevelGearAdvancedSystemDeflection(_7255.BevelGearAdvancedSystemDeflection):
    """StraightBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_394.StraightBevelGearRating':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2800.StraightBevelGearSystemDeflection]':
