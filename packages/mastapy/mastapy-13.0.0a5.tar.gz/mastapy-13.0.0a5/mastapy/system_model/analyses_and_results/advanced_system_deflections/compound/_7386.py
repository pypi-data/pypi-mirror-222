...
class BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection(_7383.BevelDifferentialGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7253.BevelDifferentialPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7253.BevelDifferentialPlanetGearAdvancedSystemDeflection]':
