...
class RollingRingAdvancedSystemDeflection(_7279.CouplingHalfAdvancedSystemDeflection):
    """RollingRingAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2781.RollingRingSystemDeflection]':
