...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7350, _7351
...
class StraightBevelGearSetAdvancedSystemDeflection(_7257.BevelGearSetAdvancedSystemDeflection):
    """StraightBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2799.StraightBevelGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_advanced_system_deflection(self) -> 'List[_7350.StraightBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_advanced_system_deflection(self) -> 'List[_7351.StraightBevelGearMeshAdvancedSystemDeflection]':
