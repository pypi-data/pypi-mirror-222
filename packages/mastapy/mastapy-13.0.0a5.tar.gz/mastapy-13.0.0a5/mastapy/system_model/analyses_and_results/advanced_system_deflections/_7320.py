...
class OilSealAdvancedSystemDeflection(_7275.ConnectorAdvancedSystemDeflection):
    """OilSealAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2766.OilSealSystemDeflection]':
