...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7288, _7290
...
class CylindricalGearAdvancedSystemDeflection(_7299.GearAdvancedSystemDeflection):
    """CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_7288.CylindricalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_7290.CylindricalMeshedGearAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_7290.CylindricalMeshedGearAdvancedSystemDeflection]':
