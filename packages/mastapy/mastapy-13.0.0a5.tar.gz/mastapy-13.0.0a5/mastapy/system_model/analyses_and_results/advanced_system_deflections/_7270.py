...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7268, _7269
...
class ConceptGearSetAdvancedSystemDeflection(_7301.GearSetAdvancedSystemDeflection):
    """ConceptGearSetAdvancedSystemDeflection
    ...
    @property
    def concept_gears_advanced_system_deflection(self) -> 'List[_7268.ConceptGearAdvancedSystemDeflection]':
    ...
    @property
    def concept_meshes_advanced_system_deflection(self) -> 'List[_7269.ConceptGearMeshAdvancedSystemDeflection]':
