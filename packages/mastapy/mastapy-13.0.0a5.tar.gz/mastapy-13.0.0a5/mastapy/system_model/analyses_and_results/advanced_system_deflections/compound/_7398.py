...
class ConceptCouplingCompoundAdvancedSystemDeflection(_7409.CouplingCompoundAdvancedSystemDeflection):
    """ConceptCouplingCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7265.ConceptCouplingAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7265.ConceptCouplingAdvancedSystemDeflection]':
