...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1015, _1009
    from mastapy.gears.cylindrical import _1210
    from mastapy.math_utility import _1503
    from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7287, _7276
...
class CylindricalGearMeshAdvancedSystemDeflection(_7300.GearMeshAdvancedSystemDeflection):
    """CylindricalGearMeshAdvancedSystemDeflection
    ...
    @property
    def inactive_flank(self) -> '_321.CylindricalFlanks':
    ...
    @property
    def gear_mesh_design(self) -> '_1015.CylindricalGearMeshDesign':
    ...
    @property
    def points_with_worst_results(self) -> '_1210.PointsWithWorstResults':
    ...
    @property
    def transmission_error_fourier_series_for_first_tooth_passing_period(self) -> '_1503.FourierSeries':
    ...
    @property
    def cylindrical_gear_advanced_analyses(self) -> 'List[_7287.CylindricalGearAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_results(self) -> 'List[_2722.CylindricalGearMeshSystemDeflectionTimestep]':
    ...
    @property
    def gear_designs(self) -> 'List[_1009.CylindricalGearDesign]':
    ...
    @property
    def max_pressure_contact_chart_for_each_tooth_pass_for_gear_a(self) -> 'List[_7276.ContactChartPerToothPass]':
