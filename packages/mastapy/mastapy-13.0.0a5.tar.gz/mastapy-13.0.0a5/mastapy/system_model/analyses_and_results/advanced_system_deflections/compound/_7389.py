...
class BevelGearMeshCompoundAdvancedSystemDeflection(_7377.AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection):
    """BevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7256.BevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7256.BevelGearMeshAdvancedSystemDeflection]':
