...
class ConceptCouplingHalfAdvancedSystemDeflection(_7279.CouplingHalfAdvancedSystemDeflection):
    """ConceptCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2700.ConceptCouplingHalfSystemDeflection]':
