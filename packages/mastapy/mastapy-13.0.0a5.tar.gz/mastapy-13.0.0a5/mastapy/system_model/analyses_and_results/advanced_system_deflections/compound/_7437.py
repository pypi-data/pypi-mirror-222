...
class InterMountableComponentConnectionCompoundAdvancedSystemDeflection(_7407.ConnectionCompoundAdvancedSystemDeflection):
    """InterMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7306.InterMountableComponentConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7306.InterMountableComponentConnectionAdvancedSystemDeflection]':
