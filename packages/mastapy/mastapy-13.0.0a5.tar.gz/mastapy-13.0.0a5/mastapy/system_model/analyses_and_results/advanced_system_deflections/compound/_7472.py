...
class SpiralBevelGearMeshCompoundAdvancedSystemDeflection(_7389.BevelGearMeshCompoundAdvancedSystemDeflection):
    """SpiralBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7342.SpiralBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7342.SpiralBevelGearMeshAdvancedSystemDeflection]':
