...
class PulleyAdvancedSystemDeflection(_7279.CouplingHalfAdvancedSystemDeflection):
    """PulleyAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2775.PulleySystemDeflection]':
