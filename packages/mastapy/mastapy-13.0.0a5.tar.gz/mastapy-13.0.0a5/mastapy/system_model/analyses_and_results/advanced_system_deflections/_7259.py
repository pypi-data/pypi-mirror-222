...
class BoltedJointAdvancedSystemDeflection(_7340.SpecialisedAssemblyAdvancedSystemDeflection):
    """BoltedJointAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2691.BoltedJointSystemDeflection]':
