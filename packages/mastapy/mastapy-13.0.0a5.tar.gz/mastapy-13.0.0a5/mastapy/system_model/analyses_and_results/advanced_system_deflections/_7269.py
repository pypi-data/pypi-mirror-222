...
class ConceptGearMeshAdvancedSystemDeflection(_7300.GearMeshAdvancedSystemDeflection):
    """ConceptGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2702.ConceptGearMeshSystemDeflection]':
