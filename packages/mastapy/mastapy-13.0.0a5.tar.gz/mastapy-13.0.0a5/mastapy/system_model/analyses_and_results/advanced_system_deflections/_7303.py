...
class HypoidGearAdvancedSystemDeflection(_7243.AGMAGleasonConicalGearAdvancedSystemDeflection):
    """HypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2747.HypoidGearSystemDeflection]':
