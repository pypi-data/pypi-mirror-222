...
class CylindricalMeshedGearAdvancedSystemDeflection(_0.APIBase):
    ...
    @property
    def cylindrical_gear_advanced_system_deflection(self) -> '_7287.CylindricalGearAdvancedSystemDeflection':
    ...
    @property
    def cylindrical_gear_mesh_advanced_system_deflection(self) -> '_7288.CylindricalGearMeshAdvancedSystemDeflection':
    ...
    @property
    def other_cylindrical_gear_advanced_system_deflection(self) -> '_7287.CylindricalGearAdvancedSystemDeflection':
