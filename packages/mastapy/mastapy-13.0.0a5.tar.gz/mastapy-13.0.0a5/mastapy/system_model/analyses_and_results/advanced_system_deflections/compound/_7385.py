...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7383, _7384
...
class BevelDifferentialGearSetCompoundAdvancedSystemDeflection(_7390.BevelGearSetCompoundAdvancedSystemDeflection):
    """BevelDifferentialGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7252.BevelDifferentialGearSetAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gears_compound_advanced_system_deflection(self) -> 'List[_7383.BevelDifferentialGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_compound_advanced_system_deflection(self) -> 'List[_7384.BevelDifferentialGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7252.BevelDifferentialGearSetAdvancedSystemDeflection]':
