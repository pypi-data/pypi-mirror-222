...
class PlanetaryConnectionHarmonicAnalysis(_5778.ShaftToMountableComponentConnectionHarmonicAnalysis):
    """PlanetaryConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2771.PlanetaryConnectionSystemDeflection':
