...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5782, _5783
...
class SpiralBevelGearSetHarmonicAnalysis(_5670.BevelGearSetHarmonicAnalysis):
    """SpiralBevelGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5782.SpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_harmonic_analysis(self) -> 'List[_5782.SpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5783.SpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_harmonic_analysis(self) -> 'List[_5783.SpiralBevelGearMeshHarmonicAnalysis]':
