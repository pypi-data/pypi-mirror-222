...
class BevelDifferentialSunGearCompoundHarmonicAnalysis(_5860.BevelDifferentialGearCompoundHarmonicAnalysis):
    """BevelDifferentialSunGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5667.BevelDifferentialSunGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5667.BevelDifferentialSunGearHarmonicAnalysis]':
