...
class ConceptCouplingConnectionCompoundHarmonicAnalysis(_5887.CouplingConnectionCompoundHarmonicAnalysis):
    """ConceptCouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5679.ConceptCouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5679.ConceptCouplingConnectionHarmonicAnalysis]':
