...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5878, _5879
...
class ConceptGearSetCompoundHarmonicAnalysis(_5909.GearSetCompoundHarmonicAnalysis):
    """ConceptGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5684.ConceptGearSetHarmonicAnalysis]':
    ...
    @property
    def concept_gears_compound_harmonic_analysis(self) -> 'List[_5878.ConceptGearCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_meshes_compound_harmonic_analysis(self) -> 'List[_5879.ConceptGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5684.ConceptGearSetHarmonicAnalysis]':
