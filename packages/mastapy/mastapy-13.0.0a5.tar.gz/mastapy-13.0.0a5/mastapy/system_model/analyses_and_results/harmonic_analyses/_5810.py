...
class WormGearSetHarmonicAnalysis(_5730.GearSetHarmonicAnalysis):
    """WormGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5808.WormGearHarmonicAnalysis]':
    ...
    @property
    def worm_gears_harmonic_analysis(self) -> 'List[_5808.WormGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5809.WormGearMeshHarmonicAnalysis]':
    ...
    @property
    def worm_meshes_harmonic_analysis(self) -> 'List[_5809.WormGearMeshHarmonicAnalysis]':
