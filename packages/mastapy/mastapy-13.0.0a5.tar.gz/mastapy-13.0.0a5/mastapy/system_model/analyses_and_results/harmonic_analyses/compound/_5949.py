...
class SpiralBevelGearMeshCompoundHarmonicAnalysis(_5866.BevelGearMeshCompoundHarmonicAnalysis):
    """SpiralBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5783.SpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5783.SpiralBevelGearMeshHarmonicAnalysis]':
