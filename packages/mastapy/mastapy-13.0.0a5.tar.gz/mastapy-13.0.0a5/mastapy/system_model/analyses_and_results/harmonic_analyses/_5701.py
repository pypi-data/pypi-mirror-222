...
class CylindricalGearMeshHarmonicAnalysis(_5727.GearMeshHarmonicAnalysis):
    """CylindricalGearMeshHarmonicAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_7288.CylindricalGearMeshAdvancedSystemDeflection':
