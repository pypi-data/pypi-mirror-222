...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5700, _5701
...
class CylindricalGearSetHarmonicAnalysis(_5730.GearSetHarmonicAnalysis):
    """CylindricalGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5700.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gears_harmonic_analysis(self) -> 'List[_5700.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5701.CylindricalGearMeshHarmonicAnalysis]':
    ...
    @property
    def cylindrical_meshes_harmonic_analysis(self) -> 'List[_5701.CylindricalGearMeshHarmonicAnalysis]':
