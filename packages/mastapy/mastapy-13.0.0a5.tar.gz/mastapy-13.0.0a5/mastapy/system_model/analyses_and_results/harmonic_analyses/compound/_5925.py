...
class MeasurementComponentCompoundHarmonicAnalysis(_5971.VirtualComponentCompoundHarmonicAnalysis):
    """MeasurementComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5755.MeasurementComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5755.MeasurementComponentHarmonicAnalysis]':
