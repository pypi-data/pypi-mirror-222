...
class TorqueConverterConnectionCompoundHarmonicAnalysis(_5887.CouplingConnectionCompoundHarmonicAnalysis):
    """TorqueConverterConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5801.TorqueConverterConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5801.TorqueConverterConnectionHarmonicAnalysis]':
