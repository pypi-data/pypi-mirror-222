...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5902, _5903
...
class FaceGearSetCompoundHarmonicAnalysis(_5909.GearSetCompoundHarmonicAnalysis):
    """FaceGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5721.FaceGearSetHarmonicAnalysis]':
    ...
    @property
    def face_gears_compound_harmonic_analysis(self) -> 'List[_5902.FaceGearCompoundHarmonicAnalysis]':
    ...
    @property
    def face_meshes_compound_harmonic_analysis(self) -> 'List[_5903.FaceGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5721.FaceGearSetHarmonicAnalysis]':
