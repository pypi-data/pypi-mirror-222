...
class ShaftCompoundHarmonicAnalysis(_5850.AbstractShaftCompoundHarmonicAnalysis):
    """ShaftCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5776.ShaftHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5776.ShaftHarmonicAnalysis]':
