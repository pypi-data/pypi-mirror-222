...
class ClutchCompoundHarmonicAnalysis(_5886.CouplingCompoundHarmonicAnalysis):
    """ClutchCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5675.ClutchHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5675.ClutchHarmonicAnalysis]':
