...
class ExternalCADModelCompoundHarmonicAnalysis(_5874.ComponentCompoundHarmonicAnalysis):
    """ExternalCADModelCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5718.ExternalCADModelHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5718.ExternalCADModelHarmonicAnalysis]':
