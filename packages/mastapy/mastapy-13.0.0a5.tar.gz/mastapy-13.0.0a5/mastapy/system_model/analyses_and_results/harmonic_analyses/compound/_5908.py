...
class GearMeshCompoundHarmonicAnalysis(_5914.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    """GearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5727.GearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5727.GearMeshHarmonicAnalysis]':
