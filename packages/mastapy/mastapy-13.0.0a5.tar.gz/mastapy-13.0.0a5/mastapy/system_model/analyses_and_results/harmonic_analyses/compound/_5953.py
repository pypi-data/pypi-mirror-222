...
class SpringDamperHalfCompoundHarmonicAnalysis(_5888.CouplingHalfCompoundHarmonicAnalysis):
    """SpringDamperHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5786.SpringDamperHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5786.SpringDamperHalfHarmonicAnalysis]':
