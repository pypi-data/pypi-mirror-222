...
class ResultsForOrderIncludingNodes(_5839.ResultsForOrder):
    """ResultsForOrderIncludingNodes
    ...
    class _Cast_ResultsForOrderIncludingNodes:
        ...
        def results_for_order_including_surfaces(self):
            ...
            return self._parent._cast(_5842.ResultsForOrderIncludingSurfaces)
    ...
    @property
    def node_results_global_coordinate_system(self) -> 'List[_5833.HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic]':
    ...
    @property
    def node_results_local_coordinate_system(self) -> 'List[_5833.HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic]':
