...
class TorqueConverterPumpCompoundModalAnalysis(_4743.CouplingHalfCompoundModalAnalysis):
    """TorqueConverterPumpCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4679.TorqueConverterPumpModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4679.TorqueConverterPumpModalAnalysis]':
