...
class MountableComponentCompoundModalAnalysis(_4729.ComponentCompoundModalAnalysis):
    """MountableComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4634.MountableComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4634.MountableComponentModalAnalysis]':
