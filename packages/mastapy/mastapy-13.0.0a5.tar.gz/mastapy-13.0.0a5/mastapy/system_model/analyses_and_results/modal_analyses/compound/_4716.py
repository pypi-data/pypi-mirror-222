...
class BevelDifferentialGearMeshCompoundModalAnalysis(_4721.BevelGearMeshCompoundModalAnalysis):
    """BevelDifferentialGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4561.BevelDifferentialGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4561.BevelDifferentialGearMeshModalAnalysis]':
