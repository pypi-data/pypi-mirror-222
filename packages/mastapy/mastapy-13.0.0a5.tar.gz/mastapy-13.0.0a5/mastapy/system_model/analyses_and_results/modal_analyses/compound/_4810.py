...
class StraightBevelDiffGearMeshCompoundModalAnalysis(_4721.BevelGearMeshCompoundModalAnalysis):
    """StraightBevelDiffGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4665.StraightBevelDiffGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4665.StraightBevelDiffGearMeshModalAnalysis]':
