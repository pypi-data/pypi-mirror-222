...
class GearCompoundModalAnalysis(_4781.MountableComponentCompoundModalAnalysis):
    """GearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4613.GearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4613.GearModalAnalysis]':
