...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis(_4771.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4626.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4626.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
