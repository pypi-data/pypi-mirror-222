...
class StraightBevelPlanetGearCompoundModalAnalysis(_4809.StraightBevelDiffGearCompoundModalAnalysis):
    """StraightBevelPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4671.StraightBevelPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4671.StraightBevelPlanetGearModalAnalysis]':
