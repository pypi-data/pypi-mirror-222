...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import (
        _4558, _4560, _4563, _4569,
        _4570, _4592, _4573, _4578,
        _4581, _4594, _4596, _4600,
        _4609, _4608, _4610, _4618,
        _4625, _4628, _4629, _4630,
        _4636, _4641, _4644, _4645,
        _4646, _4648, _4650, _4654,
        _4655, _4661, _4664, _4667,
        _4670, _4674, _4678, _4681,
        _4688, _4691
    )
...
class AssemblyModalAnalysis(_4550.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def bearings(self) -> 'List[_4558.BearingModalAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_4560.BeltDriveModalAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4563.BevelDifferentialGearSetModalAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4569.BoltedJointModalAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_4570.BoltModalAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_4592.CVTModalAnalysis]':
    ...
    @property
    def calculate_full_fe_results_by_mode(self) -> 'List[_4692.CalculateFullFEResultsForMode]':
    ...
    @property
    def clutches(self) -> 'List[_4573.ClutchModalAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4578.ConceptCouplingModalAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4581.ConceptGearSetModalAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4594.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4596.CycloidalDiscModalAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4600.CylindricalGearSetModalAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_4609.FEPartModalAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4608.FaceGearSetModalAnalysis]':
    ...
    @property
    def full_fe_meshes_for_calculating_modes(self) -> 'List[_4609.FEPartModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4625.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4628.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_4629.MassDiscModalAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_4630.MeasurementComponentModalAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_4636.OilSealModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4641.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4644.PlanetCarrierModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4645.PointLoadModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4646.PowerLoadModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4648.RingPinsModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4650.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4654.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4655.ShaftModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4661.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4664.SpringDamperModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4667.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4670.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4674.SynchroniserModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4678.TorqueConverterModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4681.UnbalancedMassModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4688.WormGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4691.ZerolBevelGearSetModalAnalysis]':
