...
class ConceptGearMeshCompoundModalAnalysis(_4763.GearMeshCompoundModalAnalysis):
    """ConceptGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4579.ConceptGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4579.ConceptGearMeshModalAnalysis]':
