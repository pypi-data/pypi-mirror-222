...
class CylindricalGearSetModalAnalysis(_4614.GearSetModalAnalysis):
    ...
    @property
    def cylindrical_gears_modal_analysis(self) -> 'List[_4599.CylindricalGearModalAnalysis]':
    ...
    @property
    def cylindrical_meshes_modal_analysis(self) -> 'List[_4598.CylindricalGearMeshModalAnalysis]':
