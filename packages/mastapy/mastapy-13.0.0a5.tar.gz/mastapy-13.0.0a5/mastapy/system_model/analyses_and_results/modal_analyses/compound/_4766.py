...
class HypoidGearCompoundModalAnalysis(_4708.AGMAGleasonConicalGearCompoundModalAnalysis):
    """HypoidGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4617.HypoidGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4617.HypoidGearModalAnalysis]':
