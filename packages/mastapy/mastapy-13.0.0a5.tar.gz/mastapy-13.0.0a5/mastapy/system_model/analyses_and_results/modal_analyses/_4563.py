...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4562, _4561
...
class BevelDifferentialGearSetModalAnalysis(_4568.BevelGearSetModalAnalysis):
    """BevelDifferentialGearSetModalAnalysis
    ...
    @property
    def bevel_differential_gears_modal_analysis(self) -> 'List[_4562.BevelDifferentialGearModalAnalysis]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis(self) -> 'List[_4561.BevelDifferentialGearMeshModalAnalysis]':
