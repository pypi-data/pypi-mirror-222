...
class ConceptGearSetModalAnalysis(_4614.GearSetModalAnalysis):
    ...
    @property
    def concept_gears_modal_analysis(self) -> 'List[_4580.ConceptGearModalAnalysis]':
    ...
    @property
    def concept_meshes_modal_analysis(self) -> 'List[_4579.ConceptGearMeshModalAnalysis]':
