...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4660, _4659
...
class SpiralBevelGearSetModalAnalysis(_4568.BevelGearSetModalAnalysis):
    """SpiralBevelGearSetModalAnalysis
    ...
    @property
    def spiral_bevel_gears_modal_analysis(self) -> 'List[_4660.SpiralBevelGearModalAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_modal_analysis(self) -> 'List[_4659.SpiralBevelGearMeshModalAnalysis]':
