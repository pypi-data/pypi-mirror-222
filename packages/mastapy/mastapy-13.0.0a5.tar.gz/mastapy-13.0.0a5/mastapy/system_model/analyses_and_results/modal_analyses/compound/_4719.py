...
class BevelDifferentialSunGearCompoundModalAnalysis(_4715.BevelDifferentialGearCompoundModalAnalysis):
    """BevelDifferentialSunGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4565.BevelDifferentialSunGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4565.BevelDifferentialSunGearModalAnalysis]':
