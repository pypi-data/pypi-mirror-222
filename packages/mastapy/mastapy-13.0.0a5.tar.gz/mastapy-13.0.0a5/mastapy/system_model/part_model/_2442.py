...
if TYPE_CHECKING:
    from mastapy.bearings.tolerances import _1889, _1891
...
class InternalClearanceTolerance(_0.APIBase):
    ...
    class _Cast_InternalClearanceTolerance:
        ...
        def axial_internal_clearance_tolerance(self):
            ...
            return self._parent._cast(_2421.AxialInternalClearanceTolerance)

        @property
        def radial_internal_clearance_tolerance(self):
            from mastapy.system_model.part_model import _2456
            
            return self._parent._cast(_2456.RadialInternalClearanceTolerance)
