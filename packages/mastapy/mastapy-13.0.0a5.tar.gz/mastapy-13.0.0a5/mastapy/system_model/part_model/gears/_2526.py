...
class SpiralBevelGearSet(_2502.BevelGearSet):
    """SpiralBevelGearSet
    ...
    @property
    def conical_gear_set_design(self) -> '_968.SpiralBevelGearSetDesign':
    ...
    @property
    def spiral_bevel_gear_set_design(self) -> '_968.SpiralBevelGearSetDesign':
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_2525.SpiralBevelGear]':
    ...
    @property
    def spiral_bevel_meshes(self) -> 'List[_2306.SpiralBevelGearMesh]':
