...
class Clutch(_2565.Coupling):
    ...
    @property
    def angular_speed_temperature_grid(self) -> '_1556.GriddedSurfaceAccessor':
    ...
    def angular_speed_temperature_grid(self, value: '_1556.GriddedSurfaceAccessor'):
    ...
    @property
    def clutch_type(self) -> '_2562.ClutchType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.PartModel.Couplings.ClutchType')
        return constructor.new_from_mastapy('mastapy.system_model.part_model.couplings._2562', 'ClutchType')(value) if value is not None else None

    @clutch_type.setter
    def clutch_type(self, value: '_2562.ClutchType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.PartModel.Couplings.ClutchType')
    ...
    @property
    def flow_rate_vs_speed(self) -> '_1525.Vector2DListAccessor':
    ...
    def flow_rate_vs_speed(self, value: '_1525.Vector2DListAccessor'):
    ...
    @property
    def linear_speed_temperature_grid(self) -> '_1556.GriddedSurfaceAccessor':
    ...
    def linear_speed_temperature_grid(self, value: '_1556.GriddedSurfaceAccessor'):
    ...
    @property
    def spring_type(self) -> '_5376.ClutchSpringType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ClutchSpringType')
        return constructor.new_from_mastapy('mastapy.system_model.analyses_and_results.mbd_analyses._5376', 'ClutchSpringType')(value) if value is not None else None

    @spring_type.setter
    def spring_type(self, value: '_5376.ClutchSpringType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ClutchSpringType')
    ...
    @property
    def clutch_connection(self) -> '_2325.ClutchConnection':
