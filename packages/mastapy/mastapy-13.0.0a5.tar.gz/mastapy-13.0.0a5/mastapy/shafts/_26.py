...
class ShaftMaterialForReports(_0.APIBase):
    ...
    def casting_factor_condition(self) -> '_7.CastingFactorCondition':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Shafts.CastingFactorCondition')
        return constructor.new_from_mastapy('mastapy.shafts._7', 'CastingFactorCondition')(value) if value is not None else None

    @casting_factor_condition.setter
    def casting_factor_condition(self, value: '_7.CastingFactorCondition'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Shafts.CastingFactorCondition')
    ...
    def consequence_of_failure(self) -> '_8.ConsequenceOfFailure':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Shafts.ConsequenceOfFailure')
        return constructor.new_from_mastapy('mastapy.shafts._8', 'ConsequenceOfFailure')(value) if value is not None else None

    @consequence_of_failure.setter
    def consequence_of_failure(self, value: '_8.ConsequenceOfFailure'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Shafts.ConsequenceOfFailure')
    ...
    def curve_model(self) -> '_12.FkmSnCurveModel':
        ...
        return constructor.new_from_mastapy('mastapy.shafts._12', 'FkmSnCurveModel')(value) if value is not None else None
    ...
    def material_group(self) -> '_11.FkmMaterialGroup':
        ...
        return constructor.new_from_mastapy('mastapy.shafts._11', 'FkmMaterialGroup')(value) if value is not None else None
