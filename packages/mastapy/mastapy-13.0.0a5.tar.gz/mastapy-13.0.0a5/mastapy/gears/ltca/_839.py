...
if TYPE_CHECKING:
    from mastapy.gears.ltca import _846, _840
...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    class _Cast_GearMeshLoadDistributionAtRotation:
        ...
        def cylindrical_mesh_load_distribution_at_rotation(self):
            ...
            return self._parent._cast(_858.CylindricalMeshLoadDistributionAtRotation)

        @property
        def conical_mesh_load_distribution_at_rotation(self):
            from mastapy.gears.ltca.conical import _868
            
            return self._parent._cast(_868.ConicalMeshLoadDistributionAtRotation)
    ...
    @property
    def gear_a_in_mesh(self) -> '_846.MeshedGearLoadDistributionAnalysisAtRotation':
    ...
    @property
    def gear_b_in_mesh(self) -> '_846.MeshedGearLoadDistributionAnalysisAtRotation':
    ...
    @property
    def loaded_contact_lines(self) -> 'List[_840.GearMeshLoadedContactLine]':
    ...
    @property
    def meshed_gears(self) -> 'List[_846.MeshedGearLoadDistributionAnalysisAtRotation]':
