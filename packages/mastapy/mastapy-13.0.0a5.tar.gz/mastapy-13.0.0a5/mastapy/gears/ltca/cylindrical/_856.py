...
class CylindricalGearMeshLoadedContactPoint(_841.GearMeshLoadedContactPoint):
    """CylindricalGearMeshLoadedContactPoint
    ...
    class _Cast_CylindricalGearMeshLoadedContactPoint:
        ...
        def gear_mesh_loaded_contact_point(self):
            return self._parent._cast(_841.GearMeshLoadedContactPoint)
    ...
    @property
    def gear_a_profile_measurement(self) -> '_1022.CylindricalGearProfileMeasurement':
    ...
    @property
    def gear_b_profile_measurement(self) -> '_1022.CylindricalGearProfileMeasurement':
    ...
    @property
    def tooth_flank_fracture_analysis_gear_a(self) -> '_523.ToothFlankFractureAnalysisContactPointMethodA':
    ...
    @property
    def tooth_flank_fracture_analysis_gear_b(self) -> '_523.ToothFlankFractureAnalysisContactPointMethodA':
