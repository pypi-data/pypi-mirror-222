...
class CylindricalGearMeshLoadDistributionAnalysis(_838.GearMeshLoadDistributionAnalysis):
    """CylindricalGearMeshLoadDistributionAnalysis
    ...
    @property
    def cylindrical_mesh_load_case(self) -> '_881.CylindricalMeshLoadCase':
    ...
    @property
    def gear_a_in_mesh(self) -> '_829.CylindricalMeshedGearLoadDistributionAnalysis':
    ...
    @property
    def gear_b_in_mesh(self) -> '_829.CylindricalMeshedGearLoadDistributionAnalysis':
    ...
    @property
    def mesh_micro_geometry(self) -> '_1094.CylindricalGearMeshMicroGeometry':
    ...
    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_858.CylindricalMeshLoadDistributionAtRotation]':
    ...
    @property
    def meshed_gears(self) -> 'List[_829.CylindricalMeshedGearLoadDistributionAnalysis]':
