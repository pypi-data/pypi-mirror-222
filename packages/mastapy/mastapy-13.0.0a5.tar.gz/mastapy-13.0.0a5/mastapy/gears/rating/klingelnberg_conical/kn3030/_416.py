...
class KlingelnbergCycloPalloidHypoidMeshSingleFlankRating(_412.KlingelnbergConicalMeshSingleFlankRating):
    """KlingelnbergCycloPalloidHypoidMeshSingleFlankRating
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_415.KlingelnbergCycloPalloidHypoidGearSingleFlankRating]':
    ...
    @property
    def kn3030_klingelnberg_gear_single_flank_ratings(self) -> 'List[_415.KlingelnbergCycloPalloidHypoidGearSingleFlankRating]':
