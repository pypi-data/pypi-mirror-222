...
class AGMAScuffingResultsRow(_481.ScuffingResultsRow):
    """AGMAScuffingResultsRow
    ...
    class _Cast_AGMAScuffingResultsRow:
        ...
        def scuffing_results_row(self):
            return self._parent._cast(_481.ScuffingResultsRow)
    ...
    @property
    def specific_film_thickness_with_filter_cutoff_wavelength_isothermal(self) -> 'float':
    ...
    def specific_film_thickness_with_filter_cutoff_wavelength_isothermal(self, value: 'float'):
        self.wrapped.SpecificFilmThicknessWithFilterCutoffWavelengthIsothermal = float(value) if value is not None else 0.0

    @property
    def specific_film_thickness_with_filter_cutoff_wavelength_with_inlet_shear_heating(self) -> 'float':
    ...
    def specific_film_thickness_with_filter_cutoff_wavelength_with_inlet_shear_heating(self, value: 'float'):
