...
class ToothFlankFractureAnalysisContactPointCommon(_0.APIBase):
    ...
    class _Cast_ToothFlankFractureAnalysisContactPointCommon:
        ...
        def tooth_flank_fracture_analysis_contact_point(self):
            ...
            return self._parent._cast(_521.ToothFlankFractureAnalysisContactPoint)

        @property
        def tooth_flank_fracture_analysis_contact_point_method_a(self):
            from mastapy.gears.rating.cylindrical.iso6336 import _523
            
            return self._parent._cast(_523.ToothFlankFractureAnalysisContactPointMethodA)
    ...
    @property
    def analysis_point_with_maximum_local_material_exposure(self) -> '_525.ToothFlankFractureAnalysisPoint':
    ...
    @property
    def watch_points(self) -> 'List[_525.ToothFlankFractureAnalysisPoint]':
