...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.cylindrical.iso6336 import _511, _516
...
class ISO6336AbstractMetalMeshSingleFlankRating(_515.ISO6336AbstractMeshSingleFlankRating):
    """ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_1069.ScuffingTemperatureMethodsISO':
    ...
    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_511.ISO63362006MeshSingleFlankRating':
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_457.CylindricalGearMicroPittingResults':
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_516.ISO6336AbstractMetalGearSingleFlankRating]':
