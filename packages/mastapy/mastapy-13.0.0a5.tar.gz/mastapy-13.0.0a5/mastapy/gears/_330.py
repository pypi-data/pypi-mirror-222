...
class GearSetOptimiser(_0.APIBase):
    ...
    class _Cast_GearSetOptimiser:
        ...
        def cylindrical_gear_set_macro_geometry_optimiser(self):
            ...
            return self._parent._cast(_1027.CylindricalGearSetMacroGeometryOptimiser)
    ...
    def perform_strength_optimisation_with_progress(self, number_of_results: 'int', progress: '_7525.TaskProgress', use_current_design_as_starting_point: Optional['bool'] = False) -> '_329.GearSetOptimisationResults':
    ...
    def perform_strength_optimisation(self, number_of_results: 'int', use_current_design_as_starting_point: Optional['bool'] = False) -> '_329.GearSetOptimisationResults':
        """ 'PerformStrengthOptimisation' is the original name of this method.
