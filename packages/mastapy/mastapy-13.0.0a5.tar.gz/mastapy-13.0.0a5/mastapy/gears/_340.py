...
class PocketingPowerLossCoefficients(_1818.NamedDatabaseItem):
    """PocketingPowerLossCoefficients
    ...
    @property
    def raw_pocketing_power_loss_lookup_table(self) -> '_1556.GriddedSurfaceAccessor':
    ...
    def raw_pocketing_power_loss_lookup_table(self, value: '_1556.GriddedSurfaceAccessor'):
    ...
    @property
    def specifications_for_the_effect_of_oil_kinematic_viscosity(self) -> 'List[_344.SpecificationForTheEffectOfOilKinematicViscosity]':
