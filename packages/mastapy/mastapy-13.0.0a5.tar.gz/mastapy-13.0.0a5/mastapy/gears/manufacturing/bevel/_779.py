...
class ConicalMeshFlankMicroGeometryConfig(_0.APIBase):
    ...
    class _Cast_ConicalMeshFlankMicroGeometryConfig:
        ...
        def conical_mesh_flank_manufacturing_config(self):
            ...
            return self._parent._cast(_778.ConicalMeshFlankManufacturingConfig)

        @property
        def conical_mesh_flank_nurbs_micro_geometry_config(self):
            from mastapy.gears.manufacturing.bevel import _780
            
            return self._parent._cast(_780.ConicalMeshFlankNURBSMicroGeometryConfig)
    ...
    @property
    def specified_ease_off_surface(self) -> '_1169.ConicalGearFlankMicroGeometry':
