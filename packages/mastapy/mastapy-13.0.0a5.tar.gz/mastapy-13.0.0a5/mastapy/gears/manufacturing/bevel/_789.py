...
class ConicalSetMicroGeometryConfig(_790.ConicalSetMicroGeometryConfigBase):
    """ConicalSetMicroGeometryConfig
    ...
    @property
    def gear_micro_geometry_configuration(self) -> 'List[_774.ConicalGearMicroGeometryConfig]':
    ...
    @property
    def meshes(self) -> 'List[_783.ConicalMeshMicroGeometryConfig]':
