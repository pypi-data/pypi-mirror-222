...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _642, _643, _650
...
class PlungeShaverInputsAndMicroGeometry(_0.APIBase):
    ...
    @property
    def points_of_interest_left_flank(self) -> 'List[_650.PointOfInterest]':
    ...
    @property
    def points_of_interest_right_flank(self) -> 'List[_650.PointOfInterest]':
