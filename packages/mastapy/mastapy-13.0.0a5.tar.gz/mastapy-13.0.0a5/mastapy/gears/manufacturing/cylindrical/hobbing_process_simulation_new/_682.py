...
class ProcessSimulationInput(_0.APIBase):
    ...
    class _Cast_ProcessSimulationInput:
        ...
        def hobbing_process_simulation_input(self):
            ...
            return self._parent._cast(_669.HobbingProcessSimulationInput)
        ...
        def worm_grinding_process_simulation_input(self):
            ...
            return self._parent._cast(_696.WormGrindingProcessSimulationInput)
    ...
    @property
    def analysis_setting(self) -> '_656.AnalysisMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.Manufacturing.Cylindrical.HobbingProcessSimulationNew.AnalysisMethod')
        return constructor.new_from_mastapy('mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new._656', 'AnalysisMethod')(value) if value is not None else None

    @analysis_setting.setter
    def analysis_setting(self, value: '_656.AnalysisMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Manufacturing.Cylindrical.HobbingProcessSimulationNew.AnalysisMethod')
    ...
    @property
    def centre_distance_offset_specification_method(self) -> '_660.CentreDistanceOffsetMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.Manufacturing.Cylindrical.HobbingProcessSimulationNew.CentreDistanceOffsetMethod')
        return constructor.new_from_mastapy('mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new._660', 'CentreDistanceOffsetMethod')(value) if value is not None else None

    @centre_distance_offset_specification_method.setter
    def centre_distance_offset_specification_method(self, value: '_660.CentreDistanceOffsetMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Manufacturing.Cylindrical.HobbingProcessSimulationNew.CentreDistanceOffsetMethod')
    ...
    @property
    def user_specified_center_distance_offset_relative_to_cutter_height(self) -> '_1525.Vector2DListAccessor':
    ...
    def user_specified_center_distance_offset_relative_to_cutter_height(self, value: '_1525.Vector2DListAccessor'):
        self.wrapped.UserSpecifiedCenterDistanceOffsetRelativeToCutterHeight = value

    @property
    def cutter_head_slide_error(self) -> '_661.CutterHeadSlideError':
    ...
    @property
    def cutter_mounting_error(self) -> '_687.RackMountingError':
    ...
    @property
    def gear_mounting_error(self) -> '_662.GearMountingError':
