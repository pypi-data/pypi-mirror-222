...
class CylindricalGearShaper(_715.InvoluteCutterDesign):
    """CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_1070.ShaperEdgeTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.ShaperEdgeTypes')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.cylindrical._1070', 'ShaperEdgeTypes')(value) if value is not None else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_1070.ShaperEdgeTypes'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.ShaperEdgeTypes')
