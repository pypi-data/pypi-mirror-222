...
if TYPE_CHECKING:
    ...
    from mastapy.gears.manufacturing.cylindrical import _631, _632
...
class CylindricalGearSpecifiedMicroGeometry(_0.APIBase):
    ...
    @property
    def lead_micro_geometry(self) -> '_631.MicroGeometryInputsLead':
    ...
    @property
    def profile_micro_geometry(self) -> 'List[_632.MicroGeometryInputsProfile]':
