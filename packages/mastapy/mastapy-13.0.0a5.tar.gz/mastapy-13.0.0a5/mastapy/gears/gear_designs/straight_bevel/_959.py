...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.straight_bevel import _960, _958, _961
...
class StraightBevelGearMeshDesign(_1177.BevelGearMeshDesign):
    """StraightBevelGearMeshDesign
    ...
    @property
    def straight_bevel_meshed_gears(self) -> 'List[_961.StraightBevelMeshedGearDesign]':
