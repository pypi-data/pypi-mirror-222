...
class CylindricalGearBiasModification(_566.BiasModification):
    """CylindricalGearBiasModification
    ...
    @property
    def profile_evaluation_lower_limit(self) -> '_1022.CylindricalGearProfileMeasurement':
    ...
    @property
    def profile_evaluation_upper_limit(self) -> '_1022.CylindricalGearProfileMeasurement':
