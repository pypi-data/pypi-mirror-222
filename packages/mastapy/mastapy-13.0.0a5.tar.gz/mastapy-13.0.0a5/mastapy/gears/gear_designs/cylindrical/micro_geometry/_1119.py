...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    @property
    def gear_option(self) -> '_1108.DrawDefiningGearOrBoth':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.MicroGeometry.DrawDefiningGearOrBoth')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.cylindrical.micro_geometry._1108', 'DrawDefiningGearOrBoth')(value) if value is not None else None

    @gear_option.setter
    def gear_option(self, value: '_1108.DrawDefiningGearOrBoth'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.MicroGeometry.DrawDefiningGearOrBoth')
