...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import (
        _1043, _995, _1019, _1056,
        _1026, _1059, _1066, _1084,
        _1009, _1015, _1027
    )
...
class CylindricalGearSetDesign(_947.GearSetDesign):
    """CylindricalGearSetDesign
    ...
    @property
    def gear_fit_system(self) -> '_1043.GearFitSystems':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.GearFitSystems')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.cylindrical._1043', 'GearFitSystems')(value) if value is not None else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_1043.GearFitSystems'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.GearFitSystems')
    ...
    @property
    def helical_gear_micro_geometry_option(self) -> '_507.HelicalGearMicroGeometryOption':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.Rating.Cylindrical.ISO6336.HelicalGearMicroGeometryOption')
        return constructor.new_from_mastapy('mastapy.gears.rating.cylindrical.iso6336._507', 'HelicalGearMicroGeometryOption')(value) if value is not None else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_507.HelicalGearMicroGeometryOption'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Rating.Cylindrical.ISO6336.HelicalGearMicroGeometryOption')
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_995.AddendumModificationDistributionRule':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.AddendumModificationDistributionRule')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.cylindrical._995', 'AddendumModificationDistributionRule')(value) if value is not None else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_995.AddendumModificationDistributionRule'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.AddendumModificationDistributionRule')
    ...
    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_622.CylindricalSetManufacturingConfig':
    ...
    @property
    def ltca_settings(self) -> '_1056.LTCASettings':
    ...
    @property
    def left_flank(self) -> '_1026.CylindricalGearSetFlankDesign':
    ...
    @property
    def micropitting(self) -> '_1059.Micropitting':
    ...
    @property
    def right_flank(self) -> '_1026.CylindricalGearSetFlankDesign':
    ...
    @property
    def gears(self) -> 'List[_1009.CylindricalGearDesign]':
    ...
    @property
    def cylindrical_gears(self) -> 'List[_1009.CylindricalGearDesign]':
    ...
    @property
    def cylindrical_meshes(self) -> 'List[_1015.CylindricalGearMeshDesign]':
    ...
    @property
    def flanks(self) -> 'List[_1026.CylindricalGearSetFlankDesign]':
    ...
    @property
    def both_flanks(self) -> '_1026.CylindricalGearSetFlankDesign':
    ...
    @property
    def micro_geometries(self) -> 'List[_1103.CylindricalGearSetMicroGeometry]':
    ...
    @property
    def manufacturing_configurations(self) -> 'List[_622.CylindricalSetManufacturingConfig]':
    ...
    def add_new_manufacturing_configuration(self, new_config_name: Optional['str'] = 'None') -> '_622.CylindricalSetManufacturingConfig':
    ...
    def add_new_micro_geometry(self) -> '_1103.CylindricalGearSetMicroGeometry':
    ...
    def add_new_micro_geometry_specifying_separate_micro_geometry_per_tooth(self) -> '_1103.CylindricalGearSetMicroGeometry':
    ...
    def add_new_micro_geometry_specifying_separate_micro_geometry_per_tooth_for(self, gears: 'List[_1009.CylindricalGearDesign]') -> '_1103.CylindricalGearSetMicroGeometry':
    ...
    def create_optimiser(self, duty_cycle: '_461.CylindricalGearSetDutyCycleRating') -> '_1027.CylindricalGearSetMacroGeometryOptimiser':
    ...
    def delete_manufacturing_configuration(self, config: '_622.CylindricalSetManufacturingConfig'):
    ...
    def delete_micro_geometry(self, micro_geometry: '_1103.CylindricalGearSetMicroGeometry'):
    ...
    def micro_geometry_named(self, micro_geometry_name: 'str') -> '_1103.CylindricalGearSetMicroGeometry':
    ...
    def set_active_manufacturing_configuration(self, value: '_622.CylindricalSetManufacturingConfig'):
    ...
    def set_active_micro_geometry(self, value: '_1103.CylindricalGearSetMicroGeometry'):
