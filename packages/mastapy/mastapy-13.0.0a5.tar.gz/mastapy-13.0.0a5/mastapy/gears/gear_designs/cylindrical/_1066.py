...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1067, _1068, _1069
...
class Scuffing(_1577.IndependentReportablePropertiesBase['Scuffing']):
    """Scuffing
    ...
    @property
    def scuffing_temperature_method_agma(self) -> '_1068.ScuffingTemperatureMethodsAGMA':
    ...
    def scuffing_temperature_method_agma(self, value: '_1068.ScuffingTemperatureMethodsAGMA'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.ScuffingTemperatureMethodsAGMA')
        self.wrapped.ScuffingTemperatureMethodAGMA = value

    @property
    def scuffing_temperature_method_iso(self) -> '_1069.ScuffingTemperatureMethodsISO':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.ScuffingTemperatureMethodsISO')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.cylindrical._1069', 'ScuffingTemperatureMethodsISO')(value) if value is not None else None

    @scuffing_temperature_method_iso.setter
    def scuffing_temperature_method_iso(self, value: '_1069.ScuffingTemperatureMethodsISO'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.ScuffingTemperatureMethodsISO')
