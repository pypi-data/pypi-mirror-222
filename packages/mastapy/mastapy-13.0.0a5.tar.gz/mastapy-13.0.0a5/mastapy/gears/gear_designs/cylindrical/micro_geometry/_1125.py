...
class SingleCylindricalGearTriangularEndModification(_0.APIBase):
    ...
    class _Cast_SingleCylindricalGearTriangularEndModification:
        ...
        def linear_cylindrical_gear_triangular_end_modification(self):
            ...
            return self._parent._cast(_1113.LinearCylindricalGearTriangularEndModification)
        ...
        def parabolic_cylindrical_gear_triangular_end_modification(self):
            ...
            return self._parent._cast(_1120.ParabolicCylindricalGearTriangularEndModification)
    ...
    @property
    def profile_evaluation(self) -> '_1022.CylindricalGearProfileMeasurement':
    ...
    @property
    def profile_start(self) -> '_1022.CylindricalGearProfileMeasurement':
