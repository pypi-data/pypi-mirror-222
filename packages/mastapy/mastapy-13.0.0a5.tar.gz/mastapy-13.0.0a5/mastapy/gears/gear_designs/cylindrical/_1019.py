...
class CylindricalGearMicroGeometrySettingsItem(_1818.NamedDatabaseItem):
    """CylindricalGearMicroGeometrySettingsItem
    ...
    @property
    def default_flank_side_with_zero_face_width(self) -> '_568.FlankSide':
    ...
    def default_flank_side_with_zero_face_width(self, value: '_568.FlankSide'):
    ...
    @property
    def default_micro_geometry_lead_tolerance_chart_view(self) -> '_1118.MicroGeometryLeadToleranceChartView':
    ...
    def default_micro_geometry_lead_tolerance_chart_view(self, value: '_1118.MicroGeometryLeadToleranceChartView'):
    ...
    @property
    def default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(self) -> '_1041.DoubleAxisScaleAndRange':
    ...
    def default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(self, value: '_1041.DoubleAxisScaleAndRange'):
    ...
    @property
    def ltca_root_stress_surface_chart_option(self) -> '_1065.RootStressSurfaceChartOption':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.RootStressSurfaceChartOption')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.cylindrical._1065', 'RootStressSurfaceChartOption')(value) if value is not None else None

    @ltca_root_stress_surface_chart_option.setter
    def ltca_root_stress_surface_chart_option(self, value: '_1065.RootStressSurfaceChartOption'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.RootStressSurfaceChartOption')
        self.wrapped.LTCARootStressSurfaceChartOption = value

    @property
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(self) -> '_574.MainProfileReliefEndsAtTheStartOfRootReliefOption':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.MicroGeometry.MainProfileReliefEndsAtTheStartOfRootReliefOption')
        return constructor.new_from_mastapy('mastapy.gears.micro_geometry._574', 'MainProfileReliefEndsAtTheStartOfRootReliefOption')(value) if value is not None else None

    @main_profile_modification_ends_at_the_start_of_root_relief_by_default.setter
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(self, value: '_574.MainProfileReliefEndsAtTheStartOfRootReliefOption'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.MicroGeometry.MainProfileReliefEndsAtTheStartOfRootReliefOption')
        self.wrapped.MainProfileModificationEndsAtTheStartOfRootReliefByDefault = value

    @property
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(self) -> '_575.MainProfileReliefEndsAtTheStartOfTipReliefOption':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.MicroGeometry.MainProfileReliefEndsAtTheStartOfTipReliefOption')
        return constructor.new_from_mastapy('mastapy.gears.micro_geometry._575', 'MainProfileReliefEndsAtTheStartOfTipReliefOption')(value) if value is not None else None

    @main_profile_modification_ends_at_the_start_of_tip_relief_by_default.setter
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(self, value: '_575.MainProfileReliefEndsAtTheStartOfTipReliefOption'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.MicroGeometry.MainProfileReliefEndsAtTheStartOfTipReliefOption')
    ...
    @property
    def micro_geometry_lead_relief_definition(self) -> '_1057.MicroGeometryConvention':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.MicroGeometryConvention')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.cylindrical._1057', 'MicroGeometryConvention')(value) if value is not None else None

    @micro_geometry_lead_relief_definition.setter
    def micro_geometry_lead_relief_definition(self, value: '_1057.MicroGeometryConvention'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.MicroGeometryConvention')
        self.wrapped.MicroGeometryLeadReliefDefinition = value

    @property
    def micro_geometry_profile_relief_definition(self) -> '_1058.MicroGeometryProfileConvention':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.MicroGeometryProfileConvention')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.cylindrical._1058', 'MicroGeometryProfileConvention')(value) if value is not None else None

    @micro_geometry_profile_relief_definition.setter
    def micro_geometry_profile_relief_definition(self, value: '_1058.MicroGeometryProfileConvention'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Cylindrical.MicroGeometryProfileConvention')
    ...
    @property
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(self) -> '_577.ParabolicRootReliefStartsTangentToMainProfileRelief':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.MicroGeometry.ParabolicRootReliefStartsTangentToMainProfileRelief')
        return constructor.new_from_mastapy('mastapy.gears.micro_geometry._577', 'ParabolicRootReliefStartsTangentToMainProfileRelief')(value) if value is not None else None

    @parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default.setter
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(self, value: '_577.ParabolicRootReliefStartsTangentToMainProfileRelief'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.MicroGeometry.ParabolicRootReliefStartsTangentToMainProfileRelief')
        self.wrapped.ParabolicRootReliefStartsTangentToMainProfileReliefByDefault = value

    @property
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(self) -> '_578.ParabolicTipReliefStartsTangentToMainProfileRelief':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.MicroGeometry.ParabolicTipReliefStartsTangentToMainProfileRelief')
        return constructor.new_from_mastapy('mastapy.gears.micro_geometry._578', 'ParabolicTipReliefStartsTangentToMainProfileRelief')(value) if value is not None else None

    @parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default.setter
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(self, value: '_578.ParabolicTipReliefStartsTangentToMainProfileRelief'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.MicroGeometry.ParabolicTipReliefStartsTangentToMainProfileRelief')
