...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.hypoid import _982, _983
...
class HypoidGearSetDesign(_1191.AGMAGleasonConicalGearSetDesign):
    """HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_982.HypoidGearDesign]':
    ...
    @property
    def meshes(self) -> 'List[_983.HypoidGearMeshDesign]':
    ...
    @property
    def hypoid_meshes(self) -> 'List[_983.HypoidGearMeshDesign]':
