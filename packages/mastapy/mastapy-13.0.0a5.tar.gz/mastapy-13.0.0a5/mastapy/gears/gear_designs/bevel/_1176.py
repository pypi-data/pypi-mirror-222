...
class BevelGearDesign(_1189.AGMAGleasonConicalGearDesign):
    """BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1182.FinishingMethods':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Bevel.FinishingMethods')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.bevel._1182', 'FinishingMethods')(value) if value is not None else None

    @finishing_method.setter
    def finishing_method(self, value: '_1182.FinishingMethods'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Bevel.FinishingMethods')
