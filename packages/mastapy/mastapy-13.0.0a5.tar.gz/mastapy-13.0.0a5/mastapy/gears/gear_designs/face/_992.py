...
class FaceGearSetDesign(_947.GearSetDesign):
    """FaceGearSetDesign
    ...
    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_993.FaceGearSetMicroGeometry':
    ...
    @property
    def face_gear(self) -> '_994.FaceGearWheelDesign':
    ...
    @property
    def pinion(self) -> '_991.FaceGearPinionDesign':
    ...
    @property
    def gears(self) -> 'List[_986.FaceGearDesign]':
    ...
    @property
    def face_meshes(self) -> 'List[_988.FaceGearMeshDesign]':
