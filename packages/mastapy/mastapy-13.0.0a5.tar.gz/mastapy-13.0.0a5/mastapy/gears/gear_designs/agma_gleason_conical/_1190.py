...
class AGMAGleasonConicalGearMeshDesign(_1151.ConicalGearMeshDesign):
    """AGMAGleasonConicalGearMeshDesign
    ...
    @property
    def iso10300_gear_set_finishing_methods(self) -> '_419.Iso10300FinishingMethods':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.Rating.Iso10300.Iso10300FinishingMethods')
        return constructor.new_from_mastapy('mastapy.gears.rating._419', 'Iso10300FinishingMethods')(value) if value is not None else None

    @iso10300_gear_set_finishing_methods.setter
    def iso10300_gear_set_finishing_methods(self, value: '_419.Iso10300FinishingMethods'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Rating.Iso10300.Iso10300FinishingMethods')
    ...
    @property
    def mounting_conditions_of_pinion_and_wheel(self) -> '_432.MountingConditionsOfPinionAndWheel':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.Rating.Iso10300.MountingConditionsOfPinionAndWheel')
        return constructor.new_from_mastapy('mastapy.gears.rating._432', 'MountingConditionsOfPinionAndWheel')(value) if value is not None else None

    @mounting_conditions_of_pinion_and_wheel.setter
    def mounting_conditions_of_pinion_and_wheel(self, value: '_432.MountingConditionsOfPinionAndWheel'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Rating.Iso10300.MountingConditionsOfPinionAndWheel')
    ...
    @property
    def profile_crowning_setting(self) -> '_434.ProfileCrowningSetting':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.Rating.Iso10300.ProfileCrowningSetting')
        return constructor.new_from_mastapy('mastapy.gears.rating._434', 'ProfileCrowningSetting')(value) if value is not None else None

    @profile_crowning_setting.setter
    def profile_crowning_setting(self, value: '_434.ProfileCrowningSetting'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Rating.Iso10300.ProfileCrowningSetting')
    ...
    @property
    def verification_of_contact_pattern(self) -> '_435.VerificationOfContactPattern':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.Rating.Iso10300.VerificationOfContactPattern')
        return constructor.new_from_mastapy('mastapy.gears.rating._435', 'VerificationOfContactPattern')(value) if value is not None else None

    @verification_of_contact_pattern.setter
    def verification_of_contact_pattern(self, value: '_435.VerificationOfContactPattern'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.Rating.Iso10300.VerificationOfContactPattern')
