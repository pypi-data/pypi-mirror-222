...
class WormDesign(_954.WormGearDesign):
    """WormDesign
    ...
    @property
    def addendum_factor(self) -> '_348.WormAddendumFactor':
        ...
        return constructor.new_from_mastapy('mastapy.gears._348', 'WormAddendumFactor')(value) if value is not None else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_348.WormAddendumFactor'):
