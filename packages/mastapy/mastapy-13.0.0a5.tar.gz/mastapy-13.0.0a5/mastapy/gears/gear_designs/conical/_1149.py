...
class ConicalGearCutter(_0.APIBase):
    ...
    @property
    def cutter_blade_type(self) -> '_1157.CutterBladeType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Conical.CutterBladeType')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.conical._1157', 'CutterBladeType')(value) if value is not None else None

    @cutter_blade_type.setter
    def cutter_blade_type(self, value: '_1157.CutterBladeType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Conical.CutterBladeType')
        self.wrapped.CutterBladeType = value

    @property
    def cutter_gauge_length(self) -> '_1158.CutterGaugeLengths':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Conical.CutterGaugeLengths')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.conical._1158', 'CutterGaugeLengths')(value) if value is not None else None

    @cutter_gauge_length.setter
    def cutter_gauge_length(self, value: '_1158.CutterGaugeLengths'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Conical.CutterGaugeLengths')
    ...
    @property
    def inner_toprem_letter_convex(self) -> '_1167.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_1167.TopremLetter'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Conical.TopremLetter')
        self.wrapped.InnerTopremLetterConvex = value

    @property
    def input_toprem_as(self) -> '_1166.TopremEntryType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Gears.GearDesigns.Conical.TopremEntryType')
        return constructor.new_from_mastapy('mastapy.gears.gear_designs.conical._1166', 'TopremEntryType')(value) if value is not None else None

    @input_toprem_as.setter
    def input_toprem_as(self, value: '_1166.TopremEntryType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Conical.TopremEntryType')
    ...
    @property
    def outer_toprem_letter_concave(self) -> '_1167.TopremLetter':
    ...
    def outer_toprem_letter_concave(self, value: '_1167.TopremLetter'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Gears.GearDesigns.Conical.TopremLetter')
