...
class GriddedSurface(_0.APIBase):
    ...
    def data_value_interpolated_at(self, row_value: 'float', column_value: 'float', row_extrapolation_option: '_1500.ExtrapolationOptions', column_extrapolation_option: '_1500.ExtrapolationOptions') -> 'float':
        ...
        row_extrapolation_option = conversion.mp_to_pn_enum(row_extrapolation_option, 'SMT.MastaAPI.MathUtility.ExtrapolationOptions')
        column_extrapolation_option = conversion.mp_to_pn_enum(column_extrapolation_option, 'SMT.MastaAPI.MathUtility.ExtrapolationOptions')
