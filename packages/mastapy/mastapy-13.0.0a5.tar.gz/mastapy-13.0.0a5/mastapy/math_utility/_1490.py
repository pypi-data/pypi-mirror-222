...
class CoordinateSystemEditor(_0.APIBase):
    ...
    @property
    def coordinate_system_for_rotation_axes(self) -> '_1491.CoordinateSystemForRotation':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.MathUtility.CoordinateSystemForRotation')
        return constructor.new_from_mastapy('mastapy.math_utility._1491', 'CoordinateSystemForRotation')(value) if value is not None else None

    @coordinate_system_for_rotation_axes.setter
    def coordinate_system_for_rotation_axes(self, value: '_1491.CoordinateSystemForRotation'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.MathUtility.CoordinateSystemForRotation')
        self.wrapped.CoordinateSystemForRotationAxes = value

    @property
    def coordinate_system_for_rotation_origin(self) -> '_1492.CoordinateSystemForRotationOrigin':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.MathUtility.CoordinateSystemForRotationOrigin')
        return constructor.new_from_mastapy('mastapy.math_utility._1492', 'CoordinateSystemForRotationOrigin')(value) if value is not None else None

    @coordinate_system_for_rotation_origin.setter
    def coordinate_system_for_rotation_origin(self, value: '_1492.CoordinateSystemForRotationOrigin'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.MathUtility.CoordinateSystemForRotationOrigin')
    ...
    @property
    def rotation_axis(self) -> '_1518.RotationAxis':
        ...
        return constructor.new_from_mastapy('mastapy.math_utility._1518', 'RotationAxis')(value) if value is not None else None

    @rotation_axis.setter
    def rotation_axis(self, value: '_1518.RotationAxis'):
    ...
    @property
    def modified_coordinate_system_for_rotation(self) -> '_1489.CoordinateSystem3D':
    ...
    @property
    def modified_coordinate_system_for_translation(self) -> '_1489.CoordinateSystem3D':
