...
class LoadedBolt(_0.APIBase):
    ...
    @property
    def axial_load_type(self) -> '_1455.AxialLoadType':
        ...
        return constructor.new_from_mastapy('mastapy.bolts._1455', 'AxialLoadType')(value) if value is not None else None

    @axial_load_type.setter
    def axial_load_type(self, value: '_1455.AxialLoadType'):
    ...
    @property
    def joint_type(self) -> '_1471.JointTypes':
        ...
        return constructor.new_from_mastapy('mastapy.bolts._1471', 'JointTypes')(value) if value is not None else None

    @joint_type.setter
    def joint_type(self, value: '_1471.JointTypes'):
    ...
    @property
    def tightening_technique(self) -> '_1477.TighteningTechniques':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Bolts.TighteningTechniques')
        return constructor.new_from_mastapy('mastapy.bolts._1477', 'TighteningTechniques')(value) if value is not None else None

    @tightening_technique.setter
    def tightening_technique(self, value: '_1477.TighteningTechniques'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Bolts.TighteningTechniques')
    ...
    @property
    def bolt(self) -> '_1467.DetailedBoltDesign':
