...
class VShapedMagnetLayerSpecification(_1286.RotorInternalLayerSpecification):
    """VShapedMagnetLayerSpecification
    ...
    @property
    def upper_flux_barrier_web_specification(self) -> '_1264.FluxBarrierOrWeb':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.ElectricMachines.FluxBarrierOrWeb')
        return constructor.new_from_mastapy('mastapy.electric_machines._1264', 'FluxBarrierOrWeb')(value) if value is not None else None

    @upper_flux_barrier_web_specification.setter
    def upper_flux_barrier_web_specification(self, value: '_1264.FluxBarrierOrWeb'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.ElectricMachines.FluxBarrierOrWeb')
