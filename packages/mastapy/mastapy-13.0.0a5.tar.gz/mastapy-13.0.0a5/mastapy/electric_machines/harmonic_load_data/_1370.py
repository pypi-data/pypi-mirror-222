...
class HarmonicLoadDataBase(_0.APIBase):
    ...
    class _Cast_HarmonicLoadDataBase:
        ...
        def conical_gear_set_harmonic_load_data(self):
            ...
            return self._parent._cast(_6815.ConicalGearSetHarmonicLoadData)

        @property
        def cylindrical_gear_set_harmonic_load_data(self):
            from mastapy.system_model.analyses_and_results.static_loads import _6832
            
            return self._parent._cast(_6832.CylindricalGearSetHarmonicLoadData)
    ...
    def set_selected_harmonic_load_data_with_fourier_series(self, fourier_series: '_1503.FourierSeries'):
    ...
    def set_selected_harmonic_load_data_extended(self, amplitudes: 'List[float]', phases: 'List[float]', mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7526.MeasurementType'):
        """ 'SetSelectedHarmonicLoadData' is the original name of this method.
    ...
    def set_selected_harmonic_load_data(self, fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7526.MeasurementType'):
        """ 'SetSelectedHarmonicLoadData' is the original name of this method.
