...
class ElectricMachineDetail(_0.APIBase):
    ...
    class _Cast_ElectricMachineDetail:
        ...
        def cad_electric_machine_detail(self):
            ...
            return self._parent._cast(_1242.CADElectricMachineDetail)
    ...
    @property
    def core_loss_build_factor_specification_method(self) -> '_1251.CoreLossBuildFactorSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.ElectricMachines.CoreLossBuildFactorSpecificationMethod')
        return constructor.new_from_mastapy('mastapy.electric_machines._1251', 'CoreLossBuildFactorSpecificationMethod')(value) if value is not None else None

    @core_loss_build_factor_specification_method.setter
    def core_loss_build_factor_specification_method(self, value: '_1251.CoreLossBuildFactorSpecificationMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.ElectricMachines.CoreLossBuildFactorSpecificationMethod')
    ...
    @property
    def electric_machine_type(self) -> '_1262.ElectricMachineType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.ElectricMachines.ElectricMachineType')
        return constructor.new_from_mastapy('mastapy.electric_machines._1262', 'ElectricMachineType')(value) if value is not None else None
    ...
    def select_setup(self) -> 'list_with_selected_item.ListWithSelectedItem_ElectricMachineSetup':
        ...
        return constructor.new_from_mastapy('mastapy._internal.implicit.list_with_selected_item', 'ListWithSelectedItem_ElectricMachineSetup')(temp) if temp is not None else None
    ...
    @property
    def non_linear_dq_model(self) -> '_1333.NonLinearDQModel':
    ...
    @property
    def selected_setup(self) -> '_1261.ElectricMachineSetup':
    ...
    @property
    def stator(self) -> '_1239.AbstractStator':
    ...
    @property
    def results_locations(self) -> 'List[_1512.Named2DLocation]':
    ...
    @property
    def setups(self) -> 'List[_1261.ElectricMachineSetup]':
    ...
    def add_setup(self) -> '_1261.ElectricMachineSetup':
    ...
    def duplicate_setup(self, setup: '_1261.ElectricMachineSetup') -> '_1261.ElectricMachineSetup':
    ...
    def generate_design_without_non_linear_dq_model(self) -> '_1582.MethodOutcomeWithResult[ElectricMachineDetail]':
    ...
    def remove_setup(self, setup: '_1261.ElectricMachineSetup'):
    ...
    def setup_named(self, name: 'str') -> '_1261.ElectricMachineSetup':
    ...
    def try_generate_non_linear_dq_model(self) -> '_1582.MethodOutcomeWithResult[ElectricMachineDetail]':
    ...
    def try_generate_non_linear_dq_model_with_task_progress(self, progress: '_7525.TaskProgress') -> '_1582.MethodOutcomeWithResult[ElectricMachineDetail]':
