...
if TYPE_CHECKING:
    from mastapy.electric_machines import (
        _1253, _1263, _1289, _1304,
        _1309, _1310, _1308, _1247,
        _1303, _1283, _1290
    )
...
class Windings(_0.APIBase):
    ...
    @property
    def double_layer_winding_slot_positions(self) -> '_1253.DoubleLayerWindingSlotPositions':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.ElectricMachines.DoubleLayerWindingSlotPositions')
        return constructor.new_from_mastapy('mastapy.electric_machines._1253', 'DoubleLayerWindingSlotPositions')(value) if value is not None else None

    @double_layer_winding_slot_positions.setter
    def double_layer_winding_slot_positions(self, value: '_1253.DoubleLayerWindingSlotPositions'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.ElectricMachines.DoubleLayerWindingSlotPositions')
    ...
    @property
    def fill_factor_specification_method(self) -> '_1263.FillFactorSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.ElectricMachines.FillFactorSpecificationMethod')
        return constructor.new_from_mastapy('mastapy.electric_machines._1263', 'FillFactorSpecificationMethod')(value) if value is not None else None

    @fill_factor_specification_method.setter
    def fill_factor_specification_method(self, value: '_1263.FillFactorSpecificationMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.ElectricMachines.FillFactorSpecificationMethod')
    ...
    def include_individual_conductors(self, value: 'bool'):
        self.wrapped.IncludeIndividualConductors = bool(value) if value is not None else False
    ...
    @property
    def single_double_layer_windings(self) -> '_1289.SingleOrDoubleLayerWindings':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.ElectricMachines.SingleOrDoubleLayerWindings')
        return constructor.new_from_mastapy('mastapy.electric_machines._1289', 'SingleOrDoubleLayerWindings')(value) if value is not None else None

    @single_double_layer_windings.setter
    def single_double_layer_windings(self, value: '_1289.SingleOrDoubleLayerWindings'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.ElectricMachines.SingleOrDoubleLayerWindings')
    ...
    def winding_connection(self, value: '_1304.WindingConnection'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.ElectricMachines.WindingConnection')
    ...
    @property
    def winding_type(self) -> '_1309.WindingType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.ElectricMachines.WindingType')
        return constructor.new_from_mastapy('mastapy.electric_machines._1309', 'WindingType')(value) if value is not None else None

    @winding_type.setter
    def winding_type(self, value: '_1309.WindingType'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.ElectricMachines.WindingType')
        self.wrapped.WindingType = value

    @property
    def wire_size_specification_method(self) -> '_1310.WireSizeSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.ElectricMachines.WireSizeSpecificationMethod')
        return constructor.new_from_mastapy('mastapy.electric_machines._1310', 'WireSizeSpecificationMethod')(value) if value is not None else None

    @wire_size_specification_method.setter
    def wire_size_specification_method(self, value: '_1310.WireSizeSpecificationMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.ElectricMachines.WireSizeSpecificationMethod')
    ...
    @property
    def windings_viewer(self) -> '_1308.WindingsViewer':
    ...
    @property
    def coils(self) -> 'List[_1247.Coil]':
    ...
    @property
    def phases(self) -> 'List[_1283.Phase]':
    ...
    @property
    def slot_section_details(self) -> 'List[_1290.SlotSectionDetail]':
