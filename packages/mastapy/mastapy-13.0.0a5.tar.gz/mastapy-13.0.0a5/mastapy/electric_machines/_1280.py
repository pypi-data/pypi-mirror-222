...
class NotchSpecification(_0.APIBase):
    ...
    @property
    def notch_shape(self) -> '_1279.NotchShape':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.ElectricMachines.NotchShape')
        return constructor.new_from_mastapy('mastapy.electric_machines._1279', 'NotchShape')(value) if value is not None else None

    @notch_shape.setter
    def notch_shape(self, value: '_1279.NotchShape'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.ElectricMachines.NotchShape')
