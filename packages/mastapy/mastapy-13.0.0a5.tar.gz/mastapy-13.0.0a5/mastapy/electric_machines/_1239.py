...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1240, _1307
...
class AbstractStator(_0.APIBase):
    ...
    class _Cast_AbstractStator:
        ...
        def cad_stator(self):
            ...
            return self._parent._cast(_1245.CADStator)

        @property
        def stator(self):
            from mastapy.electric_machines import _1291
            
            return self._parent._cast(_1291.Stator)
    ...
    @property
    def tooth_and_slot(self) -> '_1240.AbstractToothAndSlot':
