...
class ProgramSettings(_1585.PerMachineSettings):
    """ProgramSettings
    ...
    def check_for_new_version_on_startup(self) -> 'ProgramSettings.CheckForNewerVersionOption':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Utility.ProgramSettings+CheckForNewerVersionOption')
        return constructor.new_from_mastapy('mastapy.utility.ProgramSettings.ProgramSettings', 'CheckForNewerVersionOption')(value) if value is not None else None
    ...
    def check_for_new_version_on_startup(self, value: 'ProgramSettings.CheckForNewerVersionOption'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Utility.ProgramSettings+CheckForNewerVersionOption')
