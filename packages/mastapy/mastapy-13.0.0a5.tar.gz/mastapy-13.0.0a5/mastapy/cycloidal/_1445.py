...
class CycloidalDiscDesignExporter(_0.APIBase):
    ...
    @property
    def geometry_to_export(self) -> '_1450.GeometryToExport':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Cycloidal.GeometryToExport')
        return constructor.new_from_mastapy('mastapy.cycloidal._1450', 'GeometryToExport')(value) if value is not None else None

    @geometry_to_export.setter
    def geometry_to_export(self, value: '_1450.GeometryToExport'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Cycloidal.GeometryToExport')
    ...
    def profile_points(self, geometry_to_export: '_1450.GeometryToExport', include_modifications_in_export: 'bool', number_of_half_lobe_points_for_export: 'int') -> 'List[Vector2D]':
        ...
        geometry_to_export = conversion.mp_to_pn_enum(geometry_to_export, 'SMT.MastaAPI.Cycloidal.GeometryToExport')
