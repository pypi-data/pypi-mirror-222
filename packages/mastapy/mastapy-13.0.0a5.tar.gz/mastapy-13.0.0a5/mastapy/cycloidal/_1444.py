...
if TYPE_CHECKING:
    ...
    from mastapy.cycloidal import _1445, _1448
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def crowning_chart(self) -> '_1854.TwoDChartDefinition':
    ...
    @property
    def estimated_modifications_from_spline_fit(self) -> '_1854.TwoDChartDefinition':
    ...
    @property
    def exporter(self) -> '_1445.CycloidalDiscDesignExporter':
    ...
    @property
    def modifications_specification(self) -> '_1448.CycloidalDiscModificationsSpecification':
