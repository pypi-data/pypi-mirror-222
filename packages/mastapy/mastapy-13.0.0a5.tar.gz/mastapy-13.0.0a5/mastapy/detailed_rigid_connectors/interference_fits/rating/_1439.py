...
class InterferenceFitRating(_1426.ShaftHubConnectionRating):
    """InterferenceFitRating
    ...
    class _Cast_InterferenceFitRating:
        ...
        def keyway_rating(self):
            from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1432
            
            return self._parent._cast(_1432.KeywayRating)
