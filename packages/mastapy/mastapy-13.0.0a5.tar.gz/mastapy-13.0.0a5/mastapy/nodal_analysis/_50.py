...
class AnalysisSettingsItem(_1818.NamedDatabaseItem):
    """AnalysisSettingsItem
    ...
    @property
    def rating_type_for_bearing_reliability(self) -> '_81.RatingTypeForBearingReliability':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.NodalAnalysis.RatingTypeForBearingReliability')
        return constructor.new_from_mastapy('mastapy.nodal_analysis._81', 'RatingTypeForBearingReliability')(value) if value is not None else None

    @rating_type_for_bearing_reliability.setter
    def rating_type_for_bearing_reliability(self, value: '_81.RatingTypeForBearingReliability'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.NodalAnalysis.RatingTypeForBearingReliability')
        self.wrapped.RatingTypeForBearingReliability = value

    @property
    def rating_type_for_shaft_reliability(self) -> '_82.RatingTypeForShaftReliability':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.NodalAnalysis.RatingTypeForShaftReliability')
        return constructor.new_from_mastapy('mastapy.nodal_analysis._82', 'RatingTypeForShaftReliability')(value) if value is not None else None

    @rating_type_for_shaft_reliability.setter
    def rating_type_for_shaft_reliability(self, value: '_82.RatingTypeForShaftReliability'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.NodalAnalysis.RatingTypeForShaftReliability')
