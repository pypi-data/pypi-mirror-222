...
class GeometryModellerDimensions(_0.APIBase):
    ...
    @property
    def angle_dimensions(self) -> 'List[_153.GeometryModellerAngleDimension]':
    ...
    @property
    def count_dimensions(self) -> 'List[_154.GeometryModellerCountDimension]':
    ...
    @property
    def length_dimensions(self) -> 'List[_159.GeometryModellerLengthDimension]':
    ...
    @property
    def unitless_dimensions(self) -> 'List[_161.GeometryModellerUnitlessDimension]':
