...
class FEModel(_0.APIBase):
    ...
    @property
    def model_splitting_method(self) -> '_198.ModelSplittingMethod':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.NodalAnalysis.DevToolsAnalyses.ModelSplittingMethod')
        return constructor.new_from_mastapy('mastapy.nodal_analysis.dev_tools_analyses._198', 'ModelSplittingMethod')(value) if value is not None else None

    @model_splitting_method.setter
    def model_splitting_method(self, value: '_198.ModelSplittingMethod'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.NodalAnalysis.DevToolsAnalyses.ModelSplittingMethod')
    ...
    @property
    def beam_element_properties(self) -> 'List[_208.ElementPropertiesBeam]':
    ...
    @property
    def contact_pairs(self) -> 'List[_202.ContactPairReporting]':
    ...
    @property
    def coordinate_systems(self) -> 'List[_203.CoordinateSystemReporting]':
    ...
    @property
    def interface_element_properties(self) -> 'List[_209.ElementPropertiesInterface]':
    ...
    @property
    def mass_element_properties(self) -> 'List[_210.ElementPropertiesMass]':
    ...
    @property
    def materials(self) -> 'List[_216.MaterialPropertiesReporting]':
    ...
    @property
    def model_parts(self) -> 'List[_188.FEModelPart]':
    ...
    @property
    def other_element_properties(self) -> 'List[_207.ElementPropertiesBase]':
    ...
    @property
    def rigid_element_properties(self) -> 'List[_211.ElementPropertiesRigid]':
    ...
    @property
    def shell_element_properties(self) -> 'List[_212.ElementPropertiesShell]':
    ...
    @property
    def solid_element_properties(self) -> 'List[_213.ElementPropertiesSolid]':
    ...
    @property
    def spring_dashpot_element_properties(self) -> 'List[_214.ElementPropertiesSpringDashpot]':
    ...
    def get_all_element_details(self) -> '_206.ElementDetailsForFEModel':
    ...
    def get_all_node_details(self) -> '_217.NodeDetailsForFEModel':
