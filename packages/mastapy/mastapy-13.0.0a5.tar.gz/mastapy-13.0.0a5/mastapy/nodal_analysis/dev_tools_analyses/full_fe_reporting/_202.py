...
if TYPE_CHECKING:
    from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1231, _1232
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def constrained_surface_type(self) -> '_1231.ContactPairConstrainedSurfaceType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.FETools.VisToolsGlobal.VisToolsGlobalEnums.ContactPairConstrainedSurfaceType')
        return constructor.new_from_mastapy('mastapy.fe_tools.vis_tools_global.vis_tools_global_enums._1231', 'ContactPairConstrainedSurfaceType')(value) if value is not None else None
    ...
    @property
    def reference_surface_type(self) -> '_1232.ContactPairReferenceSurfaceType':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.FETools.VisToolsGlobal.VisToolsGlobalEnums.ContactPairReferenceSurfaceType')
        return constructor.new_from_mastapy('mastapy.fe_tools.vis_tools_global.vis_tools_global_enums._1232', 'ContactPairReferenceSurfaceType')(value) if value is not None else None
