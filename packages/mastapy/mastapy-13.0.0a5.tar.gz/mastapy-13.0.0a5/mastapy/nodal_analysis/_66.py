...
class FEStiffness(_0.APIBase):
    ...
    class _Cast_FEStiffness:
        ...
        def fe_substructure(self):
            ...
            return self._parent._cast(_2366.FESubstructure)
    ...
    @property
    def mass_matrix_mn_rad_s_kg(self) -> '_79.NodalMatrix':
    ...
    @property
    def stiffness_in_fe_coordinate_system_mn_rad(self) -> '_79.NodalMatrix':
    ...
    @property
    def stiffness_matrix(self) -> '_79.NodalMatrix':
    ...
    def set_stiffness_and_mass(self, stiffness: '_79.NodalMatrix', mass: Optional['_79.NodalMatrix'] = None):
