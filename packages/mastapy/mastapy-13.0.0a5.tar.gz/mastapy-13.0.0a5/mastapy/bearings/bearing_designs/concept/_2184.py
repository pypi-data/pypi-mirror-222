...
class ConceptAxialClearanceBearing(_2185.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_2183.BearingNodePosition':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Bearings.BearingDesigns.Concept.BearingNodePosition')
        return constructor.new_from_mastapy('mastapy.bearings.bearing_designs.concept._2183', 'BearingNodePosition')(value) if value is not None else None

    @node_position.setter
    def node_position(self, value: '_2183.BearingNodePosition'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Bearings.BearingDesigns.Concept.BearingNodePosition')
