...
class ThrustBallBearing(_2127.BallBearing):
    """ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1876.OuterRingMounting':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Bearings.OuterRingMounting')
        return constructor.new_from_mastapy('mastapy.bearings._1876', 'OuterRingMounting')(value) if value is not None else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1876.OuterRingMounting'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Bearings.OuterRingMounting')
