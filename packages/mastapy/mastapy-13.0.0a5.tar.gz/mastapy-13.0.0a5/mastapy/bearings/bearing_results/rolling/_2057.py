...
class RollingBearingFrictionCoefficients(_1577.IndependentReportablePropertiesBase['RollingBearingFrictionCoefficients']):
    """RollingBearingFrictionCoefficients
    ...
    def use_user_specified_f1_for_din7322010(self, value: 'bool'):
        self.wrapped.UseUserSpecifiedF1ForDIN7322010 = bool(value) if value is not None else False
    ...
    def user_specified_f1_for_din7322010(self, value: 'float'):
        self.wrapped.UserSpecifiedF1ForDIN7322010 = float(value) if value is not None else 0.0
    ...
    @property
    def iso14179_dynamic_equivalent_load_factors(self) -> '_1932.EquivalentLoadFactors':
    ...
    @property
    def iso14179_static_equivalent_load_factors(self) -> '_1932.EquivalentLoadFactors':
