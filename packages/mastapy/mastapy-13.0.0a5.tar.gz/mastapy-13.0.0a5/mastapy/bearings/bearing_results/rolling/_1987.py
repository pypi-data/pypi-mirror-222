...
class LoadedBallBearingElement(_2001.LoadedElement):
    """LoadedBallBearingElement
    ...
    @property
    def inner_race_contact_geometries(self) -> 'List[_1955.BallBearingRaceContactGeometry]':
    ...
    @property
    def outer_race_contact_geometries(self) -> 'List[_1955.BallBearingRaceContactGeometry]':
