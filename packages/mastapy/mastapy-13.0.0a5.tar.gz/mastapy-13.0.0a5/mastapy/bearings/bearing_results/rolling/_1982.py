...
class LoadedAxialThrustCylindricalRollerBearingRow(_2012.LoadedNonBarrelRollerBearingRow):
    """LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1981.LoadedAxialThrustCylindricalRollerBearingResults':
