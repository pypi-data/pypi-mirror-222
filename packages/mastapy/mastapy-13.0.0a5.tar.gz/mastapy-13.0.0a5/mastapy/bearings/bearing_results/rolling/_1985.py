...
class LoadedAxialThrustNeedleRollerBearingRow(_1982.LoadedAxialThrustCylindricalRollerBearingRow):
    """LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1984.LoadedAxialThrustNeedleRollerBearingResults':
