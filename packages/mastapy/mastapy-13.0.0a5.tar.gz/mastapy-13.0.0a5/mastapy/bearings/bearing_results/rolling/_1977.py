...
class LoadedAsymmetricSphericalRollerBearingRow(_2017.LoadedRollerBearingRow):
    """LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1976.LoadedAsymmetricSphericalRollerBearingResults':
