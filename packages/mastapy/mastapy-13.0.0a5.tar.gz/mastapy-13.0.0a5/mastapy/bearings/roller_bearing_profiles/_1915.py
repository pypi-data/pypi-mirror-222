...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self) -> '_1878.RollerBearingProfileTypes':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Bearings.RollerBearingProfileTypes')
        return constructor.new_from_mastapy('mastapy.bearings._1878', 'RollerBearingProfileTypes')(value) if value is not None else None

    @active_profile_type.setter
    def active_profile_type(self, value: '_1878.RollerBearingProfileTypes'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Bearings.RollerBearingProfileTypes')
        self.wrapped.ActiveProfileType = value

    @property
    def active_profile(self) -> '_1923.RollerBearingProfile':
