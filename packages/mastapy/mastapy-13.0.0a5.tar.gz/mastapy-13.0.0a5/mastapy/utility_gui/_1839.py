...
class ScalingDrawStyle(_0.APIBase):
    ...
    @property
    def bearing_force_arrows(self) -> '_1808.BearingForceArrowOption':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Utility.Enums.BearingForceArrowOption')
        return constructor.new_from_mastapy('mastapy.utility.enums._1808', 'BearingForceArrowOption')(value) if value is not None else None

    @bearing_force_arrows.setter
    def bearing_force_arrows(self, value: '_1808.BearingForceArrowOption'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Utility.Enums.BearingForceArrowOption')
