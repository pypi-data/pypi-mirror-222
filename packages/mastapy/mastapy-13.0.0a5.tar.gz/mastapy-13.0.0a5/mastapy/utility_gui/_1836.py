...
class DataInputFileOptions(_0.APIBase):
    ...
    class _Cast_DataInputFileOptions:
        ...
        def rotor_set_data_input_file_options(self):
            from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2540
            
            return self._parent._cast(_2540.RotorSetDataInputFileOptions)
        ...
        def multi_time_series_data_input_file_options(self):
            ...
            return self._parent._cast(_6964.MultiTimeSeriesDataInputFileOptions)
