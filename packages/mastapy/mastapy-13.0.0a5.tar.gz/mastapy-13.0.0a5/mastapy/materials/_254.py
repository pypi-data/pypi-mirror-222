...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    @property
    def bearing_iso762006_static_safety_factor_limit(self) -> '_257.ISO76StaticSafetyFactorLimits':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Materials.ISO76StaticSafetyFactorLimits')
        return constructor.new_from_mastapy('mastapy.materials._257', 'ISO76StaticSafetyFactorLimits')(value) if value is not None else None

    @bearing_iso762006_static_safety_factor_limit.setter
    def bearing_iso762006_static_safety_factor_limit(self, value: '_257.ISO76StaticSafetyFactorLimits'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Materials.ISO76StaticSafetyFactorLimits')
    ...
    @property
    def driven_machine_characteristics(self) -> '_289.WorkingCharacteristics':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Materials.WorkingCharacteristics')
        return constructor.new_from_mastapy('mastapy.materials._289', 'WorkingCharacteristics')(value) if value is not None else None

    @driven_machine_characteristics.setter
    def driven_machine_characteristics(self, value: '_289.WorkingCharacteristics'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Materials.WorkingCharacteristics')
        self.wrapped.DrivenMachineCharacteristics = value

    @property
    def driving_machine_characteristics(self) -> '_289.WorkingCharacteristics':
    ...
    def driving_machine_characteristics(self, value: '_289.WorkingCharacteristics'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Materials.WorkingCharacteristics')
    ...
    @property
    def gearing_type(self) -> '_253.GearingTypes':
        ...
        return constructor.new_from_mastapy('mastapy.materials._253', 'GearingTypes')(value) if value is not None else None

    @gearing_type.setter
    def gearing_type(self, value: '_253.GearingTypes'):
    ...
    @property
    def transmission_application(self) -> '_285.TransmissionApplications':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Materials.TransmissionApplications')
        return constructor.new_from_mastapy('mastapy.materials._285', 'TransmissionApplications')(value) if value is not None else None

    @transmission_application.setter
    def transmission_application(self, value: '_285.TransmissionApplications'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Materials.TransmissionApplications')
    ...
    @property
    def wind_turbine_standard(self) -> '_288.WindTurbineStandards':
        ...
        value = conversion.pn_to_mp_enum(temp, 'SMT.MastaAPI.Materials.WindTurbineStandards')
        return constructor.new_from_mastapy('mastapy.materials._288', 'WindTurbineStandards')(value) if value is not None else None

    @wind_turbine_standard.setter
    def wind_turbine_standard(self, value: '_288.WindTurbineStandards'):
        value = conversion.mp_to_pn_enum(value, 'SMT.MastaAPI.Materials.WindTurbineStandards')
    ...
    @property
    def air_properties(self) -> '_241.AirProperties':
    ...
    @property
    def vehicle_dynamics(self) -> '_287.VehicleDynamicsProperties':
