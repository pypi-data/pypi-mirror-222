...
class Pedigree:
    ...
    def _add_nodes(self, sample_index:xft.index.SampleIndex):
        uid = sample_index.unique_identifier.astype(str)
    ...
    def generation(self, K: int):
        ...
        """
        return nx.subgraph_view(ped.G, filter_node=lambda x: ped._generation_dict[x] == K)
    ...
    def generations(self, gens):
        ...
        """
        return nx.subgraph_view(ped.G, filter_node=lambda x: ped._generation_dict[x] in gens)
    ...
    def _add_offspring(self,
        ...
        """
        offspring_index = mating.offspring_sample_index
        uid = offspring_index.unique_identifier
        self._add_nodes(offspring_index)
        self._add_edges_from_arrays(
            mating.reproducing_maternal_index.unique_identifier, uid)
        self._add_edges_from_arrays(
            mating.reproducing_paternal_index.unique_identifier, uid)
