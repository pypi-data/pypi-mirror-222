...
class ClassifyRepository(Repository):
    ...
    def run_all_models(self, x_train, x_val, y_train, y_val):
        ...
        super().run_all_model_search(hyper_parameter_tuning, model_array)
    ...
    def run_all_visualize_models(self, x_train, x_val, y_train, y_val):
        ...
        super().run_all_model_search(hyper_parameter_tuning, self
                                     .create_model_visualize_entity_array(models, saved_model_array, y_train.shape[1]),
                                     should_run_search=False)

    def create_model_visualize_entity_array(self, models, saved_model_array, max_feature):
        saved_entity_array = []
        for model_path in saved_model_array:
            ...
            saved_entity_array.append(
                ModelVisualizeEntity(model, models.check_and_get_grid_entity(model_type, max_feature),
