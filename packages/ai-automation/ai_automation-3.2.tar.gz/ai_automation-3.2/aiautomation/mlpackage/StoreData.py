...
class InputOutputStream:
    ...
    def get_all_saved_model_path(self):
        ...
        for dir_name in os.listdir(self.storeDataDirName + Variable.allPickleFolderName):
            for model_dir_name in os.listdir(
                    self.storeDataDirName + Variable.allPickleFolderName + Variable.locationSeparator + dir_name):
                for search_dir_name in os.listdir(self.storeDataDirName + Variable.allPickleFolderName +
                                                  Variable.locationSeparator + dir_name + Variable.locationSeparator +
                                                  model_dir_name):
                    pickle_filename = self.storeDataDirName + Variable.allPickleFolderName + Variable\
                        .locationSeparator + dir_name + Variable.locationSeparator + model_dir_name + Variable\
                        .locationSeparator + search_dir_name
