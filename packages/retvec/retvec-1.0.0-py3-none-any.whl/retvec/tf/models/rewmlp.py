...
def build_rewmlp_from_config(config: Dict) -> tf.keras.Model:
    ...
    return REWMLP(
        ...
        aug_decoder_utf8_size=o.get("aug_decoder_utf8_size", 0),
        decoder_type=o.get("decoder_type", 'lstm')
    )
...
def REWMLP(
    ...
    outputs = build_outputs(
        ...
        aug_decoder_utf8_size=aug_decoder_utf8_size,
