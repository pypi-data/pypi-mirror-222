...
setup(
    ...
    download_url='https://github.com/mortazavilab/PyWGCNA/archive/refs/tags/v1.20.1.tar.gz',  # link to the tar.gz file associated with this release
