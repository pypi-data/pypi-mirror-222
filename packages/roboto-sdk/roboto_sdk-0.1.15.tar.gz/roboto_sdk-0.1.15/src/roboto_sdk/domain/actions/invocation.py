...
from ...http import PaginationToken
...
class Invocation:
    ...
    def get_logs(
        self, page_token: Optional[PaginationToken] = None
    ...
    def stream_logs(
        self, last_read: Optional[PaginationToken] = None
    ) -> collections.abc.Generator[LogRecord, None, Optional[PaginationToken]]:
