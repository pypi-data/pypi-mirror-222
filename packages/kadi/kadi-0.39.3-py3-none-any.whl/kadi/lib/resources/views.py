...
def update_roles(resource, roles, user=None):
    ...
    :param roles: A list of dictionaries containing the type, ID and role name of each
        subject whose role should be updated, which needs to correspond to the structure
        of :class:`.ResourceRolesSchema`.
