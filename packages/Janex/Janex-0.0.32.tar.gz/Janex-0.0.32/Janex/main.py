...
#        print(f"Distance: {distance}")
    ...
    def update_thesaurus(self, file_path):
        try:
            os.remove(f"{file_path}")
        except:
            print(f"Janex: '{file_path}' file does not appear to exist in your program's directory. Skipping deletion...")

        os.system(f"curl -o {file_path} https://raw.githubusercontent.com/Cipher58/intents-file/main/thesaurus.json")
