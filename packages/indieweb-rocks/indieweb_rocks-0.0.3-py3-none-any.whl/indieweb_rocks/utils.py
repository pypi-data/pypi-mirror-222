silos = {
    ...
    # "": ("", [r"(\w+)"]),
    # Mastodon
    "indieweb.social": ("indieweb.social", [r"@(\w+)"]),
    "plush.city": ("plush.city", [r"@(\w+)"]),
    "toot.cafe": ("toot.cafe", [r"@(\w+)"]),
    "mastodon.technology": ("mastodon.technology", [r"@(\w+)"]),
    "mas.to": ("mas.to", [r"@(\w+)"]),
    "toot.wales": ("toot.wales", [r"@(\w+)"]),
    "mastodon.social": ("mastodon.social", [r"@(\w+)"]),
    "XOXO Zone": ("xoxo.zone", [r"@(\w+)"]),
}
