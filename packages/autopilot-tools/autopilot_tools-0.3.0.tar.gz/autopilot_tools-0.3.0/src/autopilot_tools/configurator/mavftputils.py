...
from typing import Type, TypeVar, Sequence, NamedTuple, cast

from pymavlink.dialects.v20.ardupilotmega import MAVLink_file_transfer_protocol_message
from pymavlink.mavutil import mavfile

from autopilot_tools.configurator.ftp_filesystem import DataChunk, File, Folder
from autopilot_tools.exceptions import MavlinkTimeoutError, NoSessionsAvailable, UnknownError
    ...
    def list_directory(self, path: str) -> list:
        ...
        while there_is_more:
            ...
            if payload.opcode == OpCodes.ACK:
                result += payload.data[:payload.size].decode('ASCII')
        ...
        for line in result.strip('\0').split('\0'):
