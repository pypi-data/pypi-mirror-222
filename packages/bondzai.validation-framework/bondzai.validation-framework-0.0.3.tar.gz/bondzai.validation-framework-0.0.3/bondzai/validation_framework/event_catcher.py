...
class AgentEventCatcher:
    ...
    def __init__(self, agent: Agent, maxsize: int = 10):
        ...
        self.remover = {
            EventType.INFERENCE: self.agent.on_inference_done(self._inference_done),
            EventType.TRAINING: self.agent.on_training_done(self._training_done),
            EventType.FINAL_PROCESS: self.agent.on_final_process_done(self._final_process_done)
        }
        self.done = {}
        self.data = {}
