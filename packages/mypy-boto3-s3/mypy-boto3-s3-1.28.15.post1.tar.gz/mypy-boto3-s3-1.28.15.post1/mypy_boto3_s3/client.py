...
class S3Client(BaseClient):
    ...
    def put_bucket_encryption(
        ...
        *,
        Bucket: str,
        ServerSideEncryptionConfiguration: Union[
    ...
    def put_bucket_intelligent_tiering_configuration(
        ...
        *,
        Bucket: str,
        Id: str,
        IntelligentTieringConfiguration: Union[
    ...
    def put_bucket_metrics_configuration(
        ...
        *,
        Bucket: str,
        Id: str,
        MetricsConfiguration: Union[MetricsConfigurationTypeDef, MetricsConfigurationOutputTypeDef],
        ExpectedBucketOwner: str = ...
    ) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def put_bucket_ownership_controls(
        ...
        *,
        Bucket: str,
        OwnershipControls: Union[OwnershipControlsTypeDef, OwnershipControlsOutputTypeDef],
        ContentMD5: str = ...,
        ExpectedBucketOwner: str = ...
    ) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def put_object_retention(
        ...
        *,
        Bucket: str,
        Key: str,
        Retention: Union[ObjectLockRetentionTypeDef, ObjectLockRetentionOutputTypeDef] = ...,
        RequestPayer: Literal["requester"] = ...,
        VersionId: str = ...,
        BypassGovernanceRetention: bool = ...,
        ContentMD5: str = ...,
