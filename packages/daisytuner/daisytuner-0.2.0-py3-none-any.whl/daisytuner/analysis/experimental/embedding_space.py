...
class EmbeddingSpace:
    ...
    def from_dataset(
        cls,
        loop_nests: Union[Sequence[LoopNest], Dict[str, LoopNest]],
        model,
        hostname: str = None,
        arch: str = None,
    ) -> EmbeddingSpace:
        ...
        for name, loop_nest in tqdm(loop_nests_.items()):
            ...
            analysis = Profiling(loop_nest=loop_nest, hostname=hostname, arch=arch)
            try:
            ...
            # SOAP Analysis
            from daisytuner.analysis.experimental.soap_analysis import SOAPAnalysis
