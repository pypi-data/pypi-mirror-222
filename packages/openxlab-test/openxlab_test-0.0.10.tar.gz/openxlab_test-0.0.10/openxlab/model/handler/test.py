...
import openxlab
# method1
# openxlab.login(ak="ejbw79x7dn2mkweqlpro", sk="zep5rmjmvdagkb4jm73dlnpdz97obzn3lga628vp", re_login=True)
infer = Inference("mmocr/SVTR")
# infer.inference(['./demo_text_ocr.jpg'], var1='1', var2='2', var3=3)
result = infer.inference(['./demo_text_ocr.jpg'], var1='1', var2='2', var3=3)
# print(result)
