...
class Link(Container):
    ...
    def compose(self) -> ComposeResult:
        yield Center(
            Static(f"[@click=\"app.open_link('{self.url}')\"]{self.title}[/]", classes="trending_link_title"),
            Static(self.description, classes="trending_link_description"),
            Static("____________________________________________________________", classes="trending_link_delimeter"),
